...
perth_1987_data = pd.read_csv("../input/ldsedexcel/perth-1987.csv")


# import the 2015 data
perth_2015_data = pd.read_csv("../input/ldsedexcel/perth-2015.csv")

# add a new column for the 1987 data 

all_stations_data['perthtemp1987'] = perth_1987_data['Daily Mean Temperature']

# add a new column for the 2015 data 
all_stations_data['perthtemp2015'] = perth_2015_data['Daily Mean Temperature']
...
all_stations_data.describe()
# display a time series plot for the temperatures using the shortdate as the x variable

all_stations_data.plot(x='shortdate', y=['hurntemp1987', 'hurntemp2015', 'perthtemp1987', 'perthtemp2015'], figsize=(40,10))
plt.show()
...
print("perth 1987 temperature mean: "+str(all_stations_data['perthtemp1987'].mean()))
print("perth 1987 temperature standard deviation: "+str(all_stations_data['perthtemp1987'].std()))

# print the mean and standard deviation of the temperature for 2015

print("perth 2015 temperature mean: "+str(all_stations_data['perthtemp2015'].mean()))
print("perth 2015 temperature standard deviation: "+str(all_stations_data['perthtemp2015'].std()))

# display a boxplot for the temperatures for 1987 and 2015
all_stations_data.boxplot(column = ['perthtemp1987','perthtemp2015'], vert=False,figsize=(12, 4))
plt.show()