...
# List of distinct countries that have pollution units that are not "ppm"
# used distinct so that countries do not repeat
...
# List of pollutants that have value = 0.0
