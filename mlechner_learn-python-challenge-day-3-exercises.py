...
#q5.c.hint()
#q5.c.solution()
print("Integer on True returns", int(True))
print("Integer on False returns", int(False)) 
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    """
    if player_total >= 17:
        if player_total == 19 and player_aces == 1 and dealer_total == 6:
            return True
        elif player_total == 18 and player_aces == 1 and dealer_total >= 3 and dealer_total <= 6:
            return True
        elif player_total == 17 and player_aces == 1:
            return True
        return False
    else:
