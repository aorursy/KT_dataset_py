...
tables = (client.list_tables(dataset)) # Your code here
...
safe_config = bigquery.QueryJobConfig(maximum_bytes_billed=30**10)
...
def expert_finder(topic, client):
    ...
    bigquery.ScalarQueryParameter("topic1", "STRING", '%' + topic + '%'),

    ]



    safe_config.query_parameters = query_params
    ...
    return results
result1 = expert_finder("bigquery", client)
