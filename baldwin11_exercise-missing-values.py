...
col_names = X_train.columns[X_train.isna().any()] # Your code here
...
imputed_X_train.columns = list(X_train.columns.values)

imputed_X_valid.columns = list(X_valid.columns.values)
...
final_X_test.columns = list(X_test.columns.values)
