...
df_stat.columns=['Date','Team','Opponent','Goal Scored_A','Ball Possession %_A', 'Attempts_A','On-Target_A','Off-Target_A','Blocked_A','Corners_A','Offsides_A','Free Kicks_A','Saves_A','Pass Accuracy %_A',
                'Passes_A','Distance Covered (Kms)_A','Fouls Committed_A','Yellow Card_A','Yellow & Red_A','Red_A','Man of the Match_A','1st Goal_A','Date_D','Team_D','Opponent_D',
                 ...
                 'Passes_D','Distance Covered (Kms)_D','Fouls Committed_D','Yellow Card_D','Yellow & Red_D','Red_D','Man of the Match_D','1st Goal_D']
