...
# we scale our dataset to range between 0 and 1. In this dataset, the pixel values range from 0 to 255.
...
def multilayer_preceptron(x, no_classes, first_layer_neurons=256, second_layer_neurons=128):
    #first layer
...
#loss increases. This identifies overfitting in our network. How do we proceed? 
