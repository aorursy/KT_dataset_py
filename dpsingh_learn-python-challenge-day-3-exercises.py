...
def should_hit(player_total, dealer_total, player_aces):
    ...
    """
    if (player_total < dealer_total and player_aces == 1):
        return True
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if (player_total < 11):
        return True
    elif (player_aces == 0 and player_total > 11 and player_total < 16 and dealer_total < 6) :
        return False
    elif (player_aces == 0 and player_total < 16 and dealer_total > 7) :
        return True
    elif (player_aces == 0 and player_total > 17) :
        return False
    elif (player_aces == 1 and player_total <= 16) :
        return True
    elif (player_aces == 1 and player_total > 16) :
        return False
    else :
