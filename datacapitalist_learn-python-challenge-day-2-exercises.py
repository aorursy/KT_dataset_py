...
q1.solution()
q2.solution()
def to_smash(total_candies, nf = 3):
...
t = time()
print(round(t,1), "seconds since the Epoch")
...
print(slowest_call(sleep, 6, 2, 5))
q6.hint()
q6.solution()
print(print("Spam"))
q7.hint()
