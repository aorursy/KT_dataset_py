...
TRAIN_DIR = "../input/datafl/data/trainimg/"

TRAIN_ANNOTATION_FILE = "../input/datafl/data/scene_train_annotations_20170904.json"



VAL_DIR = "../input/datafl/data/valimg/"

VAL_ANNOTATION_FILE = "../input/datafl/data/scene_validation_annotations_20170908.json"

       
#ResNet50V2_TL

def ResNet50V2_TL(input_shape=(229,229,3),classes=80):
...
model.save_weights('ResNet50_tl.h5')
class HistoryGraph:
