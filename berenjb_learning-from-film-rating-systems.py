...
plt.plot(range(len(cost_history)), cost_history, label='linear regression')

plt.plot(range(len(cost_ridge_history)), cost_ridge_history, label='ridge regression')
...
print(learnt_df[['IMDB_norm_actual', 'IMDB_norm_predicted']].head())
fig, axes = plt.subplots(nrows=2, ncols=2, sharey=True, figsize=(8.,6.))
