...
#Escrevendo uma frase motivadora
...
print('Vamos aprender algo novo!\U0001F4A9')
...
#O resultado é 8. Multiplicação primeiro, módulo, e por fim a soma.
...
help(round)
#Essa é uma função que permite retornar a menor diferença entre três valores
...
#A função na realidade se chama round e não ruound. O erro informa que a função não se encontra definida.
