...
#Area mean must be having higher values
# Check your answer (Run this code cell to receive credit!)

step_3.b.solution()
# KDE plots for benign and malignant tumors

sns.kdeplot(cancer_b_data['Radius (worst)'],shade=True,label="Benign") # Your code here (benign tumors)

sns.kdeplot(cancer_m_data['Radius (worst)'],shade=True,label="Malignant")# Your code here (malignant tumors)
