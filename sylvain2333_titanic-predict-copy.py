...
#look at some features about age
...
#plot orginal age value

#at first drop nan in age

titanic_df['Age'].dropna().astype(int).hist(bins = 70, ax = axis1)



#generate random value between (mean-std) and (mean+std)
