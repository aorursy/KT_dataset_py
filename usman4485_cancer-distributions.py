...
cm = cancer_m_data.head()

cm.loc[842517]['Radius (mean)']
# Fill in the line below: In the first five rows of the data for benign tumors, what is the

# largest value for 'Perimeter (mean)'?

cm = cancer_b_data.head()

max_perim = max_perim = cm['Perimeter (mean)'].max()

cm = cancer_m_data.head()

# Fill in the line below: What is the value for 'Radius (mean)' for the tumor with Id 842517?

mean_radius = cm.loc[842517]['Radius (mean)']
...
sns.distplot(a = cancer_m_data['Area (mean)'],label='malignant Tumor') # Your code here (malignant tumors)

plt.legend() # To add the label
