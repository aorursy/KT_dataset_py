...
print(os.listdir('../input/Predict House Pricing'))
...
df1 = pd.read_csv('../input/Predict House Pricing/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Predict House Pricing/train.csv', delimiter=',', nrows = nRowsRead)
