...
titamic_data_test1 = pd.read_csv('/kaggle/input/titanic/test.csv')

titamic_data_train1 = pd.read_csv('/kaggle/input/titanic/train.csv')

titamic_data_train1.head()
titamic_data_train1.info()
from pandas_profiling import ProfileReport

pf = ProfileReport(titamic_data_train1, title="Rep1")

pf.to_widgets()

dt = titamic_data_train1[['Pclass', 'Sex', 'SibSp', 'Age', 'Fare','Survived']]
...
dt.head(10)
Rep_file2 = ProfileReport(dt, title="Rep 2")
