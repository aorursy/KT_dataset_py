...
speeds_query_job2 = client.query(speeds_query2, job_config=safe_config) # Your code here



# API request - run the query, and return a pandas DataFrame

speeds_result2 = speeds_query_job2.to_dataframe() # Your code here



# View results

print(speeds_result2)
