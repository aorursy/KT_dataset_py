...
# look at number of missing points in the first column
...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
# look at number of missing points in the Street Number Suffix column
sf_missing_values_count['Street Number Suffix']
# look at number of missing points in the Zipcode column
sf_missing_values_count['Zipcode']
...
# comes directly after it and then replace all the remaining NaNs with 0.
