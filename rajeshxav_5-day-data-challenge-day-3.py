...
plt.hist(coldcereals,alpha=0.4,label='cold')#Plot the hot cereals
...
plt.title("Sodium content in Cereals by type")
hotcereals = df["carbo"][df["type"] == "H"]

coldcereals = df["carbo"][df["type"] == "C"]



ttest_ind(hotcereals, coldcereals, equal_var=False)
print("Mean carbo for hot cereals : ") 

print(hotcereals.mean())



print("Mean carbo for cold cereals : ")
...
plt.title("Carbo content in Cereals by type")