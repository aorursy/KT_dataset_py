...
# comes directly after it and then replacing any remaining NaN's wisubset_nfl_data = nfl_data.loc[:, 'EPA':'Season'].head()

subset_sf_permits = sf_permits.loc[:, 'Permit Number':'Revised Cost'].head()
