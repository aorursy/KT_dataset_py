...
def get_parents(row):
    ...
    return 0
#считать датасеты из файла

#запоминаем столбец id для Пассажиров
...
param_grid =[ {'n_estimators' : [4,5,10, 15, 20, 25, 30, 35, 40], 'max_depth' : [5,10,15, 20]},]
...
#выводим результат точности(accuracy) на обучающейи тестовой выборке
