...
# south_malawi_topography.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/south_malawi_topography.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'south_malawi_topography.csv'
