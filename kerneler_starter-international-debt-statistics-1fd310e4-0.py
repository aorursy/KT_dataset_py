...
# IDSCountry.csv has 136 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/IDSCountry.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'IDSCountry.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# IDSCountry-Series.csv has 267 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/IDSCountry-Series.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'IDSCountry-Series.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# IDSData.csv has 29104 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/IDSData.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'IDSData.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
