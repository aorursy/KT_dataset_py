...
plot_subjects_with_probs(0, 49, y_prob)
...
y_train_reg = y_train.argmax(axis=1)
y_val_reg = y_val.argmax(axis=1)
print ('Training....')
...
modelF = modelR.fit(X_train, y_train_reg, nb_epoch=nb_epoch, batch_size=batch_size,
          validation_data=(X_val, y_val_reg), shuffle=True, verbose=1)
