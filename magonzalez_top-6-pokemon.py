...
my_data = pd.read_csv('../input/pokemon_clean.csv')
...
generation_1 = generation_1.drop([129])
generation_1.loc[:126].plot.bar(y='true base stats', x='name')

generation_2 = pokemon_list[1].sort_values(by=['true base stats'], ascending = False)
generation_2
generation_2.loc[:17].plot.bar(y='true base stats', x='name')
generation_3 = pokemon_list[2].sort_values(by=['true base stats'], ascending = False)
generation_3
generation_3.loc[:30].plot.bar(y='true base stats', x='name')
...
generation_4
generation_4.loc[:80].plot.bar(y='true base stats', x='name')
