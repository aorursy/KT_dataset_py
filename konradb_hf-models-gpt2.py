...
#!wget https://s3.amazonaws.com/models.huggingface.co/bert/gpt2-xl-pytorch_model.bin
!wget https://s3.amazonaws.com/models.huggingface.co/bert/distilgpt2-pytorch_model.bin