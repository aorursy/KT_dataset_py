...
round_to_two_places2(333.1416)
#q2.solution()
def to_smash(total_candies,n_friends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies <total_candies> evenly between <n_friends> friends.
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    return min( t12-t11, t22-t21, t32-t31)

a = slowest_call( f, -25789, 25788, -0.0001 )
print(a)
