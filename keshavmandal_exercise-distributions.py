...
sns.distplot(a=cancer_b_data['Area (mean)'], kde=False, label="Area (Mean) - B") # Your code here (benign tumors)

sns.distplot(a=cancer_m_data['Area (mean)'], kde=False, label="Area (Mean) - M") # Your code here (malignant tumors)
