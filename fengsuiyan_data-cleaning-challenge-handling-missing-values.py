...
total_missing_sf = missing_values_count_sf_permit.sum()

(total_missing_sf / total_cells_sf) * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_count_sf_permit[0:10]
# Street Number Suffix: because they don't exist
# 
sf_permits.sample(10).Zipcode
missing_values_count_sf_permit.Zipcode
# Zipcode: because they are missing
