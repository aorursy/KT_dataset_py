...
# business-solutions-business-courses.csv has 120 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/business-solutions-business-courses.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'business-solutions-business-courses.csv'
nRow, nCol = df1.shape
