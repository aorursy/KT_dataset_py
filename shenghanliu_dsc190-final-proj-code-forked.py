...
df
df = pd.read_csv("../input/inputdata/games.csv")
df
df2 = pd.read_csv("../input/inputdata/games.csv")
df2.dtypes
plt.figure(figsize=(12,6))
p1=sns.kdeplot(df2['gameDuration'], shade=True, color="r").set_title('Distribution of Duration')
var = 'winner'
data = pd.concat([df2['t2_towerKills'], df2[var]], axis=1)
data.plot.scatter(x=var, y='t2_towerKills');
df.columns
