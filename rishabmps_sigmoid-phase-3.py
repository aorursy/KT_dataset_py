...
# img = cv2.imread("../input/level_3_train/"+LEVEL+"/en/displayPanel_0_flip_none_c27_25.jpg",cv2.IMREAD_GRAYSCALE)
...
# et1,th1 = cv2.threshold(img,10,255,cv2.THRESH_BINARY)
# plt.imshow(th1,'gray')
...
#     print('train: %s, test: %s' % (Y_train[train], Y_train[test]))
    ...
    sn_ce.fit(X_scaled_train[train], Y_train[train], epochs=700, learning_rate=0.00002, loss_fn="ce", display_loss=True,initialise=False)
