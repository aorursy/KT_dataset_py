...
#  what percent of the sf_permits dataset is missing
MissingValuesCount2=sf_permits.isnull().sum()
# look at the # of missing points in the first ten columns
MissingValuesCount2[0:10]
# how many total missing values do we have?
total_cells = np.product(sf_permits.shape)
total_missing = MissingValuesCount2.sum()
...
subset_sf_permits=sf_permits.loc[:,'Existing Construction Type':'Record ID'].head()
