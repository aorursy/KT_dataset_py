...
ax = sns.barplot(x=literate_rate, y=literate_rate.index, alpha=0.7)
...
ax = sns.barplot(x='literates_female', y=fem_summary.index, data=fem_summary, alpha=0.5)
...
ax = sns.barplot(x='literates_male', y=male_summary.index, data=male_summary, alpha=0.5)
...
ax = sns.barplot(data=lit_by_states, x=lit_by_states.index, y='literates_total', alpha=0.7)
...
ax = sns.barplot(x=most_cities_in_states, y=most_cities_in_states.index, alpha=0.7)
