...
print(score_dataset(label_X_train, label_X_valid, y_train, y_valid)) # Your code here
...
X_test_na = X_test.copy().fillna('0')
label_X_test = X_test_na.drop(bad_label_cols, axis=1)



for col in good_label_cols:

    label_X_test[col] = label_encoder.fit_transform(X_test_na[col])
