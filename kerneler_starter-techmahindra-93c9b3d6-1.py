...
print(os.listdir('../input/sample_submission_DLC0JKW'))

print(os.listdir('../input/test_Jwt0MQH'))

print(os.listdir('../input/train_5CLrC8b'))
...
df1 = pd.read_csv('../input/sample_submission_DLC0JKW/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/test_Jwt0MQH/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/train_5CLrC8b/train.csv', delimiter=',', nrows = nRowsRead)
