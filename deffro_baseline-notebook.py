...
train = pd.read_csv('../input/duth-dbirlab2/train.csv')

test = pd.read_csv('../input/duth-dbirlab2/test.csv')
train.head()
...
sample_submission = pd.read_csv('../input/duth-dbirlab2/sample_submission.csv')
