...
#     X_test = df_X_test[["usd_pledged_real_log10", "usd_goal_real_log10"]].values
    ...
    X_train = df_X_train[["usd_pledged_real_log10"]].values
    X_test = df_X_test[["usd_pledged_real_log10"]].values
...
df_kick_2var = df_kick[["state_dummy", "usd_pledged_real_log10", "usd_goal_real_log10"]]


x = df_kick_2var[["usd_pledged_real_log10", "usd_goal_real_log10"]].values #returns a numpy array
standard_scaler = StandardScaler()
x_scaled = standard_scaler.fit_transform(x)
df_kick_2var = pd.DataFrame(x_scaled)
df_kick_2var = pd.concat([df_kick[["state_dummy"]], df_kick_2var], axis=1)

df_kick_2var.columns = ["state_dummy", "usd_pledged_real_log10", "usd_goal_real_log10"]
# df_kick_2var["state_dummy"] = df_kick_2var["state_dummy"].astype(str)
# df_kick_2var.info()
ax = sns.scatterplot(x="usd_pledged_real_log10", y="usd_goal_real_log10", hue="state_dummy", data=df_kick_2var)
ax = sns.scatterplot(x="usd_pledged_real_log10", y="usd_goal_real_log10", hue="state_dummy",
                     data=df_kick_2var[df_kick_2var["state_dummy"] == 0])
ax = sns.scatterplot(x="usd_pledged_real_log10", y="usd_goal_real_log10", hue="state_dummy",
                     data=df_kick_2var[df_kick_2var["state_dummy"] == 1])
pg = sns.pairplot(df_kick_2var)
print(type(pg))
g = sns.FacetGrid(df_kick_2var, hue='state_dummy')
g.map(sns.distplot, "usd_pledged_real_log10", label="state_dummy")
g.add_legend()
plt.show()
g = sns.FacetGrid(df_kick_2var, hue='state_dummy')
