...
num_X_train = X_train.drop(object_cols, axis=1) # Dropping ALL categorical columns, not only the low cardinal ones
...
# Create model, train on preprocessed training data, and make predictions on test data
