...
CLASSES = ['Alfa Romeo', 'Audi', 'BMW', 'Chevrolet', 'Citroen', 'Dacia', 'Daewoo', 'Dodge', 'Ferrari', 'Fiat', # 00 - 09
...
ALL_FILENAMES = tf.io.gfile.glob(f'{GCS_DS_PATH}/*.tfrec')
TRAINING_FILENAMES = ALL_FILENAMES[:4]
VALIDATION_FILENAMES = ALL_FILENAMES[4]
TEST_FILENAMES = ALL_FILENAMES[5]
