...
# Non-linear transformation (raises values to an exponent lambda to transform)
...
sns.distplot(original_data, ax=ax[0]) #index zero indicates which of the two plots will have the original_data; default is last one
...
#ax[0].set_title("Original Data woooo")
#ax[0].set_xlabel("x???")
#ax[0].set_ylabel("y????!")
...
usd_goal = kickstarters_2017.usd_goal_real #usd_goal_real is just the column name
