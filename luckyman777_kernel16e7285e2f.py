...
from keras.layers import Input, Dense, Conv2D, Reshape, Flatten, concatenate, UpSampling2D, Dropout, BatchNormalization
...
# Добавим несколько dropout и batchnorm слоёв, увеличим первый полносвязный слой

if BadMemory:

    seed = Input((10000,))

    x = Dense(4096, activation='elu')(seed)
