...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
sf_permits_missing_values_count
...
sf_permits_rows_with_na_dropped = sf_permits.dropna()
print("Rows with na's dropped: %d" % sf_permits_rows_with_na_dropped.shape[1])
