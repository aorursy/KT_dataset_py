...
np.apply_along_axis(func, 0, a) #column
np.apply_along_axis(func, 1, a) #row
%matplotlib inline
...
plt.plot(x, cos_y, color = 'blue', linewidth = 3.0, label = 'Sin', linestyle = '-')
