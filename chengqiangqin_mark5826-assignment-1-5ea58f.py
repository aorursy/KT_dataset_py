...
# Your code goes here
task1 = tally(data['style'])
task1
# Your code goes here
task2 = plot(x = 'stars',  data = data, style = 'histogram')
task2
# Your code goes here
task3 = plot(x = 'brand', y = 'stars', data = data, style = 'boxplot')
task3
# Your code goes here
task4 = tally(data['country'],top = 10, graph = True, percent = 1)
task4
# Your code goes here
task5 = query(data = data, column = 'brand', condition = '=="Ve Wong"')
task5
# Your code goes here
stars_sort = sort(data['stars'], how = 'descending')
#print(stars_sort)

print('The last 12 rows are: {}'.format(index(stars_sort)[-12:]))

#Your code goes here
#task1
data_query = query(data = data, column = 'stars', condition = '>3')


#task2
data_tab = tabulate(data_query['country'], data_query['style'], method = 'count')

plot(x = 'country', y = 'count', data = data_tab, style = 'lineplot', colour = 'style')
print('Extra: the second graph is to show the all counrties')
plot(x = 'country', y = 'count', data = data_tab, style = 'lineplot', top = 50, colour = 'style')
