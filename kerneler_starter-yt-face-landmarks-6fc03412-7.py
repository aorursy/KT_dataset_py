...
df1 = pd.read_csv('/kaggle/input/data/test_frames_keypoints.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/data/training_frames_keypoints.csv', delimiter=',', nrows = nRowsRead)
