...
#определить модель решения через логистическую регрессию
...
#чтобы оценить чувствительность алгоритма на тестовой выбоке

#[:, 1] - все строки, 1 столбец
...
plt.show()
#выводим площадь под кривой ошибок

roc_auc_score(Y_test, Y_pred)
#тренируем модель на всей выборке
