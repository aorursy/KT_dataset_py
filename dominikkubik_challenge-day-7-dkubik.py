...
def blackjack_hand_greater_than(hand_1, hand_2):
    ...
    for card in hand_1:
        ...
        if card in ('J', 'Q', 'K'):
            ...
            sum1 = sum1 + int(card)
    if aces > 1 and sum1 > 21:
        sum1 = sum1 - (aces - 1) * 10
    aces = 0
    for card in hand_2:
        print("hand 2 card:", card)
        if card in ('J', 'Q', 'K'):
            sum2 = sum2 + 10
        elif card == 'A':
            aces = aces + 1
            ...
            sum2 = sum2 + int(card)
    if aces > 2 and sum2 > 21:
        sum2 = sum2 - (aces - 1) * 10
    print("hand 1 sum", sum1, "hand 2 sum", sum2)
