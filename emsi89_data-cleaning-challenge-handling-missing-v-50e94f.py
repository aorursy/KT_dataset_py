...
#yes there is also some missing Data
...
# look at the # of missing points in the first ten columns
missing_values_count_sf_permits[0:10]# your turn! Find out what percent of the sf_permits dataset is missing
...
# look at the # of missing points in the first ten columns
missing_values_count_sf_permits[0:-1]
...
# remove all the rows that contain a missing value
sf_permits.dropna()
# also no rows which have no NaNs in it
