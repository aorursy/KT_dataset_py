...
pdf = os.path.join(outputFolder,'AI freedom growth rate.pdf[5]')

with Img(filename=pdf, resolution=300) as img:

    img.compression_quality = 99

    img.convert("RGBA").save(filename='/kaggle/working/AI freedom growth rate.jpg') # intro page to preview later
# Parse a PDF file and convert it to CSV using PyTesseract

import pytesseract

pdfimage = Image.open('/kaggle/working/AI freedom growth rate.jpg')
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 5 of AI freedom")
...
parsed = parser.from_file('/kaggle/working/AI freedom growth rate.jpg') 
...
pdf = os.path.join(outputFolder,'AI freedom growth rate.pdf[4]')

with Img(filename=pdf, resolution=300) as img:

    img.compression_quality = 99

    img.convert("RGBA").save(filename='/kaggle/working/AI freedom growth rate.jpg')

pdfimage4 = Image.open('/kaggle/working/AI freedom growth rate.jpg')
# PDF to JPG for p1
...
pdfimage5 = Image.open('/kaggle/working/AI freedom growth rate.jpg')
...
pdfimage4 = Image.open('/kaggle/working/AI freedom growth rate.jpg')
# Parse a PDF file and convert it to CSV using PyTesseract (p5)
...
parsed2 = parser.from_file('/kaggle/working/AI freedom growth rate.jpg')
...
pdfimage5 = Image.open('/kaggle/working/AI freedom growth rate.jpg')
#Explore page 5 - Mueller Report. Here I don't know how many pages each Cheat Sheet. There are 30 pages 
