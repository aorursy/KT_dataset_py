...
train_dir = "/kaggle/input/cnndata1/training_set/training_set"

eval_dir = "/kaggle/input/cnndata1/test_set/test_set"
...
hist = model.fit(X_train, y_train, epochs =5, batch_size = 512,validation_data=(X_test,y_test))

model_checkpoint = ModelCheckpoint("./my_model.h5", save_best_only=True, verbose=1)
