...
#take a look at vehicle_2015 table and columns of interest
accidents.head(
    "vehicle_2015", 
    selected_columns = ["consecutive_number", "hit_and_run", "registration_state_name"],
    num_rows = 5
)
#Query to find out which state has the most hits and runs:
