...
data.head()
data.isnull()
print('Average word length of phrases in train is {0:.0f}.'.format(np.mean(data['review'].apply(lambda x: len(x.split())))))
data.isnull().sum()
data['sentiment'].value_counts()
a='A wonderful little production'

sid.polarity_scores(a)
sid.polarity_scores(data.loc[1]['review'])
...
num_ngrams = min(15, len(all_ngrams))
