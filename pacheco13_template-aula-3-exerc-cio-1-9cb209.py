...
plt.violinplot([estado_ba['gen_feminino'],estado_ba['gen_masculino']],showmeans=True, showmedians=True,widths = 1.0, bw_method=0.1) #default
...
plt.xticks([0,1,2,3,4], ('', '18_20','21_24', '70_79','f_sup_79'))
