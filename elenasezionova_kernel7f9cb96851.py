...
for img, label in dataset:
    image_classes[label] = image_classes.get(label,0) + 1
for label in image_classes:
    print(str(classes) + str(image_classes[label]))
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        self.linear_5 = nn.Linear(32, output_size)
...
arch = "3 layers (256,128, 64, 32,20)"
lrs = [0.1, 0.01, 0.001, 0.001, 0.0001]
epochs = [20, 20, 20, 25, 30]
test_acc = 0.5462890863418579
test_loss = 1.3246939182281494
