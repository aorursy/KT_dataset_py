...
for t in tables:
    ...
    tb.append(t.table_id)



list_of_tables = tb # Your code here
...
questions_query = """
                  ...
                  WHERE tags LIKE '%bigquery%' OR tags LIKE '%bigquery-sql%'
...
safe_config = bigquery.QueryJobConfig(maximum_bytes_billed=10**11) #<-- changed the limit or it won´t work
...
bigquery_experts_query = """
                         ...
                         ORDER BY pa.owner_user_id DESC
