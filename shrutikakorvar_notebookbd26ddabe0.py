...
df=pd.read_excel('../input/implementing-the-multiple-linear-regression/companysalary.xlsx')
...
plt.show()
my_data = pd.read_excel('../input/implementing-the-multiple-linear-regression/companysalary.xlsx')
print(df.columns)
print(df.head(5))
pd.isna(df).any()
