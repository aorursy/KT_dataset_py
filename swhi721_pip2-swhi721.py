...
end_time = period_osc * N_loops    # calculate the end time of the propagation (from the input variables)
...
# --- INPUT ---
def function(q_m_ratio, b0, v, phi, rxc, ryc, start_time, N_loops,steps_rev):
    ...
    plt.show()
# original variables    
function(1,1,10,0,0,0,0,2,1000)
# 8 revolutions
function(1,1,10,0,0,0,0,8,1000)
# 8 revolutions and *10 more timesteps per revolution
function(1,1,10,0,0,0,0,8,10000)
# 8 revolutions with 10000 timesteps per revolution with double the initial velocity
function(1,1,20,0,0,0,0,8,10000)
# 8 revolutions with 10000 timesteps per revolution with half the initial velocity
function(1,1,5,0,0,0,0,8,10000)
