...
plt.plot(h['accuracy'], label = 'acc',color='green')

plt.plot(h['val_accuracy'], label = 'val_acc',color='red')
...
plt.plot(h['loss'], label = 'loss',color='yellow')
...
sns.heatmap(confusion, annot = True, fmt = 'd', xticklabels = l, yticklabels = l, square = True, cmap="YlGnBu")
