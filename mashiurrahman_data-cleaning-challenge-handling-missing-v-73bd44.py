...
missing_sf_permits_data = sf_permits.isnull().sum()
total_cell_sf_permits = np.product(sf_permits.shape)
total_missing_sf_permits = missing_sf_permits_data.sum()
#print(total_cells)
(total_missing_sf_permits/total_cell_sf_permits)*100
#missing_sf_permits_data[0:10]
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print(columns_with_na_dropped_sf_permits.head(2))
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
