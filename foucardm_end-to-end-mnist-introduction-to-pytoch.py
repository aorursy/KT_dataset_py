...
X_train, X_val, y_train, y_val = train_test_split(X_train_full, y_train_full, test_size=0.2, random_state=42) # As usual
...
print(X_train_pyt.shape) # These are now pytorch tensors
...
plt.show()
class Net(nn.Module): # In PyTorch, models are made through a class
