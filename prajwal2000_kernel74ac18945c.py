...
noimg_class = dict.fromkeys(classes, 0)

for img, label in dataset:

    noimg_class[classes[label]] += 1
...
history += fit(10, 0.0000001, model, train_loader, val_loader)
history += fit(60, 0.01, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
evaluate(model, test_loader)
arch = '3 layers(512,32,10)'
lrs = [0.01,0.001,0.0001,0.0000001,0.01]
epochs = [30,10,10,10,60]
eval = evaluate(model, test_loader)

test_acc =  eval['val_acc']

test_loss = eval['val_loss']
