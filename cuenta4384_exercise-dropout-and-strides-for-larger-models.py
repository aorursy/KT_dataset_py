...
# Fit fashion_model_1
fashion_model_1.fit(x, y, batch_size=128, epochs=epochs, validation_split=0.2)
...
fashion_model_2.fit(x, y, batch_size=128, epochs=epochs, validation_split=0.2)
...
fashion_model_3.add(Dropout(0.4))
fashion_model_3.add(Conv2D(24, kernel_size=(3, 3), activation='relu'))
fashion_model_3.add(Dropout(0.1))
...
fashion_model_3.fit(x, y, batch_size=128, epochs=epochs, validation_split=0.2)