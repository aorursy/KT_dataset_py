...
related_articles_index_file_bio = pd.read_csv("/kaggle/input/article-ref-bio-task9/article_indexes_bio_task9.csv")

related_articles_index_file_comm = pd.read_csv("/kaggle/input/article-ref-comm-task9/article_indexes_comm_task9.csv")

related_articles_index_file_noncomm = pd.read_csv("/kaggle/input/article-ref-noncomm-task9/article_indexes_noncomm_task9.csv")
###bio
...
with open('/kaggle/input/vectorizer-bio-task9/article_bio_vectorizer_task9.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-bio-task9/abstract_bio_vectorizer_task9.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-comm-task9/article_comm_vectorizer_task9.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-comm-task9/abstract_comm_vectorizer_task9.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-noncomm-task9/article_noncomm_vectorizer_task9.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-noncomm-task9/abstract_noncomm_vectorizer_task9.pickle', 'rb') as tf_abs:
...
level1_sub_questions = ["1. Efforts to articulate and translate existing ethical principles and standards to salient issues in COVID-2019",
...
sub_categories_keywords = [["ethical principle","ethical standard"],

                   ["embed ethics", "ethical issue"],

                   ["sustained education"],

                   ["establish team", "who",  "research and operational platform"],

                   ["qualitative assessment framework", "local barriers and enablers", "prevention and control","secondary impact", "surgical mask", "modification of health seeking behaviors", "school closure"],

                   ["implementing public health measure", "physical and psychological health"],

                   ["anxiety and stigma","misinformation and rumor","social media"]]
def main(sub_topic):
