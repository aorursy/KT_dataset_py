...
print(os.listdir('../input/DOG BREED IDENTIFICATION/DOG BREED IDENTIFICATION'))
...
df1 = pd.read_csv('../input/DOG BREED IDENTIFICATION/DOG BREED IDENTIFICATION/labels.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/DOG BREED IDENTIFICATION/DOG BREED IDENTIFICATION/sample_submission.csv', delimiter=',', nrows = nRowsRead)
