...
# assembled-workers-compensation-claims-beginning-2000.csv has 3330743 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/assembled-workers-compensation-claims-beginning-2000.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'assembled-workers-compensation-claims-beginning-2000.csv'
nRow, nCol = df1.shape
