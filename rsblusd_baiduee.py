...
!pip install bert4keras==0.7.0 pylcs
#! -*- coding: utf-8 -*-
...
# bert配置
config_path = '/kaggle/input/baidueedata/chinese_roberta_wwm_ext_L-12_H-768_A-12/bert_config.json'
checkpoint_path = '/kaggle/input/baidueedata/chinese_roberta_wwm_ext_L-12_H-768_A-12/bert_model.ckpt'
dict_path = '/kaggle/input/baidueedata/chinese_roberta_wwm_ext_L-12_H-768_A-12/vocab.txt'
...
# 读取数据
train_data = load_data('/kaggle/input/baidueedata/train_data.json/train_data/train.json')
valid_data = load_data('/kaggle/input/baidueedata/dev_data.json/dev_data/dev.json')

# 读取schema
with open('/kaggle/input/baidueedata/event_schema/event_schema/event_schema.json') as f:
...
predict_to_file('/kaggle/input/baidueedata/test1_data.json/test1_data/test1.json', 'ee_pred.json')