        ...
        for i in range(len_Lksub1):
            ...
            for j in range(1, len_Lksub1):
                ...
                if l1[0:k-2] == l2[0:k-2]:
                    ...
                    item=(list_Lksub1[i]|list_Lksub1[j])

                   

                    Ck.add(item)# TODO: self joining Lk-1
                ...
                for sub_set in sub_set_list:
                    ...
                    if sub_set.issubset(freq_set):
                        ...
                        for transaction in self.transactions:
                            ...
                            if b.issubset(transaction):

                                a+=1

                                 

                            support = a / float(len(self.transactions))

                            

                        

                        conf =self.support_data[freq_set]/support
