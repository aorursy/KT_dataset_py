...
df_train = pd.read_csv('../input/machine-learning-feature-titanic/titanic_train.csv')

df_test = pd.read_csv('../input/machine-learning-feature-titanic/titanic_test.csv')
...
print("Standard Deviation:", scores.std())
df_all.to_csv('Titanic',index=False)