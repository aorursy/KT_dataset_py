...
for i in results.items():
    print(i[0])
    display(pd.DataFrame(i[1]).rename(columns={0:'1% training',1:'10% training',2:'100% training'}))
...
data1 = data[['age','education-num','capital-gain','capital-loss','hours-per-week','income']]
