...
learning_rate_reduction = ReduceLROnPlateau(moniter = 'val_acc',
...
batch_size = 86
# history = cnn.fit(X_train,Y_train, batch_size=batch_size, epochs = epochs, validation_data=(X_val,Y_val), verbose=2)
...
plot_confusion_matrics(confusion_mtx, classes = range(10))
