...
for img,label in dataset:
    each_cls_num.update({label:each_cls_num.get(label,0)+1}) 
each_cls_num
for item in each_cls_num:
    print(item,':',each_cls_num.get(item,0))
