...
# Your code goes here :)
# Query 1: How many Bitcoin transactions were made each day in 2017?
query1 = """ WITH time AS 
             (
                 SELECT TIMESTAMP_MILLIS(timestamp) AS trans_time,
                     transaction_id
...
# do query with max of 21GB option
...
# Do query2 with max of 37GB option
transactions_per_root = bitcoin_blockchain.query_to_pandas_safe(query2, max_gb_scanned=37)
# Save result to csv file
transactions_per_root.to_csv("transactions_per_root.csv")