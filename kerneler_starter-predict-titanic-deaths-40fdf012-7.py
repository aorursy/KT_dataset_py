...
print(os.listdir('../input/Predict Titanic Deaths'))
...
df1 = pd.read_csv('../input/Predict Titanic Deaths/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Predict Titanic Deaths/train.csv', delimiter=',', nrows = nRowsRead)
