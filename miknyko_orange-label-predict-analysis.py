...
valid_dir = '../input/orange-label-cat/orange_label_cat/valid/'

train_dir = '../input/orange-label-cat/orange_label_cat/train/'
...
def roc_auc(y,prob):
    ...
    plt.show()
model = load_model('../input/orange-label-model-0726-3/orange_label_model_0726_3.h5')
...
print('='*100)
print(f'predict time per pic is {(end - start)/(len(labels) + len(labels_train))}s')
