...
# boxplot incelendiğinde fare ları 80 olan yolcular C limanından binmiş olmalarının olasılığı yüksek

# bu yüzden boş olan embarked degerini c olarak dolduruyoruz
train_df["Embarked"] = train_df["Embarked"].fillna("C")

train_df[train_df["Fare"].isnull()]
# Pclass ı 3 olan yolcuları bakıyoruz ve bu folcuların ödedikleri fare ların ortalamasını alıyoruz 
