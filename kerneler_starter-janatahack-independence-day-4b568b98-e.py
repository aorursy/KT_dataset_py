...
# sample_submission_UVKGLZE.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/sample_submission_UVKGLZE.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'sample_submission_UVKGLZE.csv'
