...
dataset = pd.read_csv("../input/Credit_Card_Applications.csv")
#now split our data to dependent to independed
...
g = np.concatenate((mappings[(4,1)], mappings[(6,4)]), axis = 0)
#frauds = np.concatenate((mappings[(8,1)], mappings[(6,8)]), axis = 0)
#frauds = sc.inverse_transform(frauds)
frauds =sc.inverse_transform(g) 
