...
players = pd.read_csv("../input/DIM_PLAYER.csv", encoding='ISO-8859-1' )
player_match = pd.read_csv("../input/DIM_PLAYER_MATCH.csv", encoding='ISO-8859-1' )
team = pd.read_csv("../input/DIM_TEAM.csv", encoding='ISO-8859-1' )
ball_fact = pd.read_csv ("../input/FACT_BALL_BY_BALL.csv", encoding='ISO-8859-1' )
match = pd.read_excel ("../input/DIM_MATCH.xlsx", encoding='ISO-8859-1' )
player_match.head(2)
