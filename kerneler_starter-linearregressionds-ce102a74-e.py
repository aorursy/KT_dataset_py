...
# CylinderVolume.csv has 10000 rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('../input/CylinderVolume.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'CylinderVolume.csv'
