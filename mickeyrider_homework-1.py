...
mat = loadmat("../input/dataset02/ex8data1.mat")
...
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat("../input/dataset02/ex8data1.mat")
...
mat3 = loadmat("../input/dataset03/ex8_movies.mat")

mat4 = loadmat("../input/dataset04/ex8_movieParams.mat")
...
movieList = open("../input/dataset05/movie_ids.txt","r",encoding = "ISO-8859-1").read().split("\n")[:-1]
