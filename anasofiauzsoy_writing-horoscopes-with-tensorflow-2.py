...
data = pd.read_csv("../input/horoscopes/horoscopes.csv", error_bad_lines=False, sep = "|", header = None, names = ["text", "date", "sign"], index_col = 0)
data.head()
data
len(data)
words = ""
...
write_horoscope("your life")
write_horoscope("This week")
write_horoscope("you")
write_horoscope("Love")
write_horoscope("The next")
