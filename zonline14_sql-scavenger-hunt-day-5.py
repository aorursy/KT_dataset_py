...
#build query to count number of commits per repo which are written in python
query = """
        SELECT COUNT(c.commit), f.repo_name
...
commits_to_python_repos = github.query_to_pandas_safe(query, max_gb_scanned=6)
