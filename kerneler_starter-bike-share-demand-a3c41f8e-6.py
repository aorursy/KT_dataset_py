...
print(os.listdir('../input/bike-share-demand'))
...
df1 = pd.read_csv('../input/bike-share-demand/sampleSubmission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/bike-share-demand/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/bike-share-demand/train.csv', delimiter=',', nrows = nRowsRead)
