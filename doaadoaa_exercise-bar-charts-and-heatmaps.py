...
worst_genre = ign_data.loc['PlayStation Vita'].idxmin() # or worst_genre = 'Simulation'
...
step_2.check()
# Notice : idxmin() To Get The index For Smallest Value ,,, idxmax() To Get The index For biggest Value
# Lines below will give you a hint or solution code
...
plt.title("the average score for racing games")
