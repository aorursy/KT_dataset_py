...
pdp_number_inpatient = pdp.pdp_isolate(model=my_model, dataset=val_X, model_features=val_X.columns.tolist(), feature='number_inpatient')

# plot it
pdp.pdp_plot(pdp_number_inpatient, 'Number Inpatients')
plt.show()
q_2.solution()
from matplotlib import pyplot as plt
from pdpbox import pdp, get_dataset, info_plots
