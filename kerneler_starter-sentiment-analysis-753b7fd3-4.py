...
# sentiments_submission_LGB.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/sentiments_submission_LGB.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'sentiments_submission_LGB.csv'
