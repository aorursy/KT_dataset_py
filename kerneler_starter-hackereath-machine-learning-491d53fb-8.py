...
df1 = pd.read_csv('/kaggle/input/Hacker Earth Machine Learnig/dataset/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Hacker Earth Machine Learnig/dataset/test.csv', delimiter=',', nrows = nRowsRead)
