...
for img, label in dataset: 
    if classes[label] in dic_occ: 
        dic_occ[classes[label]]+=1
    else: 
        dic_occ[classes[label]]=1
dic_occ 
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        super().__init__()
        self.linear1=nn.Linear(input_size, 1058)
        self.linear2=nn.Linear(1058,700)
        self.linear3=nn.Linear(700, 500)
        self.linear4=nn.Linear(500, 350)
        self.linear5=nn.Linear(350,160)
        self.linear6=nn.Linear(160, 10)
...
arch = "6 layers(1058, 700,500,350,160,10)"
lrs = [1e-1,1e-2,1e-3,1e-4]
epochs = [30,20,10,10]
test_acc = 0.5302734375
test_loss = 1.6356785297393799
