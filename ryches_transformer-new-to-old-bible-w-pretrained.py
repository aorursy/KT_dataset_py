    ...
    def __init__(self, is_training=True):
        ...
        with self.graph.as_default():
            ...
            with tf.device("/device:GPU:0"):
                ...
                self.logits = tf.layers.dense(self.dec, len(en2idx) + 1)
                ...
                if is_training:  
                    ...
                    self.y_smoothed = label_smoothing(tf.one_hot(self.y, depth=len(en2idx) + 1))
