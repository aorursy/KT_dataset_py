...
train           = pd.read_csv('../input/analytics-vidhyajanatahackiot/train.csv')
test            = pd.read_csv('../input/analytics-vidhyajanatahackiot/test.csv')
ss              = pd.read_csv('../input/analytics-vidhyajanatahackiot/sub.csv')
