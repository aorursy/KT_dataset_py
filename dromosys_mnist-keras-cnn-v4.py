...
def get_model():
    ...
    model.add(MaxPool2D(pool_size=(2,2), strides=(2,2))) # MaxPooling2D()
...
gen = image.ImageDataGenerator(rotation_range=4, width_shift_range=0.04, shear_range=0.3,height_shift_range=0.04, zoom_range=0.12)
from keras.preprocessing import image
...
val_pseudo = model.predict(X_test, batch_size=batch_size)
