...
# model.layers[10].trainable=False # We freeze redundant characteristics
...
# # We can cut this and use a pretrained model for the previous layers 
...
model.load_weights("/kaggle/input/weights/model.h5")
...
for i in range(4):
    ...
    datagen = MultiOutputDataGenerator(
        ...
        rotation_range=0.08,  # randomly rotate images in the range (degrees, 0 to 180)
...
with open('histRoot100', 'wb') as fp:
