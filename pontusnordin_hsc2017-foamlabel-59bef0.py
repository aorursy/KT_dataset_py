...
#stack_image = stack_image[100:300, 100:300, 100:300 ] # crop out a piece to try making the compiling faster
print(stack_image.shape, stack_image.dtype)
...
plt.imshow(bubble_inver[10], cmap='bone') #changed the index of the sample to fit the new interval
water = 0
air = 0
...
dfV.to_csv('pontus'+'bubbleVolumes.csv')
