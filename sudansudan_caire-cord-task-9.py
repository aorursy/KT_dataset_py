...
run_example(query)
query = "How about concerning ethical considerations for research??"
run_example(query)
query = "What has been published concerning social sciences at the outbreak response?" 
run_example(query)
query = "what about articulate and translate existing ethical principles and standards to salient issues in COVID-2019?" 
run_example(query)
query = "what about efforts to embed ethics across all thematic areas, engage with novel ethical issues that arise and coordinate to minimize duplication of oversight?" 
run_example(query)
query = "what about efforts to support sustained education, access, and capacity building in the area of ethics?" 
run_example(query)
query = "what about efforts to the rapid identification of use of surgical masks?" 
run_example(query)
query = "what about efforts to the rapid identification of school closures?" 
run_example(query)
query = "what about efforts to identify the physical and psychological health of those providing care for Covid-19 patients?" 
run_example(query)