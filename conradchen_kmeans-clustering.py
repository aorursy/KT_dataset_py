...
def my_euclDistance(vector1, vector2):
...
def point_cluster(dataSet,centroids):
    ...
    for index in range(data_num):
        ...
        data_center_dis = my_euclDistance(data_index, centroids)
...
def update_center(dataSet,point_assign,centroids):
...
def my_k_means(dataSet, k):
    ...
    for i in range(times):
        ...
        point_assign,clusterAssment = point_cluster(dataSet,centroids)

        centroids = update_center(dataSet,point_assign,centroids)
