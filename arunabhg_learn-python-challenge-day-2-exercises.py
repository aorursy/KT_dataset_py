...
def time_call(fn, arg):
    ...
    t2 = time() 
    fn_call_time = t2 - t1
    return print("The amount of time the functon takes: ", fn_call_time)
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    print (max(round(time_call(fn, arg1), 0), round(time_call(fn, arg2), 0), round(time_call(fn, arg3), 0)))
...
smallest_stringy_number('100', '20', '30')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
