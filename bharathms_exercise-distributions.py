...
max_perim = cancer_b_data[:5]['Perimeter (mean)'].max()



# Fill in the line below: What is the value for 'Radius (mean)' for the tumor with Id 842517?

mean_radius = cancer_m_data.loc[cancer_m_data.index == 842517, 'Radius (mean)'].values[0]
...
sns.distplot(cancer_b_data['Area (mean)'], label = 'Benign') 

# Your code here (malignant tumors)

sns.distplot(cancer_m_data['Area (mean)'], label = 'malignant')
