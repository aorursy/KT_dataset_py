...
def wants_plain_hotdog(ketchup, mustard, onion):
    ...
    """
    return True if not( ketchup or mustard or onion ) else False
...
def exactly_one_sauce(ketchup, mustard, onion):
    ...
    """
    return True if ( ketchup or mustard ) and not( ketchup and mustard ) else False
...
def exactly_one_topping(ketchup, mustard, onion):
    ...
    on their hot dog.
    """
    return True if ( ketchup or mustard or onion ) and not( ketchup and mustard ) and not( mustard and onion ) and not( ketchup and onion ) else False
