...
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip() #doesn't actually seem necessary in this case
...
# take a look at them
print(matches) #as kurram is the only one with  >90, we can use the same funciton as above
