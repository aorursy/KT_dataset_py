...
print('number of buildings training images - ',len(os.listdir(train_dir+'/buildings')))

print('number of buildings testing images - ',len(os.listdir(test_dir+'/buildings')))

print('number of glacier training images - ',len(os.listdir(train_dir+'/glacier')))

print('number of glacier testing images - ',len(os.listdir(test_dir+'/glacier')))

print('number of street training images - ',len(os.listdir(train_dir+'/street')))

print('number of street testing images - ',len(os.listdir(test_dir+'/street')))

print('number of sea training images - ',len(os.listdir(train_dir+'/sea')))

print('number of sea testing images - ',len(os.listdir(test_dir+'/sea')))

print('number of mountain training images - ',len(os.listdir(train_dir+'/mountain')))

print('number of mountain testing images - ',len(os.listdir(test_dir+'/mountain')))

print('number of forest training images - ',len(os.listdir(train_dir+'/forest')))

print('number of forest testing images - ',len(os.listdir(test_dir+'/forest')))
...
trained = classifier.fit_generator(training_set,steps_per_epoch=200,epochs=5,validation_data=test_set,validation_steps=60)
#trained = classifier.fit_generator(training_set, steps_per_epoch=2000, epochs=5, validation_data = test_set, validation_steps=60)
