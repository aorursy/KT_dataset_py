...
cities.sort()
cities
matches_mohmand = fuzzywuzzy.process.extract("mohmand agency", cities, limit = 10, scorer = fuzzywuzzy.fuzz.token_sort_ratio)
print(matches_mohmand)
matches_charsadda = fuzzywuzzy.process.extract("charsadda", cities, limit = 10, scorer = fuzzywuzzy.fuzz.token_sort_ratio)
print(matches_charsadda)
replace_matches_in_column(df = suicide_attacks, column = 'City', string_to_match = 'mohmand agency', min_ratio = 70)
replace_matches_in_column(df = suicide_attacks, column = 'City', string_to_match = 'charsadda', min_ratio = 55)
