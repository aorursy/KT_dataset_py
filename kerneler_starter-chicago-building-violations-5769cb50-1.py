...
# building-violations.csv has 1542963 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/building-violations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'building-violations.csv'
nRow, nCol = df1.shape
