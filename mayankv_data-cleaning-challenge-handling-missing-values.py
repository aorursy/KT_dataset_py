...
print("Rows with na's dropped: %d" % sf_dropped_na.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
col_with_na_dropped_sf = sf_permits.dropna(axis=1)

print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % col_with_na_dropped_sf.shape[1])
