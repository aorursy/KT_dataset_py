...
sleep_for = 5.0
slept_for = time_call(sleep, sleep_for)
print('Expected = {0:.5f}, Actual: {1:.5f}'.format(sleep_for, slept_for))
if round(slept_for, 1) == sleep_for:
...
print('Slowest function call took {0:.5f}'.format(slowest_call(sleep, 1, 1.5, 2.3)))
