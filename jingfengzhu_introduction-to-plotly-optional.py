...
iplot([go.Histogram2dContour(x=pokemon['Attack'],y=pokemon['Defense'],contours=go.Contours(coloring = 'heatmap')),go.Scatter(x=pokemon['Attack'], y=pokemon['Defense'], mode='markers')])