...
interll=pdp.pdp_interact(model=first_model, dataset=val_X,model_features=base_features,features=feats)
pdp.pdp_interact_plot(pdp_interact_out=interll, feature_names=feats, plot_type='contour')
plt.show()
...
# Create array holding predictive feature
X1 = 6*rand(n_samples)-3
X2 = 6*rand(n_samples)-3
# Create y. you should have X1 and X2 in the expression for y
y = X1*X2
