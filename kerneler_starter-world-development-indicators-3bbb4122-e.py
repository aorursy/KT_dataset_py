...
# WDICountry.csv has 263 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/WDICountry.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'WDICountry.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# WDICountry-Series.csv has 6309 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/WDICountry-Series.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# WDIData.csv has 417120 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/WDIData.csv', delimiter=',', nrows = nRowsRead)
