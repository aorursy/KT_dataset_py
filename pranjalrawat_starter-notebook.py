# URL for Simulation data - https://www.kaggle.com/pranjalrawat/msepysupportsimulation

path = '../input/msepysupportsimulation/simulation.csv'
...
path = '../input/msepysupportholdout/holdout.csv'
