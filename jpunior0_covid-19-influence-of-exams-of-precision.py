...
#Coocurence matrix for test on COVID positif patients
...
print(y)
blood_with_respiratory = df5[(df5['regular_blood_tests']==1)&(df5['SARS-Cov-2 exam result']==

0)][pcs_vars['respiratory']].dropna()
...
print(classification_report(y_test, y_pred))
# with AdaBoost (on Decision Trees)
