...
non_zero_cols = [col for col in X_train.columns if X_train[col].isnull().sum() == 0]
...
reduced_X_train = X_train[non_zero_cols]

reduced_X_valid = X_valid[non_zero_cols]
...
final_X_train = X_train[non_zero_cols]

final_X_valid = X_valid[non_zero_cols]
...
final_X_test = X_test[non_zero_cols].fillna(0)
