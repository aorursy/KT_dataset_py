...
sns.kdeplot(reviews[reviews['price'] < 200].loc[:, ['price', 'points']].dropna().sample(50))
...
sns.kdeplot(y = 'HP', x ='Attack', data= pokemon)
sns.kdeplot(pokemon.loc[:,['HP','Attack']].dropna())
sns.boxplot(data = pokemon, x = 'Legendary',y='Attack')
sns.violinplot(data = pokemon, x = 'Legendary',y='Attack')
sns.countplot(pokemon['Generation'])
sns.distplot(pokemon['HP'])
sns.jointplot(x='Attack', y='Defense', data=pokemon)
sns.jointplot(x='Attack', y='Defense', data=pokemon, kind='hex')
