...
# kc_house_data.csv has 21597 rows in reality, but we are only loading/previewing the first 1000 rows
df1 = pd.read_csv('../input/kc_house_data.csv', delimiter=',', nrows = nRowsRead)
