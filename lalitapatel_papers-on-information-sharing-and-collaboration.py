zabt = "Papers on Information Sharing and Collaboration"

znam = "Papers_on_Information_Sharing_and_Collaboration"
zwds = "academic access action agendas among assuring attention barriers baseline capability capacity circumstances citizens collaboration commercial communication community consideration containment coordinate coverage covid-19 data-gathering diagnosis disadvantaged elderly emergency ensure equity expertise families funding gaps governmental groups guidelines health high-risk incarcerated incorporate inequity information infrastructure integration inter-sectoral investments marginalized measures methods minorities misunderstanding mitigate mitigation modes nation nomenclature non-federal non-profit opportunities plan policies population potential preparedness prevention priorities private problem provider public published reach recruit relevant research response risk sharing standard standardized support surveillance system target testing threats treatment underrepresented understand value workers"
import os
