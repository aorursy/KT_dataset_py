...
# transportation-department-permits.csv has 951169 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/transportation-department-permits.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'transportation-department-permits.csv'
nRow, nCol = df1.shape
