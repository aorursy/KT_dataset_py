...
# percent of data that is mising
...
sf_with_na_rows_dropped = sf_permits.dropna()
sf_with_na_rows_dropped.shape
# Now try removing all the columns with empty values. Now how much of your data is left?
sf_with_na_columns_dropped = sf_permits.dropna(axis=1)
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_with_na_columns_dropped.shape[1])
