...
# test_40k.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df2 = pd.read_csv('/kaggle/input/test_40k.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'test_40k.csv'
