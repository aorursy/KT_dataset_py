...
def gib_folgezustaende(zustand):
    ...
    fzustaende = [
        ...
        [m+incr,k+incr*2,b_new] #im Boot: ein Missionar & zwei Kannibalen --> Missionar wird gefressen, könnte man also sofort streichen
    ]
...
print(gib_valide_folgezustaende([3,3,0]))

# Suche eine Lösung 
suche(startzustand,[],debug=2)
# Rekursive Suche in die Tiefe (depth-first search with chronolocigal backtracking)

# Zähler, um Anzahl der Lösungen anzugeben
counter = 0
