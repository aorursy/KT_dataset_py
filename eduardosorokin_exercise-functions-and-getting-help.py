...
def to_smash(total_candies, num_of_friends = 3):
    ...
    the given number of candies evenly between the number of friends passed on the
    second argument. If the second argument won't be informed, it assumed 3.
...
print(time_call(print, 'test'))
print(time_call(len, 'test'))
print(time_call(max, [72, 14, 88, 10, 3, 95, 27, 36]))
#q5.hint()
#q5.solution()
...
print(slowest_call(len, 'test', "Let's test this function", 'hello'))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
