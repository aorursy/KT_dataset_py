...
q1.solution()
print(round(417.56,-3))
print(round(816.8,-2))
print(round(816.7,-1))
q2.solution()
def to_smash(total_candies,total_friends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between the number of friends(default:3).
...
#     t_arg2=t3-t2
#     t_arg3=t4-t3
#     return max(t_arg1,t_arg2,t_arg3)
    t1=time_call(fn,arg1)
    t2=time_call(fn,arg2)
    t3=time_call(fn,arg3)
    return max(t1,t2,t3)

print(slowest_call(sleep,2,6,1))
q6.hint()
q6.solution()
print(print("Spam"))
q7.hint()
...
smallest_stringy_number('1', '2', '3')
smallest_stringy_number('15','5','3')
q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
