...
sns.factorplot(x= 'Sex', y= 'Survived', hue='Pclass', data = df_train, saturation = .9, size =9, aspect =1)
...
df_test['FamilySize'] = df_test['SibSp'] + df_train['Parch'] +1 #추가
...
#df_test['Embarked'].isnull().sum()  #null  없음
df_train.shape
...
# any() : any 함수는 Iteration 이 가능한 객체를 받아 (위의 예에서는 list) 그 항목을 돌면서 어느 하나라도 True 이면 결과로 True를 리턴 한다는 것을 알 수 있었습니다.
