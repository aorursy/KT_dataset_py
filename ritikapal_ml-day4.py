...
curve = pd.read_csv("../input/curve-student/curve.csv")

student = pd.read_csv("../input/curve-student/student.csv")
curve.head()
student.head()
import pandas as pd

curve = pd.read_csv("/kaggle/input/curve-student/curve.csv")
...
student = pd.read_csv("/kaggle/input/curve-student/student.csv")
