...
q_5.check()
fashion_model.history.history['val_acc'][-1]
# q_5.solution()
# Your code below
second_fashion_model = keras.Sequential()
second_fashion_model.add(Conv2D(64, kernel_size=(3,3), activation='elu', input_shape=(img_rows,img_cols,1)))
second_fashion_model.add(Conv2D(32, kernel_size=(2,2), activation='elu'))
second_fashion_model.add(Conv2D(32, kernel_size=(2,2), activation='elu'))
second_fashion_model.add(Conv2D(32, kernel_size=(2,2), activation='elu'))

second_fashion_model.add(Flatten())
second_fashion_model.add(Dense(100, activation='elu'))
...
q_6.check()
second_fashion_model.history.history['val_acc'][-1]
 # q_6.solution()