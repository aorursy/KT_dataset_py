...
total_number_missing = sf_permits.isnull().sum()
#print(total_number_missing)
total_cell = np.product(sf_permits.shape)
total_missing = total_number_missing.sum()
total_missing/total_cell * 100.00
...
sf_permits.columns
subset_sf_permits = sf_permits.loc[:,'Permit Number':'Plansets']
