...
df1 = pd.read_csv('/kaggle/input/plant-pathology-2020-cropped-images/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/plant-pathology-2020-cropped-images/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/plant-pathology-2020-cropped-images/train.csv', delimiter=',', nrows = nRowsRead)
