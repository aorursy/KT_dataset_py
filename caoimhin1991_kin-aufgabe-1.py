...
## Hier ist Platz für ihre Lösung, senden Sie mir ein korrekte ausgeführtes Jupyter-Notebook, 
# entweder per Link zu github oder als gerendertes PDF!
...
max_value = 4
suche([4,4,1],[],all_solutions=False)