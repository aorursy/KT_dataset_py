...
print ("Sütun Sayısı: " + str (train.shape[1]))

print ("Satır Sayısı: " + str (train.shape[0]))



print('\nTest Verisi: \n')

print ("Sütun Sayısı:" + str (test.shape[1]))

print ("Satır Sayısı:" + str (test.shape[0]))
train.head()
...
#Hizalama fonksiyonu ile verilerin hizalanması
...
print("Bütün veriler: {} ".format(all_data.shape))
...
#Olmayan verileri 0 ile değiştirme
...
#Gerekli sayısal içerikleri dönüştürme
...
#bazı kategorilerin isimlerini ekleme
...
#LabelEncoder ile kategorileri uygulama
...
#Sayısal içerikleri gösterme ve hesaplama
...
print (" {} dönüşüme uygun özellik".format(skewness.shape[0]))
...
print("Modellerin Ortalama Skoru: {:.4f} ({:.4f})\n".format(score.mean(), score.std()))
#RMSLE geliştirme fonksiyonu

def RMSLE (y, y_pred):

    return np.sqrt(mean_squared_error(y, y_pred))

#Son olarak eğit ve tahmin işlemlerini yap
...
print("Eğitim verisinin hata sonucu:") 

print(RMSLE(y_train,stacked_train_pred))

print("Accuracy Skoru:") 
