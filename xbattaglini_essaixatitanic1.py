...
# introducing a new feature : families 
...
#full_X = pd.concat( [ imputed , embarked ,pclass, cabin , family, sex ] , axis=1 )
...
print (full_X.shape , train_valid_X.shape , train_valid_y.shape,test_X.shape)
...
plot_model_var_imp(model2, train_X, train_y)




rfecv = RFECV( estimator = model2 , step = 1 , cv = StratifiedKFold( train_y , 2 ) , scoring = 'accuracy' )
