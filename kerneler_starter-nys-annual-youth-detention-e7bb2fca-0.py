...
# annual-youth-detention-admissions-by-county-beginning-2006.csv has 696 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/annual-youth-detention-admissions-by-county-beginning-2006.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'annual-youth-detention-admissions-by-county-beginning-2006.csv'
nRow, nCol = df1.shape
