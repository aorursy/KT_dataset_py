...
#take a look at the values in province column
...
#and remove the trailing whit spaces
...
#replace kuram agency for kurram agency
...
suicide_attacks.sample(5)
#dropna
hospitals_parsed=suicide_attacks['Hospital Names'].dropna()
hospitals_parsed=suicide_attacks['Hospital Names'].unique()
hospitals_parsed
