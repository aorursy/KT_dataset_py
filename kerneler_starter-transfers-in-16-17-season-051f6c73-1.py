...
# transfer_data.csv has 6237 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/transfer_data.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'transfer_data.csv'
nRow, nCol = df1.shape
