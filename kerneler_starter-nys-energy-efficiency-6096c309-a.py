...
# energy-efficiency-portfolio-standard-eeps-program-estimated-energy-savings-data.csv has 1378 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/energy-efficiency-portfolio-standard-eeps-program-estimated-energy-savings-data.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'energy-efficiency-portfolio-standard-eeps-program-estimated-energy-savings-data.csv'
nRow, nCol = df1.shape
