...
start_time =0       # enter the start time of the propagation
N_loops =8          # enter number of loops the particle should complete 
steps_rev =20000        # enter the number of time steps per revolution 
...
#Code for when the intial speed is doubled (v goes from 10 to 20)
import numpy as np
%matplotlib notebook
import matplotlib.pyplot as plt
...
#Code for when the intial speed is halved (v goes from 10 to 5)
import numpy as np
%matplotlib notebook
import matplotlib.pyplot as plt
