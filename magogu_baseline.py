...
train_data = pd.read_csv('../input/2020-abalone-age/2020-abalone-train.csv', header=None, skiprows=1)
...
x_test = pd.read_csv('../input/2020-abalone-age/2020-abalone-test.csv', header=None)
...
submit = pd.read_csv('../input/2020-abalone-age/2020-abalone-submit.csv')
