            ...
            for j in range(1+i, len_Lksub1):
                ...
                if l1[0:k-2] == l2[0:k-2]:
                    ...
                    for x in range(len(temp)):
                        ...
                        templ1 = frozenset(templ1)

                        if not templ1 in Lksub1:

                            flag = False

                    if flag == True:

                        Ck.add(frozenset(temp))
            ...
            for freq_set in L[i]:
                ...
                for sub_set in sub_set_list:
                    ...
                    if sub_set.issubset(freq_set):
                        ...
                        conf = self.supp_frozen(freq_set) /self.supp_frozen(freq_set-sub_set)
