...
print(day_of_month_landslides.head().astype(int))
# Your turn! get the day of the month from the date_parsed column
day_of_month_earthquakes = earthquakes['date_parsed'].dt.day
print(day_of_month_earthquakes.head().astype(int))
# remove na's
...
volcanos['year'] = volcanos['Last Known Eruption'].str.extract('(\d+)').astype(int)
# volcanos['year'] = pd.to_datetime(volcanos['year'], format="%Y")
print(volcanos['year'].head())
