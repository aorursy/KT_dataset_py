...
nr_weaptype1 = np.asarray(data_plot.groupby('weaptype1').weaptype1.count())

nperps_weaptype1 = np.asarray(data_plot.groupby('weaptype1').nperps.sum())

average_nperps = np.divide(nperps_weaptype1, nr_weaptype1)
...
ax = sns.barplot(y='names',x='average_nperps', data=sorted_attacktype_data, color="#00035b", palette="Reds_r")
