...
#Adding dense layers into the pretrained InceptionV3 model
...
val_seq = fold_seq[2] #Choosing the fold for validation
...
checkpt = ModelCheckpoint(monitor='val_loss',
                        ...
                        filepath = 'best_InceptionV3_final.h5',
...
model = keras.models.load_model('best_InceptionV3_final.h5', custom_objects={'focal_crossentropy': focal_loss})
...
print("Evaluation of model on val split 3:")
