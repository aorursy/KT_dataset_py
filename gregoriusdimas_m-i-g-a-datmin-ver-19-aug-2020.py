...
plt.plot(epochs, loss_train_Aug_Res, 'g', label='Training loss Augmentasi ResNet50')

plt.plot(epochs, loss_val_Aug_Res, 'b', label='Validation loss Augmentasi ResNet50')

plt.title('Training and Validation loss - Augmentasi ResNet50')
...
plt.plot(epochs, loss_train_Aug_Inc, 'g', label='Training loss Augmentasi InceptionV3')

plt.plot(epochs, loss_val_Aug_Inc, 'b', label='Validation loss Augmentasi InceptionV3')

plt.title('Training and Validation loss - Augmentasi InceptionV3')
...
val_precision_Inc = data_history_Inc.history['val_precision_1']

val_recall_Inc = data_history_Inc.history['val_recall_1']
...
plt.show()
#Plotting Val Precision and Recall - Augmentasi ResNet50

val_precision_Aug_Res = data_history_Aug_Res.history['val_precision_2']

val_recall_Aug_Res = data_history_Aug_Res.history['val_recall_2']

plt.plot(epochs, val_precision_Aug_Res, 'g', label='Validation Precision Augmentasi ResNet50')

plt.plot(epochs, val_recall_Aug_Res, 'b', label='Validation Recall Augmentasi ResNet50')
...
plt.show()
#Plotting Val Precision and Recall - Augmentasi InceptionV3

val_precision_Aug_Inc = data_history_Aug_Inc.history['val_precision_3']

val_recall_Aug_Inc = data_history_Aug_Inc.history['val_recall_3']

plt.plot(epochs, val_precision_Aug_Inc, 'g', label='Validation Precision Augmentasi InceptionV3')

plt.plot(epochs, val_recall_Aug_Inc, 'b', label='Validation Recall Augmentasi InceptionV3')
