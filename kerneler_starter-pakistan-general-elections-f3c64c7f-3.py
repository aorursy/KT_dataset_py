...
# Elections2018_allcandidates.csv has 3461 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Elections2018_allcandidates.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Elections2018_allcandidates.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Elections2018_allconstituencies.csv has 272 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/Elections2018_allconstituencies.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'Elections2018_allconstituencies.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Elections2018_win.csv has 272 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/Elections2018_win.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'Elections2018_win.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
