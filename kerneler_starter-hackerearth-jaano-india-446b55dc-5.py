...
# hackathondataset_jaano_india.csv has 2026 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/hackathondataset_jaano_india.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'hackathondataset_jaano_india.csv'
nRow, nCol = df1.shape
