...
# LGBM.csv has 48744 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# LGBM_CB.csv has 48744 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# LGBM_RB.csv has 48744 rows in reality, but we are only loading/previewing the first 100 rows
