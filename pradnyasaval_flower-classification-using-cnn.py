...
def make_train_data(flower_type,DIR):
    for img in tqdm(os.listdir(DIR)):
        ...
        img = cv2.imread(path,cv2.IMREAD_COLOR) #cv2.imread() - It is an OpenCv module used to read an image. 
                                                #path - the image should be in the working directory or a full path of 
                                                #IMREAD_COLOR − This function loads a color image and any transparency of image will be neglected.
        img = cv2.resize(img, (IMG_SIZE,IMG_SIZE)) #image size is given as 150
