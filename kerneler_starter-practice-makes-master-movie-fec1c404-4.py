...
df1 = pd.read_csv('../input/Movie_Actors.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Movie_AdditionalRating.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/Movie_Genres.csv', delimiter=',', nrows = nRowsRead)
