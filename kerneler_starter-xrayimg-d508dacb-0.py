...
df1 = pd.read_csv('/kaggle/input/data/filenames/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/data/filenames/test.csv', delimiter=',', nrows = nRowsRead)
