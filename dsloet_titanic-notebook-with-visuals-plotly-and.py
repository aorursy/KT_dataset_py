...
df_train_final = df_train[['Survived', 'age_group', 'Title', 'FamSize', 'Embarked', 'Sex', 'Pclass', 'Fare']]
df_test_final = df_test[['age_group', 'Title', 'FamSize', 'Embarked', 'Sex', 'Pclass', 'Fare']]
