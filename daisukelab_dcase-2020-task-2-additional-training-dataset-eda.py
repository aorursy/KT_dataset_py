...
!ls /kaggle/input/dc2020task2added/
! wget https://raw.githubusercontent.com/daisukelab/dcase2020_task2_variants/master/additional_file_info.csv
...
df.file = df.file.map(lambda f: str(f).replace('/data/task2/add_dev_data', '/kaggle/input/dc2020task2added'))

devdf = pd.read_csv('file_info.csv')

devdf.file = devdf.file.map(lambda f: str(f).replace('/data/task2/dev', '/kaggle/input/dc2020task2'))
