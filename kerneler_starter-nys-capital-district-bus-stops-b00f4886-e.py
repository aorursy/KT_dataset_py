...
# capital-district-bus-stops.csv has 2631 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/capital-district-bus-stops.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'capital-district-bus-stops.csv'
nRow, nCol = df1.shape
