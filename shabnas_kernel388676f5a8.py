...
quality
quality.plot(kind='bar', color='pink')
...
sns.kdeplot(df.MasVnrArea,Label='MasVnrArea',color='m')
...
#And it has significant corelation with our predictor variable SalePrice
