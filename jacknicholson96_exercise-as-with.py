...
speeds_query = """
               ...
               (
                   ...
                   SELECT trip_seconds, EXTRACT(hour FROM trip_start_timestamp) AS hour, trip_miles
               ...
               SELECT hour AS hour_of_day, COUNT(1) AS num_trips, 3600*SUM(trip_miles)/SUM(trip_seconds) AS avg_mph
