...
d2016.info()
d2017.info()
new2015=d2015.sort_values(by="Country").copy() # backup copy
...
uni_data.head(10)
uni_data.tail() # preview
uni_data.info()
uni_data.describe() # statistical values
uni_data.corr()
uni_data.sort_values(by="Economy",ascending=False).head()
uni_data.sort_values(by="Economy").head()
uni_data.sort_values(by="Score",ascending=False).head(10)
...
uni_data.set_index("Rank").sort_values(by="Rank",ascending="False")
...
print("Score Standard Deviation: ",stdscore)
...
feco=datamean.Economic_Level=="High"
fhel=datamean.Health_Level=="High"
ffam=datamean.Family_Level=="High"
datamean[feco]
f,ax=plt.subplots(figsize=(11,12))
sbr.pointplot(x="Economy",y="Economic_Level",hue="Country",data=datamean[fhel & ffam],palette="Set3",scale=2)
f,ax=plt.subplots(figsize=(11,12))
sbr.pointplot(x="Economy",y="Score_Level",hue="Country",data=datamean[fhel & feco],palette="Set3",scale=2)
f,ax=plt.subplots(figsize=(11,12))
