...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    elapsed_1 = time_call(fn,arg1)
    elapsed_2 = time_call(fn,arg2)
    elapsed_3 = time_call(fn,arg3)
    return max(elapsed_1, elapsed_2, elapsed_3)

print(slowest_call(sleep,3,1,5))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
