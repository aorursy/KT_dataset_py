...
# mapping.csv has 688 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/mapping.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# rounds2.csv has 114949 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/rounds2.csv', delimiter=',', nrows = nRowsRead)
