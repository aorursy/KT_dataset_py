...
dft=df[df['Train']==1] #sadece train datasını almak için

X=dft.drop(['country_destination','Train', 'dfb_year', 'dfb_month', 'dfb_day'],axis=1) # feature tanımlama
...
classification_metrics(y_test, y_predicted)
pred_country={ 1:"US", 2:"other", 3:"FR", 4:"CA", 5:"GB", 6:"ES", 7:"IT", 8:"PT", 9:"DE", 10:"NL", 11:"AU"}
dftest=df[df['Train']==0]# submission yapmak için hazırlık
testX=dftest.drop(['country_destination','Train', 'dfb_year', 'dfb_month', 'dfb_day'],axis=1) # submission yapmak için hazırlık
