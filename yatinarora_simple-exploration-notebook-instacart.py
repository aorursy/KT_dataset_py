...
order_products_train_df = pd.read_csv("../input/aisle3/order_products__train.csv")
...
departments_df = pd.read_csv("../input/aisle2/departments.csv")
orders_df.head()
