...
df1 = pd.read_csv('/kaggle/input/image_auto_tagging/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/image_auto_tagging/train.csv', delimiter=',', nrows = nRowsRead)
