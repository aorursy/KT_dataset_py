...
# math.csv has 23896 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/math.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'math.csv'
nRow, nCol = df1.shape
