...
ROOT_Train ="/kaggle/input/masked-facerecognition/AFDB_face_dataset/AFDB_face_dataset/"
ROOT_Test = "/kaggle/input/masked-facerecognition/AFDB_masked_face_dataset/AFDB_masked_face_dataset/"
train = []
