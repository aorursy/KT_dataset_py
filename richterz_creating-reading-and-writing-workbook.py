...
# Your code here
pd.read_excel("../input/publicassistance/xls_files_all/WICAgencies2014ytd.xls",sheet="Pregnant Women Participating")
...
pd.read_sql_query("SELECT reviewid, artist FROM artists",conn)
