...
# brownfield-redevelopment-credit-beginning-calendar-year-2005.csv has 560 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/brownfield-redevelopment-credit-beginning-calendar-year-2005.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'brownfield-redevelopment-credit-beginning-calendar-year-2005.csv'
nRow, nCol = df1.shape
