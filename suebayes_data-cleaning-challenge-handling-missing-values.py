...
missing_value_counts_sf=sf_permits.isnull().sum()
missing_value_counts_sf[1:10]
total_missing_sf=missing_value_counts_sf.sum()
...
# get a small subset of the NFL dataset
subset_sf_permits = sf_permits.loc[:, 'Permit Number':'Location'].head()
subset_sf_permits
# replace all NA's with 0
