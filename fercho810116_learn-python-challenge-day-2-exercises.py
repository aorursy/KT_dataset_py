...
n = 15445.6478
print(round(n, -3))
#It rounds to the nearest tenth position.
def to_smash(total_candies, total_friends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between N friends. N is set up to 3 by default.
...
print (slowest_call(sleep, 1, 2, 0.5))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
...
smallest_stringy_number('2111111', '213', '3')
#q8.a.solution()
smallest_stringy_number = lambda s1, s2, s3:  str(min(int(s1), int(s2), int(s3)))
