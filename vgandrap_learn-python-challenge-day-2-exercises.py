...
#q1.solution()
print (round(123456, -3), round(1234, -2), sep="\n")
print ("round with negative ndigits is useful when rounding down to nearest multiple of 10")
#q2.solution()
def to_smash(total_candies, num_of_friends = 3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between a number of friends, default is 3.
...
def time_call(fn, arg):
    ...
    begin_time = time()
    fn(arg)
    return round(time()- begin_time, 2)
...
smallest_stringy_number('11', '2', '3')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
