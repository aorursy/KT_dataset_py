# FROM https://www.kaggle.com/ailobster/python-titanic-predictions-top-3/notebook

# Changed Title mappings only.

# Slightly better score against truth

# Same score against submission sample
...
#  Select the passangers relatives number equal to 0, and the pclass equal to 1,

#  the ticket number between 113000 and 114000
...
print(titles)
# None of these descriptions are meant to be callous,

#   it was very strange while investigating the individuals behind the bulk data points.

# Remove Officer since they weren't there in an official capacity

# Jonkheer is a title that suggested nobility, bestowed on him as a young man. Now an adult.

# Don is used here for a Mexican lawyer, although wealthy he was not royalty

# Dr and Rev were also not present on an official capacity, so adult males

# Dona is a bit of mis-data here. Her first name was Dona and she was a maid, not royalty
...
Female_Child_Group = all_data.loc[
    ...
    (all_data['FamilyGroup'] >= 2) & ((all_data['Age'] <= 16) | (all_data['Sex'] == 'female'))]
...
Male_Adult_Group = all_data.loc[
    ...
    (all_data['FamilyGroup'] >= 2) & (all_data['Age'] > 16) & (all_data['Sex'] == 'male')]
