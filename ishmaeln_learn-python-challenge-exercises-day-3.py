...
def onionless(ketchup, mustard, onion):
    ...
    """
    return not onion
onionless(True, True, False) # Ketchup and mustard but no onion
onionless(False, True, True) # no Ketchup and mustard but onion
...
q5.a.check()
wants_all_toppings(True,True,True) #all toppings
