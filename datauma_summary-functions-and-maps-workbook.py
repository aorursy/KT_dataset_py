...
#q5.hint()
#q5.solution()
tropical_counts = reviews['description'].map(lambda descriptive : 'tropical' in descriptive).sum()
fruity_counts = reviews['description'].map(lambda descriptive : 'fruity' in descriptive).sum()
