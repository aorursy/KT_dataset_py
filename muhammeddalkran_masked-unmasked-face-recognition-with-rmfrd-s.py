...
ROOT_Train ="/kaggle/input/small-rmfrd/AFDB_face_dataset"
ROOT_Test = "/kaggle/input/small-rmfrd/AFDB_masked_face_dataset"
train = []
...
print("number of image in train validation : %s" %(len(valid)))
...
test.head(10)
print("number of person in train dataset : %s" %(len(test.groupby("person"))))
print("number of image in train dataset : %s" %(len(test)))
