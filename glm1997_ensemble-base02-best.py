...
import os
# print(os.listdir('../input/base02'))



#TREINO

pickle_off = open('../input/base02/X_train2s.pickle', 'rb')

X_train = pickle.load(pickle_off)



pickle_off = open('../input/base02/y_train2s.pickle', 'rb')
...
pickle_off = open('../input/base02/X_val2s.pickle', 'rb')

X_val = pickle.load(pickle_off)



pickle_off = open('../input/base02/y_val2s.pickle', 'rb')
...
mlp = MLPClassifier(hidden_layer_sizes=(10, 10, 10),activation='tanh', solver='sgd', learning_rate='adaptive', learning_rate_init= 0.25, max_iter = 1000, early_stopping=True, n_iter_no_change=5)
...
# conf_mat = confusion_matrix(y_test, mlp_pred_test)
...
# conf_mat = confusion_matrix(y_test, gb_pred_test)
...
skplt.metrics.plot_confusion_matrix(y_test, ens_pred_class, normalize=True)

plt.show()

# conf_mat = confusion_matrix(y_test, ens_pred_class)
