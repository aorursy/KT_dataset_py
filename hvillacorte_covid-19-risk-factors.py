...
questions = [
    ...
    {"question": "Data on potential risks factors: Smoking, pre-existing pulmonary disease."},

    {"question": "Data on potential risks factors: Co-infections (determine whether"

                 " co-existing respiratory/viral infections make the virus more"

                 " transmissible or virulent) and other co-morbidities."},

    {"question": "Data on potential risks factors: Neonates and pregnant women."},

    {"question": "Data on potential risks factors: Socio-economic and behavioral factors"

                 " to understand the economic impact of the virus and whether"

                 " there were differences."},

    {"question": "Transmission dynamics of the virus, including the basic reproductive"

                 " number, incubation period, serial interval, modes of transmission"

                 " and environmental factors."},

    {"question": "Severity of disease, including risk of fatality among symptomatic"
