...
sample = pd.read_csv("../input/scoring/sample_submission.csv")

mask = pd.read_csv("../input/scoring/unlinked_masked_final.csv")

variabs = pd.read_csv('../input/scoring/VariableDefinitions.csv')
