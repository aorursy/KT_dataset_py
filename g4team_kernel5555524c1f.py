...
train = train.drop(train[(train['GarageCars']>2.5) & (train['SalePrice']>500000)].index)
...
train = train.drop(train[(train['FullBath']<1.0) & (train['SalePrice']>300000)].index)
...
aiu = ['OverallQual', 'GrLivArea', 'GarageCars', 'GarageArea','TotalBsmtSF', '1stFlrSF', 'FullBath', 'TotRmsAbvGrd', 'YearBuilt']
