...
df1 = pd.read_csv('/kaggle/input/jh_2020/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/jh_2020/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/jh_2020/sample_submission.csv', delimiter=',', nrows = nRowsRead)
