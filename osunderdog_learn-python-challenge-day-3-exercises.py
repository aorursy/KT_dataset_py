...
def to_smash(total_candies):
    ...
    1
    """
    candie_word = "candy" if total_candies == 1 else 'candies'
    print("Splitting", total_candies, candie_word)
    return total_candies % 3
...
def wants_all_toppings(ketchup, mustard, onion):
    ...
    """
    return(all(iter([ketchup, mustard, onion])))
...
def wants_plain_hotdog(ketchup, mustard, onion):
    ...
    """
    return(not any(iter([ketchup, mustard, onion])))
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    return((player_total <= 11)
           ...
           or (player_total <= 16 and (dealer_total > 6))
