...
print('User ID: %d rated %d movies, the higest number of movies rated by one user.' %
      ...
      (rating_matrix.notnull().sum(axis=0).idxmax(), rating_matrix.notnull().sum(axis=0).max()))
#โปรแกรมจากตัวอย่าง ใช้สุ่มคะแนนภาพยนต์ 100 เรื่องจาก 150 เรื่อง และสุ่มผู้ให้คะแนน 30 ท่านจาก 50 ท่าน
...
#แก้ไขให้ค่าสเกลตามจริง สุ่มคะแนนภาพยนต์ทั้งหมด 150 เรื่อง และสุ่มผู้ให้คะแนนทั้งหมด 50 ท่าน
...
n_features = 5 #ยิ่งเยอะ cost function ยิ่งเยอะ
...
reg_param = 1 #ยิ่งเยอะ cost function ก็เยอะ
