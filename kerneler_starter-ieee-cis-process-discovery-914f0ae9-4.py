...
print(os.listdir('../input/contest_testeventlog'))
print(os.listdir('../input/contest_training_dataset'))
...
# test_log_june_1.csv may have more rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/contest_testeventlog/test_log_june_1.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'test_log_june_1.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# test_log_june_2.csv may have more rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/contest_testeventlog/test_log_june_2.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'test_log_june_2.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# test_log_june_3.csv may have more rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/contest_testeventlog/test_log_june_3.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'test_log_june_3.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
