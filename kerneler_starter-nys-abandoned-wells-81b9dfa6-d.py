...
# abandoned-wells.csv has 3735 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/abandoned-wells.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'abandoned-wells.csv'
nRow, nCol = df1.shape
