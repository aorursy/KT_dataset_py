...
# taxi-improvement-fund-tif-medallion-payments.csv has 7917 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/taxi-improvement-fund-tif-medallion-payments.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'taxi-improvement-fund-tif-medallion-payments.csv'
nRow, nCol = df1.shape
