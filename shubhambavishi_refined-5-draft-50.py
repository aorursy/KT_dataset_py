...
%matplotlib inline
os.listdir('/kaggle/input/refined-7-draft-45/PaintsTensorFlow_refined_20.h5')
...
class PaintsTensorFlowTrain:
    def __init__(self, model_name="PaintsTensorFlow"):
        ...
        self.saved_refined = '/kaggle/input/refined-7-draft-45/PaintsTensorFlow_refined_20.h5' #./PaintsTensorFlow_refined_11.h5
...
model.training(loadEpochs=10)
model.save_refined()
imagepath = '/kaggle/input/colorization-to-sketch-ru/real-img-test/imgreal_3110.jpeg'
linepath = '/kaggle/input/colorization-to-sketch-ru/sketch-img-test/img_3110.jpeg'
prediction = model.convert_data(imagepath,linepath)
plt.figure()
...
# cv2.imwrite('/kaggle/working/pred.jpeg',prediction[0])
