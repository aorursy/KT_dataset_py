...
# start with a string
before1 = "This is the euro symbol: €"
print(before1)
...
#after2 = after1.encode("utf-8", errors = "replace")
#print(afer2.decode("utf-8"))
...
before2 = "I'd recommend $, #, 你好 and नमस्ते"
print(before2)
after2 = before2.encode("ASCII", errors = "replace")
print(after2.decode("ASCII"))
after3 = before2.encode("utf-8", errors = "replace")
...
with open("../input/fatal-police-shootings-in-the-us/PoliceKillingsUS.csv", 'rb') as rawdata1:
    result1 = chardet.detect(rawdata1.read(50000))
