...
def to_smash(total_candies):
    ...
    can = 'candy' if total_candies == 1 else 'candies'

    print("Splitting", total_candies, can)
...
If the sum of their cards exceeds 21, 

they lose the round immediately.
...
- The dealer then deals additional cards to himself until either:
    ...
    If the player's total is greater than the dealer's, the player wins. Otherwise, 

    the dealer wins (even in case of a tie).
