...
# If you write this line, you will see "-" and "0". 
percentage_people_below_poverty_level["Geographic Area"].unique()
len(percentage_people_below_poverty_level["Geographic Area"].unique())

#general knowledge : 51 states 
# Our purpose poverty rate of each state
...
plt.title('Poverty Rate in States')
kill.head()
kill.name.value_counts()
# Let's find most common 15 name or surname of killed people
...
plt.title("Threat Types",color = "blue", size = 15)
# Flee types

sns.countplot(kill.flee)

plt.title("Flee types",color = "blue", size = 15)
# Having body cameras or not for police

sns.countplot(kill.body_camera)

plt.title("Having body cameras or not on Police",color = "blue", size = 15)
...
plt.title("Kill Numbers from States",color = "blue", size = 15)