...
print(f'Second Model test accuracy: {second_model.score(X_test, y_test)*100:.3f}%')
...
third_model = RandomForestClassifier(random_state = 1)

third_model.fit(X_train, y_train)



print(f'Third Model test accuracy: {third_model.score(X_test, y_test)*100:.3f}%')
