...
#If the data is in file format upon input, ["ls", "../input"] may return an error. You also need to show the file path inside
#Read datas
...
#manner of death(ölüm sekli) : Ates edilerek, ates edilerek ve sok tabancasıyla
...
plt.title('Most Dengerous States',color='purple',fontsize=17)
...
plt.title('Having mental illnes or not ',color='blue',fontsize=15)
#Threat types
...
plt.title('Having body cameras or not for police',color='blue',fontsize=19)
#Kill numbers from states in kill date
