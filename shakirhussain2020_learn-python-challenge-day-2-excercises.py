...
#q1.solution()
print (round(3345.12345,-2))
#q2.solution()
def to_smash(total_candies,total_friends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between total_friends when this argument is not passed it defaults to 3 friends.
