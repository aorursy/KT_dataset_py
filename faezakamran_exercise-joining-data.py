...
safe_config = bigquery.QueryJobConfig(maximum_bytes_billed=25*10**9)
...
def expert_finder(topic, client):
    ...
    my_query = """
                   ...
                   WHERE q.tags like CONCAT('%', @topic, '%')
    ...
    safe_config = bigquery.QueryJobConfig(query_parameters=query_params, maximum_bytes_billed=2*10**9)      
