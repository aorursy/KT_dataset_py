...
print("Logistic Regression test performance: %f" % (cross_val_score(logistic_model, testX, testY, cv=8).mean()))

print("Decision tree test performance: %f" % (cross_val_score(tree_model, testX, testY, cv=8).mean()))

print("Adaboost test performance: %f" % (cross_val_score(ada_model, testX, testY, cv=8).mean()))
