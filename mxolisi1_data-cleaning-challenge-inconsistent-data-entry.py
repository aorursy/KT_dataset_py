...
# Let's check if we've tidied up kuram agency correctly
#   # get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
...
cities
# get all the unique values in the 'City' column
islam_dates = suicide_attacks['Islamic Date'].unique()

# sort them alphabetically and then take a closer look
###islam_dates.sort()## I get the loat and stri errore
islam_dates
