...
fold_set = pd.read_csv('../input/deepdrid-weights/regular_train_valid_challenge2_Overall_quality.csv')
...
results = pd.DataFrame({'image_id':test['image_id'], 'Overall quality':predictions})
...
results.to_csv('Challenge2_upload_Overall_quality.csv', index=False)

display(results.head())
results['Overall quality'].value_counts()
import pandas as pd
