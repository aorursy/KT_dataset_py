...
df1 = pd.read_csv('/kaggle/input/jpeg_small_512/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/jpeg_small_512/train.csv', delimiter=',', nrows = nRowsRead)
