...
df1 = pd.read_csv('/kaggle/input/emotion_dataset/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/emotion_dataset/train.csv', delimiter=',', nrows = nRowsRead)
