...
def calculateConcentration(self):
    ...
    return conc
areaSource = areaSource(0,1,50,-100,10,20,0,1,1)
import numpy as np
...
#areaSource = areaSource(0,1,50,-100,10,20,0,rate,H)

pointSource = pointSource(0,0,0,rate,H)
...
a = gaussianPlume(pointSource,grid,stability,U)
...
fig.show()
print(grid.xMesh[0],grid.yMesh[0],concField[0])