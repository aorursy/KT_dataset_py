...
df1 = pd.read_csv('/kaggle/input/Dance Dataset/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Dance Dataset/train.csv', delimiter=',', nrows = nRowsRead)
