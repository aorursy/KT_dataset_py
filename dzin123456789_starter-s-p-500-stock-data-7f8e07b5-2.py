...
df1 = pd.read_csv('/kaggle/input/all_stocks_5yr.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/individual_stocks_5yr/individual_stocks_5yr/ABC_data.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/individual_stocks_5yr/individual_stocks_5yr/AEE_data.csv', delimiter=',', nrows = nRowsRead)
