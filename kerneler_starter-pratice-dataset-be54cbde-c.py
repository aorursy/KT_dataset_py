...
df1 = pd.read_csv('/kaggle/input/sample_submission.csv/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/test.csv/test.csv', delimiter=',', nrows = nRowsRead)
