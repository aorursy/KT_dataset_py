...
#Model to pridict the title between 0-8 words from absrtact that contains 0-250 words
...
for i in range(0,20):
    ...
    print("\n")
avrage_blue_score=blue_score/20

print('avrage blue score = ', avrage_blue_score)