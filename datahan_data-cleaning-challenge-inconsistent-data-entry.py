...
matches = process.extract("d.i khan", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
#process.extract("kurram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)    #check similarity first to determine if threshold in function is appropriate
...
process.extract("nan", hospitals, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
