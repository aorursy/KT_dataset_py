...
# death_by_group.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/death_by_group.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'death_by_group.csv'
