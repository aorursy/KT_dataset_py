...
train = pd.read_csv("/kaggle/input/answergen-dataset/train.csv")
train.head()
...
!ls
!ls ../input/
train_path = "../input/answergen-dataset/train.csv"
...
dataset = GrammerDataset(tokenizer, '../input/answergen-dataset', 'valid', 128)
...
!ls
!pwd
args_dict.update({'data_dir': '../input/answergen-dataset', 'output_dir': '/kaggle/working/result', 'num_train_epochs':1,'max_seq_length':256})
