...
prop_df.shape
prop_df.head()
missing_df = prop_df.isnull().sum(axis=0).sort_values(ascending=False).reset_index()
missing_df.columns = ['column_name', 'missing_count']
print('Shape of the data:',missing_df.shape)

width = 0.9
fig, ax = plt.subplots(figsize=(12,18))
sns.barplot(x = 'missing_count',y = 'column_name',data = missing_df, color='blue')
