...
def median(sequence):
    ...
    if n % 2 == 0:
        ...
        median1 = sequence[n//2]

        median2 = sequence[n//2 - 1]
...
def only_odd_numbers(sequence):
    ...
    only_odd = [num for num in sequence if num % 2 == 1]
...
def only_even_numbers(sequence):
    ...
    only_even = [num for num in sequence if num % 2 == 0]
...
def only_positive_numbers(sequence):
    ...
    only_positive = [num for num in sequence if num > 0]
...
def only_negative_numbers(sequence):
    ...
    only_negative = [num for num in sequence if num < 0]
...
def only_positive_evens(sequence):
    ...
    only_even_and_positive = [num for num in sequence if num % 2 == 0 and num > 0 ]

    return only_even_and_positive
...
def only_positive_odds(sequence):
    ...
    only_positive_and_odds = [num for num in sequence if num % 2 != 0 and num > 0]

    return only_positive_and_odds
...
def only_negative_evens(sequence):
    ...
    only_negative_and_evens = [num for num in sequence if num % 2 == 0 and num < 0]

    return only_negative_and_evens
...
def only_negative_odds(sequence):
    ...
    only_negative_and_odds = [num for num in sequence if num % 2 != 0 and num < 0]

    return only_negative_and_odds
...
def shortest_string(list_strings):
...
def get_number_of_books(list):
    ...
    number_of_dict = len(list)

    return number_of_dict
...
def total_of_book_prices(books):
	...
	for book in books:
	    ...
	    total_price = sum(d["price"] for d in books if d)
...
def get_average_book_price(books):
    ...
    average_per_item = total_price / number_of_dict
...
def highest_price_book(books):
	...
	books_by_price = sorted(books, key = itemgetter("price"))

	return books_by_price[-1]
...
def total_number_of_items(dict):
	...
	sum_value = sum(d["quantity"] for d in shopping_cart["items"] if d)
...
def get_average_item_price(dict):
	...
	total_price = sum(d["price"] for d in shopping_cart["items"] if d)
...
def get_average_spent_per_item(dict):
	...
	total_price_per_item = ((shopping_cart["items"][0]["price"] * shopping_cart["items"][0]["quantity"]) + (shopping_cart["items"][1]["price"] * shopping_cart["items"][1]["quantity"]) + (shopping_cart["items"][2]["price"] * shopping_cart["items"][2]["quantity"]) + (shopping_cart["items"][3]["price"] * shopping_cart["items"][3]["quantity"]) + (shopping_cart["items"][4]["price"] * shopping_cart["items"][4]["quantity"]))

	total_quantity = (sum(d["quantity"] for d in shopping_cart["items"] if d))

	average_spent = total_price_per_item / total_quantity
...
def most_spent_on_item(dict):
	...
	shopping_cart["items"][0]["total_spent"] = (shopping_cart["items"][0]["price"] * shopping_cart["items"][0]["quantity"])

	shopping_cart["items"][1]["total_spent"] = (shopping_cart["items"][1]["price"] * shopping_cart["items"][1]["quantity"])

	shopping_cart["items"][2]["total_spent"] = (shopping_cart["items"][2]["price"] * shopping_cart["items"][2]["quantity"])

	shopping_cart["items"][3]["total_spent"] = (shopping_cart["items"][3]["price"] * shopping_cart["items"][3]["quantity"])

	shopping_cart["items"][4]["total_spent"] = (shopping_cart["items"][4]["price"] * shopping_cart["items"][4]["quantity"])

	new_dict = sorted(shopping_cart["items"], key=itemgetter("quantity"), reverse=True)

	del new_dict[0]["total_spent"]
