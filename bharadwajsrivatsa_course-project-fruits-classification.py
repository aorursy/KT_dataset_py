...
num_classes
dataset = torchvision.datasets.ImageFolder(data_dir+'/Training', transform=torchvision.transforms.ToTensor())
len(dataset)
img, label = dataset[0]
...
test_dataset = torchvision.datasets.ImageFolder(data_dir+'/Test', transform=torchvision.transforms.ToTensor())
...
plt.imshow(img.permute(1, 2, 0))
print('Label:', dataset.classes[label], ', Predicted:', detect_image(img, model))
