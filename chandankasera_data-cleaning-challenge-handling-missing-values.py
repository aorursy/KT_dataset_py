...
sf_col_with_na_drops =sf_permits.dropna(axis=1)
sf_col_with_na_drops.head()
print("columns original %d "%sf_permits.shape[1])
print("columns after dropping nan %d "%sf_col_with_na_drops.shape[1])
