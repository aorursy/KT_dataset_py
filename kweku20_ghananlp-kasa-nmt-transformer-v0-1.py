...
MODE = 'train'
NUM_EPOCHS = 100
NUMBER_OF_DATASET = 200000
BATCH_SIZE = 8
def read_dataset(number):

    english_data = []
    with open('../input/dataset/jw300.en-tw.en') as file:
    ...
    twi_data = []
    with open('../input/dataset/jw300.en-tw.tw') as file:
...
for i, test_sent in enumerate(test_sents):
    ...
    # print(÷)
    print()
raw_data_en,raw_data_twi = read_dataset(20)
for i, test_sent in enumerate(raw_data_en):
    test_sequence = normalize_eng(test_sent)
    predict(test_sequence)
    # print(÷)
    print()
