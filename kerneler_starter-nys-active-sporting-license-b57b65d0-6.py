...
# active-sporting-license-issuing-agents.csv has 1261 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/active-sporting-license-issuing-agents.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'active-sporting-license-issuing-agents.csv'
nRow, nCol = df1.shape
