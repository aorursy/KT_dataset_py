...
def to_smash(total_candies,num_of_friends=3):
    ...
    the given number of candies evenly between num_of_friends friends.
    default argument num_of_friends=3
    >>> to_smash(91,3)
    1
    """
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    slowest = max(time_call(fn,arg1),time_call(fn,arg2),time_call(fn,arg3))
    return slowest
print(slowest_call(f,4,5,6))
#q6.hint()
q6.solution()
print(print("Spam"))
#q7.hint()
...
smallest_stringy_number('11', '10', '3')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
