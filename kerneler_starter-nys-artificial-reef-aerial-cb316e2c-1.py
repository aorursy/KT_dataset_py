...
# artificial-reef-aerial-survey-boat-count-beginning-1995.csv has 3782 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/artificial-reef-aerial-survey-boat-count-beginning-1995.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'artificial-reef-aerial-survey-boat-count-beginning-1995.csv'
nRow, nCol = df1.shape
