...
missing_values_sf_permit = sf_permits.isnull().sum()

total_cells_sf_permit = np.product(sf_permits.shape)
total_cells_sf_permit_missing = missing_values_sf_permit.sum()

(total_cells_sf_permit_missing/total_cells_sf_permit) * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print("final dataset shape:  " , columns_with_na_dropped_sf_permits.shape)
