...
from tqdm import tqdm
import bz2
from keras.layers import Dense, Input,   Activation, Conv1D, BatchNormalization, GlobalAveragePooling1D
...
net = Conv1D(256, 3, padding='same', activation='relu')(net)
net = BatchNormalization()(net)
net = Conv1D(32, 1, activation='relu')(net)
net = Conv1D(256, 3, strides=2, padding='same', activation='relu')(net)
net = BatchNormalization()(net)
net = Conv1D(32, 1, activation='relu')(net)
net = Conv1D(256, 3, strides=2, padding='same', activation='relu')(net)
net = BatchNormalization()(net)
...
net = Conv1D(256, 3, padding='same', activation='relu')(net)
net = BatchNormalization()(net)
net = Conv1D(256, 1, activation='relu')(net)
net = Conv1D(2, 1, activation='relu')(net)
