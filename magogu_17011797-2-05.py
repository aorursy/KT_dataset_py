...
linear1 =torch.nn.Linear(x_data.shape[1],m, bias = True)

linear2 =torch.nn.Linear(m,m2,bias = True)

linear3 =torch.nn.Linear(m2,m3,bias = True)

linear4 =torch.nn.Linear(m3,m3,bias = True)

linear5 =torch.nn.Linear(m3,1,bias = True)
...
!kaggle competitions submit -c 2020-abalone-age -f submission.csv -m 'submit'