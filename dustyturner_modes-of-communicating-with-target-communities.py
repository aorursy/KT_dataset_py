...
communication_queries = ["communicat", "engage", "talk", "messag", 

                         "relate ", "relating" "educate", "disseminate", 

                         "pass on", "telephone", "social media", 

                         "whatsapp", "facebook", "advert", "guidelines"]



searchtool.search(search_name="communicating", 

               containing=communication_queries,
...
display(HTML(searchtool.return_html_search_results(search_name="communicating")))
answers_1, html_answers = searchtool.return_html_answers(

    search_name="communicating", 

    question="communicating with people or groups at risk",
...
answers_2, html_answers = searchtool.return_html_answers(
    ...
    question="spreading awareness and information to populations",
...
answers_3, html_answers = searchtool.return_html_answers(
    ...
    question="presenting or communicating guidlines or rules",
...
summary_table_3 = summarizer_3.summary_table(
    ...
    solution_question="how to present or communicate rules and guidelines"
...
summary_table.to_csv("modes_of_communicating_with_target_high_risk_populations.csv")