...
nadropped_columns_sf= sf_permits.dropna(axis=1)
nadropped_columns_sf.head()

print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % nadropped_columns_sf.shape[1])
...
subset_sf_permits= sf_permits.loc[:,'Lot':'Zipcode'].head()
subset_sf_permits
