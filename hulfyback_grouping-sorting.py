...
answer_q6()
reviews['HUF'] = reviews.price.map(lambda price: price * 262.15)
reviews[reviews.country == 'Hungary'][['variety', 'points', 'HUF']].sort_values(by='points', ascending=False)
hungarian_wines = reviews[reviews.country == 'Hungary']
len(hungarian_wines)
hungarian_wines.shape