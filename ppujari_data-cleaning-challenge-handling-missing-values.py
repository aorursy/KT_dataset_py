...
missing_values_count[0:10]# get the number of missing data points per column
...
#missing_values_count_sf_permits[0:10]# get the number of missing data points per column
