...
# contracts.csv has 93954 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/contracts.csv', delimiter=',', nrows = nRowsRead)
