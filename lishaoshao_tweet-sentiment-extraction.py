...
train_df = pd.read_csv('../input/tweet-sentiment-extraction-wpf/train.csv')
...
test_df = pd.read_csv('../input/tweet-sentiment-extraction-wpf/test.csv')
...
sub_df = pd.read_csv('../input/tweet-sentiment-extraction-wpf/sample_submission.csv')
