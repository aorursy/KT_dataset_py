...
sns.distplot(a=cancer_b_data['Area (mean)'], label="Cancer benign Area (mean)", kde=False)

sns.distplot(a=cancer_m_data['Area (mean)'], label="Cancer Malignant Area (mean)", kde=False)
