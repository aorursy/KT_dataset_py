...
class forecast_price():
    ...
    def __init__(self,filename):
        ...
        df = pd.read_csv(self.filename, index_col='date', parse_dates=['date'])
        ...
        #input data to package

        tx = Stocker(price)

        #print out visual result

        model, model_data = tx.create_prophet_model(days=1)
forecast_price("../input/TAIEX.csv")
forecast_price("../input/TX.csv")
forecast_price("../input/2330.csv")