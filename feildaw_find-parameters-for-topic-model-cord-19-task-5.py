...
query = "What has been published concerning surge capacity and nursing homes?"

query_topicvec = topic_distribution(query, id2word_dict, lda_model)

corpus_similarities_print3(query_topicvec, index, documents_dict)
query = "What has been published concerning efforts to inform allocation of scarce resources? What do we know about personal protective equipment?"

query_topicvec = topic_distribution(query, id2word_dict, lda_model)

corpus_similarities_print3(query_topicvec, index, documents_dict)
query = "What has been published concerning alternative methods to advise on disease management"

query_topicvec = topic_distribution(query, id2word_dict, lda_model)

corpus_similarities_print3(query_topicvec, index, documents_dict)
query = "What has been published concerning processes of care? What do we know about the clinical characterization and management of the virus?"
