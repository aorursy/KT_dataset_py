...
# lost-property-contact-information.csv has 17696 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/lost-property-contact-information.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'lost-property-contact-information.csv'
nRow, nCol = df1.shape
