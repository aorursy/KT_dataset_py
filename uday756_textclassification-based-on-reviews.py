...
review=pd.read_csv('/kaggle/input/text-classification/Amazon_text.csv')
...
cmnavie=confusion_matrix(y_test,y_pred_navie)

cmnavie

import seaborn as sns

sns.heatmap(cmnavie,annot=True)
...
nb
recall_score(y_test,y_pred_navie)
...
rd.best_score_
gbccm=confusion_matrix(y_test,y_pred_gbc)
