...
df1 = pd.read_csv('/kaggle/input/student-shopee-code-league-sentiment-analysis/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/student-shopee-code-league-sentiment-analysis/sampleSubmission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/student-shopee-code-league-sentiment-analysis/train.csv', delimiter=',', nrows = nRowsRead)
