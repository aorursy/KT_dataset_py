...
fig.show()
fig = px.parallel_categories(df, color="Government Response Stringency Index ((0 to 100, 100 = strictest))", color_continuous_scale=px.colors.sequential.Viridis)
...
fig.show()
fig = px.bar(df[['Entity','Government Response Stringency Index ((0 to 100, 100 = strictest))']].sort_values('Government Response Stringency Index ((0 to 100, 100 = strictest))', ascending=False), 
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRJSz4ECSfJb7kJQaL3qLSz1U_JBcj6bXyXRw&usqp=CAU',width=400,height=400)