...
# Your code goes here :)
# I ordered by time to easily show which times of the day is the most dangerous to drive during. As shown, it is during the evening. 
...
plt.title("Number of Accidents by Rank by Hour \n (Most to least dangerous)")

print(accidents_by_hour)
query2 = """SELECT COUNT(hit_and_run) as number, 
