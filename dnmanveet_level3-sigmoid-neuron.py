...
sn_mse.fit(X_scaled_train, Y_train, epochs=10000, learning_rate=0.002, loss_fn="mse", display_loss=True)
...
sn_ce.fit(X_scaled_train, Y_train, epochs=1000, learning_rate=0.001, loss_fn="ce", display_loss=True)
