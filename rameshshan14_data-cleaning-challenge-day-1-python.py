...
# Your turn! Try replacing all the NaN's in the sf_permit data with the one tha
csf_permits = sf_permits.copy()
csf_permits.fillna(0)

# comes directly after it and then 
csf_permits.fillna(method = 'bfill', axis=0).fillna("0")