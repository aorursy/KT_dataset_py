...
titanic_df['Age_1'] = titanic_df[['Age']].apply( (lambda x: int(int(x) <16) ), axis=1)
titanic_df['Age_2'] = titanic_df[['Age']].apply( (lambda x: int(int(x) >= 16 and int(x)<32) ), axis=1)
titanic_df['Age_3'] = titanic_df[['Age']].apply( (lambda x: int(int(x) >= 32 and int(x)<48) ), axis=1)
titanic_df['Age_4'] = titanic_df[['Age']].apply( (lambda x: int(int(x) >= 48 and int(x)<64) ), axis=1)
test_df['Age_1'] = test_df[['Age']].apply( (lambda x: int(int(x) <16) ), axis=1)
test_df['Age_2'] = test_df[['Age']].apply( (lambda x: int(int(x) >= 16 and int(x)<32) ), axis=1)
test_df['Age_3'] = test_df[['Age']].apply( (lambda x: int(int(x) >= 32 and int(x)<48) ), axis=1)
test_df['Age_4'] = test_df[['Age']].apply( (lambda x: int(int(x) >= 48 and int(x)<64) ), axis=1)
...
titanic_df['Pmm'] = \
    titanic_df[['Pclass','Male','MasterMiss']].apply( get_malem, axis=1 )
test_df['Pmm'] = \
    test_df[['Pclass','Male','MasterMiss']].apply( get_malem, axis=1 )
...
def get_malepm(passenger):
    ...
    if ( pch==0 and male==1 and pc==1 ):
        ...
        return 0
titanic_df['PchM1'] = \
    titanic_df[['ParchBinary','Male','Pclass']].apply( get_malepm, axis=1 )
test_df['PchM1'] = \
    test_df[['ParchBinary','Male','Pclass']].apply( get_malepm, axis=1 )
...
titanic_df['3fs'] = \
    titanic_df[['Pclass','Female','S']].apply( get_3fs, axis=1 )
test_df['3fs'] = \
    test_df[['Pclass','Female','S']].apply( get_3fs, axis=1 )
titanic_df['FamilySize'] = titanic_df ['SibSp'] + titanic_df['Parch'] + 1
test_df['FamilySize'] = test_df ['SibSp'] + test_df['Parch'] + 1

titanic_df['BigFamily'] = \
  titanic_df[['FamilySize']].apply( (lambda x: int(int(x) >= 5) ), axis=1)
test_df['BigFamily'] = \
  test_df[['FamilySize']].apply( (lambda x: int(int(x) >= 5) ), axis=1)
    
titanic_df['SmallFamily'] = \
  titanic_df[['FamilySize']].apply( (lambda x: int(int(x) >= 2 and int(x)<=4) ), axis=1)
test_df['SmallFamily'] = \
  test_df[['FamilySize']].apply( (lambda x: int(int(x) >= 2 and int(x)<=4) ), axis=1)
    
titanic_df['Alone'] = \
  titanic_df[['FamilySize']].apply( (lambda x: int(int(x) ==1) ), axis=1)
test_df['Alone'] = \
  test_df[['FamilySize']].apply( (lambda x: int(int(x) ==1) ), axis=1)
...
titanic_df['Bc'] = \
    titanic_df[['Age_1','BigFamily']].apply( get_Bc, axis=1 )
test_df['Bc'] = \
    test_df[['Age_1','BigFamily']].apply( get_Bc, axis=1 )
...
titanic_df['Fc'] = \
    titanic_df[['C','Male']].apply( get_fmalec, axis=1 )
test_df['Fc'] = \
    test_df[['C','Male']].apply( get_fmalec, axis=1 )
...
titanic_df.drop(['Alone','SibSp','ParchBinary','Parch','MasterMiss','FamilySize','SmallFamily','S','C','Fc','Age'],axis=1,inplace=True)
test_df.drop(['Alone','SibSp','ParchBinary','Parch','MasterMiss','FamilySize','SmallFamily','S','C','Fc','Age'],axis=1,inplace=True)
