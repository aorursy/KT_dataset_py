...
#col_with_missing = [col for col in X_test_full.columns if X_test_full[col].isnull().any()]
...
#col_with_missing = [col for col in X_test.columns if X_test[col].isnull().any()] # Your code here



final_X_test = X_test.drop(col_with_missing , axis = 1)
...
#final_X_test = reduced_X_valid.columns 
