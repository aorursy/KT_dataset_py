...
df1 = pd.read_csv('/kaggle/input/google-quest-challenge/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/google-quest-challenge/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/google-quest-challenge/train.csv', delimiter=',', nrows = nRowsRead)
