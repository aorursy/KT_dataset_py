...
train_df["Title"] = train_df["Title"].replace(["Lady","the Countess","Capt","Col","Dr","Major","Rev","Sir","Jonkheer","Dona","Don"],"other")
...
classifier_param = [dt_param_grid, svc_paragrid, rf_param_grid, logreg_param_grid, knn_param_grid]
cv_results = []
...
for i in range(len(classifier)):
    ...
    print(cv_results[i])
cv_result = pd.DataFrame({"Cross Validation Means":cv_results, "ML Models":["DecisionTreeClassifier", "SVM", "RandomForestClassifier", "LogisticRegression", "KNeighborsClassifier"]})
