...
print("nfl_data shape: ", nfl_data.shape)
# your turn! Look at a couple of rows from the sf_permits dataset. Do you notice any missing data?
sf_permits.sample(5)

print("sf_permits shape: ",sf_permits.shape)
# your code goes here :)
...
columns_with_sf_dropped = sf_permits.dropna(axis=1)
columns_with_sf_dropped.head()

print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % columns_with_sf_dropped.shape[1])
