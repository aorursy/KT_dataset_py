...
for col in df_test.columns:
    ...
    print(msg)
msno.matrix( df = df_train.iloc[:,:], figsize = (8,8), color = (0, 0, 0.2))
msno.bar( df = df_train.iloc[:,:], figsize = (8,8), color = (0, 0, 0.3))
msno.matrix( df = df_test.iloc[:,:], figsize = (8,8), color = (0, 0, 0.2))
msno.bar( df = df_test.iloc[:,:], figsize = (8,8), color = (0, 0, 0.2))
...
plt.show()
df_train[['Pclass', 'Survived']].groupby(['Pclass'], as_index=True).count().style.background_gradient(cmap = 'summer_r')
df_train[['Pclass', 'Survived']].groupby(['Pclass'], as_index=True).sum().style.background_gradient(cmap = 'summer_r')
