...
class Network(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv7 = nn.Conv1d(1024, 512, 3, stride=1, padding=1) # "same" convolution

        self.conv8 = nn.Conv1d(512, 256, 3, stride=1, padding=1) # "same" convolution

        self.conv9 = nn.Conv1d(256, 128, 3, stride=1, padding=1) # "same" convolution

        self.conv10 = nn.Conv1d(128, 64, 3, stride=1, padding=1) # "same" convolution

        self.conv11 = nn.Conv1d(64, 32, 3, stride=1, padding=1) # "same" convolution

        self.conv12 = nn.Conv1d(32, 1, 3, stride=1, padding=1) # "same" convolution
