...
# Show all the countries not using ppm as unit to measure pollution
countries_not_ppm.country
...
# Show all the pollutants that have a value of exactly 0.
zero_pollutants.pollutant
