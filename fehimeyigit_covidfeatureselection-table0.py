...
data=pd.read_csv("/kaggle/input/covidmldata/data.csv")
...
df_out.to_csv('indttestTABLE0.csv', index=False)
from scipy.stats import pearsonr
from scipy.stats import spearmanr
from scipy.stats import kendalltau
from scipy.stats import mannwhitneyu
...
df_out['p_p_values'] = p_p_list
df_out['p_r_values'] = p_r_list
df_out.to_csv('pearsortable0.csv', index=False)
...
data1=x.iloc[:,[114,112,14,15,20,10,12,69,21,113]]
# split data train 80 % and test 20 %
...
data2=x.loc[:,['diagnostics_Mask-original_VoxelNum',
       'diagnostics_Mask-original_VolumeNum',
       'diagnostics_Mask-corrected_Mean', 'diagnostics_Mask-corrected_Maximum',
       'original_shape_VoxelVolume', 'original_shape_Maximum3DDiameter',
       'original_shape_MeshVolume', 'original_shape_MajorAxisLength',
       ...
       'original_glcm_Idmn', 'original_glcm_Contrast',
       'original_glcm_Correlation', 'original_glcm_ClusterProminence',
       'original_firstorder_Skewness',
       'original_firstorder_MeanAbsoluteDeviation',
       'original_firstorder_TotalEnergy', 'original_firstorder_Maximum',
       'original_firstorder_Entropy', 'original_firstorder_Range',
       'original_firstorder_10Percentile', 'original_glrlm_GrayLevelVariance',
