...
# data_test_sarcasm.csv has 60826 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/data_test_sarcasm.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'data_test_sarcasm.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# data_train_sarcasm.csv has 950000 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/data_train_sarcasm.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'data_train_sarcasm.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# spam.csv has 5572 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/spam.csv', delimiter=',', nrows = nRowsRead)
