...
# dd3_input_recodes.csv has 356255 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/dd3_input_recodes.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'dd3_input_recodes.csv'
nRow, nCol = df1.shape
