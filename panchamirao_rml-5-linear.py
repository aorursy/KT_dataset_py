...
missing_values.tail
sns.scatterplot(x='price' , y='sqft_living', data = train.tail(20000))
#Step 4: Prepare input X parameters/features and output y



# Split data into 'X' features and 'y' target label sets

X = train[['price','bedrooms','sqft_living15']]
