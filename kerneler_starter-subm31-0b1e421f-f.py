...
df2 = pd.read_csv('/kaggle/input/train.csv/train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/train.csv (1)/train.csv', delimiter=',', nrows = nRowsRead)
