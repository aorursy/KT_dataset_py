...
df1 = pd.read_csv('/kaggle/input/avhacklive/Train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/avhacklive/SampleSubmission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/avhacklive/Test.csv', delimiter=',', nrows = nRowsRead)
