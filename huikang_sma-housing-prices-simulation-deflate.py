...
NUM_BORN = lambda: np.random.binomial(40, 0.2)



# death probability function

DYING_PROB_FUNCTION = lambda age: 1./(1.+np.exp(-(0.2*(age-40))))
...
def deflate():
    ...
    houses["last_bought_price"] = houses["last_bought_price"]*0.98

    persons["wealth"] = persons["wealth"]*0.98
...
line_price_0, = ax[4,1].plot([], lw=3, label="average price")
...
ax[4,1].set_title("average housing price")
...
ax[4,2].set_title("price against utility")
