...
def has_vowels(arg):
    ...
    if any(x in arg for x in "aeiouAEIOU"):
...
def starts_and_ends_with_vowel(arg):
    ...
    if arg[0] in "aeiouAEIOU" and arg[-1] in "aeiouAEIOU":
...
def only_positive_numbers(arg):
    ...
    positives = [x for x in arg if x > 0]
...
def only_negative_numbers(arg):
    ...
    negatives = [x for x in arg if x < 0]
...
def only_positive_evens(arg):
    ...
    evens = [x for x in arg if x % 2 == 0 and x > 0]
...
def only_positive_odds(arg):
    ...
    odds = [x for x in arg if x > 0 and x % 2 == 1]
...
def only_negative_odds(arg):
    ...
    odds = [x for x in arg if x % 2 == 1 and x < 0]
...
def total_of_book_prices(arg):
  ...
  total_price = arg[0]["price"] + arg[1]["price"] + arg[2]["price"] + arg[3]["price"]
