...
# security-guard-schools-approved-by-the-division-of-criminal-justice-services.csv has 358 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/security-guard-schools-approved-by-the-division-of-criminal-justice-services.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'security-guard-schools-approved-by-the-division-of-criminal-justice-services.csv'
nRow, nCol = df1.shape
