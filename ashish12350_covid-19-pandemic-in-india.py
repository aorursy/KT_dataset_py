...
# Reading a .xls file by creating a dataframe using pandas
...
dbd_Wuhan = pd.read_excel('../input/covid-data/per_day_cases.xlsx',parse_dates=True, sheet_name="Wuhan")
...
fig.show()
df = pd.read_csv('../input/covid-data/covid_19_clean_complete.csv',parse_dates=['Date'])
...
df_deaths.head()
df.head()
df2 = df.groupby(["Date", "Country", "Province/State"])[['Date', 'Province/State', 'Country', 'Confirmed', 'Deaths', 
