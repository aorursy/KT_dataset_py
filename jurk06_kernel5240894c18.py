...
train=pd.read_csv('../input/9db113a1-cdbe-4b1c-98c2-11590f124dd8.csv')
test=pd.read_csv('../input/5c9fa979-5a84-45d6-93b9-543d1a0efc41.csv')
sub=pd.read_csv('../input/BloodDonationSubmissionFormat.csv')
sub.head()
