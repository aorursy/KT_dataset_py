...
sort_stars = sort(data['stars'],how='descending')
tail(sort_stars,12)

stars_3 = query(data,column='stars',condition= ">3")

plot_y=tabulate(stars_3['country'],stars_3['style'],method='count')

plot(data=plot_y, x = 'country', y = 'count',colour = 'style',style = 'lineplot')
