...
train_0 = get_groupby_target(tr,0)

%time

train_1 = get_groupby_target(tr,62)

%time

train_2 = get_groupby_target(tr,124)

%time

train_3 = get_groupby_target(tr,186)

%time
use_train = pd.concat([train_0,train_1,train_2,train_3])
use_train.to_csv("my_train_fisrt_part.csv", index=False)
