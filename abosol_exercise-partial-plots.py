...
for feat_name in base_features:
    ...
    plt.show()
q_1.solution()
feature_names_1=['pickup_longitude', 'dropoff_longitude']
inter1  =  pdp.pdp_interact(model=first_model, dataset=val_X, model_features=base_features, features=feature_names_1)

pdp.pdp_interact_plot(pdp_interact_out=inter1, feature_names=feature_names_1, plot_type='contour')
plt.show()
...
# Create array holding predictive feature
X1 = 1 * rand(n_samples) - 0.5
X2 = 1 * rand(n_samples) - 0.5
# Create y. you should have X1 and X2 in the expression for y
y = X1 * X2
