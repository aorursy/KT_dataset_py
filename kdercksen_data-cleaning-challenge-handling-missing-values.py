...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
sf_permits.loc[:, ['Street Number Suffix', 'Zipcode']].sample(20)
...
sf_cols_dropped = sf_permits.dropna(axis=1)
print(f'Original number of columns: {sf_permits.shape[1]}')
print(f'Columns left after dropping: {sf_cols_dropped.shape[1]}')
