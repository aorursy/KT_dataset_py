...
history = model.fit(x_train,y_train,epochs=150,batch_size=150,validation_data=(x_val,y_val))
# Training the model

history = model.fit(x_train,y_train,epochs=200,batch_size=150,validation_data=(x_val,y_val))
