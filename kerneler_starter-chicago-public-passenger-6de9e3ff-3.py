...
# public-passenger-vehicle-licenses.csv has 12136 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/public-passenger-vehicle-licenses.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'public-passenger-vehicle-licenses.csv'
nRow, nCol = df1.shape
