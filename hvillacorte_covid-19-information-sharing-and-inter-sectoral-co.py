...
questions = [
    ...
    {"question": "Methods for coordinating data-gathering with standardized nomenclature."},

    {"question": "Sharing response information among planners, providers, and others."},

    {"question": "Understanding and mitigating barriers to information-sharing."},

    {"question": "How to recruit, support, and coordinate local (non-Federal) expertise and"

                 " capacity relevant to public health emergency response (public, private,"

                 " commercial and non-profit, including academic)."},

    {"question": "Integration of federal/state/local public health surveillance systems."},

    {"question": "Value of investments in baseline public health response infrastructure"

                 " preparedness."},

    {"question": "Modes of communicating with target high-risk populations (elderly,"

                 " health care workers)."},

    {"question": "Risk communication and guidelines that are easy to understand and follow"

                 " (include targeting at risk populations’ families too)."},

    {"question": "Communication that indicates potential risk of disease to all population"

                 " groups."},

    {"question": "Misunderstanding around containment and mitigation."},

    {"question": "Action plan to mitigate gaps and problems of inequity in the Nation’s"

                 " public health capability, capacity, and funding to ensure all citizens"

                 " in need are supported and can access information, surveillance, and"

                 " treatment."},

    {"question": "Measures to reach marginalized and disadvantaged populations. Data systems"

                 " and research priorities and agendas incorporate attention to the needs"

                 " and circumstances of disadvantaged populations and underrepresented"

                 " minorities."},

    {"question": "Mitigating threats to incarcerated people from COVID-19, assuring access"

                 " to information, prevention, diagnosis, and treatment."},

    {"question": "Understanding coverage policies (barriers and opportunities) related"
