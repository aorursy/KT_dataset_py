...
generate_bubb_diff("Q28", "Tools / Techniques used")
...
fig.show()
generate_bubb_diff("Q17", "Notebooks Used")

generate_bubb_diff("Q16", "Editors / Tools Used")
...
pfs = ["University Courses", "Kaggle Learn"]
