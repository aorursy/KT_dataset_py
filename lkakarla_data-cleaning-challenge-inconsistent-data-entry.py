...
matches = fuzzywuzzy.process.extract("d.i khan", cities, limit=50, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
cities.sort()
cities
#find percentage of missing values in eachn column
missing_percent = suicide_attacks.isna().sum()/suicide_attacks.shape[0]
