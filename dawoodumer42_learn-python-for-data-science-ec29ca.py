...
def isPalindrome(string):
    ...
    for c in string:
        ...
        i = i-1
    return True
print (isPalindrome("ASDFASDFAAFDSAFDSA"))
...
def areAnagram(str1, str2):
    ...
    for c in str1:
        if c is not ' ':
            if str2.find(c) is not -1:
                str2 = str2.replace(c, '', 1)
            else:
                return False
    return len(str2) is 0
print(areAnagram('Hello My Name', 'leHloMyName'))
...
def substring(string, substr):
    ...
    for c in string:
        if c is substr[0]:
            ...
            found = True
            for x in substr:
                if temp >= len(string) or x is not string[temp]:
                    found = False
                    break
                temp = temp + 1
            if found:
        ...
        i = i+1
    return -1
print (substring("asdfasdfHelloasdfas", "Helloasdfas"))
