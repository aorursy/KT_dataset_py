...
batch_size = 100
train_data = pd.read_csv('../input/2020-ai-exam-fashionmnist-2/mnist_train_label.csv', header = None)

test_data = pd.read_csv('../input/2020-ai-exam-fashionmnist-2/mnist_test.csv', header = None, usecols=range(1, 785))
test_data
train_data
...
!kaggle competitions submit -c 2020-ai-exam-fashionmnist-2 -f submit.csv -m "result"