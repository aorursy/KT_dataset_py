...
bins=[10000,40000,50000,60000,70000,90000,180000]
...
vhigh=df[df.categories=='(90000, 180000]']
...
plot6=m.plot(x, y, 'go', markersize = 4, alpha = 0.8, color = colors[0],label='VVLow')



x, y = m(list(vlow.lon.astype(float)), list(vlow.lat.astype(float)))

plot1=m.plot(x, y, 'go', markersize = 4, alpha = 0.8, color = colors[1],label='VLow')
...
plot2=m.plot(x, y, 'go', markersize = 4, alpha = 0.8, color = colors[3],label='Medium')
...
plot3=m.plot(x, y, 'go', markersize = 4, alpha = 0.8, color = colors[4],label='high')
...
plot4=m.plot(x, y, 'go', markersize = 4, alpha = 0.8, color = colors[5],label='v high')
