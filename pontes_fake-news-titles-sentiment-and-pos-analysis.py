...
def barplot_statistics(prop, plot_title, ylimit=False):
...
barplot_statistics('avg_abs_textblob_polarity', 'Média de polaridade absoluta', .3)
#Média absoluta de subjetividade
barplot_statistics('avg_textblov_subjectivity', 'Média de subjetividade', .3)
#Média absoluta de negatividade
barplot_statistics('avg_vader_neg', 'Média de negatividade', .3)
#Média absoluta de positividade
barplot_statistics('avg_vader_pos', 'Média de positividade', .3)
#Média absoluta de neutralidade
barplot_statistics('avg_vader_neu', 'Média de neutralidade', 1)
#Média absoluta de polaridade forte
barplot_statistics('strong_polarity_percent', 'Porcentagem de títulos com polaridade forte', .3)
#Média absoluta de subjetividade forte
barplot_statistics('strong_subjectivity_percent', 'Porcentagem de títulos com subjetividade forte', .3)
#Média absoluta de positividade forte
barplot_statistics('strong_pos_percent', 'Porcentagem de títulos com positividade forte', .3)
#Média absoluta de positividade forte
barplot_statistics('strong_neg_percent', 'Porcentagem de títulos com negatividade forte', .3)
...
barplot_statistics('avg_abs_textblob_polarity_metaphors', 'Média de polaridade absoluta para títulos com metáforas', .3)
#Média absoluta de subjetividade para títulos com metáforas
barplot_statistics('avg_textblov_subjectivity_metaphors', 'Média de subjetividade para títulos com metáforas', .3)
#Média absoluta de negatividade para títulos com metáforas
barplot_statistics('avg_vader_neg_metaphors', 'Média de negatividade para títulos com metáforas', .3)
#Média absoluta de positividade para títulos com metáforas
barplot_statistics('avg_vader_pos_metaphors', 'Média de positividade para títulos com metáforas',.3)
#Média absoluta de polaridade forte para títulos com metáforas
barplot_statistics('strong_polarity_percent_metaphors', 'Porcentagem de títulos com polaridade forte para títulos com metáforas', .3)
#Média absoluta de subjetividade forte para títulos com metáforas
barplot_statistics('strong_subjectivity_percent_metaphors', 'Porcentagem de títulos com subjetividade forte para títulos com metáforas', .3)
#Média absoluta de negatividade forte para títulos com metáforas
barplot_statistics('strong_neg_percent_metaphors', 'Porcentagem de títulos com Negatividade forte para títulos com metáforas', .3)
#Média absoluta de positividade forte para títulos com metáforas
barplot_statistics('strong_pos_percent_metaphors', 'Porcentagem de títulos com positividade forte para títulos com metáforas', .3)
...
# análise de classes gramaticais + sentimento
...
barplot_statistics('avg_textblov_subjectivity_metaphors_vb', 'Média subjetividade quando existe met. VB')
barplot_statistics('avg_textblov_subjectivity_metaphors_nn', 'Média subjetividade quando existe met. NN')
barplot_statistics('avg_textblov_subjectivity_metaphors_nn_e_vb', 'Média subjetividade quando existe met. VB e NN')
barplot_statistics('avg_abs_textblob_polarity_metaphors_nn_e_vb', 'Média polaridade quando existe met. VB e NN')
barplot_statistics('avg_abs_textblob_polarity_metaphors_nn', 'Média polaridade quando existe met. NN')
barplot_statistics('avg_abs_textblob_polarity_metaphors_vb', 'Média polaridade quando existe met. VB')
