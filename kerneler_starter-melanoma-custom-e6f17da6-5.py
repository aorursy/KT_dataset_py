...
# train_Kfold.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df2 = pd.read_csv('/kaggle/input/train_Kfold.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'train_Kfold.csv'
