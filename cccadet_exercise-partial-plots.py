...
features_inter=['pickup_longitude', 'dropoff_longitude']

inter1  =  pdp.pdp_interact(model=first_model, dataset=val_X, model_features=base_features, features=features_inter)

pdp.pdp_interact_plot(pdp_interact_out=inter1, feature_names=features_inter, plot_type='contour')
plt.show()
q_2.solution()
