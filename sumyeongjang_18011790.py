...
train_data=pd.read_csv('/kaggle/input/2020-ai-exam-fashionmnist-1/mnist_train_label.csv',header=None,usecols=range(0,785))
test_data=pd.read_csv('/kaggle/input/2020-ai-exam-fashionmnist-1/mnist_test.csv',header=None,usecols=range(1,785))
...
!kaggle competitions submit -c 2020-ai-exam-fashionmnist-1 -f submission.csv -m "Message"
