...
# 311-service-requests-abandoned-vehicles.csv has 201084 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/311-service-requests-abandoned-vehicles.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = '311-service-requests-abandoned-vehicles.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-alley-lights-out.csv has 208774 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/311-service-requests-alley-lights-out.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = '311-service-requests-alley-lights-out.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-garbage-carts.csv has 386405 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/311-service-requests-garbage-carts.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = '311-service-requests-garbage-carts.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
