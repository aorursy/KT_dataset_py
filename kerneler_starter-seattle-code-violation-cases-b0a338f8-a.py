...
# code-violation-cases.csv has 41485 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/code-violation-cases.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'code-violation-cases.csv'
nRow, nCol = df1.shape
