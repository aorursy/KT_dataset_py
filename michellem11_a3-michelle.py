...
#adding the number of boy names with girls names

print (len(boys)+len(girls))


#finding the intersection between the boys names and girls names

inter = boys.keys() & girls.keys() 

print(len(inter)) # the length of the intersection list is the number of names that exist in both lists

          
#take a input name and turn input name to be lowercase

raw=input("name> ")

searchname=raw.lower()

#search boys' name dataset for input name
...
#search girls' name dataset for input name
