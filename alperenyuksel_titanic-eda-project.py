...
train_df[["Embarked","Age"]].groupby(["Embarked"], as_index=False).mean().sort_values(by="Age",ascending=False)
#Pclass-Age
...
train_df.head(5)
train_df.columns[train_df.isnull().any()]#columns that contain missing values.
train_df.isnull().sum()#sum of missing values for columns
