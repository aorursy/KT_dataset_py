...
train_tfms = transforms.Compose([transforms.RandomCrop(512, padding=8, padding_mode='reflect'),
...
img_mask = np.random.rand(len(data_df)) < 0.9

train_df = data_df[img_mask].reset_index()
val_df = data_df[~img_mask].reset_index()
...
submission_df.head()
sub_fname = 'ResNet101_submission.csv'
submission_df.to_csv(sub_fname, index=False)
weights_fname = 'protein-resnet101.pth'
