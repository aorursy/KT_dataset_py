...
# avg_class_size.csv has 19631 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/avg_class_size.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'avg_class_size.csv'
nRow, nCol = df1.shape
