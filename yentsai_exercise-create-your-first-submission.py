...
mcp_save = tf.keras.callbacks.ModelCheckpoint('model.best.hdf5', save_best_only=True, monitor='val_loss', mode='min')
el = tf.keras.callbacks.EarlyStopping(monitor='val_loss', patience=3)
callback = [mcp_save, el]
history = model.fit(
    ds_train,
...
#del model 
best_model = load_model('model.best.hdf5')
