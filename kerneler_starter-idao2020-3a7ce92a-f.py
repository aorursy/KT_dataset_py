...
df2 = pd.read_csv('/kaggle/input/data/Track 1/submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/data/Track 1/test.csv', delimiter=',', nrows = nRowsRead)
