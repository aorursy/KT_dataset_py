...
df=pd.read_csv('../input/machine-breakdown-prediction/Data_LVN_test.csv')
print(df.head())
corr=df.corr()
print(corr)
...
df_scaled.Classification=df.Classification
# df = df_scaled
X = df_scaled.loc[:, df.columns != 'Classification']
y = df_scaled.loc[:, 'Classification']
