...
url = 'https://www.kaggle.com/rankings.json?group=competitions&page=1&pageSize=20'
...
rankingTiers
# We need the number of rankers in competitions to know how many pages of 20 (every page has a fixed size of 20 users) we need to scrappe.
...
totalBronzeMedals = []
baseURL = 'https://www.kaggle.com/rankings.json?group=competitions&pageSize=20&page='
...
topKagglersCompetitions = pd.DataFrame({
...
topKagglersCompetitions.head(7)
# We check the sizes of the dataframe

topKagglersCompetitions.shape
# Build csv

topKagglersCompetitions.to_csv('topKagglersCompetitions.csv', index=False)