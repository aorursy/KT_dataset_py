...
# currently-licensed-commercial-nuisance-wildlife-control-operators.csv has 1237 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/currently-licensed-commercial-nuisance-wildlife-control-operators.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'currently-licensed-commercial-nuisance-wildlife-control-operators.csv'
nRow, nCol = df1.shape
