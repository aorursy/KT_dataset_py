...
# public-health-department-events.csv has 196 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/public-health-department-events.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'public-health-department-events.csv'
nRow, nCol = df1.shape
