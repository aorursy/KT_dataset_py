...
sns.jointplot("petal_length", "sepal_length", df, kind='kde');
plt.figure(figsize=(10,10))

sns.kdeplot(df.petal_length, df.sepal_length,  shade=True)
...
sns.kdeplot(df[setosa].petal_length, df[setosa].sepal_length, cmap="Blues",  shade=True, alpha=0.3, shade_lowest=False)

sns.kdeplot(df[virginica].petal_length, df[virginica].sepal_length, cmap="Greens", shade=True, alpha=0.3, shade_lowest=False)

sns.kdeplot(df[versicolor].petal_length, df[versicolor].sepal_length, cmap="Oranges", shade=True, alpha=0.3, shade_lowest=False)
sns.boxplot(x="species", y="sepal_length", data=df)
sns.violinplot(x="species", y="sepal_length", data=df)
fig = sns.FacetGrid(df, hue="species", aspect=4, palette="Set2")
