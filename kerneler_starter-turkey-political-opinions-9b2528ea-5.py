...
nRowsRead = 1000 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/datav2.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'datav2.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
plotHistogram(df2, 10, 5)
nRowsRead = 1000 # specify 'None' if want to read whole file
df3 = pd.read_csv('../input/yonelimfinal.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'yonelimfinal.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
