...
taxi_trips = client.get_table(table_ref)
...
#q_4.solution()
# Provided solution is incorrect.

# Look at the WHERE/BETWEEN AND part
...
speeds_query = """
               ...
               (
                   ...
                   WHERE DATE(trip_start_timestamp) BETWEEN '2017-01-01' AND '2017-07-01'
...
speeds_result[['hour_of_day', 'avg_mph']].set_index('hour_of_day').plot()
