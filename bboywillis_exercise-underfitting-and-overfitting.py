...
#for candidate_max_leaf_node in candidate_max_leaf_nodes:  
 #   if mae < get_mae(candidate_max_leaf_node, train_X, val_X,train_y, val_y):
  #      tree_size = candidate_max_leaf_node
   #     mae = get_mae(candidate_max_leaf_node, train_X, val_X,train_y, val_y)
