...
trainLabels = pd.read_csv("/kaggle/input/train-csv/trainLabels.csv")
...
listing = os.listdir("/kaggle/input/diabetic/train/train") 
...
base = os.path.basename("/kaggle/input/diabetic/train/train/" + file)
...
im = Image.open("/kaggle/input/diabetic/train/train/" + file)
