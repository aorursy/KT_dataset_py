...
sf_permits_total_missings = sf_permits.isnull().sum().sum()
sf_permits_total_missings / sf_permits_total_cells * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
sf_permits_columns_with_na_dropped = nfl_data.dropna(axis=1)
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
