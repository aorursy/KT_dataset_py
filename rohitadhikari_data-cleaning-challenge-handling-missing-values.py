...
rows_with_na_dropped_sf = sf_permits.dropna()
...
#How much data is left after dropping the columns in sf_permits dataset
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns in na's dropped dataset: %d" % columns_with_na_dropped_sf.shape[1])
