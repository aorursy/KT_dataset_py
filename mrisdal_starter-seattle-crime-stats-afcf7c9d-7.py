...
df1 = pd.read_csv('../input/seattle-crime-stats-by-1990-census-tract-1996-2007.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'seattle-crime-stats-by-1990-census-tract-1996-2007.csv'
nRow, nCol = df1.shape
