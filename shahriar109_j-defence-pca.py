...
print("The score for Random Forest Classifier is {}% with {} estimators.".format(rf_scores[4]*100, [700]))
print("For 10 estimators:")
...
print("Precision: {}%".format(precision[4]*100))

print("Recall: {}%".format(recall[4]*100))

print("F1 Score:  {}%".format(f1[4]*100))
...
#clf.fit(X_train, y_train)
    ...
    #y_pred = svc_classifier.score(X_test, y_test)
...
print("The score for K Neighbors Classifier is {}% with {} nieghbors.".format(knn_scores[15]*100, 16))
acc=knn_scores[15]

print("Accuracy: %.2f%% with 16 neighbors" % (acc * 100.0))
print("For 16 Neighbors:")

print("Precision: {}%".format(precision[15]*100))

print("Recall: {}%".format(recall[15]*100))

print("F1 Score:  {}%".format(f1[15]*100))
from sklearn import metrics
...
for i in range(1, 12):
    ...
    plt.text(i, dt_scores[i-1], (i, "%.3f" %dt_scores[i-1]))
...
print("The score for Decision Tree Classifier is {}% with {} maximum features.".format(dt_scores[10]*100, 11))
