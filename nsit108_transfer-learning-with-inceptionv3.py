...
InceptionV3_weights_path = '../input/inceptionv3/inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
preds = InceptionV3_model.predict_generator(generator=test_generator) # get proba predictions
