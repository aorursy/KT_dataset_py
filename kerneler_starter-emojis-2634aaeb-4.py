...
# emojis.csv has 2378 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/emojis.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'emojis.csv'
nRow, nCol = df1.shape
