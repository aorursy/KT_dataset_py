...
print(os.listdir("../input/ktfe-v40/data/"))
...
NUM_CLASSES = 7
data_path = '../input/kdfe-v10/kdfe/KDFE'
...
filenames = os.listdir("../input/kdfe-v10/kdfe/KDFE/train/")
...
class My_Generator(Sequence):
    ...
    def train_generate(self, batch_x, batch_y):
        ...
        for (sample, label) in zip(batch_x, batch_y):
            ...
            img = cv2.imread('../input/kdfe-v10/kdfe/KDFE/train/'+sample)
...
predicted = []
filenames = os.listdir("../input/ktfe-v40/data/data")
...
for sample in test_df['filename']:
    ...
    path = os.path.join('../input/ktfe-v40/data/data/'+sample)
...
test_df.to_csv('visble_prediction.csv', index=False)