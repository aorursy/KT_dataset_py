...
# load dataset
filename = "../input/germmmm/EngtoGer.txt"
...
# load dataset
#raw_dataset = load_clean_sentences('../input/pklzzz/english-german.pkl')

# reduce dataset size
n_sentences = 100000+7500
dataset = clean_pairs[100000:n_sentences, :]
# random shuffle
shuffle(dataset)
# split into train/test
train, test = dataset[:6750], dataset[6750:]
# save
...
model = load_model('../input/modeling/model.h5')
from pickle import load
from numpy import array
...
def evaluate_model(model, tokenizer, sources, raw_dataset):
	...
	for i, source in enumerate(sources):
		...
		raw_src, raw_target  = raw_dataset[i,0:2]
		if i < 10:
