...
run_example(query)
query = "What has been published concerning research and development and evaluation efforts of vaccines and therapeutics?"
run_example(query)
query = "what the literature reports about effectiveness of drugs being developed and tried to treat COVID-19 patients?"
run_example(query)
query = "what the literature reports about Clinical and bench trials to investigate less common viral inhibitors against COVID-19 such as naproxen, clarithromycin, and minocyclinethat that may exert effects on viral replication?"
run_example(query)
query = "what the literature reports about Methods evaluating potential complication of Antibody-Dependent Enhancement (ADE) in vaccine recipients of covid-19?"
run_example(query)
query = "what do we know about using best animal models and their predictive value for a covid-19 human vaccine?"
run_example(query)
query = "what are the capabilities to discover a covid-19 therapeutic (not vaccine) for the disease, and clinical effectiveness studies to discover therapeutics, to include antiviral agents?"
run_example(query)
query = "what do we know about alternative models to aid covid-19 decision makers in determining how to prioritize and distribute scarce, newly proven therapeutics as production ramps up?"
run_example(query)
query = "What are the approaches for expanding covid-19 production capacity to ensure equitable and timely distribution to populations in need?"
run_example(query)
query = "Which efforts have been targeting at a universal coronavirus vaccine?"
run_example(query)
query = "Which efforts have been developing animal models and standardize challenge studies?"
run_example(query)
query = "Which efforts have been developing prophylaxis clinical studies and prioritize in healthcare workers?"
run_example(query)
query = "which approaches have been evaluating risk for enhanced disease after vaccination?"
run_example(query)
query = "What do we know about assays to evaluate vaccine immune response and process development for vaccines, alongside suitable animal models?"
run_example(query)