...
print("Desvios da amostra para confiança de 93% {}".format(numero_desvios))
...
print("Inferior {}".format(inferior))

superior = media_amostra+margem_erro

print("Superior {}".format(superior))
...
print("Desvios da amostra para confiança de 80% {}".format(numero_desvios))
...
print("Desvios da amostra para confiança de 99% {}".format(numero_desvios))
