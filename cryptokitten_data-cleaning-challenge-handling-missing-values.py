...
sf_permits_no_nan = sf_permits.dropna(axis=1)
print("Original number of columns: %d n" % sf_permits.shape[1])
print("Number of columns after dropna: %d n" % sf_permits_no_nan.shape[1])
