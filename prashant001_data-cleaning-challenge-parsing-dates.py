...
#earthquakes_with_normal_dates['parsed_date'] = pd.to_datetime(earthquakes_with_normal_dates['Date'], format = "%m/%d/%Y")
# dataset that has correctly parsed dates in it. (Don't forget to 
# double-check that the dtype is correct!)
print(earthquakes_with_normal_dates['date_parsed'].head())
earthquakes_with_normal_dates['date_parsed'].dtype
