...
#getting age into a format where it can be stored as an integer
...
#just label-encoding everything
from sklearn.preprocessing import LabelEncoder
baseline_df = df.copy(deep=True)
baseline_df = baseline_df[['Date','Age','Type','Country','Area','Location','Activity','Name','Sex ','Time','Species ']].apply(LabelEncoder().fit_transform)
