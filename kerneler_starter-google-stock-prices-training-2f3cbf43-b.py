...
df1 = pd.read_csv('/kaggle/input/Google_Stock_Price_Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Google_Stock_Price_Train.csv', delimiter=',', nrows = nRowsRead)
