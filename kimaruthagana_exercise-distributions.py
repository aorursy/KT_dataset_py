...
print(cancer_b_data.head()) # Your code here
# Print the first five rows of the (malignant) data

print(cancer_m_data.head())# Your code here
# Fill in the line below: In the first five rows of the data for benign tumors, what is the

# largest value for 'Perimeter (mean)'?

head_row=cancer_b_data.head()

max_perim = max(head_row['Perimeter (mean)'])
...
sns.kdeplot(data=cancer_b_data['Radius (worst)'], label="Benign")# Your code here (benign tumors)
