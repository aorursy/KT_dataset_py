...
# model = tf.keras.models.load_model('../input/pnuemonia-detection-x-ray-classification/saved_model/my_model')



# prediction = model.predict([prepare('../input/chest-xray-pneumonia/chest_xray/test/PNEUMONIA/')])
...
confusion_matrix= confusion_matrix(categorical_test_labels, cl)
