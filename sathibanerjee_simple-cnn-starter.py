...
class ProteinCnnModel(MultilabelImageClassificationBase):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            nn.Conv2d(13, 3, kernel_size=3, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
            nn.Conv2d(30, 60, kernel_size=3, stride=2, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),

            nn.Conv2d(16, 48, kernel_size=3, stride=3, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
            nn.Conv2d(4, 12, kernel_size=2, stride=3, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),

            nn.Conv2d(60, 120, kernel_size=3, stride=1, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(2, 2),
            nn.Conv2d(128, 256, kernel_size=3, stride=1, padding=5),
            nn.ReLU(),
