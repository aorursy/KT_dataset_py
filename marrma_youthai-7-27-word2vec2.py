...
sentences = gensim.models.word2vec.Text8Corpus("../input/wikipedia-sentences/wikisent2.txt")
...
model.most_similar(positive=['earth','sun'], negative=['china'])

model.most_similar(positive=['sky','sea'], negative=['bird'])
model.most_similar(positive=['girl','mother'], negative=['boy'])