...
# baseline_submission_with_leaks.csv has 49342 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/baseline_submission_with_leaks.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'baseline_submission_with_leaks.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# baseline_submission_with_leaks_ROUNDED_MINUS2.csv has 49342 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/baseline_submission_with_leaks_ROUNDED_MINUS2.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'baseline_submission_with_leaks_ROUNDED_MINUS2.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# blend04.csv has 49342 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/blend04.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'blend04.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
