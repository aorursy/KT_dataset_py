...
def decoder_block(inputs, res, mid_channels, out_channels):
    ...
    db = Conv2DTranspose(mid_channels, (2, 2), strides=(2, 2))(inputs)
...
#         input_shape = input_size
    ...
    dec3 = decoder_block(center, res_path3, 512, 256)
    ...
    dec2 = decoder_block(dec3, res_path2, 256, 128)
    ...
    dec1 = decoder_block(dec2, res_path1, 128, 64)
