...
xgb_clf = xgb.XGBClassifier(n_estimators=3000, learning_rate=0.01)
...
abc = AdaBoostClassifier(n_estimators=3000, learning_rate=0.01)
...
classifier = CatBoostClassifier(n_estimators=500, learning_rate=0.01)
