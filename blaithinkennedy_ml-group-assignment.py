...
df1 = pd.read_csv('../input/opel_corsa_01.csv', delimiter=';', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/opel_corsa_02.csv', delimiter=';', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/peugeot_207_01.csv', delimiter=';', nrows = nRowsRead)
