...
df1 = pd.read_csv('/kaggle/input/Dataset/User_C/dataset.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Dataset/User_B/dataset.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Dataset/User_D/dataset.csv', delimiter=',', nrows = nRowsRead)
