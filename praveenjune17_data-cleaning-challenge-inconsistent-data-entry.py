...
close_matches
rows=suicide_attacks['City'].isin(close_matches)
suicide_attacks.loc[rows, column] = string_to_match
...
def replace_matches_in_column(df, column, string_to_match, min_ratio = 90):
    ...
    #print(df.loc[rows_with_matches, column])
