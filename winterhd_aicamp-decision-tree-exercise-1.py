...
plt.show()
model_logistic = LogisticRegression() # 调用logistic regression 模型
#TODO 
#模型在X, Y数据集上fit
...
plt.scatter(X[:,0], X[:,1], s=100, c=Y, alpha=0.5)
#TODO 
#调用plot_decision_boundary 函数画出logistic regression的决策边界
...
# 打印logistic regression的表现
print("score for basic tree:", model_logistic.score(X, Y))
plt.scatter(X[:,0], X[:,1], s=100, c=Y, alpha=0.5)
#TODO 
#调用plot_decision_boundary 函数画出决策边界
plot_decision_boundary(X, model_logistic)
...
print("score for tree with depth 3: ", model_depth_3.score(X,Y))
plt.scatter(X[:,0], X[:,1], c=Y, s=100, alpha=0.5)
plot_decision_boundary(X, model_depth_3)
plt.show()

print("score for tree with depth 5: ", model_depth_5.score(X,Y))
plt.scatter(X[:,0], X[:,1], c=Y, s=100, alpha=0.5)
plot_decision_boundary(X, model_depth_5)
plt.show()
...
print("score for tree with logistic regression: ", model_logistic.score(X,Y))
plt.scatter(X[:,0], X[:,1], c=Y, s=100, alpha=0.5)
plot_decision_boundary(X, model_logistic)
plt.show()
