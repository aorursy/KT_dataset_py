...
# dhs-daily-report.csv has 1768 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/dhs-daily-report.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'dhs-daily-report.csv'
nRow, nCol = df1.shape
