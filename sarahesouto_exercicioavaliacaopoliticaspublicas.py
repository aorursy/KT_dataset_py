...
#3-Calcule quantos desvios precisará para seu grau de confiânça ex. numero_desvios = calcula_numero_desvios_tstudent_para_confianca(confianca, tamanho_amostra)

numero_desvios = calcula_numero_desvios_tstudent_para_confianca(confianca, tamanho_amostra)

print(" Números desvios da amostra {}:".format(numero_desvios))
...
print('A média da poulação estará entre {} e {} com confiança {}'.format(inferior,superior,93))
...
print('A média da poulação estará entre {} e {} com confiança {}'.format(inferior,superior,80))
...
print('A média da poulação estará entre {} e {} com confiança {}'.format(inferior,superior,99))