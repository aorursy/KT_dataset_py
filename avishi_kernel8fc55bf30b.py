...
housing.head(10)
housing.info() #explains data types of data categories
#info on instance of that object
housing.describe()
...
plt.ylabel("Price")
plt.show()
plt.scatter(housing.price,housing.sqft_living)
plt.title("Price vs Square Feet")
plt.scatter(housing.price,housing.lat)
plt.title("Price vs Square Feet")
...
X = np.c_[housing[attributes]] #what are the attributes and what are you training on
