...
import pandas as pd
train_data = pd.read_csv("../input/train_data.csv/train_data.csv", encoding="utf8")
train_data.head()
train_data.author.unique().shape
target = pd.read_csv("../input/train_target.csv")
target.head()
...
model = Model()
test_data = pd.read_csv("../input/test_data.csv/test_data.csv", encoding="utf8")
features_dict = {}
