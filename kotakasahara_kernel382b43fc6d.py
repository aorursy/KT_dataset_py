...
clf2.fit(X_train_, y_train_, early_stopping_rounds=200,eval_metric='auc',eval_set=[(X_val,y_val)])
clf3 = LGBMClassifier(boosting_type='gbdt', 
...
clf3.fit(X_train_, y_train_, early_stopping_rounds=200,eval_metric='auc',eval_set=[(X_val,y_val)])
clf4 = LGBMClassifier(boosting_type='gbdt', 
...
clf4.fit(X_train_, y_train_, early_stopping_rounds=200,eval_metric='auc',eval_set=[(X_val,y_val)])
clf5 = LGBMClassifier(boosting_type='gbdt', 
...
clf5.fit(X_train_, y_train_, early_stopping_rounds=200,eval_metric='auc',eval_set=[(X_val,y_val)])
...
y_pred5 = clf5.predict_proba(X_test)[:,1]
pred_fin = []
