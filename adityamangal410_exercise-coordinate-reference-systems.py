...
birds = gpd.GeoDataFrame(birds_df, geometry = gpd.points_from_xy(x = birds_df['location-long'], y = birds_df['location-lat']) )
...
# ax = protected_areas[protected_areas['MARINE']!='2'].plot()

# birds[birds['location-lat'] < 0].plot(ax=ax)
