...
data_dir = '../input/masked-facerecognition'
TRAIN = 'AFDB_face_dataset/AFDB_face_dataset'
VAL = 'AFDB_masked_face_dataset/AFDB_masked_face_dataset'
TEST = 'AFDB_masked_face_dataset/AFDB_masked_face_dataset'
