...
history
history += fit(32, 1e-2, model, train_loader, val_loader)
history += fit(32, 1e-3, model, train_loader, val_loader)
history += fit(16, 1e-4, model, train_loader, val_loader)
history += fit(16, 1e-2, model, train_loader, val_loader)
history += fit(16, 1e-3, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
evaluate(model, test_loader)
arch = (128,32,64,10)
lrs = [1e-2, 1e-3, 1e-4, 1e-2, 1e-3]
epochs = [32,32,16,16.16]
test_acc = 1.356939435005188
test_loss = 51.7871081829071
