...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/rr4504.jpg') # intro page to preview later
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 9 of rr4504")
...
pdfimage9 = Image.open('/kaggle/working/rr4504.jpg')
# PDF to JPG for p7
...
pdfimage13 = Image.open('/kaggle/working/rr4504.jpg')
# Parse a PDF file and convert it to CSV using PyTesseract (p9)
...
pdfimage13.crop((0, 1240, w, h-1300)) # display exerpt of PDF
# Convert PDF to JPG and then convert JPG to CSV
...
pdfimage15 = Image.open('/kaggle/working/rr4504.jpg')
#Explore page 15 - Mueller Report. Here I don't know how many pages each Cheat Sheet. There are 30 pages 

w, h = pdfimage15.size # crop image

pdfimage15.crop((0, 1240, w, h-1300)) # display exerpt of PDF
# Pages 2, 3 and 8
