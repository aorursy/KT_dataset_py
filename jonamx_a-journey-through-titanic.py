...
feature_names = ['Age','Fare','C','Q','Family','Child','Female','Class_1','Class_2']
...
clf_l, Xtrain_l, ytrain_l, Xtest_l, ytest_l  = do_classify(clfForest , parameter_grid, titanic_df, feature_names, 'Survived',1)
