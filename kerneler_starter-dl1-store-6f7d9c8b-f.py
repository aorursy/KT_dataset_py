...
print(os.listdir('../input/challenge1'))
...
df1 = pd.read_csv('../input/challenge1/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/challenge1/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/challenge1/train.csv', delimiter=',', nrows = nRowsRead)
