...
wd = 0.1 
learn_c.fit_one_cycle(5, lr, wd=wd, moms=(0.8,0.7)) # 9 min/cycle (400k)
...
learn_c.fit_one_cycle(6, slice(lr/10/(2.6**4),lr/10), wd=wd, moms=(0.8,0.7)) 
...
print(f'accuracy global: {(cm[0,0]+cm[1,1]++cm[2,2])/(cm.sum())}') # 3 classes
