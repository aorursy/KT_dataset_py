...
train = pd.read_csv('/kaggle/input/mercaripricesuggestionchallenge-inputdata/train.tsv', delimiter='\t', low_memory=True, dtype=types_dict_train)

test = pd.read_csv('/kaggle/input/mercaripricesuggestionchallenge-inputdata/test_stg2.tsv', delimiter='\t', low_memory=True, dtype=types_dict_test)
