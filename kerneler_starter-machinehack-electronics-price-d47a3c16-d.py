...
df1 = pd.read_csv('/kaggle/input/Used_Electronics_Participants_Data/Train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Used_Electronics_Participants_Data/Test.csv', delimiter=',', nrows = nRowsRead)
