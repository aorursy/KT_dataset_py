...
# census-2000-and-2010-population-towns.csv has 1072 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/census-2000-and-2010-population-towns.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'census-2000-and-2010-population-towns.csv'
nRow, nCol = df1.shape
