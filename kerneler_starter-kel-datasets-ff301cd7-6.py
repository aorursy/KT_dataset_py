...
# Customers.csv has 360000 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Customers.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Demog.csv has 200 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/Demog.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'Demog.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Mailings1_2.csv has 60000 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/Mailings1_2.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'Mailings1_2.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
