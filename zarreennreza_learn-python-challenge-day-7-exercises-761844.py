...
def prettify_graph(graph):
    ...
    doll = ['${}'.format(amt) for amt in ticks]
    graph.set_yticklabels(doll)
    print(doll)
...
def blackjack_hand_greater_than(hand_1, hand_2):
    ...
    if h1_sum <= 21 and (h1_sum > h2_sum or h2_sum > 21):
        return True
    return False
#blackjack_hand_greater_than(['10','A'], ['8', 'J', '7', 'K'])
q3.check()
#q3.hint()
q3.solution()
