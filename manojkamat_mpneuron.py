...
X_binary_train = X_train.apply(pd.cut, bins = 2, labels = [0,1])

Y_binary_train = Y_train.apply(pd.cut, bins = 2, labels = [0,1])
...
y_pred = mpn.predict(X_binary_test)
