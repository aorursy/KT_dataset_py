...
# test.csv has 10000 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# train.csv has 32000 rows in reality, but we are only loading/previewing the first 100 rows
