...
second_fashion_model.add(Conv2D(20, kernel_size=(5, 5),

                 activation='relu',

                 input_shape=(img_rows, img_cols, 1)))

second_fashion_model.add(Conv2D(40, kernel_size=(3, 3), activation='relu'))

second_fashion_model.add(Conv2D(100, kernel_size=(3, 3), activation='relu'))
