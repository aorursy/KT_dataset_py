...
matches2 = fuzzywuzzy.process.extract("kuram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
with open('../input/PakistanSuicideAttacks Ver 6 (10-October-2017).csv', 'rb')  as rawdata:
    ...
    result2 = chardet.detect(rawdata.read(1000000))

print(result2)



attack= pd.read_csv('../input/PakistanSuicideAttacks Ver 6 (10-October-2017).csv', encoding='Windows-1252')
...
city=attack['City'].unique()

city.sort()

city
attack['City']=attack['City'].str.lower()

attack['City']=attack['City'].str.strip()



cities=attack['City'].unique()

cities.sort()

cities
matches2 = fuzzywuzzy.process.extract("d.i khan", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
def replace_matches_in_column(df, column, string_to_match, min_ratio = 90):
    ...
    print("All done!")
replace_matches_in_column(df= attack, column='City', string_to_match='d.i khan', min_ratio = 90)



c=attack['City'].unique()
