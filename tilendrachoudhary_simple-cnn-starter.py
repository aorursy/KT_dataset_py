...
encode_label('2 4 5')
decode_target(torch.tensor([0.3, 0.7, 1, 0, 1, 1, 0, 0, 0, 0.]))
...
class ProteinCnnModel(MultilabelImageClassificationBase):
    def __init__(self):
        ...
        self.network = nn.Sequential(
            ...
            nn.ReLU(),
            nn.Linear(64, 10),
            nn.Sigmoid() # for multilabel multiclass classification
        )
...
import jovian
jovian.commit(project='zerogans-protein-competition_simple_CNN_starter')