...
#First, let's make sure that 90 ratio won't substitute anything we don't want to
matches = fuzzywuzzy.process.extract("kurram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)

matches
#ratio of 90 was good to just fix the actual problems we see

#now I will use the function to fix it
