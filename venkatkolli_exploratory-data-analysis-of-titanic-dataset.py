...
Age_types # No of total passengers
Alive_2# No of Alive passengers 
(Alive_2/Age_types)*100 # percent of age types alive
...
df_3.plot(kind='bar',stacked=True, figsize=(12,10))
total_alive2= Alive_3.sum()
(Alive_3/total_alive2)*100 #Percent of alive passengers in terms of Fare type
total_dead2= dead_3.sum()
(dead_3/total_dead2)*100 #Percent of dead passengers in terms of Fare type