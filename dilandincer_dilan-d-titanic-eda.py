...
train_df["Sex"] = [0 if i == "female" else 1 for i in train_df["Sex"]]
train_df.Sex.head(220)
sns.heatmap(train_df[["Age","Sex","SibSp","Parch","Pclass"]].corr(),annot = True)

plt.show()
index_nun_age = list(train_df["Age"][train_df["Age"].isnull()].index)

for i in index_nun_age:
