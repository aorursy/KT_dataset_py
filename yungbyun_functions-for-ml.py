...
boxplot(data_f, 'Sex', 'Weight')
violin_plot(data_f, 'Sex', 'Weight')
plot_3d('Sex', 'Weight', 'FeetSize')
heatmap(data_f,['Height', 'Weight', 'FeetSize', 'Sex'])
train_X, train_y, test_X, test_y = split_4_parts(data_f, ['Height', 'Weight', 'Sex'], ['FeetSize'])
run_4_regressors(train_X, train_y, test_X, test_y)