...
print(os.listdir('../input/sample_submission_IPsBlCT'))

print(os.listdir('../input/test_aq1FGdB'))

print(os.listdir('../input/train_NA17Sgz'))
...
df1 = pd.read_csv('../input/sample_submission_IPsBlCT/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/test_aq1FGdB/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/train_NA17Sgz/train.csv', delimiter=',', nrows = nRowsRead)
