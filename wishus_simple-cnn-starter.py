...
print("HumanProteinDataset done")
...
#                                transforms.Pad(2, fill=0, padding_mode='reflect'), 
                                transforms.ToTensor(), 
...
print("ProteinCnnModel and forward done")
...
print("ProteinCnnModel2 and forward done")
...
history += fit(5, 1e-6, model, train_dl, val_dl, opt_func)
history += fit(5, 1e-5, model, train_dl, val_dl, opt_func)  #new code
history += fit(5, 1e-4, model, train_dl, val_dl, opt_func)  #new code
history
...
submission_df.head()
sub_fname = 'resnet34_submission5d.csv'
