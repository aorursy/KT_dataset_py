...
# county-agricultural-districts-profile.csv has 182 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/county-agricultural-districts-profile.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'county-agricultural-districts-profile.csv'
nRow, nCol = df1.shape
