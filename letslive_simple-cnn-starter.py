...
history += fit(num_epochs, 1e-4 , model, train_dl, val_dl, opt_func)
history += fit(1 , 1e-5 , model, train_dl, val_dl, opt_func)
history += fit(1 , 1e-5 , model, train_dl, val_dl, opt_func)
history += fit(num_epochs, 1e-5 , model, train_dl, val_dl, opt_func)
...
submission_df.head()
sub_fname = 'submission_resnet34_nival1.csv'
submission_df.to_csv(sub_fname, index=False)
!pip install jovian --upgrade
import jovian
jovian.commit(project='zerogans-protein-competition_Nival')