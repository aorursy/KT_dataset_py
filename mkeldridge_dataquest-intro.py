...
print(predictions)
print(((titanic["Survived"] == predictions) == True).sum())
((titanic["Survived"] == predictions) == True).sum() / len(predictions)
...
titanic_test["Age"].fillna(value=titanic["Age"].median(), inplace=True)
...
titanic_test["Fare"].fillna(value=titanic["Fare"].median(), inplace=True)
