...
# Your code here
output = pd.DataFrame({'Apples':[30], 'Bananas':[21]})
check_q1(output)
print(output)
...
import sqlite3
connec = sqlite3.connect("../input/pitchfork-data/database.sqlite")
artists = pd.read_sql_query("SELECT * FROM artists", connec)
artists.head()
check_q7(artists)