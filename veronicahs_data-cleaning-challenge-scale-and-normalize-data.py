...
#plot the original and the scaled to compare
fig, ax=plt.subplots(1,2)
...
#get the indexes for positive pledged column
index_of_pos_pledges=kickstarters_2017.pledged>0

#get the values of pledged with those indexes
positive_pledged=kickstarters_2017.pledged.loc[index_of_pos_pledges]

#normalize the data (with box cox)
normalized_pledged=stats.boxcox(positive_pledged)[0]

#represent the data in two graphics
fig, ax=plt.subplots(1,2)
