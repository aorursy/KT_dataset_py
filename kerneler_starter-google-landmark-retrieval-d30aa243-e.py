...
df1 = pd.read_csv('../input/google-landmarks-dataset/test.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# index.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows
df2 = pd.read_csv('../input/google-landmarks-dataset/index.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'index.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
df3 = pd.read_csv('../input/google-landmarks-dataset/train.csv', delimiter=',', nrows = nRowsRead)
