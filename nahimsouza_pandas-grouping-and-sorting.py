...
# reviews.loc[reviews["country"] == "Ukraine"].groupby("taster_name").count()
# Your code here
...
# test: check the min and max values
# reviews.loc[reviews["country"] == "Abouriou"]
# Your code here
...
# Your code here
reviews["n"] = 0 # create a column to be counted
