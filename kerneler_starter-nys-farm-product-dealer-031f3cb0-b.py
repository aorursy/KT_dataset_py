...
# farm-product-dealer-licenses-currently-issued.csv has 289 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/farm-product-dealer-licenses-currently-issued.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'farm-product-dealer-licenses-currently-issued.csv'
nRow, nCol = df1.shape
