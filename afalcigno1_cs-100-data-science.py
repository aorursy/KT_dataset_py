...
train_data[['Embarked', 'Pclass']].groupby(['Embarked']).mean()
...
for idx, row in test_data.iterrows():
    ...
    if row['Sex'] == 'female':
        ...
        if row['Pclass'] == '1':
            ...
            if row['Embarked'] == 'C': # this age doesn't seem to matter either
            ...
            if row['Embarked'] == 'C' or row['Fare'] > 8: #keep this at 8 - i checked it
        ...
        if row['Age'] < 10 and row['Pclass'] != '3': # keep this age at 10 too
