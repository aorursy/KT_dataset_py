...
cls_wt = class_weight.compute_class_weight('balanced',np.unique(train_labels),train_labels)
...
history = model.fit_generator(train_gen, epochs=50, steps_per_epoch=2662//32,
                    ...
                    callbacks=[ck,re], class_weight=cls_wt)
...
pred = model.evaluate(x_test, y_test_multi)

print('Test Accuracy:', pred[1]*100)
model_json = model.to_json()

with open('dr_model.json', mode='w') as json_file:
