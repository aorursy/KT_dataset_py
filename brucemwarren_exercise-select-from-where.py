...
distinct_cities_ans = open_aq.query_to_pandas_safe(distinct_cities_query)

print(distinct_cities_ans.head())



# Pull out where co > 400

co_query = """

                            SELECT DISTINCT city, pollutant, value 

                            FROM `bigquery-public-data.openaq.global_air_quality`

                            WHERE pollutant = "co" AND value > 400

                            

"""

co_ans = open_aq.query_to_pandas_safe(co_query)
