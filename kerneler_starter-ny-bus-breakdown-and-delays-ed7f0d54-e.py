...
# bus-breakdown-and-delays.csv has 235759 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/bus-breakdown-and-delays.csv', delimiter=',', nrows = nRowsRead)
