...
total_missing1=missing_value_count1.sum()
...
print("Rows with na's dropped: %d" % columns_with_na_dropped.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
columns_with_na_dropped = sf_permits.dropna(axis=1)
columns_with_na_dropped.head()
print("Colums in original dataset: %d \n" % sf_permits.shape[1])
print("Colums with na's dropped: %d" % columns_with_na_dropped.shape[1])
# get a small subset of the NFL dataset
subset_nfl_data = nfl_data.loc[:10, 'EPA':'Season']
subset_nfl_data
