...
multipleImages = glob('../input/blur-dataset/Blur_dataset/Blur/**')
 ...
 #   im = cv2.imread(l)
  #  im = cv2.resize(im, (128, 128)) 
   # plt.subplot(5, 5, i_+1) #.set_title(l)
    #plt.imshow(cv2.cvtColor(im, cv2.COLOR_BGR2RGB)); plt.axis('off')
    #i_ += 1
map_characters = {0: 'Defocus', 1: 'Motion', 2: 'Sharp'}
...
map_characters1 = {0: 'Defocus', 1: 'Motion', 2: 'Sharp'}
...
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_1,weight_path1,class_weight1,4,4,optimizer1,map_characters1)
...
pretrainedNetwork(X_trainRosReshaped[:10000], Y_trainRosHot[:10000], X_testRosReshaped[:2000], Y_testRosHot[:2000],pretrained_model_2,weight_path2,class_weight2,4,2,optimizer2,map_characters1)
pretrainedNetwork(X_trainRosReshaped[:10000], Y_trainRosHot[:10000], X_testRosReshaped[:2000], Y_testRosHot[:2000],pretrained_model_1,weight_path1,class_weight2,4,2,optimizer3,map_characters1)
pretrainedNetwork(X_trainRosReshaped[:10000], Y_trainRosHot[:10000], X_testRosReshaped[:2000], Y_testRosHot[:2000],pretrained_model_1,weight_path1,class_weight2,4,2,optimizer4,map_characters1)
pretrainedNetwork(X_trainRosReshaped[:10000], Y_trainRosHot[:10000], X_testRosReshaped[:2000], Y_testRosHot[:2000],pretrained_model_1,weight_path1,class_weight2,4,2,optimizer5,map_characters1)
...
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_2,weight_path2,class_weight1,4,8,optimizer2,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_2,weight_path2,class_weight1,4,8,optimizer3,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_2,weight_path2,class_weight1,4,8,optimizer4,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_3,weight_path2,class_weight1,4,8,optimizer1,map_characters1)
...
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_4,weight_path2,class_weight1,4,8,optimizer1,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_4,weight_path2,class_weight1,4,8,optimizer2,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_4,weight_path2,class_weight1,4,8,optimizer3,map_characters1)
pretrainedNetwork(X_train, y_trainHot, X_test, y_testHot,pretrained_model_4,weight_path2,class_weight1,4,8,optimizer4,map_characters1)