...
plt.show()
        ...
        #code snippet 7 -- FINDING THE NUMERICAL ERROR 



exact__radius_blue_line = (np.sqrt((exact_position_x-rxc)**2+(exact_position_y-ryc)**2))

numerical__radius_orange_line = (np.sqrt(((position_x-rxc)**2+(position_y-ryc)**2)))



numerical_error = numerical__radius_orange_line - exact__radius_blue_line    
...
plt.title("Numerical error trend")
...
print(exact__radius_blue_line) 

print(numerical__radius_orange_line)
