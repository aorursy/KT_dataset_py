...
df = pd.read_csv("../input/drugsets/drug200.csv")

df[0:5]
X = df[['Age', 'Sex', 'BP', 'Cholesterol', 'Na_to_K']].values

X[0:5] #Remove the column containing the target name
...
print(f'Model Accuracy: {drugTree.score(X, y)}')
y.unique()
...
print("DecisionTrees's Accuracy: ", jaccard_score(y_testset, y_pred, average=None))
drugTree = DecisionTreeClassifier(max_depth = 3)
