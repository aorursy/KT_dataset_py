...
second_fashion_model.add(Conv2D(12, activation='relu', kernel_size=3, input_shape=(img_rows,img_cols,1)))

second_fashion_model.add(Conv2D(40, activation='relu', kernel_size=2))
...
second_fashion_model.fit(x, y, batch_size=100, epochs=7, validation_split=0.2)
