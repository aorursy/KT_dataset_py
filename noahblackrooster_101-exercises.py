...
def mean(input):
    ...
    return sum_all(input)/ len(input)
...
def only_positive_numbers(numbers):
    ...
    return [x for x in numbers if is_positive(x)]
...
def only_negative_numbers(numbers):
    ...
    return [x for x in numbers if is_negative(x)]
...
def has_evens(x):
    ...
    return len(only_even_numbers(x)) > 0
...
def count_evens(x):
    ...
    return len(only_even_numbers(x))
...
def has_odds(x):
    ...
    return len(only_odd_numbers(x)) > 0
...
def count_negatives(x):
    ...
    return len(only_negative_numbers(x))
...
def count_positives(x):
    ...
    return len(only_positive_numbers(x))
...
def only_positive_evens(series):

    return [x for x in series if is_even(x) and is_positive(x)]
...
def only_positive_odds(series):

    return [x for x in series if is_odd(x) and is_positive(x)]
...
def only_negative_evens(series):

    return [x for x in series if is_negative(x) and is_even(x)]
...
def only_negative_odds(series):

    return [x for x in series if is_negative(x) and is_odd(x)]
...
def get_year_published(paper):
    ...
    return paper.get("year_published")
...
def get_book_author(dicti):

    return dicti.get("author")
...
def total_of_book_prices(total):
...
def get_average_book_price(total):
