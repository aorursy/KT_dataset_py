...
fig.update_layout(
    title_text = 'Confirmed Cases as of mar ,25 2020',
    title_x = 0.5,
    geo=dict(
        showframe = False,
...
fig.show()
is_2002 =  df['Country']=='US'
df_2 = df[is_2002]
bar_data = df_2.groupby(['Country', 'Date'])['Confirmed', 'Deaths', 'Recovered'].sum().reset_index().sort_values('Date', ascending=True)
