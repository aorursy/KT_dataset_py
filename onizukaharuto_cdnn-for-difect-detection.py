...
#y=to_categorical(np.array(cls_list))
...
model.compile(optimizer='adagrad', loss='binary_crossentropy', metrics=['accuracy', auc])

model.summary()
model.fit(X_train, y_train, epochs=10, batch_size=100)

#gscv.fit(X_train,y_train)
#print('%.5f  %r' % (grid_result.best_score_, grid_result.best_params_))
import glob
