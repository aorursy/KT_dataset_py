...
sf_cols_w_na_dropped = sf_permits.dropna(axis=1)
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_cols_w_na_dropped.shape[1])
...
sf_permits.fillna(method='bfill', axis=1).fillna('NaN')