...
pd.DataFrame(data={"Apples": [35,41],"Bananas": [21,34]},index=["2017 Sales", "2018 Sales"])
...
import sqlite3
pd.read_sql_query("SELECT * FROM artists", sqlite3.connect("../input/pitchfork-data/database.sqlite"))