...
# horse-racing-licensing.csv has 26410 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# horse-racing-rulings-beginning-1985.csv has 35777 rows in reality, but we are only loading/previewing the first 100 rows
