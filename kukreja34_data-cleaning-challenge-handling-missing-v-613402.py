...
dropped_na_sf = sf_permits.dropna()
dropped_na_sf

# Now try removing all the columns with empty values. Now how much of your data is left?
columns_with_dropped_na_sf = sf_permits.dropna(axis=1)

print ("Before dropping columns with null values",sf_permits.shape)
print ("After dropping columns with null values",columns_with_dropped_na_sf.shape)
