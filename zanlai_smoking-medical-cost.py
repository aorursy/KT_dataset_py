...
files()
data2 = read('../input/insurance.csv')
# liner regration
data2
describe(data2)
def function1(a):
    if a > 9382.033:
        ...
        return 0
# This function gives 1 to high charges and gives 0 to low charges.
data2['high_or_low'] = data2.apply(lambda x: function1(x.charges), axis=1)
...
def function1(a):
    if a > 9382.033:
        ...
        return 0
# This function gives 1 to high charges and gives 0 to low charges.
# The reason I use median instead of average is that I wish to separate this column into 
# two group with same number.
# If I use average number, the result can be inaccurate.
data2['high_or_low'] = data2.apply(lambda x: function1(x.charges), axis=1)
...
def function2(a):
    if a =='yes':
        ...
        return 0
data2['smoking'] = data2.apply(lambda x: function2(x.smoker), axis=1)

head(data2)
data2 = clean(data2)
head(data2)
# Now clean this dataset again, I can get what I want.
Y = data2['high_or_low']
X = exclude(data2, ['high_or_low','charges'])
head(X)
...
data2 = read('../input/insurance.csv')
describe(data2)
i = (1121.874 + 9382.033) / 2
j = (9382.033 + 63770.428) / 2
print(i)
print(j)
data2 = read('../input/insurance.csv')
def function1(a):
