...
df1 = pd.read_csv('../input/Death penalty - ABOLITIONISTS.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Death penalty - ABOLITIONISTS.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/Death penalty - EXECUTIONS BY COUNTRY.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'Death penalty - EXECUTIONS BY COUNTRY.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
