...
test_sub=pd.read_csv('../input/gender_submission.csv')
...
test_lable=test_sub.loc[:,'Survived']



precision=precision_score(result,test_lable,average='binary')

recall=recall_score(result,test_lable)
