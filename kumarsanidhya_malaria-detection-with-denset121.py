...
learn = create_cnn(data, mdl.densenet121, metrics=accuracy, model_dir="/tmp/model/")
...
pred_data= ImageDataBunch.from_folder(path, train=".", 
                                  ...
                                  num_workers=0).normalize(imagenet_stats)
predictor=cnn_learner(data, mdl.densenet121, metrics=accuracy, model_dir="/tmp/model/").load('stage-2')
