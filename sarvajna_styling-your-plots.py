...
pokemon.plot.scatter(x='Attack', y='Defense', figsize=(12,6), title="Pokemon by Attack and Defense")
...
pokemon['Total'].plot.hist(figsize=(12,6), fontsize=16, color='gray', bins=50).set_title("Pokemon by Stat Total", fontsize=20)
...
pokemon['Type 1'].value_counts().plot.bar(figsize=(12,6), fontsize=14).set_title("Pokemon by Primary Type", fontsize=20)
