...
mat1=sio.loadmat("../input/rawsec.mat")
syn_image_stack_input= mat1['K']
syn_image_stack = syn_image_stack_input[:,:,:, np.newaxis]
syn_image_stack.shape
mat2=sio.loadmat("../input/realsec.mat")
real_image_stack_input= mat2['K']
real_image_stack = real_image_stack_input[:,:,:, np.newaxis]
syn_image_stack.shape
img_height = 512
img_width = 512
img_channels = 1
syn_image_stack[1][1][1][0]
