...
print(dataset5.shape)
#ดูการกระจายตัวของข้อมูลใน dataset1

sns.pairplot(dataset1)
#ดู outlier ของข้อมูลชุด dataset1 ระหว่างพืชกับ ราคาต้นทุนการเพาะปลูก

ax = sns.boxplot(x="Crop", y="CostofCultivationA2", data=dataset1, palette="Set3")
#check ค่า unique values
...
#ทำ column "Crop" mapกับตัวเลขเพื่อที่จะ ทำให้แต่ละค่าเป็นสี
...
dataset1.head()
#ดูการกระจายตัวของข้อมูลแต่ละพืชของ dataset1 
