...
df1 = pd.read_csv('/kaggle/input/Age_Detection/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Age_Detection_test/test.csv', delimiter=',', nrows = nRowsRead)
