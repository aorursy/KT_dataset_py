...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    pass
    t=min(arg1,arg2,arg3,key=fn)
    return time_call(f,t)
slowest_call(f,2,3,4)
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
...
smallest_stringy_number2=lambda s1,s2,s3:min(s1,s2,s3,key=int)

smallest_stringy_number2('-1','2','-3')
#q8.b.hint()
#q8.b.solution()