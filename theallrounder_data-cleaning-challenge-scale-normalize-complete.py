...
barbeque = pd.read_csv("../input/kcbs-bbq/results_ribs.csv")
...
# read in all our additional data
barbeque = pd.read_csv("../input/kcbs-bbq/results_ribs.csv")
barbeque.sample(5)
sns.distplot(barbeque.score)
# normalise score (w/ Box-Cox)
normalised_score = stats.boxcox(barbeque.score)[0]

# plot both together to compare
fig, ax=plt.subplots(1,2)
sns.distplot(barbeque.score, ax=ax[0])
ax[0].set_title("Original Data")
sns.distplot(normalised_score, ax=ax[1])
