...
# loan_test.csv has 887379 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/loan_test.csv', delimiter=',', nrows = nRowsRead)
