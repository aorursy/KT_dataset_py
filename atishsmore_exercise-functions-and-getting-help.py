...
def to_smash(total_candies,no_of_friends=3):
    ...
    the given number of candies evenly between number of friends (no_of_friends). Default value of no_of_friends
    is 3 if not passed while calling the function.
...
#     return max(t1_arg1 - t0_arg1, t1_arg2 - t0_arg2, t1_arg3 - t0_arg3)
