...
#นำข้อมูล anime.csv ไปเก็บ anime
anime = pd.read_csv('../input/anime.csv')
#แสดงตารางข้อมูล 4 เรื่องแรก
anime.head()
#แสดงผลลัพธ์
print(anime.shape)
#นำข้อมูล rating.csv ไปเก็บ user
user = pd.read_csv('../input/rating.csv')
#แสดงตารางข้อมูล user id
user.head(10)
#แสดงผลลัพธ์
print(user.shape)
#แสดงการคำนวนคะแนนเฉลี่ยของผู้ใช้ที่ติดลบ จากuserเดียว

user[user['user_id']==1].rating.mean()
#แสดงการคำนวนคะแนนเฉลี่ยของผู้ใช้ที่ต่ำที่สุด จาก 2 user

user[user['user_id']==2].rating.mean()
#แสดงการคำนวนคะแนนเฉลี่ยของผู้ใช้ 5 user
