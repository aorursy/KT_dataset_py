...
data_1_2a = csv_to_list('stress1a_promoters.csv')

data_0_2b = csv_to_list('stress1b_promoters.csv')

data_1_1a = csv_to_list('stress2a_promoters.csv')

data_0_1b = csv_to_list('stress2b_promoters.csv')

data_n = csv_to_list('red_neutral_95.csv')
data_0t=list()
...
model = KerasClassifier(build_fn=create_model,batch_size=512,epochs=100,verbose=0)  
...
model_train3 = modelSimple(X_smote_3,y_smote_3,x_test3,y_test3)
test(x_test3,y_test3,model_train3)
