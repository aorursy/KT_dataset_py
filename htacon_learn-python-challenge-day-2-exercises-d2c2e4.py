...
def to_smash(total_candies, n=3):
    ...
    the given number of candies evenly between n friends, n will assume to be 3 when not passed
...
print(slowest_call(sleep,0.5,1,1.5))
q6.hint()
#q6.solution()
print(print("Spam"))
q7.hint()
...
def smallest_stringy_number(s1, s2, s3):
    ...
    '1'
    """
    return str(min(s1, s2, s3, key=int))
