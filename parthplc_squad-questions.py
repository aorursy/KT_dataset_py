...
train = pd.read_csv("../input/squad-20-csv-file/squad_csv/train-squad.csv")
train.shape
...
!ls
!ls ../input/
train_path = "../input/squad-20-csv-file/squad_csv/train-squad.csv"
...
dataset = GrammerDataset(tokenizer, '../input/squad-20-csv-file/squad_csv', 'validation-squad', 128)
...
!ls
!pwd
args_dict.update({'data_dir': '../input/squad-20-csv-file/squad_csv', 'output_dir': '/kaggle/working/result', 'num_train_epochs':1,'max_seq_length':400})
