...
print(list(map(lambda table: table.table_id, client.list_tables(dataset))))
...
speeds_query = """
               ...
               (
                   ...
                   WHERE trip_start_timestamp > TIMESTAMP('2017-01-01') and trip_start_timestamp < TIMESTAMP('2017-07-01')
