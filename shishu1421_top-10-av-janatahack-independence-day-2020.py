...
df_train_classes.apply(pd.value_counts).transpose().plot(kind='bar',title='Data Points Per Class',figsize=[12,10])
df_train_classes[(df_train_classes['Quantitative Biology']==1 ) & (df_train_classes['Quantitative Finance']==1)]
