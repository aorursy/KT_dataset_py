...
q1=['Non-pharmaceutical intervention effectiveness',

'equity to compliance for non-pharmaceutical intervention',

'barrier to compliance for non-pharmaceutical intervention',

'Guidance to scale up Non-pharmaceutical intervention/ NPI',

'collaboration with all states for Non-pharmaceutical intervention/ NPI',

'experiments for implementing Non-pharmaceutical intervention/ NPI',

'DHS Centers used for conducting experiment',

'Efficacy of school closure',

'Efficacy of mass gatherings bans',

'Efficacy of travel bans',

'Social distancing effect',

'Methods to control spread in communities',

'Barrier to compiance among population',

'potential intervention to predict cost',

'potential interventions to predict benefits',

'benefit of potential interventions factors',

'Policy change for compliance',

'Policy change for undeserved and population with limited resources',

'Why people fail to comply with public health advice',

'social cost of public health advice',

'financial cost of public health advice',

'Economic effect of pandemic',

'Food distribution cost of pandemic', 

'cost of pandemic' 

]
s1=['What do we know about the effectiveness of non-pharmaceutical interventions?',
...
q2=['What do we know about the effectiveness of non-pharmaceutical interventions?',
...
new_frame.to_csv("task6_results.csv",index=False)