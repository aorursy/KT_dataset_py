...
print (usd_goal.min(), usd_goal.mean(), usd_goal.max())
kickstarters_2017[kickstarters_2017['usd_goal_real'] == usd_goal.max()]
sns.distplot(usd_goal)
# select the usd_goal_real column
usd_goal = kickstarters_2017.usd_goal_real
...
print (goal.min(), goal.mean(), goal.max())
kickstarters_2017[kickstarters_2017['goal'] == goal.max()]
# scale the goals from 0 to 1
