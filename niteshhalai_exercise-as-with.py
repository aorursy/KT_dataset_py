...
#print(rides_per_year_query_job)
...
speeds_query = """
               ...
               (
                   ...
                   SELECT unique_key, EXTRACT(HOUR FROM trip_start_timestamp) as hour_of_day, trip_miles, trip_seconds

                   FROM `bigquery-public-data.chicago_taxi_trips.taxi_trips`

                   WHERE trip_start_timestamp > '2017-01-01' AND 

                         trip_start_timestamp < '2017-07-01' and trip_seconds>0 and trip_miles>0
