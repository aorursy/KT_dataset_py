...
football
edu = pd.read_csv('/kaggle/input/experiment-2-12-10-2020/files/ch02/educ_figdp_1_Data.csv',
...
edu.sort_values(by = 'Value', ascending = False,
                inplace = True)
edu.head()
edu.sort_values(by = 'Value', ascending = True,
                inplace = True)
edu.head()
...
group.head()
filtered_data = edu[edu["TIME"] > 1999]
