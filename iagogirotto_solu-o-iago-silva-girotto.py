...
df_train_preparado = df_train_bruto.drop(['ID_CANDIDATO'], axis=1)
df_test_preparado = df_test_bruto.drop(['ID_CANDIDATO'], axis=1)
# Substitui valores nulos por 0 nas colunas numéricas
colunas_numericas = ['ANO_ELEICAO','CD_TIPO_ELEICAO','NR_TURNO','CD_ELEICAO','CD_CARGO','CD_SITUACAO_CANDIDATURA','CD_DETALHE_SITUACAO_CAND','NR_PARTIDO','CD_NACIONALIDADE','CD_GENERO','CD_GRAU_INSTRUCAO','CD_ESTADO_CIVIL','CD_COR_RACA','CD_OCUPACAO', 'NR_IDADE_DATA_POSSE', 'TOTAL_BENS']
