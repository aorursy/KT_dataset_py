...
# city-of-albany-building-permits-issued-beginning-january-2009.csv has 11837 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/city-of-albany-building-permits-issued-beginning-january-2009.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'city-of-albany-building-permits-issued-beginning-january-2009.csv'
nRow, nCol = df1.shape
