...
print(os.listdir('../input/dc99623a-c-vista_data'))
...
df1 = pd.read_csv('../input/dc99623a-c-vista_data/sample.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/dc99623a-c-vista_data/train.csv', delimiter=',', nrows = nRowsRead)
