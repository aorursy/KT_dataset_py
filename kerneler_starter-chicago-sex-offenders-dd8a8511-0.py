...
# sex-offenders.csv has 1108 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/sex-offenders.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'sex-offenders.csv'
nRow, nCol = df1.shape
