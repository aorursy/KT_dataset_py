...
# проверка и очищение постоянных столбцов
colsToRemove = []
...
print(colsToRemove)
# # удаляем повторяющиеся столбцы в train
train_df.drop(colsToRemove, axis=1, inplace=True) 

# удаляем повторяющиеся столбцы в test
test_df.drop(colsToRemove, axis=1, inplace=True)

print("Removed `{}` Duplicate Columns\n".format(len(colsToRemove)))
print(colsToRemove)
#Отбросываем лишние данные
...
#Построение обучающих и тестовых данных для моделирования
