...
head(data, 5)
tally(data['style'])
plot(data['stars'], style = 'histogram')
plot(data['brand'],data['stars'], style = 'boxplot')
#help(tally)
tally(data['country'], 10, graph = True, percent = True)
query(data, column = 'brand', condition ='=="Ve Wong"')
sort(data['stars'],how = 'descending')[-13:-1]
task2 = query(data, column = 'stars', condition ='>3')
#task2
final = tabulate(task2['country'], task2['style'], method = "count")
plot(x='country',y='count', data = final, style = 'lineplot', colour = 'style')
