...
train_data_path = '../input/dogs-gone-sideways/images/train'
train_generator = data_generator.flow_from_directory(directory = train_data_path,
                                                    target_size = (image_size,image_size),
                                                    batch_size = 22,
                                                    class_mode='categorical')

validation_data_path = '../input/dogs-gone-sideways/images/val'
validation_generator = data_generator.flow_from_directory(directory = validation_data_path,
                                                         target_size = (image_size, image_size),
                                                         class_mode = 'categorical')
