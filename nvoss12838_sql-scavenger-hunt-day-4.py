...
transactions_per_day.plot(x='day',y='transactions')
transactions_per_day.plot(y='transactions')
plt.xlabel('DOY')
...
#transactions_per_root.plot(x='day',y='transactions')
len(transactions_per_root)