...
def estimate_average_slot_payout(n_runs):
    ...
    return average/n_runs - 1

print(estimate_average_slot_payout(10**6))
q4.solution()
def slots_survival_probability(start_balance, n_spins, n_simulations):
    ...
    for _ in range(n_simulations):
        ...
        while balance >= 1.0:
            ...
            spin_count += 1
            #print("Spin counter: ",spin_count)
            
        #print(spin_count)
        prob += 1 if spin_count >= n_spins else 0
...
#slots_survival_probability(10, 10, 10)
#slots_survival_probability(1, 2, 10)
q5.check()
q5.solution()