...
trainloader = torch.utils.data.DataLoader(trainset, batch_size=batch_size, shuffle=train_sampler)
...
is_cuda
your_model = models.densenet161(pretrained=True)
your_model
...
your_model.classifier = classifier
your_model.cuda()
...
valid_loss_min = 0.478 # model has been trained for 20 epochs already
...
!pip install kaggle
!kaggle competitions submit -c qstp-deep-learning-2019 -f submission.csv -m "densenet161_ft_val1"