...
trainip1 = np.zeros((len(trainip),5), dtype = np.float64)

trainop1 = trainop

testip1 = np.zeros((len(testip),5), dtype = np.float64)
...
trainip2 = np.zeros((len(trainip),6), dtype = np.float64)

trainop2 = trainop

testip2 = np.zeros((len(testip),6), dtype = np.float64)

testop2 = testop



trainip2[0:len(trainip),0:5] = trainip1.copy(); trainop2 = trainop.copy()

testip2[0:len(testip),0:5] = testip1.copy(); testop2 = testop.copy()
...
trainip2[:,5] = (trainip[:,3] * x621) + x622

testip2[:,5] = (testip[:,3] * x621) + x622
...
trainip3 = np.zeros((len(trainip),7), dtype = np.float64)

trainop3 = trainop

testip3 = np.zeros((len(testip),7), dtype = np.float64)

testop3 = testop



trainip3[0:len(trainip),0:5] = trainip1.copy(); trainop3 = trainop.copy()

testip3[0:len(testip),0:5] = testip1.copy(); testop3 = testop.copy()
...
trainip3[:,5] = (trainip[:,3] * x621) + x622

testip3[:,5] = (testip[:,3] * x621) + x622



trainip3[:,6] = (trainip[:,4] * x71) + x72

testip3[:,6] = (testip[:,4] * x71) + x72
