...
max_commits_query = """
                    ...
                    SELECT committer.name AS committer_name,
                        ...
                        COUNT(committer.name) AS num_commits
...
result_query = client.query(max_commits_query).result().to_dataframe()
...
result_query = client.query(pop_lang_query).result().to_dataframe()
...
result_query = client.query(all_langs_query).result().to_dataframe()
