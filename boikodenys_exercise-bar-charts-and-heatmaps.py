...
#sns.barplot(x = ign_data.index, y = ign_data.loc[:, 'Racing'])

#plt.xticks(rotation = 45)

sns.barplot(x = ign_data.loc[:, 'Racing'], y = ign_data.index)
...
sns.heatmap(data = ign_data, annot = True, cmap = 'Greens') # Your code here
