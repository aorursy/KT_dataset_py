...
# alternative way of computingthe above
...
for idx, row in test_data.iterrows():
    ...
    if row['Sex'] == 'female' and row['Parch'] == 0:
...
len(predictions) == len(test_data), 'Number of predictions must match number of test data rows!'
