...
def numericalSort(value):
    ...
    return parts
filelist_trainx_ph2 = sorted(glob.glob('../input/*/*/*/PH2/trainx/*.bmp'), key=numericalSort)

X_train_ph2 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_ph2])



filelist_trainy_ph2 = sorted(glob.glob('../input/*/*/*/PH2/trainy/*.bmp'), key=numericalSort)
...
for i in range(0,200):
    ...
    im = Image.open(filelist_trainx_ph2[i])

    im_resized = im.resize(size, Image.ANTIALIAS)

    X_train_ph2_resized.append(im_resized)   

    im = Image.open(filelist_trainy_ph2[i])

    im_resized = im.resize(size, Image.ANTIALIAS)

    Y_train_ph2_resized.append(im_resized)   
...
# filelist_trainx_ph2 = sorted(glob.glob('../input/*/*/*/ISIC_2017/trainx/*.jpg'), key=numericalSort)

# X_train_isic2017 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_ph2])



# filelist_trainy_ph2 = sorted(glob.glob('../input/*/*/*/ISIC_2017/trainy/*.jpg'), key=numericalSort)

# Y_train_isic2017 = np.array([np.array(Image.open(fname)) for fname in filelist_trainy_ph2])
# X_train_isic2017_part1 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[:200]])

# X_train_isic2017_part2 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[200:400]])

# X_train_isic2017_part3 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[400:600]])

# X_train_isic2017_part4 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[600:800]])

# X_train_isic2017_part5 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[800:1000]])

# X_train_isic2017_part6 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[1000:1200]])

# X_train_isic2017_part7 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[1200:1400]])

# X_train_isic2017_part8 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[1400:1600]])

# X_train_isic2017_part9 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[1600:1800]])

# X_train_isic2017_part10 = np.array([np.array(Image.open(fname)) for fname in filelist_trainx_isic2017[1800:2000]])
