...
# new-york-state-registered-tax-return-preparers-and-facilitators.csv has 37506 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/new-york-state-registered-tax-return-preparers-and-facilitators.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'new-york-state-registered-tax-return-preparers-and-facilitators.csv'
nRow, nCol = df1.shape
