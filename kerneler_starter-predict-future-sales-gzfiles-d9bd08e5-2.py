...
# sales_train.csv has 2935849 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/sales_train.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'sales_train.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# sample_submission.csv has 214200 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# test.csv has 214200 rows in reality, but we are only loading/previewing the first 100 rows
