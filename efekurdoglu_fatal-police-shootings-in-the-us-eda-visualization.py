...
percentage_people_below_poverty_level.head() # First 5 data
percentage_people_below_poverty_level.describe()
percentage_people_below_poverty_level.poverty_rate.value_counts()
percentage_people_below_poverty_level['Geographic Area'].unique() # 50 states in the US
...
kill.head() # First 5 data in kill dataset
...
plt.show()
data.head(10)
# parameters of joint plot can be changed
