...
training0 = "/kaggle/input/employee-resignation-mlpo/train_data.csv"
test0 = "/kaggle/input/employee-resignation-mlpo/test_data.csv"
training_data = pd.read_csv(training0)
training_data.info()
