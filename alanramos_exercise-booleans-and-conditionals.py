...
def to_smash(total_candies):
    ...
    if(total_candies==1): print("Splitting", total_candies, "candie")
...
def should_hit(dealer_total, player_total, player_low_aces, player_high_aces):
  ...
  #  print(dealer_total, player_total, player_low_aces, player_high_aces)

    suma = player_total +  player_low_aces + player_high_aces*11

    if suma <18: return True
