...
def should_hit(player_total, dealer_total, player_aces):
    ...
    """
    if player_total < 20 and player_total <= dealer_total:
        return True
#     elif:
#         player_total > 20 and player_total <=dealer_total and player_aces > 1
#         player_total = player_total - 10 * player_aces
#         return True
    else:
        return False
