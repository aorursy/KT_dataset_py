...
babo_dataset = pd.read_csv('../input/train.csv', header=0)
df = babo_dataset.select_dtypes(include=numerics)
df.head()
...
dead['Age'].hist(normed=1)
alive['Age'].hist(normed=1,alpha=0.7)
dead['Gender'].hist(normed=1)
alive['Gender'].hist(normed=1,alpha=0.7)
#alive['Gender'].plt()
dead.head()
