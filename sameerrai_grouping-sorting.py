...
# Your code here
country_variety_pairs_multiindex = reviews.groupby (['country', 'variety']).description.agg ([len])
country_variety_pairs = country_variety_pairs_multiindex.reset_index().sort_values(by = ['len'], ascending = False )
