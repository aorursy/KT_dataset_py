...
# Nice_Ride_2017_Station_Locations.csv has 202 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Nice_Ride_2017_Station_Locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Nice_Ride_2017_Station_Locations.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Nice_ride_trip_history_2017_season.csv has 460718 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/Nice_ride_trip_history_2017_season.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'Nice_ride_trip_history_2017_season.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# WeatherDailyMinneapolis2017.csv has 365 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/WeatherDailyMinneapolis2017.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'WeatherDailyMinneapolis2017.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
