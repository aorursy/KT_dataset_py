...
def to_smash(total_candies, num_friends = 3):
    ...
    the given number of candies evenly between the given number of friends (assume 3
    friends if no second argument is provided.
...
time_call(round_to_two_places, 3.14159)
#q5.hint()
#q5.solution()
