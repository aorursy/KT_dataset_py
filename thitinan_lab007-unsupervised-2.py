...
mat = loadmat("../input/unsupervised-data/ex8data1.mat")
X = mat["X"]
Xval = mat["Xval"]
yval = mat["yval"]
...
for c in contour_level:
    plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),c)
plt.xlim(0,35)
plt.ylim(0,35)
plt.xlabel("Latency (ms)")
plt.ylabel("Throughput (mb/s)")
...
plt.xlabel("Latency (ms)")
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat("../input/unsupervised-data/ex8data2.mat")
X2 = mat2["X"]
Xval2 = mat2["Xval"]
yval2 = mat2["yval"]
...
mat3 = loadmat("../input/unsupervised-data/ex8_movies.mat")
mat4 = loadmat("../input/unsupervised-data/ex8_movieParams.mat")
...
# load movie list
movieList = open("../input/unsupervised-data/movie_ids.txt","r", encoding="ISO-8859-1").read().split("\n")[:-1]
