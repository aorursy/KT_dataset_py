...
subprocess.check_output('ls -ltr ../input/yelp-dataset', shell=True)
...
json.loads()
yelp_reviews=pd.read_csv("../input/yelp-dataset/yelp_academic_dataset_review.csv",usecols=["stars","text"])
