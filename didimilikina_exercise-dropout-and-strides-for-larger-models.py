...
fashion_model_3.add(Conv2D(24, kernel_size=(3, 3), strides=1,
                 padding='same',
                 activation='relu',
                 input_shape=(img_rows, img_cols, 1)))
fashion_model_3.add(Dropout(0.2))
fashion_model_3.add(Conv2D(24, (3, 3), strides=2, activation='relu', padding='same'))
fashion_model_3.add(Dropout(0.2))
fashion_model_3.add(Conv2D(24, (3, 3), strides=2, activation='relu', padding='same'))
fashion_model_3.add(Dropout(0.2))
