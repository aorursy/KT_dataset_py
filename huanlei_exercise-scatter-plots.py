...
plt.title('Ralationship between sugar & win')
...
plt.title('Ralationship between price & win')
...
'Step 7 is better. It behaves like box-plot which clearly represents the two distributions.'
# Check your answer (Run this code cell to receive credit!)
