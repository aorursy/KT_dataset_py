...
missing_columns = [col for col in X_train.columns if X_train[col].isnull().any()] # Your code here

print(missing_columns)

# Fill in the lines below: drop columns in training and validation data

reduced_X_train = X_train.dropna(axis=1).copy()

reduced_X_valid = X_valid.dropna(axis=1).copy()
