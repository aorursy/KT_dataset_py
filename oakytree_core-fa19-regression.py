...
housing_data =  pd.read_csv(f"{DATA_DIR}/house-prices-advanced-regression-techniques/train.csv") 
...
data = pd.read_csv(f"{DATA_DIR}/ucfai-core-fa19-regression/adult.data", names =["age","workclass","fnlwgt","education","education-num","marital-status","occupation","relationship","race","sex","capital-gain","capital-loss","hours-per-week","native-country","income"])
...
test_data = pd.read_csv("/kaggle/input/ucfai-core-fa19-regression/adult.test", names =["age","workclass","fnlwgt","education","education-num","marital-status","occupation","relationship","race","sex","capital-gain","capital-loss","hours-per-week","native-country","income"])
...
test_data["income"] = test_data.apply(lambda row: incomeFixer(row['income']), axis=1)
