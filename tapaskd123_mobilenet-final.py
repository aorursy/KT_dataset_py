...
f = np.load('/kaggle/input/compression/final.npy',allow_pickle=True)
...
#   model.layers[-1].trainable=True
  ...
  hist=model.fit(trn_x,to_categorical(trn_y),batch_size=32,epochs=epoch)
  ...
  del([tst,trn,trn_x,trn_y,tst_x,tst_y])
