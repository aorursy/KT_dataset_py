...
sf_missing_count[0:43]

total_cells = np.product(sf_permits.shape)
total_missing = sf_missing_count.sum()
print(total_cells)
print(total_missing)
...
sf_permit_wo_na_columns = sf_permits.dropna(axis = 1)
sf_permit_wo_na_columns.head()

print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_permit_wo_na_columns.shape[1])
