...
df1 = pd.read_csv('../input/capital-district-transportation-authority-cdta-annual-reports-beginning-2007.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'capital-district-transportation-authority-cdta-annual-reports-beginning-2007.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# capital-district-transportation-authority-cdta-performance-metrics.csv has 106 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/capital-district-transportation-authority-cdta-performance-metrics.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'capital-district-transportation-authority-cdta-performance-metrics.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
