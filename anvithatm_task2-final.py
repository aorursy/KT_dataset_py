...
related_articles_index_file_bio = pd.read_csv("/kaggle/input/article-ref-bio-task2/article_indexes_bio_task2.csv",sep=";")

related_articles_index_file_comm = pd.read_csv("/kaggle/input/article-ref-comm-task2/article_indexes_comm_task2.csv")

related_articles_index_file_noncomm = pd.read_csv("/kaggle/input/article-ref-noncomm-task2/article_indexes_noncomm_task2.csv")
###bio
...
with open('/kaggle/input/vectorizer-bio-task2/article_bio_vectorizer_task2.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-bio-task2/abstract_bio_vectorizer_task2.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-comm-task2/article_comm_vectorizer_task2.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-comm-task2/abstract_comm_vectorizer_task2.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-noncomm-task2/article_noncomm_vectorizer_task2.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-noncomm-task2/abstract_noncomm_vectorizer_task2.pickle', 'rb') as tf_abs:
...
level1_sub_questions = ["1. Smoking, pre-existing pulmonary disease",
...
sub_categories_keywords = [["pulmonary disease", "smoking"],

                   ["Co-infections", "viral infection","co-morbidities"],

                   ["neonates", "pregnant women"],

                   ["socio economic", "behavioural factors","economic impact"],

                   ["Transmission dynamics", "reproductive number", "incubation period", "serial interval", "modes of transmission", "environmental factors"],

                   ["Severity of disease", "risk of fatality", "high risk patient groups"],
