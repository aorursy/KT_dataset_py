...
fig.show()
# numper of place which covid-19
...
# temp data cases princes cruise ship
...
fig.show()
# location hubei-china and world
...
fig.show()
# number cases every day in world
...
plt.show()
# cases in each confirmed in country
