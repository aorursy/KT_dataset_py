...
data_history = my_new_model.fit_generator(
...
loss_train = data_history.history['loss']

loss_val = data_history.history['val_loss']
...
plt.show()
val_precision = data_history.history['val_precision_22']

val_recall = data_history.history['val_recall_19']
...
plt.show()
val_precision = data_history.history['val_precision_23']

val_recall = data_history.history['val_recall_17']
...
plt.show()
val_precision = data_history.history['val_precision_18']

val_recall = data_history.history['val_recall_15']
