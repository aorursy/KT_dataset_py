...
head(data, 5)
tally(data['style'])
plot(x = data['stars'],style = 'histogram', data = data)
plot(x = 'brand', y = 'stars', style = 'boxplot', data = data)
tally(data['country'], graph = True, percent = '>0', top = 10)
query(data = data, column = 'brand', condition = "== 'Ve Wong'")
sort(data,by = 'stars', how = 'descending')[-12:]
star_bigger_than_3 = query(data, column = 'stars', condition = '> 3')
star_bigger_than_3
country_style_tabular = tabulate(star_bigger_than_3['country'], star_bigger_than_3['style'])
plot(x = 'country', y = 'count', style = 'lineplot', colour = 'style', data = country_style_tabular)
