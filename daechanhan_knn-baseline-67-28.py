...
train_csv=pd.read_csv("/kaggle/input/sejongai-challenge-pretest-2/2020.AI.bike-train.csv")
train_csv
...
test_csv=pd.read_csv("/kaggle/input/sejongai-challenge-pretest-2/2020.AI.bike-test.csv")
test_csv
...
df=pd.DataFrame(result,columns=["id","count"])
