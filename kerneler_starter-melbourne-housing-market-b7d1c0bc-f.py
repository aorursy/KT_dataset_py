...
# MELBOURNE_HOUSE_PRICES_LESS.csv has 58189 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Melbourne_housing_FULL.csv has 34857 rows in reality, but we are only loading/previewing the first 100 rows
