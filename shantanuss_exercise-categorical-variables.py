...
#     OH_X_train = OH_X_train.drop([col],axis=1)

#     OH_X_valid = OH_X_valid.drop([col],axis=1)
...
OH_cols_test = pd.DataFrame(OH_encoder.fit_transform(final_X_test[low_cardinality_cols]))
