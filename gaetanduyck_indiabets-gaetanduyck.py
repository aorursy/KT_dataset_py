...
india = pd.read_csv("../input/pima-indians-diabetes-database/diabetes.csv")
india.head()
india.count()
india.Age.value_counts()
india.Pregnancies.value_counts()
HighPreg = (india.Pregnancies>=5)
india[HighPreg].head()
india[HighPreg].count()
india[HighPreg].Outcome.value_counts()
LowPreg = (india.Pregnancies<5)
...
NoDiab = ~ Diab
Ayana = Age30 & HighPreg

Aponi = Age60 & LowPreg
p_Ayana = india[Ayana & Diab].Age.count()/india[Ayana].Age.count()

print(p_Ayana)
p_Aponi = india[Aponi & Diab].Age.count()/india[Aponi].Age.count()

print(p_Aponi)
sns.violinplot(x="Outcome", y="Age", data=india)
fig = sns.FacetGrid(india, hue="Outcome", aspect=4, palette="Set1")
...
india.columns
india.count()
plt.hist(india.BloodPressure, bins=80)
def replace_0(india,col) :
...
india = replace_0(india,'BloodPressure')

india = replace_0(india,"SkinThickness")

india = replace_0(india,"Insulin")

india = replace_0(india,'BMI')
plt.hist(india.BloodPressure, bins=80)
sns.distplot(india.Pregnancies, color='blue')
sns.kdeplot(india.Pregnancies, color='blue')
india[['Age','Pregnancies']].describe()
sns.kdeplot(india.Age, color='blue')

sns.kdeplot(india.Pregnancies, color='red')
india.info()
X = india.drop(['Outcome'], axis=1)
