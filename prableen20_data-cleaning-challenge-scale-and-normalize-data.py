...
# We can see that our data has categorical and numeric data
...
pos_pledged = kickstarters_2017['pledged'] > 0

positives = kickstarters_2017.pledged.loc[pos_pledged]
normalized_data = stats.boxcox(positives)[0]
