...
def cnn_model(result_class_size):
    ...
    adamOPT = Adam(lr=0.001, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0, amsgrad=False)
...
random_seed = 3
#validate size = 5%
split_train_x, split_val_x, split_train_y, split_val_y, = train_test_split(arr_train_x_28x28, arr_train_y, test_size = 0.05, random_state=0)
print("Train: ", split_train_x.shape)
print("Train label: ", split_train_y.shape)
print("Test: ", split_val_x.shape)
print("Test label: ", split_val_y.shape)
...
model.fit_generator(datagen.flow(split_train_x, split_train_y, batch_size=1024),
