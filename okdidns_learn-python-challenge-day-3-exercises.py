...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if player_aces:
        if player_total > 18:
            return False
        elif dealer_total < 9 and dealer_total > 1 and player_total > 17:
            return False
        else:
            return True
    else:
        if player_total > 16:
            return False
        elif (dealer_total==2 or dealer_total==3) and player_total > 12:
            return False
        elif (dealer_total>3 and dealer_total<7) and player_total > 11:
            return False
        else:
            return True
