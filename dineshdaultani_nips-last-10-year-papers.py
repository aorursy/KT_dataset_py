...
## Creating urls list for further use
base_url  = "http://papers.nips.cc"
index_conf_year = 2015
index_conf_number = 28

index_url_array = []
## For 10 years range is 10.
for i in range(10):
...
pd.DataFrame(list(nips_authors), columns=["Id","Name"]).to_csv("output/Authors.csv", mode='a', header=False, index=False)
