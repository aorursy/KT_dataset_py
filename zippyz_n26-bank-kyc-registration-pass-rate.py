...
doc.head(5)
face = pd.read_csv('../input/kyc_challenge/facial_similarity_reports.csv', delimiter=',')
...
face.head(5)
mb = pd.merge(doc, face, on='Unnamed: 0', how='left', suffixes=('_doc', '_face'), validate='one_to_one')

mb = mb.drop(['Unnamed: 0', 'user_id_face', 'attempt_id_doc', 'attempt_id_face', 'created_at_face', 'sub_result', 'properties_face',], axis=1)
mb.head()
