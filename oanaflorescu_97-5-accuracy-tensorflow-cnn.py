...
model1.add(layers.Dense(32, activation='relu', input_shape=(*target_im_size,))) # Fully-connected layer "on top"

model1.add(layers.Dense(64, activation='relu')),

model1.add(layers.Dense(4, activation='softmax')) # Softmax output from logits
model1.summary()
...
model1.fit(train_ds, epochs=EPOCHS, steps_per_epoch=len(train_image_paths)//BATCH_SIZE, callbacks=[checkpoint_callback])
