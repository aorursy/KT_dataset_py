...
for elts in dataset:
    img, label = elts
    d[classes[label]] = d.setdefault(classes[label], 0) + 1
d
...
history += fit(70, 0.01, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
eval = evaluate(model, test_loader)
eval
arch = "4 layers ({}, 1024, 512, 256, {})".format(input_size, output_size)
lrs = [0.001, 0.01, 0.1, 0.01]
epochs = [50, 50, 50, 70]
