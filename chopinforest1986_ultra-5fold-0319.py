...
fold_set = pd.read_csv('../input/ultratrainvalid5fold/ultra_train_valid_challenge3_5fold.csv')
...
train_dir ='../input/ultra-crop-crop/train_vslid_crop_crop'



test_dir  ='../input/ultra-crop-crop/test_crop_crop'



test = pd.read_csv('../input/ultratrainvalid5fold/Challenge3_upload.csv')

test["image_id"] = test["image_id"].apply(lambda x: x + ".jpg")

print('Number of train samples: ',fold_set.shape[0])
...
#model.load_weights('../input/deepdrid-weights/efficientnet-b3-preprocessing-300-e32-b32_0315_10-36-50.h5')
...
results = pd.DataFrame({'image_id':test['image_id'], 'DR_level':predictions})
...
results.to_csv('Challenge3_upload.csv', index=False)
...
regular_train_valid_5fold_test_pseudolabel = pd.read_csv("../input/deepdrid-weights/regular_train_valid_5fold_test_pseudolabel.csv")
...
regular_train_valid_challenge3_5fold = pd.read_csv("../input/deepdrid-weights/regular_train_valid_challenge3_5fold.csv")