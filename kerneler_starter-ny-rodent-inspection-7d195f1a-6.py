...
# rodent-inspection.csv has 1483045 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/rodent-inspection.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'rodent-inspection.csv'
nRow, nCol = df1.shape
