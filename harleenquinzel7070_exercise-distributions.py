...
cancer_m_data.head() # Your code here # Your code here
cancer_m_data.loc[842517]["Radius (mean)"]
# Fill in the line below: In the first five rows of the data for benign tumors, what is the

# largest value for 'Perimeter (mean)'?

max_perim = max(cancer_b_data["Perimeter (mean)"].head())
...
sns.distplot(a=cancer_m_data["Area (mean)"], label="Malignent", kde=False) # Your code here (malignant tumors)
...
sns.kdeplot(data=cancer_m_data["Radius (worst)"], label="benign", shade=True) # Your code here (malignant tumors)
