...
def exactly_one_topping(ketchup, mustard, onion):
    ...
    on their hot dog.
    """
    return ((ketchup and not (mustard or onion)) or 
            (mustard and not (ketchup or onion)) or
            (onion and not (ketchup or mustard)))
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if (player_aces == 0) and (player_total <= 14):
        return True
    if (player_aces == 1) and (player_total < 10):
        return True
    if (player_aces == 1) and (player_total == 10):
        return False
    return False
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if (player_aces == 0) and (player_total <= 14):
        return True
    if (player_aces == 1) and (player_total <= 12):
        return True
    if (player_aces == 1) and (player_total == 10):
        return False
    return False
