...
# Your code goes here :)
# check out the schema of the accident_2015 table
...
# check out the schema of the vehicle_2015 table
accidents.table_schema("vehicle_2015")
# the query, using the vehicle_2015 table
...
hit_and_runs_per_state = accidents.query_to_pandas_safe(query2)
