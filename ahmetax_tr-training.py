...
result = model.most_similar(positive=['suriye'],topn=5)
...
print()
model.most_similar(positive=["başbakan","yıldırım"])
model.most_similar(positive=["başbakan","yıldırım"], negative=["yunanistan"])
model.most_similar(positive=["başbakan","yıldırım"], negative=["yunanistan", "türkiye"])