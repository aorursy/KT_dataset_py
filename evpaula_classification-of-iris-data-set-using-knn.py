#Importing all the libraries needed and setting up the visualization of the data
#Importando todas as livrarias necessárias e organizando a visualização dos dados
