...
print(sf_permits.shape)       # prints the number of rows and columns in the dataframe
...
print("Number of columns with na's dropped : %d" % sf_columns_with_na_dropped.shape[1])
