...
train_data=pd.read_csv('train_water_melon_price.csv')

test_data=pd.read_csv('test_watermelon_price.csv')

x_train_data=train_data.loc[:,[i for i in train_data.keys()[1:-1]]]
