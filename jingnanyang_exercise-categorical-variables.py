...
OH_cols_train = pd.DataFrame(OH_encoder.fit_transform(X[low_cardinality_cols])) # Your code here

OH_cols_test = pd.DataFrame(OH_encoder.transform(X_test[low_cardinality_cols])) # Your code here
...
OH_X_test = OH_X_test.fillna(0)
#OH_X_train = OH_X_train.drop([122,123,124,125], axis = 1)
#OH_X_test
