...
# check out the scores of job postings 
# (if the query is smaller than 1 gig which is the default value)
job_post_scores = hacker_news.query_to_pandas_safe(query)
# Since this has returned a dataframe, we can work with it as we would any other dataframe. 
# For example, we can get the mean of the column:
