...
query2 = """SELECT COUNT(consecutive_number) AS number, 
...
# to 1 GB by default
accidents_by_day = accidents.query_to_pandas_safe(query2)
...
accidents.query_to_pandas(query_1)
...
accidents.query_to_pandas(query_2)