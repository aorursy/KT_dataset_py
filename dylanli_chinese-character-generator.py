...
DroidSansFallbackFull = ImageFont.truetype("./input/font/DroidSansFallbackFull.ttf", 36, 0);

#fangzheng_fangsong = ImageFont.truetype("./input/font/fangzheng_fangsong.ttf", 36, 0);

#fangzheng_heiti = ImageFont.truetype("./input/font/fangzheng_heiti.ttf", 36, 0);

#fangzheng_shusong = ImageFont.truetype('./input/font/fangzheng_shusong.ttf',36,0)

#Lantinghei = ImageFont.truetype('./input/font/Lantinghei.ttc',36,0)

#mingliu = ImageFont.truetype('./input/font/mingliu.ttc',36,0)

'''

NotoSansHans_Black = ImageFont.truetype('./input/font/NotoSansHans-Black.otf',36,0)

NotoSansHans_Bold = ImageFont.truetype('./input/font/NotoSansHans-Bold.otf',36,0)

NotoSansHans_DemiLight = ImageFont.truetype('./input/font/NotoSansHans-DemiLight.otf',36,0)

NotoSansHans_Light = ImageFont.truetype('./input/font/NotoSansHans-Light.otf',36,0)

NotoSansHans_Medium = ImageFont.truetype('./input/font/NotoSansHans-Medium.otf',36,0)

NotoSansHans_Regular = ImageFont.truetype('./input/font/NotoSansHans-Regular.otf',36,0)

NotoSansHans_Thin_Windows = ImageFont.truetype('./input/font/NotoSansHans-Thin-Windows.otf',36,0)
...
def main():
    ...
    draw.text((8,2),charset[char_id],(255),font=fonts[font_id])
    ...
    image = augmentation(image,mode)

    imshow(image)

    cv2.imwrite(''.join([str(i) for i in [i for i in time.gmtime()]])+'.jpg',image)
