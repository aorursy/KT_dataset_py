...
# public-right-of-way-use-permits-historical.csv has 1082526 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/public-right-of-way-use-permits-historical.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'public-right-of-way-use-permits-historical.csv'
nRow, nCol = df1.shape
