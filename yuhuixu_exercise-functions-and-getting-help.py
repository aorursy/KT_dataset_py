...
def to_smash(total_candies, total_friends = 3):
    ...
    the given number of candies evenly between x number of friends. If the number of
    of friends is not specified, 3 friends are assumed.
