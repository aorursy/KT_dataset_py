...
df1 = pd.read_csv('/kaggle/input/smote_balanced_plant_data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/smote_balanced_plant_data/train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/smote_balanced_plant_data/test.csv', delimiter=',', nrows = nRowsRead)
