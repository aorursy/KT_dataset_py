...
print(reviews['province'].value_counts().head(10))
print(len(reviewse))
...
max=reviews['price'].max()
min=reviews['price'].min()

print(max)
print(min)
reviews[reviews['price'] > 1500]
reviews[reviews['price']==max]
reviews[reviews['price']==min]
...
print(pokemon['weight_kg'].max())
print(pokemon['weight_kg'].min())
