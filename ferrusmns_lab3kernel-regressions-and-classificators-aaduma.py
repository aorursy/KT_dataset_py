...
davis.head()
davis.weight.corr(davis.height)

davis.weight.corr(davis.sex)
...
#Линейная регрессия сработала хуже чем случайный лес, поэтому оставляем данные случайного леса
...
plt.show()
diabetes_categorical = diabetes.Outcome
