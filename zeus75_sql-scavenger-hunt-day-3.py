...
plt.title('Number of accidents occurred in each hour of the day in 2015')
...
query2= """SELECT COUNT(hit_and_run), registration_state_name
       ...
       """
states_most_hit_n_run = accidents.query_to_pandas_safe(query2)
print(states_most_hit_n_run)