...
1.0 * elastic_model_full_data.predict(X)
print('Predict ridge submission')
submission_ridge = pd.read_csv("../input/house-prices-advanced-regression-techniques/sample_submission.csv")
submission_ridge.iloc[:,1] = np.floor(np.expm1(ridge_model_full_data.predict(X_sub)))
print('Predict lasso submission')
submission_lasso = pd.read_csv("../input/house-prices-advanced-regression-techniques/sample_submission.csv")
submission_lasso.iloc[:,1] = np.floor(np.expm1(lasso_model_full_data.predict(X_sub)))
print('Predict elastic submission')
submission_elastic = pd.read_csv("../input/house-prices-advanced-regression-techniques/sample_submission.csv")
submission_elastic.iloc[:,1] = np.floor(np.expm1(elastic_model_full_data.predict(X_sub)))
