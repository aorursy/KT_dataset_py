...
sf_pct_missing = (sf_total_missing/sf_total_cells) * 100
sf_pct_missing
# look at the # of missing points in the first ten columns
print(missing_values_count[0:10])
print(sf_permits["Street Number Suffix"].isna().sum())
print(sf_permits["Zipcode"].isna().sum())
...
sf_cols_droppedna = sf_permits.dropna(axis = 1)
print(sf_cols_droppedna.head())
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_cols_droppedna.shape[1])
