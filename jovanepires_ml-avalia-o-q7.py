...
# varie o parâmetro n_estimators de 1 a 100 (de 10 em 10) e mostre um gráfico contendo a diferença entre os scores
...
for i in np.arange(0, 101, step=10): # interval [1:100]

    ind.append(i or 1)

    model = GradientBoostingClassifier(n_estimators=i or 1)
...
plt.title("Gradient Boosting Classifier", fontsize=16)
...
for i in np.arange(0, 101, step=10): # interval [1:100]
    ...
    model = RandomForestClassifier(n_estimators=i or 1)
