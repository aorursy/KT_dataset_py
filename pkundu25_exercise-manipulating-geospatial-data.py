...
cols_to_join=CA_pop.join([CA_high_earners,CA_median_age]).reset_index()

CA_stats = CA_counties.merge(cols_to_join, on='GEOID')
...
for idx, row in locations_of_interest.iterrows():
    ...
    if not math.isnan(row['Longitude']) and not math.isnan(row['Latitude']):
        ...
        mc.add_child(folium.Marker([row['Longitude'],row['Latitude']]))
