...
print("Total cells: ", total_cells_sf)
# total missing
total_missing_sf = missing_values_count_sf.sum()
print ("Total missing values: ", total_missing_sf)
# % of missing data
total_percentage_missing = (total_missing_sf/total_cells_sf)*100
print("Total % missing: ", total_percentage_missing)
...
sf_permits_r = sf_permits.dropna()
print("Shape with NA rows removed: " , sf_permits_r.shape)
