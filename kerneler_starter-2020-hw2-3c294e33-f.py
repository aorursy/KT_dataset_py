...
# test_no_label.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df2 = pd.read_csv('/kaggle/input/test_no_label.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'test_no_label.csv'
