...
movie.head() #this created new column for year
...
#The recommendation is based on the likes and dislikes or ratings of the users
movie.drop(columns=['genres'], inplace=True)
#Now we shall start with collaborative filtering
#we will use user to user technique first
user = [
...
userSubsetGroup[0:3]
#Using the pearson correlation technique
...
topUsers.head()
#Rating of selected users to all movies We're going to do this by taking the weighted average of the ratings of the movies using the Pearson Correlation as the weight
