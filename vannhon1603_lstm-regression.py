...
train_df = pd.read_csv('../input/PM_train1.txt', sep=" ", header=None)
...
test_df = pd.read_csv('../input/PM_train1.txt', sep=" ", header=None)
...
truth_df = pd.read_csv('../input/PM_truth1.txt', sep=" ", header=None)
...
# test_df.to_csv('PredictiveManteinanceEngineTesting.csv', encoding='utf-8',index = None)
