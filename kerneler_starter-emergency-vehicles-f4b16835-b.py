...
df1 = pd.read_csv('/kaggle/input/Emergency_Vehicles/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Emergency_Vehicles/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Emergency_Vehicles/train.csv', delimiter=',', nrows = nRowsRead)
