...
def time_call(fn, arg):
    ...
    fn(arg)
    t1 = time()
    print("Start:",round(t0),"End:",round(t1))
    return t1 - t0
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    fn (arg3)
    t3 = time()
    print("Time1:",round(t0),"Time2:",round(t1), "Time3:", round(t2))
    d1 = t1 - t0
    d2 = t2 - t1
    d3 = t3 - t2
    print("Duration1:",round(d1),"Duration2:",round(d2), "Duration3:", round(d3))
    return round(max(d1,d2,d3))

print("Longest Call:",slowest_call(sleep,1,2,3))
#q6.hint()
#q6.solution()
print(print("Spam"))
q7.hint()
