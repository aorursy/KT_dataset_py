...
x_tr,x_val,y_tr,y_val=train_test_split(np.array(dataframe['article']),np.array(dataframe['manualKeyPhrases']),test_size=0.1,random_state=0,shuffle=True)
...
print("Total coverage of words:",(freq/tot_freq)*100)
