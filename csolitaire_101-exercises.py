...
def is_multiple_of_both_three_and_five (number):
    ...
    if number % 3 == int() and number % 5 == int():
...
def starts_and_ends_with_vowel (word):
    ...
    for letter in splitstring:
        ...
        if letter[-1] and letter[0] in ["a", "e", "i", "o", "u"]:
...
def only_even_numbers (sequence):
    ...
    only_even = [num for num in sequence if num % 2 != 1] 
...
def count_evens (sequence):
    ...
    even = [num for num in sequence if num % 2 != 1]
...
def count_odds (sequence):
    ...
    odd = [num for num in sequence if num % 2 == 1] 
...
def only_positive_evens (sequence):
    ...
    pos = [num for num in sequence if num >= 0]
...
def only_negative_evens (sequence):
    ...
    negative = [num for num in sequence if num < 0]
...
def total_of_book_prices (x):
    ...
    return sum(books["price"] for books in x)
...
def get_average_book_price (x):
    ...
    y = statistics.mean(books["price"] for books in x)
...
def number_of_item_types (n):

    for x in n: 

        count = 0

        if isinstance(n[x], list): 
...
def total_number_of_items (x):
        ...
        a = x["items"][0]["quantity"]

        b = x["items"][1]["quantity"]

        c = x["items"][2]["quantity"]

        d = x["items"][3]["quantity"]

        e = x["items"][4]["quantity"]
...
def get_average_spent_per_item (n):

        a = n["items"][0]["price"] * n["items"][0]["quantity"]

        b = n["items"][1]["price"] * n["items"][1]["quantity"]

        c = n["items"][2]["price"] * n["items"][2]["quantity"]

        d = n["items"][3]["price"] * n["items"][3]["quantity"]

        e = n["items"][4]["price"] * n["items"][4]["quantity"]

        total_cost = a + b + c + d + e

        f = n["items"][0]["quantity"]

        g = n["items"][1]["quantity"]

        h = n["items"][2]["quantity"]

        i = n["items"][3]["quantity"]

        j = n["items"][4]["quantity"]

        total_quantity = f + g + h + i + j

        ave = total_cost / total_quantity
