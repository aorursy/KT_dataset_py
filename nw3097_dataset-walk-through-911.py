...
# in about 15 months, Montgomery County with a population of 820,000, had 180,835 911 calls

# that's 0.18 calls per person per year, way below the national average of 0.7. Do we have all

# 911 calls from 201601 to 201703 in Montgomery County?
...
pp.head()
# what is the above cell doing?

# it is summing calls by (week/EMS categories)

j=d[d['title'] == 'EMS: ABDOMINAL PAINS']

j[j['timeStamp'] <= "2016-01-04 00:00:00"].shape[0], j[j['timeStamp'] <= "2016-01-11 00:00:00"].shape[0]
