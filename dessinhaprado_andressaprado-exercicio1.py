...
df = pd.read_csv('../input/dataviz-facens-20182-aula-1-exerccio-2/anv.csv', delimiter=',', nrows = None)



df.head(15) 

ex1 = [["aeronave_pais_registro", "Qualitativa Nominal"],
...
ex1 = pd.DataFrame(ex1, columns=["Variáveis", "Classificação"])
...
soma_fatalidade_veic = soma_fatalidade_veic.groupby(['aeronave_tipo_veiculo']).count() 

soma_fatalidade_veic = soma_fatalidade_veic.sort_values(by=['total_fatalidades'], ascending=False)
...
cont_fatalidade_faseop = cont_fatalidade_faseop.groupby(['aeronave_fase_operacao']).count()

cont_fatalidade_faseop = cont_fatalidade_faseop.sort_values(by=['total_fatalidades'], ascending=False)
...
soma_fatalidade_dano = soma_fatalidade_dano.groupby(['aeronave_nivel_dano']).count() 

soma_fatalidade_dano = soma_fatalidade_dano.sort_values(by=['total_fatalidades'], ascending=False)
...
soma_fatalidade_dano = soma_fatalidade_dano.groupby(['aeronave_pais_registro']).count() 
