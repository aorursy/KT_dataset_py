...
matches_yt = fuzzywuzzy.process.extract("kuram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
# Das Array zeigt, dass es nur noch kuram city gibt