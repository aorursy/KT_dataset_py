...
def to_smash(total_candies, number_of_friends=3):
    ...
    the given number of candies evenly between the input number of friends (default 3).
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    call_1 = time_call(fn, arg1)
    call_2 = time_call(fn, arg2)
    call_3 = time_call(fn, arg3)
    slowest = max(call_1, call_2, call_3)
    return(slowest)
slowest_call(sleep, 2, 4, 1)
#q6.hint()
#q6.solution()
print(print("Spam"))
q7.hint()
