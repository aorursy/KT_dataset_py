...
print( " Desvio de amostras {}".format(desvio_amostras))
...
print(" Intervalo inferior {}".format(inferior))



superior = media_amostra+margem_erro

print(" Intervalo Superior {}".format(superior))
...
print('A média da populacao estará entre {} e {} com confiança {}'.format(inferior,superior,93))
...
print( " esvio de amostras {}".format(desvio_amostras))
...
print( " argem de erro {}".format(margem_erro))
...
print('A média da populacao estará entre {} e {} com confiança {}'.format(inferior,superior,80))
...
print('A média da populacao estará entre {} e {} com confiança {}'.format(inferior,superior,99))