...
# Your code goes here
#stars_1 = tally(data['brand']) 
plot(x = 'brand', y = 'stars', style = "boxplot", data = data)
help(tally)
# Your code goes here
#tabulate(data['country'], data['state'],method = 'count_percent')
count_percent = tally(data['country'], graph =True, percent = True) [0:10]
# Your code goes here
help(query)
query (data= data, column = "brand", condition = '=="Ve Wong"' )
# Your code goes here
help(sort)
sort(data = data, by = ['stars'], how = 'descending') [-12:]
#Your code goes here
help(plot)
meaning = query(data=data, column ="stars", condition = ">3" )
meaning_1 = tabulate(meaning['country'],meaning['style'])
plot(x ='country',y = 'count', colour = 'style',  data = meaning_1, style = "lineplot")
