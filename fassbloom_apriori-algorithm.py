        ...
        for i in range(len_Lksub1):
            ...
            for j in range(1, len_Lksub1):
                ...
                if l1[0:k-2] == l2[0:k-2]:
                    ...
                    retlist = list_Lksub1[i] | list_Lksub1[j]

                    retlist=list(retlist)

                    #unionset = l1[0:(len(l1)-1)]+l2[len(l2)-1]+l1[len(l1)-1]

                    #if support_data[unionset]>=self.min_support:
                    ...
                    for re in range(k):
                        ...
                        if frozenset(retlist) not in list_Lksub1:

                            flag = False

                            break

                        retlist.insert(re, comp)

                    if flag:

                        Ck.add(frozenset(retlist))
