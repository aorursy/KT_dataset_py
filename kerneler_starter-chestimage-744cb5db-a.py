...
df1 = pd.read_csv('/kaggle/input/filenames/filenames/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/filenames/filenames/test.csv', delimiter=',', nrows = nRowsRead)
