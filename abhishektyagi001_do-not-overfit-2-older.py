...
train_df = pd.read_csv("../input/older-dataset-for-dont-overfit-ii-challenge/train.csv")
...
for i in tqdm_notebook(range(0,20)):
    ...
    t = apply_noise(train_df, noise_level = i * 0.0005)

    noise_train_df.append(t)

noise_train_df = pd.concat(noise_train_df, axis = 0)
print("Shape train with noise added:",noise_train_df.shape)
