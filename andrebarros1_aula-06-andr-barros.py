...
crf.predict([sent2features([('Sven')])])  
sentenca_teste = nltk.word_tokenize("assisted by Sven Bender")

sentenca_teste = tuple2NER([sentenca_teste])

teste = [sent2features(s) for s in sentenca_teste]
