...
df1 = pd.read_csv('/kaggle/input/E-Commerce_Participants_Data/Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/E-Commerce_Participants_Data/Train.csv', delimiter=',', nrows = nRowsRead)
