...
class MenuCategory:
    # CONSTRUCTOR CALLED AUTOMATICALLY WHEN CREATE AN INSTANCE e.g Category("drinks")
...
class Order:
    def __init__(self, customer=None):
        self.customer: Customer = Customer("", "", "") if customer is None else customer
...
if __name__ == "__main__":
    ...
    order = Order(Customer("Kevin Ernest Long", "503-888-6879", "97018"))
    order.customer.car_make = "mazda"
    order.customer.car_model = "Miata"
    order.customer.car_color = "White with Red Top"
