...
def generate_attention_lstm(lstm_dropout, dropout, recurrent_dropout, lstm_output):
    ...
    return model
def generate_attention_big_lstm(lstm_dropout, dropout, recurrent_dropout, lstm_output):
...
def lstm():
    ...
    return generate_lstm(lstm_dropout=0.1, dropout=0.1, 
...
def bidirectional_lstm():
    ...
    return generate_bidirectional_lstm(lstm_dropout = 0.1, dropout = 0.1, 
...
def attention_lstm():
    ...
    return generate_attention_lstm(lstm_dropout = 0.1, dropout = 0.1, 
...
format_accuracy(scores)
def attention_big_lstm():

    return generate_attention_big_lstm(lstm_dropout = 0.1, dropout = 0.1, 

                                       recurrent_dropout = 0.1, lstm_output = 100)
scores = evaluate_model(attention_big_lstm, preprocess_short)
