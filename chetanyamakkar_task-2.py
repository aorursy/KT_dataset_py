...
plt.plot(df2['AMBIENT_TEMPERATURE'],df2['MODULE_TEMPERATURE'],marker = 'o' ,linestyle = '', ms=10)
...
plt.plot(df1['DC_POWER'],df1['AC_POWER'],marker = 'o' ,linestyle = '', ms=10)
...
plt.plot(df2['AMBIENT_TEMPERATURE'],df2['IRRADIATION'],marker = 'o' ,linestyle = '', ms=10)
