...
df1 = pd.read_csv('/kaggle/input/Valuelabs_DataSet/Results.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Valuelabs_DataSet/Train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Valuelabs_DataSet/Sample_Submission.csv', delimiter=',', nrows = nRowsRead)
