...
# nypd-motor-vehicle-collisions.csv has 1314671 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/nypd-motor-vehicle-collisions.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'nypd-motor-vehicle-collisions.csv'
nRow, nCol = df1.shape
