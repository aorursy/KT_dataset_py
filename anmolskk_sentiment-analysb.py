...
import os
import seaborn as sns                                  # Statistical graphing in Python
import matplotlib.pyplot as plt                        # For plotting the graph
%matplotlib inline
from nltk.corpus import stopwords                      # For processing stopwords like you,he,me,etc.
from sklearn.feature_extraction.text import CountVectorizer   # Algorithm
...
mr = pd.read_csv('/kaggle/input/imdb-dataset-of-50k-movie-reviews/IMDB Dataset.csv')
mr.head()
mr.info()
plt.figure(figsize=(8,4))
sns.countplot('sentiment',data=mr)
plt.show()
mr['length'] = mr['review'].apply(len)
mr['length'].describe()
mr.hist(column='length',by='sentiment',bins=30,figsize=(12,6))
plt.show()
#Split the data into training set and test set by 70:30 ratio
review_train,review_test,sentiment_train,sentiment_test = train_test_split(mr['review'],mr['sentiment'],test_size=0.3)
