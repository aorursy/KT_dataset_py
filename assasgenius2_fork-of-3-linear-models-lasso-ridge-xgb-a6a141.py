...
def rmse_cv(model):
    ...
    return(rmse)
n_estimators = [150, 170 , 180, 190, 400]
...
plt.ylabel("rmse")
cv_gb.min()
model_gb = GradientBoostingRegressor(n_estimators = 180).fit(X_train, y)
...
alphas_lasso = [1, 0.01, 0.001, 0.0005]
...
model_xgb = xgb.XGBRegressor(n_estimators=100, max_depth=10, learning_rate=0.1) #the params were tuned using xgb.cv
