...
# Competitions.csv has 927 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Competitions.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Competitions.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# CompetitionTags.csv has 310 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/CompetitionTags.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'CompetitionTags.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Datasets.csv has 9226 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/Datasets.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'Datasets.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
