...
class my_gbdt(object):
    ...
    def __init__(self):
        ...
        self.tree = DecisionTreeRegressor(min_samples_split=20, max_depth=15)

        self.tree0 = DecisionTreeRegressor(min_samples_split=20, max_depth=15)
    ...
    def fit(self, X, y):
        ...
        for i in range(self.number):
            ...
            a=a-self.learningrate*(self.tree.predict(X))
    ...
    def predict(self, X):
        ...
        for tree in self.trees:
            ...
            pred_proba=pred_proba*self.learningrate*tmp_proba[:,1]
