...
def prepared_for_weather(have_umbrella, rain_level, have_hood, is_workday):
    ...
    # return have_umbrella + rain_level < 5 * have_hood + not rain_level > 0 * is_workday
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    """
    # print('should_hit', player_total, dealer_total, player_aces )
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if(player_total >= 17) :
        if(dealer_total > player_total) :
            if(player_aces ==  1):
                return True
            if (player_total < 20)  and (player_aces == 2) :
                return True
        else :
            return False
    else :
