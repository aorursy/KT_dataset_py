...
for max_leaf in candidate_max_leaf_nodes[1:]:
    compare_mae = get_mae(max_leaf, train_X, val_X, train_y, val_y)
...
#best_tree_size = _ #commented by me again, ehe

step_1.check()

print("Best leaf nodes: %d ... \t ...with best MAE: %d" %(best_tree_size, best_mae))
