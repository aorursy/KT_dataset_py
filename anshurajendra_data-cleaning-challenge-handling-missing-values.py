...
cols_sf_missing= sf_permits.dropna(axis=1)
cols_sf_missing.shape[1]
...
# Your sf_permitsturn! Try replacing all the NaN's in the sf_permits data with the one that
