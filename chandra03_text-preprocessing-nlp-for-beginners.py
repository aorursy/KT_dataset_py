...
correct_spellings(text)
df.head()
df1=df[['text_lemmatized']][:5]

df1
df1["text_lemmatized1"] = df1["text_lemmatized"].apply(lambda text_lemmatized: remove_punctuation(text_lemmatized))

df1.head()
df1["text_convert_emoticons"] = df1["text_lemmatized1"].apply(lambda text_lemmatized1: convert_emoticons(text_lemmatized1))

df1.head()
df1["remove_freqwords"] = df1["text_convert_emoticons"].apply(lambda text_convert_emoticons: remove_freqwords(text_convert_emoticons))
