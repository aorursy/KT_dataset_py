...
class my_gbdt(object):
    ...
    def __init__(self):
        ...
        for i in range(itera):
            ...
            self.trees.append(DecisionTreeRegressor(min_samples_split= min_samples_split, max_depth=depth))
    ...
    def fit(self, X, y):
        ...
        for i in range(1,itera):
            ...
            self.trees[i].fit(X, (y-y_pred)*lr)
    ...
    def predict(self, X):
        ...
        for i in range(1, itera):
            ...
            y_pred += lr * self.trees[i].predict(X)
