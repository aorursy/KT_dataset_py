...
# payments.csv has 725901 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/payments.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'payments.csv'
nRow, nCol = df1.shape
