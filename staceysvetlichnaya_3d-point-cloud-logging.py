...
#!pip install --upgrade 'git+git://github.com/wandb/client.git@object3D/lidar#egg=wandb' -qq
!pip install wandb
...
wandb.init(entity="stacey", project="lyft")
...
#print(m[0])
wandb.init(entity="stacey", project="lyft", name="lyft scene 5")
scene_id = SCENES[5]
