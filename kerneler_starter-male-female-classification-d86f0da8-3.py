...
df1 = pd.read_csv('/kaggle/input/male_vs_female_classification/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/male_vs_female_classification/test.csv', delimiter=',', nrows = nRowsRead)
