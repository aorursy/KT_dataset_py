...
df1 = pd.read_csv('../input/district wise rainfall normal.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/rainfall in india 1901-2015.csv', delimiter=',', nrows = nRowsRead)
