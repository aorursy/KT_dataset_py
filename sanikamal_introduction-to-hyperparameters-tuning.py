...
def train_and_evaluate(output_dir, num_train_steps):
  ...
  def rmse(labels, predictions):
    ...
    pred_values = tf.cast(predictions['predictions'],tf.int64)
  ...
  train_spec=tf.estimator.TrainSpec(
                       ...
                       input_fn = tf.estimator.inputs.pandas_input_fn(x = train_df[["num_rooms"]],

                                              y = train_df["median_house_value"],  # note the scaling
  ...
  eval_spec=tf.estimator.EvalSpec(
                       ...
                       input_fn = tf.estimator.inputs.pandas_input_fn(x = eval_df[["num_rooms"]],

                                              y = eval_df["median_house_value"],  # note the scaling
...
def train_and_evaluate(output_dir, num_train_steps):
  ...
  train_spec=tf.estimator.TrainSpec(
                       ...
                       input_fn = tf.estimator.inputs.pandas_input_fn(x = train_df[["num_rooms"]],
                                              ...
                                              y = train_df["median_house_value"] / SCALE,  # note the scaling
