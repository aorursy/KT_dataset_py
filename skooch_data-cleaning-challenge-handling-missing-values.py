...
sf_dropped_rows = sf_permits.dropna()
sf_dropped_rows.shape
# Now try removing all the columns with empty values. Now how much of your data is left?
sf_dropped_cols = sf_permits.dropna(axis=1)
print("SF Permits:", sf_dropped_cols.shape)
print("SF Permits with NA cols dropped:", sf_dropped_cols.shape)
