...
count_encoder = ce.CountEncoder(cols=cat_features).fit(train[cat_features])
...
a = train_model(train_encoded, valid_encoded)
# Check your answer (Run this code cell to receive credit!)
...
target_enc = ce.TargetEncoder(cols=cat_features).fit(train[cat_features], train['is_attributed'])
...
cb_enc = ce.CatBoostEncoder(cols=cat_features).fit(train[cat_features],train['is_attributed'])
