...
mat = loadmat('../input/ex8data1.mat')
...
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat('../input/ex8data1.mat')
...
mat3 = loadmat("../input/ex8_movies.mat")

mat4 = loadmat("../input/ex8_movieParams.mat")
...
movieList = open("../input/movie_ids.txt","r", encoding="ISO-8859-1").read().split("\n")[:-1]
