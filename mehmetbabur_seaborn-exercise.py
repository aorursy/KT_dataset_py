...
sns.barplot(x=sorted_data["area_list"],y=sorted_data['area_poverty_ratio'],palette=sns.cubehelix_palette(51))
...
sns.barplot(x=x, y=y, palette=sns.color_palette("BuGn_r",len(x)))
...
sns.barplot(x=sorted_data2.area_list,y=sorted_data2.area_highschool_ratio,palette=sns.cubehelix_palette(51))
...
sorted_data_p=data.reindex(new_index)
...
sorted_data_h=data.reindex(new_index)



# high school graduation rate vs Poverty rate of each state

sorted_data_p["area_poverty_ratio"] /= max(sorted_data_p["area_poverty_ratio"])

sorted_data_h["area_highschool_ratio"] /= max(sorted_data_h["area_highschool_ratio"])

data=pd.concat([sorted_data_p,sorted_data_h["area_highschool_ratio"]],axis=1)
...
sns.lmplot("area_poverty_ratio","area_highschool_ratio",data=data,height=7)
...
sns.heatmap(data.corr(),annot=True,linewidths=.5,linecolor="yellow",fmt=".1f",ax=ax)
