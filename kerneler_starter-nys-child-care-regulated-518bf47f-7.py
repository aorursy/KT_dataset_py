...
# child-care-regulated-programs.csv has 16877 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/child-care-regulated-programs.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'child-care-regulated-programs.csv'
nRow, nCol = df1.shape
