...
#step_1.c.solution()
#eval_set=[(X_valid,y_valid)],early_stopping_rounds=5,
# Define the model
...
my_model_2.fit(X_train,y_train,  verbose=False) # Your code here
...
my_model_3 = XGBRegressor(random_state=0,n_estimators=50,learning_rate=0.15)
