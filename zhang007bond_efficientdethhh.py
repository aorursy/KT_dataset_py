...
sys.path.insert(0, "../input/effdet")
...
model_path='../input/model6/best.bin'
SEED = 42
...
def run_wbf(predictions, image_index, image_size=512, iou_thr=0.45, skip_box_thr=0.43, weights=None):
...
if len(os.listdir('../input/global-wheat-detection/test/'))<11:
    ...
    run_training()
weights = f'plabel_model/last-checkpoint.bin'
