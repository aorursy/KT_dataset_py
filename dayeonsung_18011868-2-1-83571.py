...
batch_size = 80
train=pd.read_csv('/kaggle/input/ai-project-life-environment/train data.csv',header=None, skiprows=1)
...
linear5 = torch.nn.Linear(5,1, bias = True)
relu = torch.nn.ReLU()
...
test_xy = pd.read_csv("/kaggle/input/ai-project-life-environment/test data.csv", header=None, skiprows=1)
...
submit=pd.read_csv('/kaggle/input/ai-project-life-environment/submit sample.csv')
