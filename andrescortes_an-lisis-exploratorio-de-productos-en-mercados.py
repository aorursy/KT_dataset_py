...
sns.distplot(df['prod_unit_price']);
...
sns.distplot(df['prod_unit_price'], fit = norm);
fig = plt.figure()
res = stats.probplot(df['prod_unit_price'], plot = plt)
# Transformación de los datos:
df2=df
df2['prod_unit_price'] = np.log(df['prod_unit_price'])
sns.distplot(df2['prod_unit_price'], fit = norm);
fig = plt.figure()
res = stats.probplot(df2['prod_unit_price'], plot = plt)
