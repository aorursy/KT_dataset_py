...
rides_per_year_query = """ SELECT EXTRACT(YEAR FROM trip_start_timestamp) As 

                             year, COUNT(1) As num_trips
...
rides_per_month_query = """ SELECT EXTRACT(MONTH FROM trip_start_timestamp) As 

                             month, COUNT(1) As num_trips
...
speeds_query = """
               ...
               (
                   ...
                   SELECT EXTRACT(HOUR FROM trip_start_timestamp) AS 
