...
xy_data = pd.read_csv('../input/2020-ai-exam-cancer/2020.AI.cancer-train.csv')

x_test = pd.read_csv('../input/2020-ai-exam-cancer/2020.AI.cancer-test.csv')

submit = pd.read_csv('../input/2020-ai-exam-cancer/2020.AI.cancer-sample-submission.csv')
