...
#plot to compare original and scaled data
...
indexof = kickstarters_2017.pledged > 0

#get only positive values using their indexes

positive = kickstarters_2017.pledged.loc[indexof]

#normalize with box-cox

normalized = stats.boxcox(positive)[0]
