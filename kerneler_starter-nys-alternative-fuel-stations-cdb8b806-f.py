...
# alternative-fuel-stations-in-new-york.csv has 1141 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/alternative-fuel-stations-in-new-york.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'alternative-fuel-stations-in-new-york.csv'
nRow, nCol = df1.shape
