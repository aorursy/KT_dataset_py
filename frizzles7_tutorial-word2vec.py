...
# has it seen the word anarchy?
word2vec.wv['anarchy']
word2vec.wv['king']
# find similar words
word2vec.wv.most_similar(positive=['king'])
vect = word2vec.wv['france'] - word2vec.wv['paris'] + word2vec.wv['london']
word2vec.wv.similar_by_vector(vect)
