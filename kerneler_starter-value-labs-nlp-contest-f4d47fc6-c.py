...
df1 = pd.read_csv('/kaggle/input/DataSet/Sample_Submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/DataSet/Results.csv', delimiter=',', nrows = nRowsRead)
