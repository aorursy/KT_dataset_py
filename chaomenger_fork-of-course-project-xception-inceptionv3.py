...
def create_xception_model(input_shape, n_out):
    ...
    return model
model1 = create_xception_model(input_shape=(img_size, img_size, 3), n_out=num_classes)
...
def create_inceptionv3_model(input_shape, n_out):
    ...
    return model
model2 = create_inceptionv3_model(input_shape=(img_size, img_size, 3), n_out=num_classes)
