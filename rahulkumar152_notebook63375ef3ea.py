...
trainData=pd.read_csv("../input/mobile-price-range-prediction-is2020-v2/train_data.csv")

trainData
testData=pd.read_csv('../input/mobile-price-range-prediction-is2020-v2/test_data.csv')
...
res2=pd.DataFrame({'id':testData['id'],'price_range':y_pred})
