...
gb_ens_clf = GradientBoostingClassifier(learning_rate=0.4, n_estimators=150, max_depth=3)

rf_ens_clf = RandomForestClassifier(random_state=8, n_estimators=400, max_depth=20)
