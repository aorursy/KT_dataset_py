...
sns.kdeplot(df[versicolor].sepal_length, df[versicolor].sepal_width, cmap="Greens", shade=True, alpha=0.3, shade_lowest=False)

sns.kdeplot(df[virginica].sepal_length, df[virginica].sepal_width, cmap="Blues", shade=True, alpha=0.3, shade_lowest=False)
