...
df1 = pd.read_csv('/kaggle/input/Insurance_Churn_ParticipantsData/Train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Insurance_Churn_ParticipantsData/Test.csv', delimiter=',', nrows = nRowsRead)
