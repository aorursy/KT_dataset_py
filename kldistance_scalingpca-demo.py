...
#obtain eigenvectors of standardized data
std_eigenvectors = np.array(pca.components_)
print(std_eigenvectors)
projection = np.matmul(std_eigenvectors, np.array(wine).T).T
print(projection.shape)

#graph the transformed values
