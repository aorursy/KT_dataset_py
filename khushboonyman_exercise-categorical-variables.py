...
#print(list(x for x in d if d[x] > 10))
# Fill in the line below: How many categorical variables in the training data

# have cardinality greater than 10?

high_cardinality_numcols = len(list(x for x in d if d[x] > 10))
...
#low_cardinality_cols.extend(low_cardinality_cols_test)
...
k = (X_train.dtypes != 'object')

numeric_cols = list(k[k].index)
