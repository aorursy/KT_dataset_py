...
data = pd.read_csv("../input/nmimschat/NMIMSchat.csv")
...
print('😎 '+'Aman Jain')
dname
print('Top 10 Popular folks (TimesTexted)')

dname.sort_values(by='TimesTexted',ascending=False).head(10).iloc[:,5:6]
print('Top 10 Consistent folks (DaysTexted/DaysBeen)')

dname.sort_values(by='Consistency',ascending=False).head(10).iloc[:,4:5]
print('Top 10 most Frequently texting folks (TimesTexted/DaysBeen)')
...
print('Top 5 emojis most used by Top 10 popular folks')
...
print('Top Women who write SHORT texts')
...
print('Top Positively texting women')
...
pcs.sort_values(by='Pos',ascending=False).head(10).iloc[:,9:10]
print('Top Neutraly texting Women')
...
print('Top Women with diverse vocab \n(maximum different words)')

pcs = names[names['Gender']==0]

pcs.sort_values(by='vocab',ascending=False).head(10).iloc[:,7:8]
print('Top 5 emojis most used by Top popular Women')

pcs = names[names['Gender']==0]

pcs.sort_values(by='TextTimes',ascending=False).head(10).iloc[:,6:7]
print('Top 5 most used words by Top frequently texting Women')
...
ax.set(xlabel=xlabel, ylabel=ylabel);
mc = pd.read_csv("../input/nmimschat/monthcount.csv")
for s in mc['Name']:
  ...
  ax.set(xlabel='Month', ylabel='Times Texted');