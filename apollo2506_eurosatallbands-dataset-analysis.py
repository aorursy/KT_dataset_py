...
train_path = "../input/eurosat-dataset/EuroSATallBands/train.csv"

val_path = "../input/eurosat-dataset/EuroSATallBands/validation.csv"

test_path = "../input/eurosat-dataset/EuroSATallBands/test.csv"
train_df = pd.read_csv(train_path)

train_df.drop(columns=train_count_df.columns[0],inplace=True)

train_df.head()
val_df = pd.read_csv(val_path)

val_df.drop(columns=val_count_df.columns[0],inplace=True)

val_df.head()
test_df = pd.read_csv(test_path)

test_df.drop(columns=test_count_df.columns[0],inplace=True)

test_df.head()
with open("../input/eurosat-dataset/EuroSATallBands/label_map.json","r") as file:
