...
# city-record-online.csv has 445387 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/city-record-online.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'city-record-online.csv'
nRow, nCol = df1.shape
