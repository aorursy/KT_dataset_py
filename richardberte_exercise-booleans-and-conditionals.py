...
def exactly_one_sauce(ketchup, mustard, onion):
    ...
    """
    return ketchup ==1 and mustard == 0 or ketchup == 0 and mustard == 1
    pass
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    state, or False if the player should stay. player_aces is the number of aces the player has.
    """
    if player_total < 16 and dealer_total > 16:
        return True
    elif (player_total == 17 or player_total == 18) and player_aces == 1:
        return True
    else:
        return False
