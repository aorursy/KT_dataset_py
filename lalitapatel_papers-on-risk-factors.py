zabt = "Papers on Risk Factors"

znam = "Papers_on_Risk_Factors"
zwds = "behavioral co-existing co-infections co-morbidities control differences disease dynamics economic effective environmental factors fatality health high-risk hospitalized impact incubation infections interval, measures mitigation modes neonates patient populations potential pre-existing pregnant pulmonary reproductive respiratory risk serial severity smoking socio-economic susceptibility symptomatic transmissible transmission understand virulent virus"
import os
