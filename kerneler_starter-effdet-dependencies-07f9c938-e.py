...
df1 = pd.read_csv('/kaggle/input/global-wheat-detection-512x512/global-wheat-detection-512x512/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/global-wheat-detection-512x512/global-wheat-detection-512x512/sample_submission.csv', delimiter=',', nrows = nRowsRead)
