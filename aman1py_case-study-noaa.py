...
txt = np.loadtxt('../input/sunlight-in-austin-tx/2011_Austin_Weather.txt',delimiter=',',dtype=str)
df = pd.DataFrame(txt)
...
check = df_clean['dry_bulb_faren'] != 'M'
df_clean['dry_bulb_faren'][check].count()
...
df_clean.to_csv('2011_Austin_Weather.csv')
