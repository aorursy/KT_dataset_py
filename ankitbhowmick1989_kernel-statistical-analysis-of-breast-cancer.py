...
data.head()
# Deleting id and unnamed : 32column as it is not used
...
print(data_bening[data_bening.radius_mean < lower_bound].radius_mean)

print("Outliers: ",data_bening[(data_bening.radius_mean < lower_bound) | (data_bening.radius_mean > upper_bound)].radius_mean.values)

 ## In this above case we check the outlier of radius mean column
...
# From above analysis we can match the value in column
