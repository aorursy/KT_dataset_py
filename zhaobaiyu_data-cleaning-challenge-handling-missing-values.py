...
print('Missing data counts in sf_permits:')
print(sf_missing_values_count[:10])
sf_total_cells = np.product(sf_permits.shape)
sf_total_missing = sf_missing_values_count.sum()
print('\nPercentage of missing data is {}%'.format(sf_total_missing / sf_total_cells * 100))
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
# remove all the rows that contain a missing value
nfl_data.dropna()  # return the remaining object
