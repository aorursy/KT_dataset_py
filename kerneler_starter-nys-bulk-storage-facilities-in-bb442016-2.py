...
# bulk-storage-facilities-in-new-york-state.csv has 266929 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/bulk-storage-facilities-in-new-york-state.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'bulk-storage-facilities-in-new-york-state.csv'
nRow, nCol = df1.shape
