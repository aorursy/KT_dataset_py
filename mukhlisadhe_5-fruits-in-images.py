...
train_dir = '../input/buahtraining/buah/buah/'

test_dir = '../input/buahtest2/buah-test/buah-test/'
...
evaluate_model(convolutional, 128, epoch)
convolutional = Sequential()
...
evaluate_model(convolutional, 32, epoch)
convolutional = Sequential()
...
for idx in range(num_categories):
    ...
    try:
        ...
        accuracy = res_crosstab.iloc[idx, idx] / res_crosstab.iloc[:, idx].sum()
...
for idx in range(35):
    ...
    for idx2 in range(35):
        ...
        try:
            ...
            if idx != idx2 and res_crosstab.iloc[idx, idx2] != 0:

                pred_fruit = dict_idx_fruit[idx]

                actual_fruit = dict_idx_fruit[idx2]

                num_mistakes = res_crosstab.iloc[idx, idx2]
