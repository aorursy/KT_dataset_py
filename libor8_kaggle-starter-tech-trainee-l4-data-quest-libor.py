...
detector = cv2.dnn.readNetFromCaffe("../input/opencvfacerecognizer/face_detection_model/deploy.prototxt",\
                                    "../input/opencvfacerecognizer/face_detection_model/res10_300x300_ssd_iter_140000.caffemodel")
# Embedder is the pre-trained model to extract face embeddings
embedder = cv2.dnn.readNetFromTorch("../input/opencvfacerecognizer/openface_nn4.small2.v1.t7")

# fill our training set with some photos which do not show you
imagePaths = ["../input/opencvfacerecognizer/images/unknown1.jpg",\
              "../input/opencvfacerecognizer/images/unknown2.jpg",\
              "../input/opencvfacerecognizer/images/unknown3.jpg",\
              "../input/opencvfacerecognizer/images/unknown4.jpg",\
              "../input/opencvfacerecognizer/images/unknown5.jpg"]
              #"../input/images2/images2/unknown6.jpg",\
              #"../input/images2/images2/unknown7.jpg",\
              #"../input/images2/images2/unknown8.jpg"]

# now add the file names of our input photos
for root, dirs, files in os.walk("../input/mypictures/dataset"):
    for file in files:
...
# maintaining the aspect ratio), and then grab the image dimensions
    ...
    (h, w) = image.shape[:2]
    image_blob = cv2.dnn.blobFromImage(cv2.resize(image, (300, 300)), 1.0, (300,300),(104, 177, 123), swapRB=False, crop=False)
...
image_path = "../input/opencvfacerecognizer/images/where-is-waldo.jpg"
