...
ax1 = sns.countplot('diagnosis', data=train_df)
...
ax2 = sns.countplot('diagnosis', data=valid_df)
...
#model.summary()
class_weights = class_weight.compute_class_weight('balanced', np.unique(train_df['diagnosis'].astype('int').values), train_df['diagnosis'].astype('int').values)
