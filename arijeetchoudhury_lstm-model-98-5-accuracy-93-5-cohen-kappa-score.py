...
history = model2.fit(padded_sequences,y_train,epochs=epochs,validation_data=(padded_test_sequences,y_test),batch_size=64,callbacks=[callbacks,mycallback])
train_stats2 = model2.evaluate(padded_sequences,y_train)
...
print('Cohen-kappa score:',cohen_kappa_score(y_test,y_pred2))
