...
str_um_andar = "1ª Andar " + str(round(um_andar,1))+"%"

str_dois_andares = "2ª Andar " + str(round(dois_andares,2))+"%"

str_tres_andares = "3ª Andar " + str(round(tres_andares,3))+"%"
...
plt.show()
housenew = dados[(dados['bedrooms']==3) & (dados['city']=='Seattle')]
...
trace = go.Scatter(x = dados['bathrooms'],
