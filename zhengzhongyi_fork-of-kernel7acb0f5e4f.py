...
df = pd.read_excel('/kaggle/input/20190215/SimFin-data(Apple).xlsx', sheet_name='APPLE INC') 
...
L64 = NetIncomeAvailableToCommonShareholders[9] / ShareCapital_AdditionalPaidInCapital[9]
...
for index in range(len(yearsList)-1):
    ...
    CAGRList.append((L64/(NetIncomeAvailableToCommonShareholders[index] / ShareCapital_AdditionalPaidInCapital[index]))**(1/(2019-yearsList[index]))-1)

CAGRList.append("NaN") # Empty array in 2019
