...
def train_model(model, criterion, optimizer, scheduler, num_epochs=25):
    ...
    return model
model_00 = models.resnet18(pretrained=True)
...
optimizer_ft = optim.SGD(model_00.parameters(), lr=0.001, momentum=0.9)

# Decay LR by a factor of 0.1 every 7 epochs
exp_lr_scheduler = lr_scheduler.StepLR(optimizer_ft, step_size=7, gamma=0.1)
model_00 = train_model(model_00, criterion, optimizer_ft, exp_lr_scheduler, num_epochs = 3)
