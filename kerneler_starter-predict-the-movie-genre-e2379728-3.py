...
df1 = pd.read_csv('/kaggle/input/MovieScriptsParticipantsData/Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/MovieScriptsParticipantsData/Train.csv', delimiter=',', nrows = nRowsRead)
