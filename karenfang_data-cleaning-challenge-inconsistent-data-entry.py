...
# check out the "Province" column
province = suicide_attacks['Province'].unique()

province.sort()
province
# change province to all lower case
...
# take a look at them
matches
# looks like anything over 90 can be replaced to the right kurram agency city name.
...
# see below, and you see there is only one city: kurram agency.