...
# breast-cancer.csv has 698 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/breast-cancer.csv', delimiter=',', nrows = nRowsRead)
