...
# There are many raw data processing methods, 
...
class CNNModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.cnn1 = nn.Conv2d(in_channels=1, out_channels=16, kernel_size=(1, 2), stride=1, padding=0)
        ...
        self.cnn2 = nn.Conv2d(in_channels=16, out_channels=32, kernel_size=(1, 2), stride=1, padding=0)
