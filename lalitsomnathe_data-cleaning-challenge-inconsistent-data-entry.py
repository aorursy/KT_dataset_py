...
suicide_attacks.describe(include='all')
...
cities.sort()
cities
np.unique(suicide_attacks['City'], return_counts=True)
# convert to lower case
suicide_attacks['City'] = suicide_attacks['City'].str.lower()

#print(suicide_attacks['City'].head(10))
# remove trailing white spaces
suicide_attacks['City'] = suicide_attacks['City'].str.strip()
#(print(suicide_attacks['City'].head(10)))
# Your turn! Take a look at all the unique values in the "Province" column. 
#suicide_attacks.info()
print(suicide_attacks['Province'].value_counts())
print('#' *50)
suicide_attacks['Province'].nunique()
...
def replace_matches_in_column(df, column, string_to_match, min_ratio = 90):
    ...
    print(rows_with_matches.head(4))
