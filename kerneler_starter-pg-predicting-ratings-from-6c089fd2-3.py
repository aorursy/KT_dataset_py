...
print(os.listdir('../input/Dataset015b79c'))
...
df1 = pd.read_csv('../input/Dataset015b79c/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Dataset015b79c/train.csv', delimiter=',', nrows = nRowsRead)
