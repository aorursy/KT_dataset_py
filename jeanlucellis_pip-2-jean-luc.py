...
np.pi = 3.1415         # I tried to define pi as np.pi but it didn't work so I left it as pi
...
ryc =  10            # enter the correct y-coordinate of the centre of the circle
...
print(omega)                       # calculate the cyclotron frequency (from the input variables)

                                   # Omega = 1 rad/s



period_osc = (2*np.pi)/omega

print(period_osc)                  # calculate the period of the oscillation (from the input variables)

                                   # Period = 2pi because omega = 1 (2pi/1 = 2pi)



end_time =  N_loops*period_osc

print(end_time)                    # calculate the end time of the propagation (from the input variables)

                                   # End time is 4pi because 2 loops * 2pi



time_steps = period_osc/(N_loops*steps_rev)

print(time_steps)                          # calculate the number of time steps (from the input variables)
...
b0 =  1             # magnetic field (homogeneous, in z direction)          # I tried to define pi as np.pi but it didn't work so I left it as pi
...
plt.show()
#number of loops increased from 2 to 8
...
plt.show()
#increased from 1000 steps_rev to 10000 steps_rev
...
time_steps = steps_rev*N_loops        

                # calculate the number of time steps (from the input variables)
