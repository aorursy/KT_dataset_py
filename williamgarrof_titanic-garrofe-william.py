...
print(p_rose)
sns.boxplot(x="Sex", y="Pclass", data=t)
fig = sns.FacetGrid(t, hue="Sex", aspect=3, palette="Set2") # aspect=3 permet d'allonger le graphique
...
sns.boxplot(x="diabete", y="age", data=d)
fig = sns.FacetGrid(d, hue="diabete", aspect=3, palette="Set2") # aspect=3 permet d'allonger le graphique
