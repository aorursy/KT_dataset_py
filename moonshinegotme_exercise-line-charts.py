...
ca_museum_jul18 = museum_data.iloc[54, 2]
...
avila_oct18 = museum_data.iloc[57, 0] - museum_data.iloc[57, 1]
...
plt.title('Monthly Avila visitors over time: seasonal impact')
