...
train_paths, valid_paths, train_labels, valid_labels = train_test_split(
    ...
    train_paths, train_labels, test_size=0.1, random_state=2020) # test size was .15
...
## all images have a compression ratio (from original) of .95, .90, .75

#     image = tf.image.random_jpeg_quality(image, min_jpeg_quality=0.75, max_jpeg_quality=100)
