...
# current-season-spring-trout-stocking.csv has 1471 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/current-season-spring-trout-stocking.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'current-season-spring-trout-stocking.csv'
nRow, nCol = df1.shape
