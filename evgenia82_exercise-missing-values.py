...
#step_3.b.hint()
#step_3.b.solution()
# Preprocessed training and validation features using drop columns
...
#step_4.b.check()
# I have to redo because the number of columns in a test data doesn't match with a train data and therefore 

# model

# Preprocess test data using drop columns
