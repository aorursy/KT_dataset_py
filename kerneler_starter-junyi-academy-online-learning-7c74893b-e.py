...
df1 = pd.read_csv('/kaggle/input/Info_Content.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'Info_Content.csv'
...
df2 = pd.read_csv('/kaggle/input/Info_UserData.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'Info_UserData.csv'
...
df3 = pd.read_csv('/kaggle/input/Log_Problem.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'Log_Problem.csv'
