...
plt.show()
#Capital Gaindeki aykırı veriye bakmak istedim.
...
plt.show()
Karsılastırma = pd.DataFrame({d_tree1.score(X_test, y_test),
...
Karsılastırma
SonTablo = pd.DataFrame({ "Gerçek Salary": y_test[0:10],
                        ...
                        "XGBoost Sonucu": Xgb.predict(X_test)[0:10]}); SonTablo