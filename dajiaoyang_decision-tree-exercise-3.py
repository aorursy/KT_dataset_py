...
def best_split(data, features, target):
    ...
    for feature in features:
        ...
        error = (left_misses + right_misses) * 1.0 / num_data_points  #TODO
...
class MyDecisionTree(BaseEstimator):
    ...
    def fit(self, X, Y, data_weights = None):
        ...
        self.root_node = self.create_tree(data_set, 
    ...
    def create_tree(self, data, features, target, current_depth=0, max_depth=10, min_error=0):
        ...
        left_tree = self.create_tree(left_split, 
        ...
        right_tree = self.create_tree(right_split, 
...
class MyDecisionTree2(MyDecisionTree):
    ...
    def create_tree(self, data, features, target, current_depth=0, max_depth=10, min_error=0):
        ...
        return result_node    
m2 = MyDecisionTree2(max_depth = 10, min_error = 1e-15)

m2.fit(trainX, trainY)
print(m2.score(testX, testY))

print(m2.count_leaves())
model2_1 = MyDecisionTree2(max_depth = 3, min_error = 1e-15)

model2_2 = MyDecisionTree2(max_depth = 7, min_error = 1e-15)

model2_3 = MyDecisionTree2(max_depth = 15, min_error = 1e-15)
model2_1.fit(trainX, trainY)

model2_2.fit(trainX, trainY)

model2_3.fit(trainX, trainY)
# 基于正确率的结果

print("model2_1 training accuracy :", model2_1.score(trainX, trainY))

print("model2_2 training accuracy :", model2_2.score(trainX, trainY))

print("model2_3 training accuracy :", model2_3.score(trainX, trainY))



print("model2_1 testing accuracy :", model2_1.score(testX, testY))

print("model2_2 testing accuracy :", model2_2.score(testX, testY))

print("model2_3 testing accuracy :", model2_3.score(testX, testY))



print("model2_1 complexity is: ", model2_1.count_leaves())

print("model2_2 complexity is: ", model2_2.count_leaves())

print("model2_3 complexity is: ", model2_3.count_leaves())
# 基于熵的结果
