    ...
    def save_images(self,epoch):
        ...
        for row in range(rows):
            ...
            for column in range(columns):
               ...
               axis.imshow(generated_images[image_count, :], cmap='spring')

               axis.axis('off')

               image_count += 1

        figure.savefig("/kaggle/working/generated_%d.png" % epoch)
...
if __name__ == '__main__':
    ...
    facegenerator.train(datafolder="../input/jpeg-flags",epochs=4500, batch_size=100, save_images_interval=10)

    facegenerator.generate_single_image("/kaggle/working","test.png")
