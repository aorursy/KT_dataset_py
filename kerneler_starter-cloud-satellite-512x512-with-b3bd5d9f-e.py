...
df1 = pd.read_csv('/kaggle/input/cloud/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/cloud/train.csv', delimiter=',', nrows = nRowsRead)
