...
nRowsRead = 1000 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/mall_customers.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'mall_customers.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# property.csv has 17290 rows in reality, but we are only loading/previewing the first 1000 rows
df3 = pd.read_csv('../input/property.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'property.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
