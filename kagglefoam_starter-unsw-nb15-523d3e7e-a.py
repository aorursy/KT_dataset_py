...
df2.shape
df2.describe()
df2['service'].value_counts().sort_index().plot.line()
df2['service'].value_counts().head(10).plot.bar()
df2['proto'].value_counts().head(10).plot.bar()
df2['state'].value_counts().head(10).plot.bar()
