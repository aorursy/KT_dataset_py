...
male_le_data.head()
male_le_data.dtypes
male_le_data['North West'].describe()
...
male_le_data.plot(x='Years',y=['North East',
                               ...
                               'South East',
                               'South West' ],
                  figsize=(10, 10), yticks=(0,70,72,74,76,78,80))
plt.show()
# create a plot with Years on the x axis and the regions on the y axis 
male_le_data.plot(x='Years',y=['Bexley',
                               'Camden',
                               'Croydon', 
                               'Haringey',
                               'Islington'],
...
plt.show()
#import the data and check by viewing the top rows
female_le_data = pd.read_csv('../input/meilds2/female-life-expectancy.csv')
female_le_data.head()
# create a plot with Years on the x axis and the regions on the y axis 
female_le_data.plot(x='Years',y=['Bexley',
                               'Camden',
                               'Croydon', 
                               'Haringey',
                               'Islington'],
