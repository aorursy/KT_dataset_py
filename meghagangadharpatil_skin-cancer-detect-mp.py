...
image_information = pd.read_csv('/kaggle/input/HAM78cannon/HAM78cannon.csv')
...
dataset_train = HAMN10000DataSet(csv_path=images_train_info,
                              ...
                              img_dir='/kaggle/input/imagenewdata/imagenewdata', transform=transform_train)



dataset_test = HAMN10000DataSet(csv_path=images_test_info,

                              img_dir='/kaggle/input/imagenewdata/imagenewdata', transform=transform_test)
batchsize= 2
...
img5, label5 = dataset_train.__visualizeitem__(100)
...
net.fc = nn.Linear(2048, 2) #inception-v3 output layer num_classes change from default 1000 to 7
