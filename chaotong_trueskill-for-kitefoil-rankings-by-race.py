...
dfResultsTempPlatinum = pd.read_csv('../input/'+raceName+ '-Platinum.csv',encoding = "ISO-8859-1")
...
dfResultsTempGold = pd.read_csv('../input/'+raceName+ '-Gold.csv',encoding = "ISO-8859-1")
...
dfResultsTempSilver = pd.read_csv('../input/'+raceName+ '-Silver.csv',encoding = "ISO-8859-1")
...
dfResultsTempPlatinumAndGold = pd.read_csv('../input/'+raceName+ '-PlatinumAndGold.csv',encoding = "ISO-8859-1")
