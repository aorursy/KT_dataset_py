...
#len(suicide_attacks['Target Type'].unique())



len(suicide_attacks['Target Type'].str.lower().str.strip().unique())

suicide_attacks['Target Type']=suicide_attacks['Target Type'].str.lower().str.strip()
