...
def best_split_weighted(data, features, target, data_weights):
    ...
    for feature in features:
        ...
        error = (left_misses + right_misses) * 1.0 / sum(data_weights) # Note that the denominator is sum(data_weights)
...
class WeightedDecisionTree(BaseEstimator):
    ...
    def fit(self, X, Y, data_weights = None):
        ...
        self.root_node = create_weighted_tree(data_set, data_weights, features, target, current_depth = 0, max_depth = 10, min_error = 1e-15)
