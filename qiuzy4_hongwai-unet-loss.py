...
train_ids, valid_ids = train_test_split(mask, 
...
train_df = pd.merge(mask, train_ids)

valid_df = pd.merge(mask, valid_ids)
...
def _unet(n_classes=2, encoder=qzynetnew,  input_height=256, input_width=320):
    ...
    [f1, f2, f3, f4, f5] = levels#f5:8,f4:16,f3:32,f2:64,f1:128
...
seg_model.load_weights("../input/hongwai-qzy/seg_model_weights.best.hdf5")
