...
test_generator = test_datagen.flow_from_directory(test_dir, 
                                                  ...
                                                  seed=seed,
                                                  class_mode='binary')
weights = Path('../input/keras-pretrained-models/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5')
from keras.applications.vgg16 import VGG16
conv_base = VGG16(include_top= False, weights = '../input/keras-pretrained-models/vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5',
