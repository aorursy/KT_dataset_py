...
# public-chauffeurs.csv has 34974 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/public-chauffeurs.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'public-chauffeurs.csv'
nRow, nCol = df1.shape
