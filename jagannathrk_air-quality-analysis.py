...
#sns.heatmap(corr, mask=mask, cmap=cmap, vmax=.3, center=0,square=False, linewidths=.5, cbar_kws={"shrink": .5});
...
print('The average PM2.5 AQI during late fall / early winter is' , df_daily['pm25_AQI'])
