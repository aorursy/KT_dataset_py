...
# business-licenses.csv has 943619 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# business-owners.csv has 272473 rows in reality, but we are only loading/previewing the first 100 rows
