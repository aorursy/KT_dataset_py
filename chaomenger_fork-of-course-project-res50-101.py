...
def create_resnet50_model(input_shape, n_out):
    ...
    return model
model1 = create_resnet50_model(input_shape=(img_size, img_size, 3), n_out=num_classes)
...
def create_resnet101_model(input_shape, n_out):
    ...
    return model
model2 = create_resnet101_model(input_shape=(img_size, img_size, 3), n_out=num_classes)
