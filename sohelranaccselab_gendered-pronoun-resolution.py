...
df_test = pd.read_csv("/kaggle/input/gendered-pronoun-resolution/test_stage_2.tsv", delimiter="\t")

sample_sub = pd.read_csv("/kaggle/input/gendered-pronoun-resolution/sample_submission_stage_2.csv")
