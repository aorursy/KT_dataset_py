...
train.info()
train.describe()
# checking if there are neighborhoods more popular than others
...
# transforming other 'rankable' categorical features to numerical
...
# train_ohe = onehotencoder.fit_transform(X)
# test_ohe = onehotencoder.fit_transform(test)
# print(train_ohe)
