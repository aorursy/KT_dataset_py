...
df1 = pd.read_csv('/kaggle/input/PlayStoreApps-ParticipantsData/Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/PlayStoreApps-ParticipantsData/Train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/PlayStoreApps-ParticipantsData/Sample_Submission.csv', delimiter=',', nrows = nRowsRead)
