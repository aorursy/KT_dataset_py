...
# league-of-spuds.csv has 6298 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/league-of-spuds.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'league-of-spuds.csv'
nRow, nCol = df1.shape
