...
PARAMETERS['model_saved'] = 'moco_saved_imgnet_mini_4096K.pth'

PARAMETERS['model_load'] = '../input/saved-models/moco_saved_imgnet_mini_4096K_160.pth'
...
def start_training(rank, parameters):
    ...
    print("[Epoch, Train Loss, Train Acc(top5), Val Loss, Val Acc(top5)]")
...
xmp.spawn(start_training, args=(PARAMETERS, ), nprocs = world_size,
          ...
          start_method='fork')
df = pd.Dataframe(losses_df);
df.to_csv(r'moco_train_tpu.csv', encoding='utf-8', index=False)