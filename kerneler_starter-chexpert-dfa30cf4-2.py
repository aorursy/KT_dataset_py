...
df1 = pd.read_csv('/kaggle/input/CheXpert-v1.0-small/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/CheXpert-v1.0-small/valid.csv', delimiter=',', nrows = nRowsRead)
