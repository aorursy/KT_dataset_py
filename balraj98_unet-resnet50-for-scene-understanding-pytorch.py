...
DATA_DIR = '../input/stanford-background-dataset'
...
if os.path.exists('../input/unet-resnet50-for-scene-understanding-pytorch/best_model.pth'):

    model = torch.load('../input/unet-resnet50-for-scene-understanding-pytorch/best_model.pth', map_location=DEVICE)
