...
df_test.head()
print("Any missing sample in training set:",df_train.isnull().values.sum())
print("Any missing sample in test set:",df_test.isnull().values.sum(), "\n")
print("Check the Country list in train and testing data: ",(df_test.Country_Region.unique() == df_train.Country_Region.unique()).all())
print("Train :",df_train.Country_Region.unique(),"\n *****Total:",df_train.Country_Region.nunique(),"**********")
print("\n \n Test :",df_test.Country_Region.unique(),"\n *****Total:",df_test.Country_Region.nunique(),"**********")
...
renames = {'Province_State':'State','Country_Region':'Country','ConfirmedCases':'CC','Fatalities':'Deaths','Date':'Date','ForecastId':'FID','Id':'ID'}
