...
print ("Hello I am Nikhil Kamboj")
...
# solution is 10.. How ? Answer - when there are odd ' - 'then it is the subtraction to the expression and when the even '--' then it is used for the additon of the expression 
# for Example - 1-2 = -1 and 1--2 = 3 thats it.. Hopefully this is better way to understands the problems..


ninety_nine_dashes = 7 - 3
q5.check()
