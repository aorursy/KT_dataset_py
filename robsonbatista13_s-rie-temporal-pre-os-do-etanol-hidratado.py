...
rawData = pd.read_excel('../input/srie-temporal-etanol-hidratado/Brasil.xlsx',skiprows=12,usecols=[0,1,4],encoding='latin1')
...
parsedData.head()
#Carregando o segundo dataset e fazendo o primeiro filtro nas linhas e colunas
