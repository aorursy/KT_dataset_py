...
print("Constant yielded: 96.06% same as adaptive, for the sake of consistency with the MobileDataset we will use adaptive")
...
lriRange = numpy.arange(0.0001, 0.1, 0.001)
...
print("Value 0.005509 yielded 97.91% which is the same as value=0.00951")
'''Determine best learning_rate_INIT value for best training size identified above'''
...
lriRange = numpy.arange(0.00951, 0.1, 0.001)
...
lriRange = numpy.arange(0.08, 1.0, 0.01)
...
for mom in momRange:
    ...
    model = MLPClassifier(random_state=1234, solver='sgd', activation='logistic', learning_rate='adaptive', learning_rate_init=0.0925099, momentum=mom)
...
iterRange = list(range(1, 1002, 100))
...
for itera in iterRange:
    ...
    model = MLPClassifier(random_state=1234, solver='sgd', activation='logistic', learning_rate='adaptive', learning_rate_init=0.0925099, momentum=0.9, max_iter=itera)
...
layerRange = list(range(100, 2500, 100))
...
for layer in layerRange:
    ...
    model = MLPClassifier(random_state=1234, solver='sgd', activation='logistic', learning_rate='adaptive', learning_rate_init=0.0925099, momentum=0.9, max_iter=201, hidden_layer_sizes=layer)
...
plot.text(bestLayer, highestAccuracy, "Best Value: {}\nAccuracy: {}%".format(bestLayer, highestAccuracy), horizontalalignment='right', verticalalignment='center_baseline', color='red')
...
model = MLPClassifier(random_state=1234, solver='sgd', activation='logistic', learning_rate='adaptive', learning_rate_init=0.0925099, momentum=0.9, max_iter=201, hidden_layer_sizes=100)
