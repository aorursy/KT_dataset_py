...
maram_imputed = SimpleImputer()

imputed_X_train = pd.DataFrame(maram_imputed.fit_transform(X_train))

imputed_X_valid = pd.DataFrame(maram_imputed.transform(X_valid))
