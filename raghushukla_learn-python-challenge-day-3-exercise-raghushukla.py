...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if dealer_total < 17 and player_total <= dealer_total:
        if player_aces == 1 and player_total > 11:
            return True
        elif player_aces >=2 and (18 - player_aces) > (player_total - player_aces):
            return True
        elif 21 - player_total >= 10:
            return True
        else:
            return False
    elif dealer_total < 17 and player_total >= dealer_total and player_total < 21:
        if player_aces == 1 and player_total > 11:
            return True
        elif player_aces >=2 and (18 - player_aces) > (player_total - player_aces):
            return True
