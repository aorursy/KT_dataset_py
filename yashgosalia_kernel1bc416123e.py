...
class CIFAR10Model(ImageClassificationBase):
    ...
    def forward(self, xb):
        ...
        return out
model = to_device(CIFAR10Model(input_size=input_size, hidden_size = 1028, output_size=output_size), device)
...
test_result
arch = "6 layers(1028, 512, 256, 128, 64,10)"
lrs = [0.5,0.1,0.05,0.01]
epochs = [5,10,10,10]
test_acc = 0.5401366949081421
test_loss = 1.3679007291793823
