...
#plot both results to see how they compare
fig, ax=plt.subplots(1,2)
...
#select the indices of positive pledges
pledges_index = kickstarters_2017.pledged > 0

#select all the positive values of the pledged column
positive_pledged = kickstarters_2017.pledged.loc[pledges_index]
