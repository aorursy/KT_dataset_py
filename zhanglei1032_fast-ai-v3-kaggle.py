...
# 如果无法下载数据，需要点击右侧settings验证手机，才可以联网下载

# 最好的方法是点击右上角的add dataset，搜索Oxford-IIIT Pet直接添加，路径为 ‘…/input/images/’
...
# 由于kaggle的input目录是只读的，所以需要把生成模型文件的path指定为其他文件夹
...
learn = cnn_learner(data, models.resnet50, metrics=error_rate, model_dir=model_path)  
learn.lr_find()
