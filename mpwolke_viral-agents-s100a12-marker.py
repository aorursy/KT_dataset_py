...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQl4Yq4DqTmBPdA07AtrQ6r1r43FOiryUHdPziakTTpDIUmXqPn',width=400,height=400)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQ9uUbVfIIl2Q3fcSuNg0B_YM9Jj57KkXDEj68__leCB7_Kx3Kr',width=400,height=400)
import json
...
def plotWordFrequency(input):
    ...
    plt.show()
json_file = '../input/CORD-19-research-challenge/2020-03-13/comm_use_subset/comm_use_subset/129341a52b43ccd59368d094950322d983ebe223.json'
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSbFh3PrRssSQE3_pjUeWDaabWjCldlo4I0ZueZ_xD3VOiNeatz',width=400,height=400)