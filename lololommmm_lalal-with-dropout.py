...
test_data = datasets.ImageFolder('../input/gnt123/ts_data', transform = TestTransform())

train_data = datasets.ImageFolder('../input/gnt123/tr_data', transform = TrainTransform())



batch_size = 64

train_loader = Data.DataLoader(train_data,batch_size=batch_size, num_workers=8, shuffle=True)

test_loader = Data.DataLoader(test_data,batch_size=batch_size, num_workers=8, shuffle=True)
...
loadcheckpoint(model, optimizer, '../input/klalalall/0')
