...
q1.solution()
print(round(101511,-3))
print(round(201511,-2))
# rounding up of negative numbers might be useful for simplifying large numbers 
q2.solution()
def to_smash(total_candies, pax=3):
