...
print(check_output(["ls", "../input/better-donald-trump-tweets"]).decode("utf8"))
# Read the entire file containing song lyrics

path = "../input/better-donald-trump-tweets/Donald-Tweets!.csv"
...
#Limit corpus to a smaller number of characters
...
if not trained:
    ...
    model.save('trumpweights.h5')

    

else:

    model.load_weights('../input/trumptweetmodel/trumpweights.h5')


# Given a seed, lets check out what our model predicts

sentence = 'china vaccine manufactured by me'
