...
sns.kdeplot(cancer_m_data['Radius (worst)'], label='bening',shade=True) # Your code here (benign tumors)

sns.kdeplot(cancer_b_data['Radius (worst)'], label='malignant',shade=True) # Your code here (malignant tumors)
