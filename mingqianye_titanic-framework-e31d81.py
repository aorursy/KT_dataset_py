...
df=pd.DataFrame({
    ...
    'male':dataset.Survived[dataset.Sex == 'male'].value_counts(), 

    'female':dataset.Survived[dataset.Sex == 'female'].value_counts()
...
plt.show()
dataset.Survived[dataset['Embarked'] == 'S'].value_counts()
