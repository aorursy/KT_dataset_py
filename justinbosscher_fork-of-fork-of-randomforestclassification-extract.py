...
combine['Pclass'].isna().sum()
# Impact of Pclass on Survived
print(combine[['Pclass', 'Survived']].groupby(['Pclass'], as_index=False).mean())
# Encomde Pclass values
combine['Pclass_0'] = 0
combine.loc[(combine['Pclass'] == 0), 'Pclass_0'] = 1
combine['Pclass_1'] = 0
combine.loc[(combine['Pclass'] == 1), 'Pclass_1'] = 1
combine['Pclass_2'] = 0
combine.loc[(combine['Pclass'] == 2), 'Pclass_2'] = 1
combine['Pclass_3'] = 0
combine.loc[(combine['Pclass'] == 3), 'Pclass_3'] = 1
# Take a look at Cabin data
print(combine['Cabin'].unique())
# Take a look at the row that has 3 cabins
combine.loc[(combine['Cabin'] == "B52 B54 B56")]
# Take a look at the data for the people that have the same last name as the passenger w/ 3 cabins
combine.loc[(combine['Name'].str.contains("Ismay"))]
# It looks like there is no one else by that name
# Check percent of 'Cabin' data present
print(combine[combine['Cabin'].isnull()==True].shape[0] / combine.shape[0])
# Take a look at the data for the cabin that has 2 decks
combine.loc[(combine['Cabin'] == ("F E57"))]
# Set deck values to the first character in the cabin data
combine['Deck'] = combine['Cabin'].astype(str).str[0]
combine['Deck'].unique()
# Take a look at the impact of deck on survived
print(combine[['Deck', 'Survived']].groupby(['Deck'], as_index=False).mean())
# Code deck values
# Set deck values to 0 for any NaN cabin data
combine['Deck_None'] = 0
combine.loc[(combine['Cabin']).isna(), 'Deck_None'] = 1
combine['Deck_C'] = 0
combine.loc[(combine['Deck'] == "C"), 'Deck_C'] = 1
combine['Deck_E'] = 0
combine.loc[(combine['Deck'] == "E"), 'Deck_E'] = 1
combine['Deck_G'] = 0
combine.loc[(combine['Deck'] == "G"), 'Deck_G'] = 1
combine['Deck_D'] = 0
combine.loc[(combine['Deck'] == "D"), 'Deck_D'] = 1
combine['Deck_A'] = 0
combine.loc[(combine['Deck'] == "A"), 'Deck_A'] = 1
combine['Deck_B'] = 0
combine.loc[(combine['Deck'] == "B"), 'Deck_B'] = 1
combine['Deck_F'] = 0
combine.loc[(combine['Deck'] == "F"), 'Deck_F'] = 1
combine['Deck_T'] = 0
combine.loc[(combine['Deck'] == "T"), 'Deck_T'] = 1
...
# Well,if el capitanoo paid to get on board, the other crew members probably did, too.
# Identify nobility
...
# Impact of Sex on Age
print(combine[['Sex', 'Age']].groupby(['Sex'], as_index=False).mean())
combine['FamilySize'].unique()
# Bin FamilySize based on mean survival rates
# 1 pos, 0 neg
# Family size of 1
combine['FamSize_1'] = 0
combine.loc[(combine['FamilySize'] == 1), 'FamSize_1'] = 1
# Famimly Size of 2
combine['FamSize_2'] = 0
combine.loc[(combine['FamilySize'] == 2), 'FamSize_2'] = 1
# Famimly Size of 3
combine['FamSize_3'] = 0
combine.loc[(combine['FamilySize'] == 3), 'FamSize_3'] = 1
# Family size of 4
combine['FamSize_4'] = 0
combine.loc[combine['FamilySize'] == 4, 'FamSize_4'] = 1
# Family size of 5
combine['FamSize_5'] = 0
combine.loc[combine['FamilySize'] == 5, 'FamSize_5'] = 1
# Family size of 6
combine['FamSize_6'] = 0
combine.loc[combine['FamilySize'] == 6, 'FamSize_6'] = 1
# Family size of 7
combine['FamSize_7'] = 0
combine.loc[combine['FamilySize'] == 7, 'FamSize_7'] = 1
# Family size of 8
combine['FamSize_8'] = 0
combine.loc[(combine['FamilySize'] == 8), 'FamSize_8'] = 1
# Family size of 11
combine['FamSize_11'] = 0
combine.loc[combine['FamilySize'] == 11, 'FamSize_11'] = 1

# Check
combine.tail()
# Check percent of 'Age' data present
print(combine[combine['Age'].isnull()==True].shape[0] / combine.shape[0])
# Impact of Age on Survived
print(combine[['Survived', 'Age']].groupby(['Survived'], as_index=False).mean())
# Impact of Sex on Age
print(combine[['Sex', 'Age']].groupby(['Sex'], as_index=False).mean())
# Impact of Pclass on Age
print(combine[['Pclass', 'Age']].groupby(['Pclass'], as_index=False).mean())
...
combine.Age.isna().sum()
# Discretize age data
combine['Age_cat'] = pd.qcut(combine['Age'], 9)
print(combine[['Age_cat', 'Survived']].groupby(['Age_cat'], as_index=False).mean())
# Replace all Age categories with 0-8
combine.loc['Age_0'] = 0
combine.loc[(combine['Age'] <= 16), 'Age_0'] = 1
combine.loc[(combine['Age_0'].isna()), 'Age_0'] = 0
combine['Age_0'].astype(int)
combine.loc['Age_1'] = 0
combine.loc[(combine['Age'] > 16) & (combine['Age'] <= 21), 'Age_1'] = 1
combine.loc[(combine['Age_1'].isna()), 'Age_1'] = 0
combine['Age_1'].astype(int)
combine.loc['Age_2'] = 0
combine.loc[(combine['Age'] > 21) & (combine['Age'] <= 25), 'Age_2'] = 1
combine.loc[(combine['Age_2'].isna()), 'Age_2'] = 0
combine['Age_2'].astype(int)
combine.loc['Age_3'] = 0
combine.loc[(combine['Age'] > 25) & (combine['Age'] <= 28), 'Age_3'] = 1
combine.loc[(combine['Age_3'].isna()), 'Age_3'] = 0
combine['Age_3'].astype(int)
combine.loc['Age_4'] = 0
combine.loc[(combine['Age'] > 28) & (combine['Age'] <= 33), 'Age_4'] = 1
combine.loc[(combine['Age_4'].isna()), 'Age_4'] = 0
combine['Age_4'].astype(int)
combine.loc['Age_5'] = 0
combine.loc[(combine['Age'] > 33) & (combine['Age'] <= 34.78), 'Age_5'] = 1
combine.loc[(combine['Age_5'].isna()), 'Age_5'] = 0
combine['Age_5'].astype(int)
combine.loc['Age_6'] = 0
combine.loc[(combine['Age'] > 34.78) & (combine['Age'] <= 38), 'Age_6'] = 1
combine.loc[(combine['Age_6'].isna()), 'Age_6'] = 0
combine['Age_6'].astype(int)
combine.loc['Age_7'] = 0
combine.loc[(combine['Age'] > 38) & (combine['Age'] <= 47), 'Age_7'] = 1
combine.loc[(combine['Age_7'].isna()), 'Age_7'] = 0
combine['Age_7'].astype(int)
combine.loc['Age_8'] = 0
combine.loc[(combine['Age'] > 47), 'Age_8'] = 1
combine.loc[(combine['Age_8'].isna()), 'Age_8'] = 0
combine['Age_8'].astype(int)
...
# Discretize fare data
combine['Fare_cat'] = pd.qcut(combine['Fare'], 4)
print(combine[['Fare_cat', 'Survived']].groupby(['Fare_cat'], as_index=False).mean())
# Encode Fare data
combine['Fare_0'] = 0
combine.loc[(combine['Fare'] <= 7.896), 'Fare_0'] = 1
combine['Fare_1'] = 0
combine.loc[(combine['Fare'] > 7.896) & (combine['Fare'] <= 14.454), 'Fare_1'] = 1
combine['Fare_2'] = 0
combine.loc[(combine['Fare'] > 14.454) & (combine['Fare'] <= 31.275), 'Fare_2'] = 1
combine['Fare_3'] = 0
combine.loc[(combine['Fare'] > 31.275), 'Fare_3'] = 1
...
combine['Female'] = 0
combine.loc[combine.Sex == 'female', 'Female'] = 1
combine['Male'] = 0
combine.loc[combine.Sex == 'male', 'Male'] = 1
...
combine['Embarked_None'] = 0
combine.loc[(combine['Embarked'].isnull()), 'Embarked_None'] = 1
combine['Embarked_S'] = 0
combine.loc[(combine['Embarked'] == 'S'), 'Embarked_S'] = 1
combine['Embarked_C'] = 0
combine.loc[(combine['Embarked'] == 'C'), 'Embarked_C'] = 1
combine['Embarked_Q'] = 0
combine.loc[(combine['Embarked'] == 'Q'), 'Embarked'] = 1
combine.head()
...
combine = combine.drop(['Sex'], axis=1)
...
combine = combine.drop(['Age_cat'], axis=1)
combine = combine.drop(['Fare_cat'], axis=1)
combine = combine.drop(['Deck'], axis=1)
combine.head()
# Create X df
...
actual_y.dtypes
# Random Forest
random_forest = RandomForestClassifier(bootstrap=True, n_estimators=300, max_depth=7)
random_forest.fit(X, actual_y)
acc_random_forest = round(random_forest.score(X, actual_y) * 100, 2)
...
predict_y = random_forest.predict(test).astype(int)
