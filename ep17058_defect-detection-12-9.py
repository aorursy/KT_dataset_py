...
y_train = to_categorical(np.array(cls_list))
model.fit(X_train2, y_train, epochs=6)
img_array_list = []
...
y_train = to_categorical(np.array(cls_list))
model.fit(X_train3, y_train, epochs=6)
img_array_list = []
...
y_train = to_categorical(np.array(cls_list))
model.fit(X_train4, y_train, epochs=6)
img_array_list = []
...
y_train = to_categorical(np.array(cls_list))
model.fit(X_train5, y_train, epochs=6)
img_array_list = []
...
y_train = to_categorical(np.array(cls_list))
model.fit(X_train6, y_train, epochs=6)
import glob
