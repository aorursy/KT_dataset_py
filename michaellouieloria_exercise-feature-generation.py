...
bsm = train_model(train, valid, test)
import itertools
...
nem = train_model(train, valid, test)
...
tsm = train_model(train, valid, test)
...
tem = train_model(train, valid, test)
# Check your answer (Run this code cell to receive credit!)
