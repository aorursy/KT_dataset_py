...
print(f"Percentage of collisions more than 10 km away from the closest hospital: {percentage}%")
...
folium.GeoJson(ten_km_buffer.to_crs(epsg=4326)).add_to(m_6)
