...
col_X_test = X_test[low_cardinality_cols]

col_X_test = col_X_test.applymap(replace_nan_by_unknown)

col_X_test = pd.DataFrame(OHE.transform(col_X_test))



col_X_test.index = X_test.index



final_num = X_test.select_dtypes(exclude=['object'])



final_X_test = pd.concat([final_num, col_X_test], axis=1)



fillnan_test(OH_X_train, final_X_test)
