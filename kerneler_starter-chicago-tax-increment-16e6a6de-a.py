...
# tax-increment-financing-tif-projects.csv has 482 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/tax-increment-financing-tif-projects.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'tax-increment-financing-tif-projects.csv'
nRow, nCol = df1.shape
