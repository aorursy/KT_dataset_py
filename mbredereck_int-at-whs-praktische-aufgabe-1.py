...
def gib_folgezustaende(zustand):
    ...
    fzustaende = [
        [m+incr,k+incr,b_new],   # 1 | 1
        [m+incr,k,b_new],        # 1 | 0
        [m,k+incr,b_new],        # 0 | 1
        [m+incr*2,k,b_new],      # 2 | 0
        [m,k+incr*2,b_new],      # 0 | 2
        [m+incr*3,k,b_new],      # 3 | 0
        [m,k+incr*3,b_new],      # 0 | 3
        [m+incr,k+incr*2,b_new], # 1 | 2
        [m+incr*2,k+incr,b_new]  # 2 | 1
    ]
...
print('Gefundene Möglichkeiten: ', success_counter)