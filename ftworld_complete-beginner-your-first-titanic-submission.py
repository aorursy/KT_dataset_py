...
#replacing DecisionTree with RandomForest
...
plt.xlabel(" Dead 0 - Alive 1")
plt.ylabel("# of Passangers")
plt.title("Dead vs Alive")
plt.show()
combined = pd.merge(test,submission, on='PassengerId', how='left')

sns.countplot(x='Sex', hue='Survived', data=combined)
plt.ylabel('# of Passengers')
plt.xlabel('Sex, Dead 0 - Alive 1')
plt.show()
combined.head()
sns.countplot(x='Pclass', hue='Survived', data=combined)
plt.ylabel('# of Passengers')
plt.xlabel('Sex, Dead 0 - Alive 1')
plt.show()
