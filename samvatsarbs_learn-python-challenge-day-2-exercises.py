...
def to_smash(total_candies, number_friends = 3):
    ...
    number_friends argument represents the number of friends the candies are being split between- default value is 3
    >>> to_smash(91)
    1
    """
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    t5 = time()
    time_arg3 = t5 - t4
    return(max(time_arg1, time_arg2, time_arg_3))
