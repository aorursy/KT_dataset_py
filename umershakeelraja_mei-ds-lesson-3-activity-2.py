...
print("CO2: mean = "+str(petrol_data['CO2'].mean()))
print("CO2: standard deviation = "+str(petrol_data['CO2'].std()))
# NOTE: This block of code will only work if the PropulsionTypeId has been changed to the text values

# a new datset called petrol_data is created
# this contains only the rows where the Propulsion Type is Petrol
diesel_data = cars_data[cars_data['PropulsionTypeId']=='Diesel']

# print out the mean and standard deviation for the Mass converted to text (i.e. a string)

print("mass: mean = "+str(diesel_data['Mass'].mean()))
print("mass: standard deviation = "+str(diesel_data['Mass'].std()))

print("CO2: mean = "+str(diesel_data['CO2'].mean()))
print("CO2: standard deviation = "+str(diesel_data['CO2'].std()))