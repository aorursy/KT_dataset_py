...
df1 = pd.read_csv('/kaggle/input/data/input/BaldClassification/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/data/input/BaldClassification/test.csv', delimiter=',', nrows = nRowsRead)
