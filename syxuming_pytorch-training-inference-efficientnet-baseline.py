!ls ../input/landmark-lib
!mkdir -p /tmp/pip/cache/

!cp ../input/landmark-lib/efficientnet_pytorch-0.7.0.xyz /tmp/pip/cache/efficientnet_pytorch-0.7.0.tar.gz

!cp ../input/landmark-lib/torch_optimizer-0.0.1a15-py3-none-any.whl /tmp/pip/cache/

!cp ../input/landmark-lib/pytorch_ranger-0.1.1-py3-none-any.whl /tmp/pip/cache/
!ls /tmp/pip/cache/
!pip install --no-index --find-links /tmp/pip/cache/ efficientnet_pytorch
!pip install --no-index --find-links /tmp/pip/cache/ pytorch_ranger
!pip install --no-index --find-links /tmp/pip/cache/ torch_optimizer
