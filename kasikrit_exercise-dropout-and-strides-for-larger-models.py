...
# Fit fashion_model_1
train_x, train_y = x, y
fashion_model_1.fit(train_x, train_y,
          batch_size=128,
          epochs=10,
          validation_split = 0.2)

score, acc = fashion_model_1.evaluate(train_x, train_y, batch_size=128)
...
# Specify the rest of the model
fashion_model_2.add(Conv2D(12, kernel_size=(3, 3), strides=2,
                 activation='relu',
                 input_shape=(img_rows, img_cols, 1)))
...
# Fit fashion_model_1
fashion_model_2.fit(train_x, train_y,
          batch_size=128,
          epochs=10,
          validation_split = 0.2)

score, acc = fashion_model_2.evaluate(train_x, train_y, batch_size=128)
print('score', score, 'acc', acc)
...
# Specify the rest of the model
fashion_model_3.add(Conv2D(12, kernel_size=(3, 3), strides=2,
                 activation='relu',
                 input_shape=(img_rows, img_cols, 1)))
...
fashion_model_3.fit(train_x, train_y,
          batch_size=128,
          epochs=10,
          validation_split = 0.2)

score, acc = fashion_model_3.evaluate(train_x, train_y, batch_size=128)
print('score', score, 'acc', acc)
