...
#As a answer to the question, I can see missing data from the sf_permits dataset.
...
#None of the rows left after removing rows that contaion missing values.
...
subset_sf_data=sf_permits.loc[:, 'Block':'Location'].head()
subset_sf_data
