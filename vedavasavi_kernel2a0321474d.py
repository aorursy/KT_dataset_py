...
class CIFAR10Model(ImageClassificationBase):
    ...
    def forward(self, xb):
        ...
        # get intermediate output using the first hidden layer
...
history
history += fit(5, 2e-1, model, train_loader, val_loader)
...
lrs = [2e-1, 1e-2 ,1e-3,1e-4]
epochs = [5,10,20,20]
test_acc = 0.4906249940395355
test_loss = 1.4380172491073608
