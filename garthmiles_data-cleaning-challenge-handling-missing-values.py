...
sf_cell_count = np.product(sf_permits.shape) # total number of cells in dataset
sf_missing_data = sf_permits.isnull().sum()  # number of cells (per col) w/ missing data 
sf_total_missing = sf_missing_data.sum()     # total number of cells w/ missing data

# percent of missing data
(sf_total_missing/sf_cell_count) * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
