...
totalBronzeMedals = []
baseURL = 'https://www.kaggle.com/rankings.json?group=discussion&pageSize=20&page='
...
topKagglersDiscussion.head(7)
# We check the sizes of the dataframe

topKagglersDiscussion.shape
# Build csv

topKagglersDiscussion.to_csv('topKagglersDiscussion.csv', index=False)