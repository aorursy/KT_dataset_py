...
total_missing_sf = missing_values_sfdata.sum()

percentage_of_missing_sf = total_missing_sf/total_cells_sf*100
percentage_of_missing_sf
...
sf_permits_fillna_dataset = sf_permits.fillna(method = 'bfill', axis = 0).fillna('0')

sf_permits_fillna_dataset.tail(10)