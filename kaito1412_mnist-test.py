...
submission.to_csv("cnn_mnist_e10_b86.csv",index=False)
...
submission.to_csv("cnn_mnist_e20_b86.csv",index=False)
...
submission.to_csv("cnn_mnist_e30_b86.csv",index=False)
epochs = 10 # Turn epochs to 30 to get 0.9967 accuracy
...
submission.to_csv("cnn_mnist_e10_b64.csv",index=False)
epochs = 10 # Turn epochs to 30 to get 0.9967 accuracy

batch_size = 128
# Without data augmentation i obtained an accuracy of 0.98114

history5 = model.fit(X_train, Y_train, batch_size = batch_size, epochs = epochs, 
...
submission.to_csv("cnn_mnist_e10_b128.csv",index=False)
