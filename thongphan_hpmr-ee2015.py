...
#input với channels_last

inputShape = (height, width, depth)

chanDim = -1

#nếu dùng channels_first thì update inputShape
...
#Thêm ConvLayer với 32 kernel, kích thước 3*3

model.add(Conv2D(32, (3, 3), padding="same",input_shape=inputShape))

#Thêm Activation RELU
