...
sns.scatterplot('pricepercent','winpercent',data=candy_data,hue='chocolate') # Your code here
...
sns.lmplot('pricepercent','winpercent',data=candy_data,hue='chocolate') # Your code here
