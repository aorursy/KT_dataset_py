...
X = train_data.drop(['Name', 'PassengerId', 'Ticket', 'Cabin'], axis=1)
X.head()
...
train_data.head()
test_data.head()
X = test_data.drop(['Name', 'PassengerId', 'Ticket', 'Cabin'], axis=1)
X = X.replace(to_replace='S', value=3)
X = X.replace(to_replace='Q', value=2)
X = X.replace(to_replace='C', value=1)
X = X.replace(to_replace='male', value=1)
...
test_data
test_data['Survived'] = test_data['Survived'].replace(to_replace=0, value='No')
test_data['Survived'] = test_data['Survived'].replace(to_replace=1, value='Yes')
