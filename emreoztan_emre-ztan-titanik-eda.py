...
def detect_outliers(df,features):
    ...
    for i in features:
        ...
        #detech outlier and their indeces
...
plt.show()
train_df["Sex_Text"] = [1 if i == "male" else 0 for i in train_df["Sex"]]
sns.heatmap(train_df[["Age","Sex_Text","SibSp","Parch","Pclass"]].corr(), annot = True)
...
results.to_csv("/kaggle/output/titanic/titanic.csv", index = False)
