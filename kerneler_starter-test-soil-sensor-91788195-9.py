...
# Flower power 6A22.csv has 2755 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Flower power 6A22.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Flower power 6A22.csv'
nRow, nCol = df1.shape
