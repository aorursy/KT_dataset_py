...
# 2344212789972.csv has 9999 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/2344212789972.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 4533082618913.csv has 9999 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/4533082618913.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 5715151001506.csv has 9999 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/5715151001506.csv', delimiter=',', nrows = nRowsRead)
