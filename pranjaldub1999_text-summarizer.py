...
MAX_NUM_WORDS = 20000
EMBEDDING_DIM = 300
data = pd.read_csv('/kaggle/input/input-files/news.csv',encoding='latin1')
text = data['Text']
...
word2vec = {}
with open(os.path.join('/kaggle/input/glove-input/glove.6B.300d.txt')) as f:
...
checkpoint = ModelCheckpoint("text_sum.h5",
                            monitor="val_loss",
                            mode="min",
                            save_best_only=True,
                            verbose=1)
