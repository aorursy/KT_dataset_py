...
df1 = pd.read_csv('/kaggle/input/HE_Challenge_data/data/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/HE_Challenge_data/data/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/HE_Challenge_data/data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
