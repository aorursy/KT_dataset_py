...
densidade_fx3 = df_2290[df_2290["faixa"] == 3][["data_hora", "milissegundo", "velocidade_entrada", "velocidade_saida"]].copy()
...
iplot(fig)
plt.plot(fluxo_fx3["Fluxo"], color='green')
plt.title("Fluxo")
