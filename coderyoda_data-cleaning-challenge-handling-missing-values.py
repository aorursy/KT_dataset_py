...
print("Number of rows in original:%d\n"% sf_permits.shape[0])
print("Number of rows in dropped:%d\n"% sf_permits_rows_dropped.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
sf_permits_col_dropped = sf_permits.dropna(axis=1)
print("Number of columns in original:%d\n"% sf_permits.shape[1])
print("Number of columns in dropped:%d\n"% sf_permits_col_dropped.shape[1])
