...
# certified-disadvantaged-business-enterprises-dbes-in-the-nys-unified-certification-program.csv has 2262 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/certified-disadvantaged-business-enterprises-dbes-in-the-nys-unified-certification-program.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'certified-disadvantaged-business-enterprises-dbes-in-the-nys-unified-certification-program.csv'
nRow, nCol = df1.shape
