...
df1 = pd.read_csv('/kaggle/input/contrafold/dataset.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/eternafold/dataset.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/nupack/dataset.csv', delimiter=',', nrows = nRowsRead)
