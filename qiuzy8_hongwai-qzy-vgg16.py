...
def VGG_16(input_shape=[256, 320, 3], classes=2,target=1):
    ...
    x=ZeroPadding2D((1, 1), input_shape=(256, 320, 3),data_format=IMAGE_ORDERING)(img_input)

    x=Convolution2D(64, (3, 3), strides=(1, 1) ,activation='relu')(x)

    x=ZeroPadding2D((1, 1),data_format=IMAGE_ORDERING)(x)

    x=Convolution2D(64,(3, 3), strides=(1, 1) , activation='relu',data_format=IMAGE_ORDERING)(x)

    x=MaxPooling2D((2, 2), strides=(2, 2), padding='same',data_format=IMAGE_ORDERING)(x)
    ...
    x=Convolution2D(128,(3, 3), strides=(1, 1) , activation='relu',data_format=IMAGE_ORDERING)(x)
    ...
    x=Convolution2D(256, (3, 3), strides=(1, 1) , activation='relu',data_format=IMAGE_ORDERING)(x)
    ...
    x=Convolution2D(512, (3, 3), strides=(1, 1) , activation='relu',data_format=IMAGE_ORDERING)(x)
...
def _unet(n_classes=2, encoder=VGG_16,  input_height=256, input_width=320):
