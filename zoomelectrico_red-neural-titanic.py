...
train_df.info()
#Vamos a reemplazar las categorías para las columnas title, sex, embarked, cabin

#train_df = pd.get_dummies(train_df, columns=['Title','Sex','Embarked','Cabin'], dtype=int)

#test_df = pd.get_dummies(test_df, columns=['Title','Sex','Embarked','Cabin'], dtype=int)
...
def model(): 
    ...
    a=Dense(12, activation = "relu", kernel_regularizer = regularizers.l2(0.01))(X)

    a=Dropout(0.4)(a)

    a=Dense(12, activation = "relu", kernel_regularizer = regularizers.l2(0.01))(a)

    a=Dropout(0.45)(a)

    a=Dense(14, activation = "relu", kernel_regularizer = regularizers.l2(0.01))(a)
