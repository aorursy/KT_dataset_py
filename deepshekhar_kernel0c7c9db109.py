...
tweets.head()
tweets.sentiment_type.value_counts().plot(kind='bar',title="sentiment analysis", color=['g','b','r'])
import bokeh
...
plt.title('The Average of length of Tweets by hour', bbox={'facecolor':'0.8', 'pad':0})
