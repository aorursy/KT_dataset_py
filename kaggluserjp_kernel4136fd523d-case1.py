...
x_o_d = pd.get_dummies(x_o_neighbor, drop_first = True)#仮説1
...
x_n_c5 = ["TotalFloorArea","YearBuilt","OverallQual","GrLivArea","GarageCars"]#仮説1

x_n_c6 = ["GarageCars","TotalFloorArea","GarageYrBlt","OverallQual","GrLivArea","FullBath","TotRmsAbvGrd"]#仮説2

x_final = pd.concat([x_n[x_n_c4],x_o_d], axis = 1, sort = False)#仮説1
