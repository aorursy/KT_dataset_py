...
def balance_profile_recalculator(df, scenario_option='scenario_1', pay_arrears_period = None):
    ...
    for index, row in df.iterrows():    
        ...
        if row['trigger_flag'] == 1:
            ...
            cmi_adjusted = cmi_calculator(rate, nper, scenario_arrears_dict[scenario_option])
        ...
        arrears_adjusted = arrears_adjusted + missed_cmi_breakdown[0] - cmi_adjusted
...
df_config.at[[0,2, 4, 78, 90, 177], 'trigger_flag'] = 1

df_config.at[[0,1, 176, 178], 'missed_flag'] = 1
