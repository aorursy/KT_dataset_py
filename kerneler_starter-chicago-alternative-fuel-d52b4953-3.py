...
# alternative-fuel-locations.csv has 836 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/alternative-fuel-locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'alternative-fuel-locations.csv'
nRow, nCol = df1.shape
