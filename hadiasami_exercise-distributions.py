...
#cancer_b_data['Perimeter (mean)'].head(5).max()

#cancer_b_data.loc[cancer_b_data['Id'] == 842517, 'Radius (mean)']

#cancer_b_data.head(5).loc[842517]

cancer_m_data.head(5).loc[842517]['Radius (mean)']

# Fill in the line below: In the first five rows of the data for benign tumors, what is the

# largest value for 'Perimeter (mean)'?

max_perim = cancer_b_data['Perimeter (mean)'].head(5).max()
