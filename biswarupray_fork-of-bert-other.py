...
t=pd.concat([df1, df2, df3], axis=0).reset_index(drop=True)
t.loc[ t['reviews.rating'] <2.5, 'reviews.rating'] = 0

t.loc[ t['reviews.rating'] ==2.5, 'reviews.rating'] = 0

t.loc[ t['reviews.rating'] >2.5, 'reviews.rating'] = 1
t=(t.dropna())

t["reviews.rating"]=t["reviews.rating"].astype(int)
t=t.rename(columns={"reviews.text": "text", "reviews.rating": "review"})
...
df_train=pd.concat([df_train,t], axis=0).reset_index(drop=True)
df_train
