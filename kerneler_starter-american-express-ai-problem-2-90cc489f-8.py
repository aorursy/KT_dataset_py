...
df1 = pd.read_csv('../input/header.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'header.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# test.csv has 174302 rows in reality, but we are only loading/previewing the first 100 rows
