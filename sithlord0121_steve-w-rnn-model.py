...
#Steve Wang modified dropout of demographic layer from 0.2 to 0.1

demographic_dropout = layers.Dropout(0.1)(demographic_dense) 
...
#Steve Wang add a layer

middle_c = layers.Dense(128)(merge_c)

dense_c = layers.Dense(128)(middle_c)

#Steve Wang modified dropout from 0.3 to 0.2
...
middle_f = layers.Dense(128)(merge_f)

dense_f = layers.Dense(128)(middle_f)
...
history = model.fit([X_temporal_train,X_demographic_train], [Y_cases_train, Y_fatalities_train], 
          ...
          #changed batch_size from 16 to 20 
