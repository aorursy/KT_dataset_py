...
q_1.check()
q_1.solution()
# No,the range can be determined by outliers
# 'number_inpatient' and 'number_diagnosis'
q_2.solution()
shap.summary_plot(shap_values[1], small_val_X)
...
q_3.check()
q_3.solution()
# It has no significant effect on the output
q_4.solution()
# Yes. No. Yes 
q_5.solution()
shap.summary_plot(shap_values[1], small_val_X)
# Your code here
features_of_interest = ['num_medications', 'num_lab_procedures']
for feature in features_of_interest:
    shap.dependence_plot(feature, shap_values[1], small_val_X)
q_6.solution()