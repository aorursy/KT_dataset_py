...
# mined-land-permits-beginning-1974.csv has 5933 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/mined-land-permits-beginning-1974.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'mined-land-permits-beginning-1974.csv'
nRow, nCol = df1.shape
