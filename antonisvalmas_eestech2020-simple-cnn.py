...
model.compile(
    optimizers.Adam(learning_rate=0.0005, beta_1=0.9, beta_2=0.999, epsilon=1e-8),
...
eval_hist = model.evaluate_generator(generator=valid_generator, steps=STEP_SIZE_VALID)
...
csv_out = open('submissionLeaky01.csv', 'w')
