...
output = pd.DataFrame({'Id': X_test.index, # Changed Id: final_X_test.index to X_test.index as the imputer seems to wipe out the row

                       # indexing as well as the column names
