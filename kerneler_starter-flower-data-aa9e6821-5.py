...
print(os.listdir('../input/HE_Challenge_data'))
...
df1 = pd.read_csv('../input/HE_Challenge_data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/HE_Challenge_data/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/HE_Challenge_data/train.csv', delimiter=',', nrows = nRowsRead)
