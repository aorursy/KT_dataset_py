...
test_data = pd.read_csv("../input/adult-pmr3508/test_data.csv", names = column_names, na_values='?').drop(0, axis = 0).reset_index(drop = True)

train_data = pd.read_csv("../input/adult-pmr3508/train_data.csv", names = column_names, na_values='?').drop(0, axis = 0).reset_index(drop = True)
