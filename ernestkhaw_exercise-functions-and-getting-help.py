...
q1.solution()
def round_in_negatives(num):
    return round(num,-1)

round_in_negatives(337)

#q2.solution()
def to_smash(total_candies,number_of_pax=3):
    ...
    1
    """
    return total_candies % number_of_pax
...
q7.solution()
def smallest_stringy_number(s1, s2, s3, s4, s5):
...
smallest_stringy_number('birdman', '2', '3','1.02','12')
#q8.a.solution()
