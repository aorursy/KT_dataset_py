...
edu=pd.read_csv('/kaggle/input/ict-ense3-2020/files/ch07/educ_figdp_1_Data.csv',na_values=':')
edu.head()
edu.tail()
...
plt.xticks([0,1,2])
plt.yticks([0,1,2])
plt.savefig("/kaggle/working/correlationkmeans.png",dpi=300, bbox_inches='tight')
...
plt.savefig("/kaggle/working/clusterexpenditure.png",dpi=300, bbox_inches='tight')
...
plt.savefig("/kaggle/working/dist2cluster01.png",dpi=300, bbox_inches='tight')
...
fig = plt.gcf()
fig.set_size_inches((12,5))
plt.savefig("/kaggle/working/distances4clusters.png",dpi=300, bbox_inches='tight')
