...
classes_dict = {label:0 for label in classes}

for data in dataset:
    img, label = data
    classes_dict[classes[label]] += 1
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        self.linear6 = nn.Linear(8, output_size)
...
arch = "6 layers (8, 16, 32, 16, 8, 10)"
lrs = [1e-1, 1e-2]
epochs = [10, 30]
test_acc = 0.42500001192092896
test_loss = 1.590057373046875
