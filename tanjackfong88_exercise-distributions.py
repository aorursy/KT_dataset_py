...
# Malignant turmours have higher mean values for Area compared to benign tumours.

# Malignant tumours also have larger range of potential values.
...
# The algorithm is more likely to classify the tumour as malignant.
# Check your answer (Run this code cell to receive credit!)
