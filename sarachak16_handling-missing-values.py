...
orig_data = pd.read_csv('../input/house-prices-advanced-regression-techniques/train.csv')

orig_data.isnull().sum()



Y = orig_data.pop('SalePrice')

print (Y.head())



missing_data_cols = [col for col in orig_data.columns if orig_data[col].isnull().any()]
