...
nc_X_train = X_train.drop(object_cols, axis=1)

nc_X_valid = X_valid.drop(object_cols, axis=1)



# concat

OH_X_train = pd.concat([OH_X_train, nc_X_train], axis=1)

OH_X_valid = pd.concat([OH_X_valid, nc_X_valid], axis=1)
