...
class my_gbdt(object):
    ...
    def __init__(self):
        ...
        for i in range(self.iter_n):
            ...
            self.trees.append(DecisionTreeRegressor(min_samples_split = 20, max_depth = 15))
    ...
    def fit(self, X, y):
        ...
        for i in range(1, self.iter_n):
            ...
            gradient = y - pred_proba

            self.trees[i].fit(X, gradient)

            pred_proba =  pred_proba + self.learning_rate * self.trees[i].predict(X)
