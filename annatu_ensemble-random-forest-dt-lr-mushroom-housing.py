...
hdata = transform_numerical(house_data)  # transform your data
...
plt.plot(r,r)
plt.show()
# another way to plot for comparison, the more overlapping, the better.
