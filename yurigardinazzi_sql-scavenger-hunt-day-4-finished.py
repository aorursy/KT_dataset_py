...
# note that max_gb_scanned is set to 21, rather than 1
transactions_per_day = bitcoin_blockchain.query_to_pandas_safe(query_transactions_per_day,
                                                               max_gb_scanned=21)
...
transactions_per_merkle_root= bitcoin_blockchain.query_to_pandas_safe(query_associations, 
                                                                      max_gb_scanned=37)
