...
model.compile(optimizer='momentum', loss='binary_crossentropy', metrics=['acc'])
...
with open("model_LSTM_he_uniform.json", "w") as json_file : 

    json_file.write(model_json)

    

model.save_weights("model_LSTM_he_uniform.h5")

print("Saved model to disk")
#from keras.models import load_model

#new_model=load_model('model_LSTM_he_uniform.h5')
!ls 
