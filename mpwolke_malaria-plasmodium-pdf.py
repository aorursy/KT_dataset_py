...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/Quinn16.jpg') # intro page to preview later
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 5 of Quinn")
...
pdfimage5 = Image.open('/kaggle/working/Quinn16.jpg')
# PDF to JPG for p7
...
pdfimage8 = Image.open('/kaggle/working/Quinn16.jpg')
...
pdfimage3 = Image.open('/kaggle/working/Quinn16.jpg')
#Explore page 3 - Mueller Report. Here I don't know how many pages each Cheat Sheet. There are 30 pages 
