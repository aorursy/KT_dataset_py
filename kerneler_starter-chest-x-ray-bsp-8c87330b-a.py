...
df1 = pd.read_csv('/kaggle/input/Chest_Xray_BSP/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Chest_Xray_BSP/train.csv', delimiter=',', nrows = nRowsRead)
