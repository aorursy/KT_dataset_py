...
file_path = "/kaggle/input/aakash/Dataset/Test Data/"

import pandas as pd

test = pd.read_csv("/kaggle/input/aakash/Dataset/Test.csv")

import cv2

img = cv2.imread("../input/aakash/Dataset/Test Data/Img1001.jpg")
...
Test_img = np.squeeze(Test_data)

pred = model.predict(Test_img)
res = []
for i in range(0, pred.shape[0]):
    res.append(labels[np.argmax(pred[i])])    
