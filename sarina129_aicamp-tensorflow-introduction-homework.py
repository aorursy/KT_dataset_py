    ...
    def fit(self, trainX,trainY):
        ...
        for epoch in range(self.training_epochs):
            ...
            for (x, y) in zip(trainX, trainY):
                 ...
                 self.sess.run(optimizer, feed_dict={self.X: x, self.Y: y})# TODO
...
lr = LinearRegressionTF(learning_rate, 700, display_step, annotate=False)# TODO
    ...
    def fit(self, trainX,trainY):
        ...
        for epoch in range(self.training_epochs):
            ...
            for (x, y) in zip(trainX, trainY):
                ...
                self.sess.run(optimizer, feed_dict={self.X: np.asmatrix(x), self.Y: np.asmatrix(y)})# TODO
...
logisticTF = LogisticRegressionTF(learning_rate, 700, display_step, annotate=False)
...
#data_folder = "../input/fashion MNIST"
