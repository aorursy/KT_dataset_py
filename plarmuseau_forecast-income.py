...
adult_data = pd.read_csv('../input/mlcourse/adult_train.csv')
...
def clustertechniques2(dtrain,label,indexv):
    ...
    clunaam=['PCA','tSVD','UMAP','raw','tSVD','nmf','UMAP','tSNE']
    ...
    clanaam= ['Logi','Logi2','PasAggr','rFor','Xtree','sgd','xgb','Gauss','QDis']#,'KNN','rFor','Xtr','MLP','Decis','LinDis','QuadDis']#['Logi','KNN','rFor','SVC','MLP','SGD']
...
sub,sign=clustertechniques2(adult_data.reset_index(),'Target','index') #total[len(train):].fillna(0)
