...
train_df = pd.read_csv('../input/nlp-getting-started/train.csv', dtype={'id': np.int16, 'target': np.int8})
test_df = pd.read_csv('../input/nlp-getting-started/test.csv', dtype={'id': np.int16, 'target': np.int8})
...
print('Test Set Memory Usage = {}'.format(test_df.shape))
...
sns.barplot(y=df_disaster_unigrams[0].values[:N], x=df_disaster_unigrams[1].values[:N], ax=axes[0], color='maroon')
