...
print(os.listdir("../input/banglalekha/data/data/"))
...
TRAIN_DIR = "../input/banglalekha/data/data/train"

VAL_DIR = "../input/banglalekha/data/data/val"
...
utils.save_class_list(class_list, model_name="VGG19", dataset_name="dataset")
