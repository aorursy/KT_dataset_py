...
print('Target Label:', train.iloc[20000, 0])
...
submission['laber'] = y_pred
# Jika sudah, harusnya nilai dari kolom `Label` akan bervariasi, bukan 0 semua
submission.head(5)
submission.to_csv('Mawan_Submission.csv', index=False) # index=False adalah argumen untuk tidak memasukan index kedalam CSV.
