...
history
history += fit(16, 1e-1, model, train_loader, val_loader)
history += fit(16, 1e-3, model, train_loader, val_loader)
history += fit(16, 1e-5, model, train_loader, val_loader)
history += fit(16, 1e-7, model, train_loader, val_loader)
plot_losses(history)
