...
dataset = pd.read_csv('/kaggle/input/credit-card-application/Credit_Card_Applications.csv')

X = dataset.iloc[:, :-1].values

y = dataset.iloc[:, -1].values
# Feature Scaling， good for high dimensional data to reduce computations
...
# x,y dimension of som map, sigma-radis of circles, learning rate-converging speed
