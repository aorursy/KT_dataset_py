...
sd = df.sort_values('gk_Shot_Stopper')[:1]
x1 = np.array(list(sd['Name']))
x2 = np.array(list(sd['gk_Shot_Stopper']))
plt.figure(figsize=(5,2))
sns.barplot(x1,x2,palette='colorblind')
plt.ylabel("Shot Stopping Players")
plt.figure(figsize=(5,2))
sd = df.sort_values('gk_Sweeper')[:1]
...
plt.figure(figsize=(5,2))
sd = df[(df['Club_Position'] == 'LCB')].sort_values('df_centre_backs')[:1]
x2 = np.array(list(sd['Name']))
y2 = np.array(list(sd['df_centre_backs']))
sns.barplot(x2, y2, palette=sns.color_palette("Blues_d"))
plt.ylabel("LCB Score")
plt.figure(figsize=(5,2))
sd = df[(df['Club_Position'] == 'LWB') | (df['Club_Position'] == 'LB')].sort_values('df_wb_Wing_Backs')[:1]
...
plt.figure(figsize=(5,2))
sd = df[(df['Club_Position'] == 'RWB') | (df['Club_Position'] == 'RB')].sort_values('df_wb_Wing_Backs')[:1]
...
ss = df[(df['Club_Position'] == 'CAM') | (df['Club_Position'] == 'LAM') | (df['Club_Position'] == 'RAM')].sort_values('mf_playmaker')[:1]
...
plt.figure(figsize=(5,2))
ss = df[(df['Club_Position'] == 'RCM') | (df['Club_Position'] == 'RM')].sort_values('mf_beast')[:1]
...
ss = df[(df['Club_Position'] == 'LCM') | (df['Club_Position'] == 'LM')].sort_values('mf_controller')[:1]
...
ss = df[(df['Club_Position'] == 'LW') | (df['Club_Position'] == 'LM') | (df['Club_Position'] == 'LS')].sort_values('att_left_wing')[:1]
x1 = np.array(list(ss['Name']))
...
ss = df[(df['Club_Position'] == 'RW') | (df['Club_Position'] == 'RM') | (df['Club_Position'] == 'RS')].sort_values('att_right_wing')[:1]
x2 = np.array(list(ss['Name']))
...
plt.figure(figsize=(5,2))
ss = df[(df['Club_Position'] == 'ST') | (df['Club_Position'] == 'LS') | (df['Club_Position'] == 'RS') | (df['Club_Position'] == 'CF')].sort_values('att_striker')[:1]
x3 = np.array(list(ss['Name']))
