...
provs = suicide_attacks['Province'].unique()
# sort them alphabetically and then take a closer look
provs.sort()
print(prov)
# convert to lower case
...
suicide_attacks_2 = pd.read_csv("../input/PakistanSuicideAttacks Ver 11 (30-November-2017).csv", 
                              encoding=result['encoding'])
suicide_attacks_2.head(10)
# get all the unique values in the 'City' column
cities = suicide_attacks_2['City'].unique()
provs = suicide_attacks_2['Province'].unique()
# sort them alphabetically and then take a closer look
cities.sort()
provs.sort()
print('Before:')
...
print(cities)
print(provs)
replace_dict = ['d.i khan','kuram agency']
for i in replace_dict:
    replace_matches_in_column(df=suicide_attacks_2, column='City', string_to_match=i)

replace_dict = 'balochistan'
