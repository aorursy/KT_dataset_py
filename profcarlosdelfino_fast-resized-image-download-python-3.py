...
# set files and dir
CSV_PATH, OUT_DIR = '../input/train.csv', '../output/train'  # recognition challenge
# CSV_PATH, OUT_DIR = '../input/index.csv', '../output/index'  # retrieval challenge
# CSV_PATH, OUT_DIR = '../input/test.csv', '../output/test'  # test data
