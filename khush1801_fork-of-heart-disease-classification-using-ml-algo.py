...
import os
print(os.listdir("../input/heart"))
print(os.listdir("../input/heart-test-1"))

# Any results you write to the current directory are saved as output.
import pandas as pd # Data processing
import numpy as np # For Linear Algebra Calculation
heart_disease = pd.read_csv('../input/heart/heart.csv')
heart_disease_test = pd.read_csv('../input/heart-test-1/heart1.csv')
heart_disease.tail()
heart_disease_test.tail()
# Find how many variables and objects in the data set
heart_disease.shape
# Find how many variables and objects in the data set
heart_disease_test.shape
...
heart_disease_test= heart_disease_test.rename(columns= {'cp': 'chest_pain_type' , 'trestbps': 'resting_blood_pressure' , 'chol' : 'cholesterol',
                                             'fbs': 'fasting_blood_sugar' , 'restecg' : 'rest_ecg' ,'thalach' : 'max_heart_rate_achieved',
                                             'exang' : 'exercise_induced_angina' , 'oldpeak' : 'st_depression' , 'slope' : 'st_slope',
                                             'ca' : 'num_major_vessels' , 'thal' : 'thalassemia'})
# View the first 10 rows in data set
heart_disease.head(10)
heart_disease_test.head(10)
# View the last 10 rows in the data set
heart_disease.tail(10)
heart_disease_test.tail(10)
...
# Convert Sex Column data
heart_disease_test['sex'][heart_disease_test['sex'] == 0] = 'Female'
heart_disease_test['sex'][heart_disease_test['sex'] == 1] = 'Male'
heart_disease_test['sex']
...
# Convert Chest pain type column data
heart_disease_test['chest_pain_type'][heart_disease_test['chest_pain_type'] == 0] = 'typical angina'
heart_disease_test['chest_pain_type'][heart_disease_test['chest_pain_type'] == 1] = 'atypical angina'
heart_disease_test['chest_pain_type'][heart_disease_test['chest_pain_type'] == 2] = 'non-anginal pain'
heart_disease_test['chest_pain_type'][heart_disease_test['chest_pain_type'] == 3] = 'asymptomatic'
...
heart_disease_test['fasting_blood_sugar'][heart_disease_test['fasting_blood_sugar'] == 0] = 'lower than 120mg/ml'
heart_disease_test['fasting_blood_sugar'][heart_disease_test['fasting_blood_sugar'] == 1] = 'greater than 120mg/ml'
heart_disease_test['fasting_blood_sugar']
...
# Convert rest_ecg column data
heart_disease_test['rest_ecg'][heart_disease_test['rest_ecg'] == 0] = 'normal'
heart_disease_test['rest_ecg'][heart_disease_test['rest_ecg'] == 1] = 'ST-T wave abnormality'
heart_disease_test['rest_ecg'][heart_disease_test['rest_ecg'] == 2] = 'left ventricular hypertrophy'
heart_disease_test['rest_ecg']
...
# Convert exercise_included_angina
heart_disease_test['exercise_induced_angina'][heart_disease_test['exercise_induced_angina'] == 0] = 'no'
heart_disease_test['exercise_induced_angina'][heart_disease_test['exercise_induced_angina'] == 1] = 'yes'
...
# Convert solpe column data
heart_disease_test['st_slope'][heart_disease_test['st_slope'] == 1] = 'upsloping'
heart_disease_test['st_slope'][heart_disease_test['st_slope'] == 2] = 'flat'
heart_disease_test['st_slope'][heart_disease_test['st_slope'] == 3] = 'downsloping'
...
# convert Thalassemia column data
heart_disease_test['thalassemia'][heart_disease_test['thalassemia'] == 1] = 'normal'
heart_disease_test['thalassemia'][heart_disease_test['thalassemia'] == 2] = 'fixed defect'
heart_disease_test['thalassemia'][heart_disease_test['thalassemia'] == 3] = 'reversable defect'
heart_disease_test['thalassemia']
...
print("skewness of the st_depression" , skew(heart_disease_test['st_depression']))
print("Kurtosis of st_depression ", kurtosis(heart_disease_test['st_depression']))
# Import Libraries
...
heart_disease_test.groupby('chest_pain_type', as_index=False)['target'].mean()
heart_disease.groupby('st_slope',as_index=False)['target'].mean()
heart_disease_test.groupby('st_slope',as_index=False)['target'].mean()
heart_disease.groupby('thalassemia',as_index=False)['target'].mean()
heart_disease_test.groupby('thalassemia',as_index=False)['target'].mean()
heart_disease.groupby('target').mean()
heart_disease_test.groupby('target').mean()
...
# Convert the data into categorical data type
heart_disease_test.chest_pain_type = heart_disease_test.chest_pain_type.astype("category")
heart_disease_test.exercise_induced_angina = heart_disease_test.exercise_induced_angina.astype("category")
heart_disease_test.fasting_blood_sugar = heart_disease_test.fasting_blood_sugar.astype("category")
heart_disease_test.rest_ecg = heart_disease_test.rest_ecg.astype("category")
heart_disease_test.sex = heart_disease_test.sex.astype("category")
heart_disease_test.st_slope = heart_disease_test.st_slope.astype("category")
heart_disease_test.thalassemia = heart_disease_test.thalassemia.astype("category")
heart_disease.head()
heart_disease_test.head()
# Dummy values
heart_disease1 = pd.get_dummies(heart_disease, drop_first=True)
heart_disease_test1 = pd.get_dummies(heart_disease_test, drop_first=True)
print(heart_disease_test1)
heart_disease1.head()
# Import Libraries
from sklearn.preprocessing import scale
scale(heart_disease1)
scale(heart_disease_test1)
np.exp(scale(heart_disease1))
np.exp(scale(heart_disease_test1))
x_train = heart_disease1.drop(['target'], axis = 1)
y_train = heart_disease1.target.values
x_test = heart_disease_test1.drop(['target'], axis = 1)
y_test = heart_disease_test1.target.values
# Input values
x_test
# Output Values
y_test
...
print("NBC Accuracy is: ",NBC_accuracy)
...
print("Grids search accuracy is: ",accuracy_score(y_test, predictions))
