...
def wait_seconds(val):
    sleep(val)
          
time_call(wait_seconds, 3)
time_call(wait_seconds, 2)
time_call(wait_seconds, 1)
...
slowest_call(wait_seconds, 1, 2, 3)
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
...
smallest_stringy_number('2', '2', '19')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
