...
df2 = pd.read_csv('/kaggle/input/dataset/test_file.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/dataset/train_file.csv', delimiter=',', nrows = nRowsRead)
