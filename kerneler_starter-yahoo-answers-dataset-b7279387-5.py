...
df1 = pd.read_csv('/kaggle/input/yahoo_answers_csv/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/yahoo_answers_csv/test.csv', delimiter=',', nrows = nRowsRead)
