...
!cd draw_rna_pkg && python setup.py installh/
import os
import sys
...
dat  = open("../input/ribologic/ribologic_SI.txt","r") 
dat
print (dat.readlines() )
sequence = "GUUGAGUUAGGAGCGGGUGAGAUCAAAAUACAUGAGGAUCACCCAUGUUAUAGGGUAAUCAGCCAGAAUACUUGUCG"
...
sequence = "AGACGCUAGGCGCGAGGGAAGAACCUCAUACAUGAGGAUCACCCAUGUUACACGCGCACGCGAAACGAGCUGGCAUG"
mfe_structure = mfe(sequence)
print(mfe_structure)
bp_matrix = bpps(sequence)
plt.imshow(bp_matrix, origin='lower left', cmap='gist_heat_r')
