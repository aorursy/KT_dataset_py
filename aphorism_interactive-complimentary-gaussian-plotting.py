...
widget_intensity = ipywidgets.widgets.FloatSlider(
...
def widget_graphs_update(change):
    ...
    with widget_graph1:
        ...
        sd_gaussian.values = sd_gaussian.values * widget_intensity.value
        ...
        widget_XYZ_label.value = "xy: {}".format(

            colour.XYZ_to_xy(

                colour.sd_to_XYZ(sd_gaussian, method="Integration")
...
widget_intensity.observe(widget_graphs_update, "value")
