...
# sampleSubmission.csv has 10000 rows in reality, but we are only loading/previewing the first 1000 rows
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# train.csv has 20000 rows in reality, but we are only loading/previewing the first 1000 rows
