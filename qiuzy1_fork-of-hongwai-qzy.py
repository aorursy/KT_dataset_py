...
def get_mobilenet_encoder(input_shape=[256, 320, 3], classes=2,target=1  ):
...
def _unet(n_classes=2, encoder=get_mobilenet_encoder,  input_height=256, input_width=320):
