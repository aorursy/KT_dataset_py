...
ka_matches = fuzzywuzzy.process.extract("kurram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)

# take a look at them
ka_matches

# use the function to replace 'kuram agency' with 'kurram agency'
...
cities.sort()
cities
# change the province name "baluchistan" to "balochistan"
# find close matches
bl_matches = fuzzywuzzy.process.extract("balochistan", provinces, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
bl_matches
