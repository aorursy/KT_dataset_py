...
from sklearn.model_selection import cross_validate as cross_validation, train_test_split
...
class NaiveSGD():
    ...
    def __init__(self, X, y, max_iter=1000, r=.001):
...
clf = SGDRegressor(loss='squared_loss', learning_rate='invscaling', eta0=0.001, power_t=1)
