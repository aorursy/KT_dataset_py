...
sign = lambda x: round(x / (abs(x) + 1e-300))
...
def to_smash(total_candies):
    ...
    1
    """
    print("Splitting", total_candies, ("candy", "candies")[total_candies > 1])
    return total_candies % 3
...
concise_is_negative = lambda x: x < 0 # Are you counting from zero? Zero-line solution, then.
