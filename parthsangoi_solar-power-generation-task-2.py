...
plt.ylabel('AC_POWER')
plt.show()
#Line Graph for the Total Yield vs Date_Time for 34 days for Plant 1
...
#Line Graph for the Total Yield vs Date_Time for 34 days for Plant 2
_, ax = plt.subplots(1, 1, figsize=(18, 9))
...
plt.ylabel('Power')
plt.show()
#Scatter Plot for Module Temperature vs Ambient Temperature
plt.figure(figsize=(20,10))
plt.plot(df_pgen2['AMBIENT_TEMPERATURE'],df_pgen2['MODULE_TEMPERATURE'],marker = 'o',linestyle='', color='c', alpha=0.5)
...
plt.show()
plt.figure(figsize=(20,10))
plt.plot(df_pgen4['AMBIENT_TEMPERATURE'],df_pgen4['MODULE_TEMPERATURE'],marker = 'o',linestyle='', color='c', alpha=0.5)
plt.title('Scatter Plot for Module Temperature vs Ambient Temp at Plant 1')
plt.xlabel('Ambient Temperature')
plt.ylabel('Module Temperature')
plt.grid()
...
plt.show()
plt.figure(figsize=(20,10))
plt.plot(df_pgen4['AMBIENT_TEMPERATURE'],df_pgen4['MODULE_TEMPERATURE'],marker = 'o',linestyle='', color='r', alpha=0.4,label='Plant 2')
plt.plot(df_pgen2['AMBIENT_TEMPERATURE'],df_pgen2['MODULE_TEMPERATURE'],marker = 'o',linestyle='', color='c', alpha=0.4,label='Plant 1')
...
plt.legend()
plt.show()
#graph of sourcekey vs total yield for a particular inverte
plt.figure(figsize= (20,10))
inv_lst= df_pgen1['SOURCE_KEY'].unique()
plt.plot(inv_lst,df_pgen1.groupby('SOURCE_KEY')['TOTAL_YIELD'].max())
...
plt.plot(inv_lst2,df_pgen3.groupby('SOURCE_KEY')['TOTAL_YIELD'].max())
...
plt.plot(r_left['IRRADIATION'],r_left['DC_POWER'],c='cyan',marker ='o',linestyle='',alpha = 0.25,label ='DC POWER')
plt.legend()
plt.xlabel('irradiation')
plt.ylabel('dc power')
plt.show()
#Scatter Plot for Module Temperature vs Ambient Temperature for 34 Days and its variation
