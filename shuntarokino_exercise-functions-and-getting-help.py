...
def to_smash(total_candies, num_friends = 3):
    ...
    the given number of candies evenly between any number of friends (default 3).
...
q3.hint()
q3.solution()
ruound_to_two_places = lambda x : round(x, 2)
...
smallest_stringy_number = lambda s1, s2, s3 : min(s1, s2, s3, key = int)
