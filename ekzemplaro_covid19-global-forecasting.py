...
test_last_day = int(test_data.shape[0]/nn_unique) + int(data_train[data_train.Date<20200326].shape[0]/nn_unique)
test_last_day
#days in test data

test_days = np.arange(int(data_train[data_train.Date<20200326].shape[0]/nn_unique), test_last_day, 1)
test_days
