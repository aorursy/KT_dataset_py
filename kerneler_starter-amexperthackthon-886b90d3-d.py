...
df1 = pd.read_csv('/kaggle/input/campaign_data.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/coupon_item_mapping.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/customer_demographics.csv', delimiter=',', nrows = nRowsRead)
