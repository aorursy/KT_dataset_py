...
!nvidia-smi
X_data = CeleaDataset(img_dir, label_path, X_label, spread=(0,6000))

Y_data = CeleaDataset(img_dir, label_path, Y_label, scale = 0.25, spread=(6000,12000))
...
resume = "../input/ganweights/checkpoint-small-70.pth"
...
#             print("{}/{} iter : {}".format(i,epoch, time.time() - iter_data_time))
    ...
    if epoch % 5 == 0:
        ...
        torch.save(
          ...
          './checkpoint-small-{}.pth'.format(epoch)
