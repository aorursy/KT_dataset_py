...
# restaurant_week_2018_final.csv has 348 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/restaurant_week_2018_final.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'restaurant_week_2018_final.csv'
nRow, nCol = df1.shape
