...
# Create a variable named fruits and assign it a list of fruits containing 

#the following fruit names as strings: 
...
# Create a variable named vegetables and assign it a list of 

# fruits containing the following vegetable names as strings: 
...
# Create a variable named numbers and assign it a list of numbers, 
...
# Given the following assigment of the list of fruits, 

# add "tomato" to the end of the list. 
...
# Given the following assignment of the vegetables list, 

# add "tomato" to the end of the list.

vegetables = ["eggplant", "broccoli", "carrot", "cauliflower", "zucchini"]

vegetables.append("tomoto")
...
# Given the list of numbers defined below, 

# reverse the list of numbers that you created above. 
...
def identity(x):
    ...
    if x in numbers: 
        ...
        if x > 0 and x % 2 == 1:
            ...
            return 'positive_odd_number'

        if x > 0 and x % 2 == 0:

            return 'positive_even_number'
...
def is_negative_odd(x):
    ...
    return True if (x < 0 and x % 2 == 1) else False
...
# Write a function definition named is_negative_even that takes in a number and returns True or False if the value is 
...
# Write a function definition named absolute_value that takes in a number and returns the absolute  

# value of the provided number
...
def is_multiple_of_both_three_and_five(x):
    ...
    return True if x%3==0 and x%5==0 else False
...
# Write a function definition named area_of_circle that takes in a number representing a circle's radius and returns 
...
# Write a function definition named is_vowel that takes in value and returns True if the value is a, e, i, o, u 
...
# Exercise 44 Write a function definition named has_vowels that takes in value and returns True if the string contains any vowels.
...
def has_vowels(x):
    ...
    for each in x: 
        ...
        return True if (each in vowels) else False
...
def starts_and_ends_with_vowel(x):
    ...
    return True if (x.startswith(("a","e","i","o","u")) and x.endswith(("a","e","i","o","u"))) else False
...
# Write a function definition named first_to_last that takes in sequence and returns 

# the sequence with the first value moved to the end of the sequence.

def first_to_last(x):

    x = list(x)

    x.append(x.pop(x.index(x[0])))
...
def only_positive_evens(x):
    ...
    num = [i for i in x if i > 0 and i % 2 ==0]
...
def only_positive_odds(x):
    ...
    num = [i for i in x if i > 0 and i % 2 == 1]
...
# Write a function definition named get_unique_values that takes in a list and returns a set with only the unique values 
...
# Write a function definition named get_unique_values_from_two_lists that takes two lists and returns a single 
...
# Write a function definition named get_values_in_common that takes two lists and returns a single set 

# with the values that each list has in common
...
# Write a function definition named get_values_not_in_common that takes two lists and 

# returns a single set with the values that each list does not have in common
...
dict2={'name':'b','age':30,'gender':'female'}

list=[dict1,dict2]

def getGender(gen='male'):
...
def get_latest_paper(x,y):

    list = [x,y]

    val1 = x["year_published"]

    val2 = y["year_published"]
...
assert get_latest_paper(tukey_paper, thomas_paper) == {'title': 'A mathematical model of glutathione metabolism','author': 'Rachel Thomas','link': 'https://www.ncbi.nlm.nih.gov/pubmed/18442411','year_published': 2008}
...
assert get_author(book) == "Frances Buontempo"
...
# Write a function named total_of_book_prices that takes in a list of dictionaries and 
...
def highest_priced_book(x):

    newlist = sorted(x, key=lambda k: k['price']) 

    return newlist[-1]



assert highest_priced_book(books) == {
...
# Write a function named get_average_item_price that takes in the shopping 

# cart as an input and returns the average of all the item prices.

def get_average_item_price(x):

    y = x.get("items")

    total = sum([item["price"] for item in y])
...
def most_spent_on_item(x):
    ...
    maxp = max([item["price"] * item["quantity"] for item in y])



    for item in y:

        if maxp == (item["price"] * item["quantity"]):
