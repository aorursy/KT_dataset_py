...
pd.read_csv('/kaggle/input/jigsaw-multilingual-toxic-comment-classification/jigsaw-toxic-comment-train-processed-seqlen128.csv')
import os, time
...
BERT_GCS_PATH = KaggleDatasets().get_gcs_path('bert-multi')#"/kaggle/input/bert-multi"
...
#!gsutil -m cp -r dir gs://kaggle/working
...
#4/zQHBp-DNnoTOHFHBvCWaYZ9tkz2prsNrMuLxZYyj-c00MJ-qf33llnU'''
