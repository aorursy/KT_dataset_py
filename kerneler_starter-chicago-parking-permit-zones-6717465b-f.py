...
# parking-permit-zones.csv has 9289 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/parking-permit-zones.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'parking-permit-zones.csv'
nRow, nCol = df1.shape
