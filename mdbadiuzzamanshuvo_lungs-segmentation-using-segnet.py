...
from tensorflow.keras.layers import Input, Activation, BatchNormalization, Dropout, Lambda, Dense, Conv2D, Conv2DTranspose, UpSampling2D, MaxPooling2D, concatenate, Reshape
