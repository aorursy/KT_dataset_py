...
# Case 1:  with epochs -6, and lr = 0.01 , Epoch [5], train_loss: 0.2726, val_loss: 0.3188, val_score: 0.5167
# prediction has come to be 51.67 %
# num_epochs =6
# opt_func = torch.optim.Adam
# lr = 0.01
# lr = 1e-2

# Case 2 :  with epochs - 7, and lr = 0.001 got a prediction of 66.91%
# Epoch [6], train_loss: 0.2041, val_loss: 0.2208, val_score: 0.6691
...
submission_df.head()
sub_fname = 'resnet34.1_submission.csv'
