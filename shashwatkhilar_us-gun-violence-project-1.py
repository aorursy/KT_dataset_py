...
df = pd.read_csv('/kaggle/input/us-gun-violence/gun-violence-data_01-2013_03-2018.csv')
...
sns.lineplot(x = df.state, y = df.n_killed)
import seaborn as sns

sns.set(style="darkgrid", rc={'figure.figsize':(20,20)})

ax = sns.countplot(x="n_killed", data=df)
import seaborn as sns

sns.set(rc={'figure.figsize':(50,20)})

sns.scatterplot(x=df.state,y=df.n_killed)
df.info()
df.isnull().sum()
