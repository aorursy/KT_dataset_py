...
# athlete_events.csv has 271116 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/athlete_events.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# noc_regions.csv has 230 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/noc_regions.csv', delimiter=',', nrows = nRowsRead)
