...
movie_bias_embedded = keras.layers.Embedding(df.movieId.max()+1, 
                                             1, 
                                             input_length=1, 
                                             name='bias_movie')(movie_id_input)
movie_bias = keras.layers.Flatten()(movie_bias_embedded)
################################################################################
...
bias_layer = model_bias.get_layer("bias_movie")
