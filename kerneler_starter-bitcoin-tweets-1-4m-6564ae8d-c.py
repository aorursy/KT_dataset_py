...
# cleanprep.csv has 1413000 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/cleanprep.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'cleanprep.csv'
nRow, nCol = df1.shape
