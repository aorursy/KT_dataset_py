...
sns.distplot(df['date_fifth_death'])
print('skew',df['date_fifth_death'].skew())

print('kurtosis',df['date_fifth_death'].kurtosis())
...
y = df['date_fifth_death']

df = df.drop(['date_fifth_death'], axis=1)
