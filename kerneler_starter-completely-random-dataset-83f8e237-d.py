...
# test_data9.csv has 999 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/test_data9.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'test_data9.csv'
nRow, nCol = df1.shape
