...
print('Using bitstampUSD_1-min_data_2012-01-01_to_2018-01-08.csv...')
data = pd.read_csv('../input/bitstampUSD_1-min_data_2012-01-01_to_2018-01-08.csv', parse_dates=True, date_parser=dateparse, index_col=[0])
