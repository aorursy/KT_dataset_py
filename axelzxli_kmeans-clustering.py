...
def my_k_means(dataSet, k):
    ...
    while(True):
        ...
        for i in range(len(dataSet)):
            ...
            distance = euclDistance(dataSet[i], centroids[0])
        ...
        for i in range(k):
            ...
            for j in range(len(dataSet)):
                ...
                if clusterAssment[j][0]==i:
                    ...
                    sumofx += dataSet.item(j,0)

                    sumofy += dataSet.item(j,1)
            ...
            centroids_new.append((meanofx, meanofy))

            if (meanofx, meanofy)==(centroids[i][0],centroids[i][1]):
