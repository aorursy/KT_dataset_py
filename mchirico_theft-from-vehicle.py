...
sum('Theft from Vehicle' == text_general_code) as 'Theft from Vehicle'



from crime 

where text_general_code like 'Theft from Vehicle%'

and strftime('%m', dispatch_date_time) = '11'
...
def plotCat(cat='Theft from Vehicle',title=''):
...
plotCat(cat='Theft from Vehicle',title='Theft from Vehicle (November Months)\nPhiladelphia')