...
# Check Targeted Sect for inconsistancies

# get list of unique sects
sect = suicide_attacks['Targeted Sect if any'].unique()
sect
# convert to lowercase
suicide_attacks['Targeted Sect if any'] = suicide_attacks['Targeted Sect if any'].str.lower()
# get rid of leading/trailing whitespace
suicide_attacks['Targeted Sect if any'] = suicide_attacks['Targeted Sect if any'].str.strip()
