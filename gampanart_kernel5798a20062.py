...
mat = loadmat('../input/ex8data1/ex8data1.mat')
...
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat('../input/dataset2/ex8data2.mat')
...
mat3 = loadmat("../input/dataset2/ex8_movies.mat")
...
movieList = open("../input/dataset2/movie_ids.txt","r",encoding="ISO-8859-1").read().split("\n")[:-1]
