...
embedding_titles = Embedding(num_words + 1, 100, name='embedding_titles', mask_zero=False)(input_titles)

spatial_dropout = SpatialDropout1D(0.15, name='spatial_dropout')(embedding_titles) # changed from 0.2 sp.dropout
...
embedding_domain = Embedding(num_domains + 1, 40, name='embedding_titles', mask_zero=False)(input_domains)
