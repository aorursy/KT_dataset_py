...
nx.draw_circular(G, with_labels=True, node_color='blue', node_size=300, edge_color='red', linewidths=1, font_size=11)
...
venn2(subsets = (len(sepal_length)-20, len(sepal_width)-20, 20), set_labels = ('sepal_length', 'sepal_width'))
...
plt.pie(feature_size, labels = feature_names, colors = ["red","green","blue","yellow"] )
...
cg = sns.clustermap(df,row_colors=row_colors,figsize=(18, 18),metric="correlation")
