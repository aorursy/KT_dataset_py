...
cancer_b_data['Perimeter (mean)']
cancer_m_data.loc[cancer_m_data.index == 842517]
...
sns.kdeplot(data = cancer_b_data['Radius (worst)'], 
           ...
           label = 'Benign', 
            ...
            shade = True) # Your code here (benign tumors)

sns.kdeplot(data = cancer_m_data['Radius (worst)'], 

           label = 'Mlignant', 

            shade = True) # Your code here (malignant tumors)
