...
df1 = pd.read_csv('/kaggle/input/kfolds/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/kfolds/1/train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/kfolds/1/valid.csv', delimiter=',', nrows = nRowsRead)
