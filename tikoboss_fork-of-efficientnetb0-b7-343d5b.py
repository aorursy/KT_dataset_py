...
history0 = model5.fit(get_training_dataset(), steps_per_epoch=STEPS_PER_EPOCH, epochs=EPOCHS,validation_data=get_validation_dataset(),callbacks=[lr_schedule])

history3 = model6.fit(get_training_dataset(), steps_per_epoch=STEPS_PER_EPOCH, epochs=EPOCHS,validation_data=get_validation_dataset(),callbacks=[lr_schedule])

history7 = model7.fit(get_training_dataset(), steps_per_epoch=STEPS_PER_EPOCH, epochs=EPOCHS,validation_data=get_validation_dataset(),callbacks=[lr_schedule])
...
ensemble1 = (sub0['target'] + sub3['target'] + sub7['target'])/3

ensemble_img1 = sub7['image_name']
