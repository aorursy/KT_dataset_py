...
# Your code goes here
plot(x='brand',y='stars',data=data)
# Your code goes here
tally(data['country'],top=10,graph=True,percent=True)
# Your code goes here
query(data=data,column='brand',condition='=="Ve Wong"')
# Your code goes here
stars_sort=sort(data=data['stars'],how='descending')
index(stars_sort)[-12:]
#Your code goes here
stars_bigger3=query(data=data,column='stars',condition='>3')
goal=tabulate(stars_bigger3['country'],stars_bigger3['style'],method='count')
plot(x='country',y='count',colour='style',data=goal,style='lineplot')
