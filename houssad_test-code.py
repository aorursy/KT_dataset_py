...
def CE_loss(input_logits, target_targets, ignore_index=255, temperature=1):
    print((input_logits/temperature).dtype)
    target_targets=target_targets.double()
    print(target_targets.dtype)
    
    return F.binary_cross_entropy(input_logits / temperature, target_targets)
...
def main():
    ...
    unsupervised_loader=create_dataloader('unlabel',4)
