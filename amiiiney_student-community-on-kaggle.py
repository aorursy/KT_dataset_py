...
countries=st9.Q3.value_counts().reset_index()
...
fig.update_layout(
    ...
    title_text = '2019 Kaggle survey student respondents per country')
...
sns.countplot(c.Q1,order=c['Q1'].value_counts().index, palette='Paired')
...
sns.countplot(c.Q2, palette='Paired')

plt.title('GENDER', fontsize=15, weight='bold' )

plt.xticks( weight='bold', rotation=15)
...
m= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color='silver',edgecolor='black', height=0.7)

m[1].set_color('crimson')

m[1].set_edgecolor('black')
...
n= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color='silver',edgecolor='black', height=0.7)

n[0].set_color('crimson')

n[0].set_edgecolor('black')
...
n= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color='silver',edgecolor='black',)
...
m= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color='silver',edgecolor='black',)

m[0].set_color('crimson')

m[0].set_edgecolor('black')
...
mn= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color=sns.color_palette('Reds',len(title_cnt)),edgecolor='black',)
...
mn= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1],color=sns.color_palette('Blues',len(title_cnt)), edgecolor='black')
...
mn= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color=sns.color_palette('Greys',len(title_cnt)), edgecolor='black')

mn[0].set_color('crimson')

mn[0].set_edgecolor('black')

mn[1].set_color('lightskyblue')

mn[1].set_edgecolor('black')
...
n= ax.barh(title_cnt.iloc[:,0], title_cnt.iloc[:,1], color=sns.color_palette('Greys',len(title_cnt)),edgecolor='black')
