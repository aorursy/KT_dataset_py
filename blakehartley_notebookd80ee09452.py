...
v = 5      #---------------------------------------change the velocity to half the original velocity(10)------------------------------------------------
...
#---------------------------------------------------------------------sets values and sets time steps to 1000-------------------------------------
...
step = (end_time-start_time)/(time_steps-1)
time = np.linspace(start_time,end_time,time_steps)
time_1000 = np.linspace(start_time,end_time,time_steps)
...
numerical_radius_1000 = (position_x**2 + position_y**2)**(1/2)
numerical_error_1000 = numerical_radius_1000 - v




#---------------------------------------------------------------------sets values and sets time steps to 3000-------------------------------------
...
step = (end_time-start_time)/(time_steps-1)
time = np.linspace(start_time,end_time,time_steps)
time_3000 = np.linspace(start_time,end_time,time_steps)
...
numerical_radius_3000 = (position_x**2 + position_y**2)**(1/2)
numerical_error_3000 = numerical_radius_3000 - v




#---------------------------------------------------------------------sets values and sets time steps to 5000-------------------------------------
...
step = (end_time-start_time)/(time_steps-1)
time = np.linspace(start_time,end_time,time_steps)
time_5000 = np.linspace(start_time,end_time,time_steps)
...
numerical_radius_5000 = (position_x**2 + position_y**2)**(1/2)
numerical_error_5000 = numerical_radius_5000 - v




#---------------------------------------------------------------------sets values and sets time steps to 7000-------------------------------------
...
step = (end_time-start_time)/(time_steps-1)
time = np.linspace(start_time,end_time,time_steps)
time_7000 = np.linspace(start_time,end_time,time_steps)
...
numerical_radius_7000 = (position_x**2 + position_y**2)**(1/2)
numerical_error_7000 = numerical_radius_7000 - v
...
exact_line = 0*time_1000   #make a line for the analytical solution
...
plt.figure(7)
plt.plot(time_1000,exact_line,linewidth=3,label='analytical solution')
plt.plot(time_1000,numerical_error_1000,linewidth=3,label='1000 timesteps')
plt.plot(time_3000,numerical_error_3000,linewidth=3,label='3000 timesteps')
plt.plot(time_5000,numerical_error_5000,linewidth=3,label='5000 timesteps')
plt.plot(time_7000,numerical_error_7000,linewidth=3,label='7000 timesteps')
plt.legend()
plt.title(f"How numerical error increases over time for different timestep per rev values")
plt.xlabel(f"x time [s]") 
plt.ylabel(f"y numerical error [m]") 
plt.show()
...
difference_1000 = (position_x[1]**2 + position_y[1]**2)**(1/2) - v
...
difference_3000 = (position_x[1]**2 + position_y[1]**2)**(1/2) - v
...
difference_5000 = (position_x[1]**2 + position_y[1]**2)**(1/2) - v
...
difference_7000 = (position_x[1]**2 + position_y[1]**2)**(1/2) - v
...
plt.figure(8)
plt.plot([1000, 3000, 5000, 7000],[difference_1000, difference_3000, difference_5000, difference_7000])
plt.legend()
plt.title(f"How numerical error increases per step depending on different time steps per revolution")
plt.xlabel(f"x time steps per revolution") 
plt.ylabel(f"y numerical error per step[m]") 
plt.show()
