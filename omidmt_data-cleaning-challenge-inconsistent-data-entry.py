...
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip().str.lower()
...
fuzzywuzzy.process.extract('kurram agency', suicide_attacks['City'].unique(), limit=10)

replace_matches_in_column(df=suicide_attacks, column='City', string_to_match='kurram agency')
suicide_attacks['Location Sensitivity'].unique()
suicide_attacks['Target Type'].unique()
