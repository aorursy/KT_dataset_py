zabt = "Papers on Transmission and Incubation"

znam = "Papers_on_Transmission_and_Incubation"
zwds = "adaptation adhesion animal asymptomatic blood care change charge clinical community contagious control copper coronavirus decontamination diagnostics discharge disease distribution effectiveness environmental equipment fecal health history hydrophilic immune immunity implementation incubation infection matter models monitor movement nasal natural persistence phenotypic phobic plastic potential prevalence prevent prevention processed protective recovery reduce response risk seasonality secondary settings shedding sputum stability stainless status steel strategies substrates surfaces survival transmission urine usefulness viral virus"
import os
