...
print(os.listdir('../input/dc99623a-c-vista_data (1)'))
...
df1 = pd.read_csv('../input/dc99623a-c-vista_data (1)/sample.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/dc99623a-c-vista_data (1)/train.csv', delimiter=',', nrows = nRowsRead)
