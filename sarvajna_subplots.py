...
pokemon["Attack"].plot.hist(ax=axarr[0])

axarr[0].set_title("Pokemon Attack Ratings", fontsize=12)



pokemon["Defense"].plot.hist(ax=axarr[1])

axarr[1].set_title("Pokemon Defense Ratings", fontsize=12)