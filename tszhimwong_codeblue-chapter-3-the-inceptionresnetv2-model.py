...
#Adding dense layers into the pretrained InceptionResNetV2 model
...
val_seq = fold_seq[1] #Using the first fold as validation 
...
checkpt = ModelCheckpoint(monitor='val_loss',
                        ...
                        filepath = 'best_InceptionResNetV2_final.h5',
...
model = keras.models.load_model('best_InceptionResNetV2_final.h5', custom_objects={'focal_crossentropy': focal_loss})
...
print("Evaluation of model on val split 1:")
