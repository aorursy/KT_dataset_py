...
propstoplot.sort_values('Fatalities per Accident',ascending = False).head(50).plot(x = 'Operator'
...
typestoplot.sort_values('Fatalities per Accident',ascending = False).head(50).plot(x = 'Type'
...
typestoplot.sort_values('Fatalities per Accident',ascending = False).head(50).plot(x = 'Type'
                                                                                  ...
                                                                                  , grid = True)
# Create a new column that extracts the year from the date, then group by Year
