...
ramen_stars=tally(data['stars'])
plot(data=ramen_stars,x='stars', style='histogram')
# Your code goes here

plot(data=data, x='brand',y='stars',style='boxplot')
# Your code goes here
tally(data['country'],graph=True,top=10, percent=True)

# Your code goes here
query(data=data,column='brand',condition='=="Ve Wong"')
# Your code goes here
sorted_stars=data['stars']
tail(sort(sorted_stars, how='descending'),12)

#Your code goes here
stars_over3=query(data=data, column='stars', condition='>3')
new_data=tabulate(stars_over3['country'],stars_over3['style'],method='count')
plot(data=new_data, x='country', y='count', colour='style',style='lineplot')
