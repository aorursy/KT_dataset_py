...
# towed-vehicles.csv has 4794 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/towed-vehicles.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'towed-vehicles.csv'
nRow, nCol = df1.shape
