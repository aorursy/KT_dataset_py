...
n=0 #number of boy's names that are also in girl's names - question 4 
...
num_alexander = 0 #number of boys and girls named as alexander - question 7

for name in boys.keys():

    if name=="alexander":

        num_alexander = num_alexander+1
...
for index, name in enumerate(boys):
    ...
    if name.startswith("j"):
        ...
        namestartswithJ=namestartswithJ+1

print(namestartswithJ)