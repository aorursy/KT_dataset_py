...
# 213k-gaiadr2-sources-with-photometry.csv has 213109 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/213k-gaiadr2-sources-with-photometry.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = '213k-gaiadr2-sources-with-photometry.csv'
nRow, nCol = df1.shape
