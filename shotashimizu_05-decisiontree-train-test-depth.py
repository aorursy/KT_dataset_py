...
for i in depths:
    ...
    test_scores[i-1] = root_mean_squared_error(y_test, y_predicted)

results = pd.DataFrame([depths, train_scores, test_scores]).transpose()
results.columns = ['depth', 'train_score', 'test_score']
results
