...
combine.loc[(combine['Cabin']).isna(), 'Deck'] = 0
combine['Deck'].unique()
# Code deck values
combine.loc[(combine['Deck']) == "C", 'Deck'] = 1
combine.loc[(combine['Deck']) == "E", 'Deck'] = 2
combine.loc[(combine['Deck']) == "G", 'Deck'] = 3
combine.loc[(combine['Deck']) == "D", 'Deck'] = 4
combine.loc[(combine['Deck']) == "A", 'Deck'] = 5
combine.loc[(combine['Deck']) == "B", 'Deck'] = 6
combine.loc[(combine['Deck']) == "F", 'Deck'] = 7
combine.loc[(combine['Deck']) == "T", 'Deck'] = 8
combine.head(5)
...
# How many passengers are labeled as crew?
print((combine['isCrew'] == 1).count())
...
combine.loc['Age_cat'] = 0
combine.loc[(combine['Age'] <= 16), 'Age_cat'] = 0
combine.loc[(combine['Age'] > 16) & (combine['Age'] <= 21), 'Age_cat'] = 1
combine.loc[(combine['Age'] > 21) & (combine['Age'] <= 25), 'Age_cat'] = 2
combine.loc[(combine['Age'] > 25) & (combine['Age'] <= 28), 'Age_cat'] = 3
combine.loc[(combine['Age'] > 28) & (combine['Age'] <= 33), 'Age_cat'] = 4
combine.loc[(combine['Age'] > 33) & (combine['Age'] <= 34.78), 'Age_cat'] = 5
combine.loc[(combine['Age'] > 34.78) & (combine['Age'] <= 38), 'Age_cat'] = 6
combine.loc[(combine['Age'] > 38) & (combine['Age'] <= 47), 'Age_cat'] = 7
combine.loc[(combine['Age'] > 47), 'Age_cat'] = 8
...
# Replace all Fare categories with 0,1,2,3
combine['Fare_cat'] = 0
combine.loc[(combine['Fare'] <= 7.896), 'Fare_cat'] = 0
combine.loc[(combine['Fare'] > 7.896) & (combine['Fare'] <= 14.454), 'Fare_cat'] = 1
combine.loc[(combine['Fare'] > 14.454) & (combine['Fare'] <= 31.275), 'Fare_cat'] = 2
combine.loc[(combine['Fare'] > 31.275), 'Fare_cat'] = 3
...
combine = combine.drop(['hasCabin'], axis=1)
#combine = combine.drop(['isNoble'], axis=1)
combine = combine.drop(['isCrew'], axis=1)
...
actual_y.dtypes
# Random Forest
random_forest = RandomForestClassifier(bootstrap=False, n_estimators=200)
