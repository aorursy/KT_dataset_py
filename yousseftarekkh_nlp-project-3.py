...
def print_results(data_relevant,query):
    ...
    html_ranks = ""
    for i in range(0,5):
        html_ranks += "<h4 style='color: brown;'>Rank: "+str(i+1)+"</h4><h4>"+data_relevant.iloc[i]['title']+"</h4><span id='abstract"+str(i)+"'>"+data_relevant.iloc[i]['abstract'][:500]+ "...</span><a onclick='show_more("+str(i)+")'></a><br/>"
    ...
    html_show = "<html>"+html_scripts+"<head></head><body><h1 style='color:blue;'> Query: "+query+"</h1>"+html_ranks+"</body></html>"
