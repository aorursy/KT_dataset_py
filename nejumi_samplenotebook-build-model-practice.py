...
df_train = pd.read_csv('../input/homework-for-students3/train.csv', index_col=0, skiprows=lambda x: x%20!=0)
...
df_train = pd.read_csv('../input/homework-for-students3/train.csv', index_col=0, parse_dates=['issue_d'], skiprows=lambda x: x%20!=0)
