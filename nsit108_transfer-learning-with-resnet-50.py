...
from tensorflow.keras.layers import Conv2D, SeparableConv2D,  LeakyReLU, Activation
...
print('Step/Iterations in each epoch  = {}'.format(STEPS))
...
resNet50.compile(optimizer=optimizer, loss='categorical_crossentropy', metrics=Metrics)
resNet50.summary()
...
resNet50.save('resnet-50_model.h5')
scores = resNet50.evaluate_generator(test_generator)
print("\n%s: %.2f%%" % (resNet50.metrics_names[0], scores[0]*100))
print("\n%s: %.2f%%" % (resNet50.metrics_names[1], scores[1]*100))
print("\n%s: %.2f%%" % (resNet50.metrics_names[2], scores[2]*100))
print("\n%s: %.2f%%" % (resNet50.metrics_names[3], scores[3]*100))
print("\n%s: %.2f%%" % (resNet50.metrics_names[4], scores[4]*100))
from sklearn.metrics import accuracy_score, confusion_matrix
from mlxtend.plotting import plot_confusion_matrix
#preds = model.predict(test_data)

preds = resNet50.predict_generator(generator=test_generator) # get proba predictions
