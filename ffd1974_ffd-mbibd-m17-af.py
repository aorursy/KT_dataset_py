...
# Añadimos líneas para la distribucion de Poisson
...
##Histrograma de Skellman desde 8 goles a favor del visitante hasta 8 a favor del local
...
plt.show()
##Importación de las librerias necesarias  para crear el modelo de regresion
