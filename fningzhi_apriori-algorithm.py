        ...
        for i in range(len_Lksub1):
            ...
            for j in range(i+1, len_Lksub1):
                ...
                if l1[0:k-2] == l2[0:k-2]:
                    ...
                    while(True and m<k1-1): #只需验证到k1-2位即可，因为最后两位分别是l1、l2的最后一位，去除这两位的一定存在于Lksub1，即l1和l2
                    ...
                    if m==k1-1:#循环是到了规定位置自动退出而不是检测不到导致的break，那么可以添加到Ck
        ...
        for i in range(0, len(L)):
            ...
            for freq_set in L[i]:
                ...
                for sub_set in sub_set_list:
                    ...
                    if sub_set.issubset(freq_set):  #如果sub_set（单/多）存在于freq_set（多）中，则计算置信度
