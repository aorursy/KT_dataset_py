...
reduced_X_train = X_train.drop(features,axis=1)

reduced_X_valid = X_valid.drop(features,axis=1)
...
imputed_X_train = pd.DataFrame(imputer.fit_transform(X_train)) #Ajusta os dados apenas para os de treinamento!!!
...
X_valid = X_valid.drop(['LotFrontage','GarageYrBlt','MasVnrArea'],axis=1)
