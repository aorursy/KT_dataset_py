...
plt.show()
ex.scatter(data,x='Potential',y='Special')

ex.box(data,x='Potential',y='Wage',color='Preferred Foot')

ex.scatter(data,x='Special',y='Wage')
ex.scatter(data,x='Special',y='Potential')
ex.histogram(data,x='Overall',color='Preferred Foot')
