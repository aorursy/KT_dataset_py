...
# トレーニングデータとテストデータの使用するカラム分を合体させる
...
big_X_imputed
# モデルが読み込める形に変換する、下のセルがそうしている

big_X_imputed[0:train_df.shape[0]].values
big_X_imputed[train_df.shape[0]::].values
