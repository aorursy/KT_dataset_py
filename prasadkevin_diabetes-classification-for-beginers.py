...
# p.plot.scatter(x='sepal_length', y='sepal_width', title='Iris Dataset')
...
y_pred = knn.predict([[ 0.93691372, -0.25271997, -0.52985903, -0.01230129, -0.18154124,0.05018291, -0.64593181,  0.74529338]])

if y_pred == 1:

    print('you have diabaties')

else:

    print('you dont have diabaties')
