...
pdDataset['img_path'] = pdDataset['id'].apply(lambda x : f'/kaggle/input/super-ai-image-classification/train/train/images/{x}')
pdDataset.head()
...
for i, image_path in enumerate(tqdm(pdDataset['img_path'])):
#     print(image_path)
...
pdValidate[['id', 'category']].to_csv("val2.csv", index=False)
pdValidate = pdValidate.drop(['id_path'],axis=1)
pdValidate