...
class CIFAR10Model(ImageClassificationBase):
    ...
    def forward(self, xb):
        ...
        out = F.relu(out)         # rectified linear unit func
...
history
history += fit(59, 0.1, model, train_loader, val_loader) # accuracy really crashed after this point and val loss goes to NaN
...
t
arch = "3 layers (512, 1024, 10)"
lrs = [0.1, 0.01, 1e-2, 1e-3]
epochs = [59, 20, 25, 10]
test_acc = t['val_acc']
test_loss = t['val_loss']
