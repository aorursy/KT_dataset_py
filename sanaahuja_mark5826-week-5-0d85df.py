...
# ternary
clean(data)
falling = ternary (states, '=="Falling"', 3 ,0)
tally(falling)
# model
model = LinearModel(logistic = True)
model.fit(X, falling)
model.coefficients(plot = True)
# interpretion: It shows that eeg has the highest positive co-relation with falling, followed by circulation and time. 
#the highest negative co-relation is seen with sugar levels which could be untrue.
# good or bad?
