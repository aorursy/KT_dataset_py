...
def replace_matches_in_column(df, column, string_to_match, min_ratio = 90):
    ...
    rows_with_matches = df[column].isin(close_matches) #returns boolean values and row index
...
cities = suicide_attacks['City'].unique()
matches = fuzzywuzzy.process.extract('kuram agency', choices=cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
matches
replace_matches_in_column(suicide_attacks, column='City',string_to_match='kuram agency')
cities = suicide_attacks['City'].unique()
cities
