...
parsed = parser.from_file('/kaggle/working/2020.03.17.20037713v1.full.jpg') 
...
pdf = os.path.join(outputFolder,'2020.03.17.20037713v1.full.pdf[1]')

with Img(filename=pdf, resolution=300) as img:

    img.compression_quality = 99

    img.convert("RGBA").save(filename='/kaggle/working/2020.03.17.20037713v1.full.jpg') # intro page to preview later
# Look at intro page

pdf = os.path.join(outputFolder,'2020.03.17.20037713v1.full.pdf[4]')
...
pdfimage = Image.open('/kaggle/working/2020.03.17.20037713v1.full.jpg')
...
pdfimage4 = Image.open('/kaggle/working/2020.03.17.20037713v1.full.jpg')
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 1 of the 2020.03.17.20037713v1.full")