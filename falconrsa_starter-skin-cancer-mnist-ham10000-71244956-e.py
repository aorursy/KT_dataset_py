...
df1 = pd.read_csv('../input/HAM10000_metadata.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/hmnist_28_28_L.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/hmnist_28_28_RGB.csv', delimiter=',', nrows = nRowsRead)
