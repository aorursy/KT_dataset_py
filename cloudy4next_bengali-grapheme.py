...
for i in range(4):
    ...
    Y_train_root = label_binrizer.fit_transform(Y_train_root)

    Y_train_vowel = label_binrizer.fit_transform(Y_train_vowel)

    Y_train_consonant = label_binrizer.fit_transform( Y_train_consonant)
