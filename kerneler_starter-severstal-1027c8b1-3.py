...
df1 = pd.read_csv('/kaggle/input/severstal/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/severstal/train.csv', delimiter=',', nrows = nRowsRead)
