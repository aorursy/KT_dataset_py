...
print("The size of the dataframe is: ", suicide_attacks.shape)
# let's print the first 5 rows
suicide_attacks.head()
# let's print some info
suicide_attacks.info()
# Let's print some statistical information
# of the columns with numerical type
...
# let's convert the column to lowercase and remove the trailing white spaces
