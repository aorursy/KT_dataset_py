...
print ("media da mostra {}:".format(media_amostra))
...
print ("margem erro) {}:".format(numero_desvios*desvio_amostras))
...
print ("a media da população estará entre {} e {} confiança {}".format(inferior,superior,93))
