...
#Ta = Temperatura atmosfera

Tp = (Save * (1-alpha)/(1-0.5*emiss)/sigma) **0.25

print('Tp: ' + str(round(Tp, 3)) + '°K')



Ta = ((Tp**4 / 2) **0.25)

print('Ta: ' + str(round(Ta, 3)) + '°K')
print('Temperatura atmosfera  : ' + str(Ta- 273.15) + '°C')

print('Temperatura del pianeta: ' + str(Tp- 273.15) + '°C')
#creiamo un array di nome "emiss" di 101 valori di emissività che vanno da 0 a 1 (compresi)
...
#Calcoliamo le Temperature del pianeta al variare dell'emissività, immettendo i risultati in un nuovo array di nome "Tp_C" 

Tp_C=(Save*(1-alpha)/(1-0.5*emiss)/sigma)**0.25-273.15
Tp_C
#Creiamo un grafico nel quale in ascisse poniamo i 101 valori di emissività in percentuale, mentre in ordinate poniamo le Ta corrispondenti.
