...
# nyc_attend.csv has 599 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/nyc_attend.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'nyc_attend.csv'
nRow, nCol = df1.shape
