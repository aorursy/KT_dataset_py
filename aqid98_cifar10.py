...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        self.out_layer = nn.Linear(32, output_size)
...
history += fit(25, 2e-2, model, train_loader, val_loader)
history += fit(20, 3e-3, model, train_loader, val_loader)
history += fit(20, 0.001, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
evaluate(model, test_loader)
arch = "5 layers (128,256,64,32,10)"
lrs = [0.1,2e-2,3e-3,0.01]
epochs = [10,25,20,20]
test_acc = 0.5380859375
test_loss = 1.337328314781189
