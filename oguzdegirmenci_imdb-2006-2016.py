...
imdb = pd.read_csv("../input/imdb-data/IMDB-Movie-Data.csv") #Dataframe
imdb.head()
genresList = []
...
print(len(genresList)) #len -> length = eleman sayısı
...
print("IMDB LOVES " + resultGenre + " WITH AN AVERAGE OF " + str(round(resultRating,2)))