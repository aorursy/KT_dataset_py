...
# Removing The 500+ Rows Containing A Typo 5 Digit Sequences (All Other Rows Are Dates)
...
no_nan_df = df.drop(['datetime', 'seconds', 'state', 'city', 'minutes','country', 'shape','comments',
              'date added','month_name', 'added_region','sighting_time','sighting_date', 'mask'],axis=1)
