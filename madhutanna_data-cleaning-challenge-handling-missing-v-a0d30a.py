...
col_droped = sf_permits.dropna(axis=1)
col_droped.head()
print(sf_permits.shape[1])
print(col_droped.shape[1])
...
print(sf_permits.isna().sum().sum())
x=sf_permits.fillna(method='bfill',axis=0).fillna("0")
