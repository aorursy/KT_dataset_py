...
print(os.listdir('../input/CheXpert'))
...
df1 = pd.read_csv('../input/CheXpert/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/CheXpert/valid.csv', delimiter=',', nrows = nRowsRead)
