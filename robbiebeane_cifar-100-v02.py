...
cnn.add(Conv2D(32, (3,3), input_shape=(32,32,3), activation='relu', padding='same'))
cnn.add(Conv2D(32, (3,3), input_shape=(32,32,3), activation='relu', padding='same'))
...
h1 = cnn.fit(X_train_sc, y_train, batch_size=2048, epochs=40, verbose=1, validation_data=(X_valid_sc, y_valid))
...
valid_prob = cnn.predict_proba(X_valid)
