...
sf_permits.dropna()   # It removes all data
...
# just how much data did we lose?
print("Columns in original dataset: %d \n" % sf_permits.shape[1])   #43 coloumns
print("Columns with na's dropped: %d" % columns_sf_with_na_dropped.shape[1])  #12 coloumns
