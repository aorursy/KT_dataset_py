...
train_df = train_df[['Id', 'LotArea', 'SalePrice', 'TotalBsmtSF', 'GrLivArea','GarageCars', 'YearBuilt', 'YrSold', 'PoolArea', 'TotRmsAbvGrd', 'FullBath', 'HalfBath', 'KitchenAbvGr', 'BedroomAbvGr', 'GarageArea','BedroomAbvGr','BsmtFullBath','BsmtHalfBath', 'WoodDeckSF','OpenPorchSF','EnclosedPorch','3SsnPorch','ScreenPorch','LotFrontage','BsmtUnfSF','LowQualFinSF','BsmtFinSF1','BsmtFinSF2', 'MSZoning', 'BldgType', 'HouseStyle', 'Neighborhood', 'Condition1', 'Condition2', 'OverallQual', 'OverallCond', 'Street', 'LotConfig', 'ExterCond', 'BsmtCond', 'HeatingQC', 'KitchenQual', 'GarageCond', 'SaleType', 'SaleCondition']]
...
test_df = test_df[['Id', 'LotArea', 'TotalBsmtSF', 'GrLivArea','GarageCars', 'YearBuilt', 'YrSold', 'PoolArea', 'TotRmsAbvGrd', 'FullBath', 'HalfBath', 'KitchenAbvGr', 'BedroomAbvGr', 'GarageArea','BedroomAbvGr','BsmtFullBath','BsmtHalfBath', 'WoodDeckSF','OpenPorchSF','EnclosedPorch','3SsnPorch','ScreenPorch','LotFrontage','BsmtUnfSF','LowQualFinSF','BsmtFinSF1','BsmtFinSF2', 'MSZoning', 'BldgType', 'HouseStyle', 'Neighborhood', 'Condition1', 'Condition2', 'OverallQual', 'OverallCond', 'Street', 'LotConfig', 'ExterCond', 'BsmtCond', 'HeatingQC', 'KitchenQual','GarageCond', 'SaleType', 'SaleCondition']]
...
test_df.info()
test_df[['Id', 'Utilities']].groupby(['Utilities']).count()
...
firePlace_dummies_test = pd.get_dummies(test_df['FireplaceQu'])
...
test_df = test_df.join(firePlace_dummies_test)
...
submission.to_csv('HousePricePred_20170222_v1.csv', index=False)