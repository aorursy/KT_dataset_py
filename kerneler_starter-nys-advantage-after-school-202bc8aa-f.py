...
# advantage-after-school-program.csv has 177 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/advantage-after-school-program.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'advantage-after-school-program.csv'
nRow, nCol = df1.shape
