...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
# look at the # of missing points of Street Number Suffix and zipcode columns
...
dropped_columns_with_missing_info = sf_permits.dropna(axis = 1)
dropped_columns_with_missing_info.head()
# just how much data did we lose?
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % dropped_columns_with_missing_info.shape[1])
# number of rows 
print("Columns in original dataset: %d \n" % sf_permits.shape[0])
print("Columns with na's dropped: %d" % dropped_columns_with_missing_info.shape[0])
