...
def iteration(batch_size: int, epoch: int, unit: int) -> float:
    ...
    df = pd.read_csv('https://raw.githubusercontent.com/KunXie/CIS-Paper-dataset/master/BTC-USD.csv')
    ...
    model.add(SimpleRNN(units=unit, activation=activation_function, input_shape=(None, 1)))
