...
#the most accidents occured between the hours of 5PM-9PM

#output the file for future reference
accidents_by_hour.to_csv("accidents_by_hour.csv")

#registration_state_name and hit_and_run columns should be used
...
print(hitandruns_by_state)

hitandruns_by_state.to_csv("hitandruns_by_state.csv")