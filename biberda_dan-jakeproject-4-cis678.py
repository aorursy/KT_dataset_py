...
def NNBulk(array, lr, epochs, hiddenLayerRatio):
    ...
    for epoch in range(epochs):
        ...
        outWts += lr * outError*hidLayerNode #Out wts should be a 4X1

        

        hlBias += lr * outError #Should be 1 x 1

        

        hLWts += lr * hidError*Feats #should be 4X4

        

        inputBias += lr* hidError #should be 4X1
...
fishres = NNBulk(encode_fishdf,0.5,100,1)
