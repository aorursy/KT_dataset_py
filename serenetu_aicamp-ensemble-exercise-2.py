...
data.head()
data.drop([0], axis=0, inplace=True) # drop the 0 line
...
forest = LogisticRegression() #TODO
...
for col in NUMERICAL_COLS:
    ...
    scaler.fit(house_data[col].astype(np.float64).values.reshape(-1,1))
    scalers[col] = scaler
