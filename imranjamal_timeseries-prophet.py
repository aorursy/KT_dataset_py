...
sns.pairplot(trainData,hue="hour", palette="ch:r=-.5,l=.75",x_vars=['year'],y_vars='PJME_MW',height=12.5)
sns.pairplot(trainData,hue="hour", palette="ch:r=-.5,l=.75",x_vars=['month'],y_vars='PJME_MW',height=12.5)
