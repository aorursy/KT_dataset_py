...
model.add(layers.Conv2D(128, (3,3), activation='relu')) #not here
...
model.add(layers.MaxPooling2D(pool_size=(2,2), strides=2))   #added
...
# rotated_train_datagen = ImageDataGenerator(rescale=1./255, horizontal_flip=True,zoom_range=0.5)

# rotated_val_datagen = ImageDataGenerator(rescale=1./255,zoom_range=0.5)
...
checkpointer = ModelCheckpoint(filepath='small_last4.h5', verbose=1, save_best_only=True)
...
#       rotated_train_generator,

#       steps_per_epoch=rotated_train_generator.samples/train_generator.batch_size ,
