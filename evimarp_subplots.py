...
pokemon.head(3)
# Make vertical subplot
figure, axes = plt.subplots(2, 1, figsize=(8, 8))
horizontal_plot, horizontal_axes = plt.subplots(1, 2, figsize=(16,4))

figure, axes = plt.subplots(2, 1, figsize=(8, 8))
h1 = pokemon.Attack.hist(ax=axes[0])
h1.set_title("Pokemon Attack Ratings")
h1.set_ylabel("Frequency")
h1.grid()
h2 = pokemon.Defense.hist(ax=axes[1])
h2.set_title("Pokemon Defense Ratings")
