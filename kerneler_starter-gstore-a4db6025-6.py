...
df1 = pd.read_csv('../input/Google/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Google/train.csv', delimiter=',', nrows = nRowsRead)
