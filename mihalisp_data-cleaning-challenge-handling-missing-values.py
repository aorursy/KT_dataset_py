...
print("Rows in with na's dropped: %d \n" % drop_rows.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
drop_columns = sf_permits.dropna(axis=1)
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % drop_columns.shape[1])
...
filled_sf = sf_permits.fillna(method = 'bfill', axis=0).fillna("0")
print(filled_sf.head(10))