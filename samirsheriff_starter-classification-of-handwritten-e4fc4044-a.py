...
df1 = pd.read_csv('../input/letters.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/letters2.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/letters3.csv', delimiter=',', nrows = nRowsRead)
