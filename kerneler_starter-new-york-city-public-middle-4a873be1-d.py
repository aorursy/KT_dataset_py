...
# ms_directory_2018.csv has 484 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/ms_directory_2018.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'ms_directory_2018.csv'
nRow, nCol = df1.shape
