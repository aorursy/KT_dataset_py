...
Images, Labels = get_images('../input/almond-dataset-2/training/training/') #Extract the training images from the folders.
...
plot.legend(['Training', 'Validation'], loc='upper left')
plot.show()
test_images,test_labels = get_images('../input/almond-dataset-2/validation/validation/')
test_images = np.array(test_images)
test_labels = np.array(test_labels)
model.evaluate(test_images,test_labels, verbose=1)
pred_images,no_labels = get_images('../input/almond-dataset-2/testing/')
