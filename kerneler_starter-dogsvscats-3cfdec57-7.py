...
# submission_file.csv has 12500 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/submission_file.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'submission_file.csv'
nRow, nCol = df1.shape
