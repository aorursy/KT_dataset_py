...
print(os.listdir('../input/Flower_Recognition'))
...
df1 = pd.read_csv('../input/Flower_Recognition/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Flower_Recognition/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/Flower_Recognition/train.csv', delimiter=',', nrows = nRowsRead)
