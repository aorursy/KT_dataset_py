...
nRowsRead = 1000 # specify 'None' if want to read whole file
# googleplaystore2.csv has 3870 rows in reality, but we are only loading/previewing the first 1000 rows
df3 = pd.read_csv('../input/googleplaystore2.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'googleplaystore2.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
