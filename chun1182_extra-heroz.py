...
train = pd.read_csv("/kaggle/input/heroz-internal-competition-extra2/train.csv")

test = pd.read_csv("/kaggle/input/heroz-internal-competition-extra2/test_features.csv")

ans = pd.read_csv("/kaggle/input/heroz-internal-competition-extra2/sample_submission.csv")
