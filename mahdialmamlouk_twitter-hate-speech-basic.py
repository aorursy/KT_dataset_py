...
import pandas as pd 
train = pd.read_csv("../input/hate-speech-twitter-train-and-test/train_E6oV3lV.csv")

test = pd.read_csv("../input/hate-speech-twitter-train-and-test/test_tweets_anuFYb8.csv")
train.head()
import string
