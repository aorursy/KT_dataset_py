...
df1 = pd.read_csv('/kaggle/input/fold/fold/fold5/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/fold/fold/fold5/valid.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/fold/fold/fold4/train.csv', delimiter=',', nrows = nRowsRead)
