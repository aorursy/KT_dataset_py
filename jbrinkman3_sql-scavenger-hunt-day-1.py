...
# Query to select all distinct countries that use
# unit other than ppm to measure any type of pollution
...
# the query_to_pandas_safe will only return a result if it's less
# than one gigabyte (by default)
pollutants_valueZero = open_aq.query_to_pandas_safe(query)
#display query results
pollutants_valueZero