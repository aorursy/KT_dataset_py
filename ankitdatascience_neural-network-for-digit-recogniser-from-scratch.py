...
# Reading the kaggle dataset in our environment.
data = pd.read_csv("/kaggle/input/digit-recognizer/train.csv")
data.shape
# Writing this command to see which column is the target column.
data.head()
X = scale(data.drop('label', axis = 1).values)
...
net.SGD(training_data, 30, 10, 0.5, evaluation_data = validation_data, monitor_evaluation_accuracy=True)
