...
query2 = """SELECT registration_state_name, COUNT(hit_and_run)
        ...
        """
hit_and_run_vehicles = accidents.query_to_pandas_safe(query2)
print(hit_and_run_vehicles)
import seaborn as sns
f, ax = plt.subplots(figsize=(6, 15))
sns.set_style("whitegrid") 
ax = sns.barplot(x="f0_", y="registration_state_name", data=hit_and_run_vehicles,palette='coolwarm')
