...
columns_with_na_dropped.head()#isnull().sum()
...
print(sf_permits_columns_with_na_dropped.head())#isnull().sum()
print('-------------')
print('-------------')
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
...
# Your turn! Try replacing all the NaN's in the sf_permit data with the one that comes directly after it and then 
