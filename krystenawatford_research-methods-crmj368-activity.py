...
lVar=['race', 'age', 'class_', 'gunlaw', 'fear', 'income', 'courts']
...
plt.title('Histogram of age') # Replace VAR_LABEL with the label of your variable
...
plt.hist(dfGSS['class_']) # Replace VAR with the name of a numeric variable.
plt.xlabel('class_') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of age') # Replace VAR_LABEL with the label of your variable
...
plt.xlabel('class_') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of class_') # Replace VAR_LABEL with the label of your variable
plt.hist(dfGSS['income']) # Replace VAR with the name of a numeric variable.
plt.xlabel('income') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of income') # Replace VAR_LABEL with the label of your variable
...
my_variable = 'gunlaw' # Replace VAR with the name of a categorical variable.
