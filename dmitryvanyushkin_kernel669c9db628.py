...
model.fit(inputMatrix, outputMatrix, epochs=10, batch_size=100)
...
#dataSetModifiedPredict = pd.get_dummies(data = dataSetDroppedPredict,columns = ['Usage'],dtype = int)
