...
mat = loadmat('../input/mydataset/ex8data1.mat')
...
plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[0])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[1])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[2])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[3])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[4])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[5])

plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[6])
...
plt.show()
mat2 = loadmat('../input/mydataset/ex8data1.mat')
...
mat3 = loadmat("../input/dataset3/ex8_movies.mat")

mat4 = loadmat("../input/dataset2/ex8_movieParams.mat")
...
movieList = open("../input/movieids/movie_ids.txt","r", encoding="ISO-8859-1").read().split("\n")[:-1]
