...
model = tree.DecisionTreeClassifier(criterion='entropy', max_depth=3, min_samples_leaf=7)
...
model2 = tree.DecisionTreeClassifier(criterion='entropy', max_depth=4, min_samples_leaf=7)
model2.fit(trainX, trainY)
measure_performance(testX, testY, model2)
