...
total_missingval = missing_val.sum()
Missing_percent =  (total_missingval/total_cells)*100
Missing_percent
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
coloums_with_missingvalues_dropped = sf_permits.dropna(axis=1)
coloums_with_missingvalues_dropped.shape
...
subset_sf_permits = sf_permits.loc[:,'Permit Type':'Street Suffix'].head()
