...
def solve_it(input_data):
    ...
    # for example, get all points in cluster 1
    ...
    plt.scatter(data.loc[:,0], data.loc[:,1], c=kmeans.labels_.astype(float))

    plt.scatter(centroids[:,0], centroids[:,1], c='b')

    

    # A partir de aquí tendrían que ver como modificar el código para tener en cuenta los clusters
