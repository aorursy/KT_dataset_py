...
pokemon.plot.scatter(x='Sp. Atk', y='Sp. Def')
pokemon.plot.scatter(x='Total', y='HP')
pokemon.plot.scatter(x='Sp. Def', y='Defense')
pokemon.plot.hexbin(x='Attack', y='Defense', gridsize=20)
pokemon.plot.hexbin(x='Total', y='HP', gridsize=20)
pokemon.plot.hexbin(x='Sp. Def', y='Defense', gridsize=20)
pokemon_stats_legendary = pokemon.groupby(['Legendary', 'Generation']).mean()[['Attack', 'Defense']]
pokemon_stats_legendary.plot.bar(stacked=True)
pokemon_stats_legendary = pokemon.groupby(['Type 1']).mean()[['Sp. Atk', 'Speed']]
pokemon_stats_legendary.plot.bar(stacked=True)
pokemon_stats_by_generation = pokemon.groupby('Generation').mean()[['HP', 'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed']]
pokemon_stats_by_generation.plot.line()
pokemon_stats_by_generation = pokemon.groupby('Legendary').mean()[['HP', 'Attack', 'Defense', 'Sp. Atk', 'Sp. Def', 'Speed']]
pokemon_stats_by_generation.plot.line()
