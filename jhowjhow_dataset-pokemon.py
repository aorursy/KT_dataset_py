...
DATA_DIR='../input/pokemon/Pokemon'
os.listdir('../input/pokemon/Pokemon')
...
learn1 = cnn_learner(data, models.alexnet, metrics=accuracy, model_dir="/tmp/model/")

learn2 = cnn_learner(data, models.densenet201, metrics=accuracy, model_dir="/tmp/model/")
