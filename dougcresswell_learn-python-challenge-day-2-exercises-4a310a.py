...
def to_smash(total_candies, friends=3):
    ...
    parameters:
        total_candies: an integer dividend
        friends: an optional integer divisor
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    #args = [arg1, arg2, arg3]
    #return max(args, key=lambda arg: fn(arg))
...
smallest_stringy_number('1', '2', '3')
# return smallest string, in lexicographic order not numeric order
smallest_stringy_number('19', '92', '3')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
