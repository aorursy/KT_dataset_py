...
query = ("""
        -- define a repo as pyhton repo if it contains a .py file
...
commit_count_of_python_repos = github.query_to_pandas_safe(query, max_gb_scanned=10)
commit_count_of_python_repos.head()
