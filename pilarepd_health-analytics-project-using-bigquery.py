...
test = """SELECT provider_id, facility_name,total_stays, average_length_of_stays_days

FROM `bigquery-public-data.cms_medicare.nursing_facilities_2014`;"""

response1 = medicare.query_to_pandas_safe(test)
...
test = """SELECT provider_id, facility_name,distinct_beneficiaries_per_provider, white_beneficiaries, dual_beneficiaries
...
mean_score1 =  (np.mean(X[X['cluster'] == 0]['average_hcc_score']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['average_hcc_score']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['average_hcc_score']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['average_hcc_score']))
...
mean_score1 =  (np.mean(X[X['cluster'] == 0]['average_length_of_stays_days']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['average_length_of_stays_days']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['average_length_of_stays_days']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['average_length_of_stays_days']))





mean_score1 =  (np.mean(X[X['cluster'] == 0]['distinct_beneficiaries_per_provider']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['distinct_beneficiaries_per_provider']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['distinct_beneficiaries_per_provider']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['distinct_beneficiaries_per_provider']))
...
mean_score1 =  (np.mean(X[X['cluster'] == 0]['white_beneficiaries']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['white_beneficiaries']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['white_beneficiaries']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['white_beneficiaries']))



mean_score1 =  (np.mean(X[X['cluster'] == 0]['black_beneficiaries']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['black_beneficiaries']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['black_beneficiaries']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['black_beneficiaries']))



mean_score1 =  (np.mean(X[X['cluster'] == 0]['total_stays']))

mean_score2 = (np.mean(X[X['cluster'] == 1]['total_stays']))

mean_score3 = (np.mean(X[X['cluster'] == 2]['total_stays']))

mean_score4 = (np.mean(X[X['cluster'] == 3]['total_stays']))



print(mean_score1 , mean_score2, mean_score3, mean_score4)
