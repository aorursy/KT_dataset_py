...
# liquor-authority-quarterly-list-of-active-licenses.csv has 48599 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/liquor-authority-quarterly-list-of-active-licenses.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'liquor-authority-quarterly-list-of-active-licenses.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# liquor-authority-quarterly-list-of-active-permits.csv has 4028 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/liquor-authority-quarterly-list-of-active-permits.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'liquor-authority-quarterly-list-of-active-permits.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
