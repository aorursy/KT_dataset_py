...
def prettify_graph(graph):
    ...
    graph.set_title("Results of 500 slot machine pulls")
    # Complete steps 2 and 3 here
    # Configuration for the y values to start from 0
    graph.set_ylim(ymin=0)
    # Labelling the y axis as Balance
    graph.set_ylabel('Balance')
    # Obtain the y values in an array
    ticks = graph.get_yticks()
    #Loop through the above array and format the values with $ symbol
    new_labels = ['${}'.format(int(amt)) for amt in ticks]
    # Set the y axis with the formatted values
