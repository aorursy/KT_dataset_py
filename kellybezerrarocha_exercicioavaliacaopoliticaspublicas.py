...
numero_desvios = calcula_numero_desvios_tstudent_para_confianca(0.93, 100)

print("número de desvios {}:".format(0.93, 100))
...
print ("desvio amostras {}:".format (desvio_amostra/np.sqrt(tamanho_amostra)))
...
print ("margem de erro {}:".format (numero_desvios*desvio_amostras))
...
print ("A média da população estará entre {} e {} com confiança {}".format (inferior,superior,0.93))
...
numero_desvios = calcula_numero_desvios_tstudent_para_confianca(0.80, 1000)

print("número de desvios {}:".format(0.80, 1000))
...
print ("A média da população estará entre {} e {} com confiança {}".format (inferior,superior,0.80))
...
numero_desvios = calcula_numero_desvios_tstudent_para_confianca(0.99, 100)

print("número de desvios {}:".format(0.99, 100))
...
print ("A média da população estará entre {} e {} com confiança {}".format (inferior,superior,0.99))
