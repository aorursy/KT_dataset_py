...
bos.shape
bos.head()
#Removing CHAS as it is a categorical var wito 0 or 1. So z score of all the 1's will be greater thqan 3 sigmas away from mean [As no. of zeros are a lot more than no. of 1's]

z_scores = stats.zscore(bos[['CRIM', 'ZN', 'INDUS', 'NOX', 'RM', 'AGE', 'DIS', 'RAD', 'TAX', 'PTRATIO', 'B', 'LSTAT', 'Price']])
