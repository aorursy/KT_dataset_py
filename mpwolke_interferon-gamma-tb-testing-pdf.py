...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcToCUTD2I5lj4H9e-AClxBLMTg0cqF2xOe2qT1xnUAzSa27gli7&usqp=CAU',width=400,height=400)
...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/ifngamma3.jpg') # intro page to preview later
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 3 of IFG_Gamma")
...
pdfimage3 = Image.open('/kaggle/working/ifngamma3.jpg')
# PDF to JPG for p2
...
pdfimage8 = Image.open('/kaggle/working/ifngamma8.jpg')
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRdze0IVZATkOD1BN7lxDIL0PwoyuqNZ1irbs-3JCStbd4FPxbn&usqp=CAU',width=400,height=400)