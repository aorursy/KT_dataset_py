...
%matplotlib inline
df=pd.read_csv('../input/covid-19-indiacsv/covid_19_india_v1.1.csv')
...
ax.set(ylabel="States/UT",xlabel="Cured")

sns.despine(left=True, bottom=True)
fig=go.Figure()

fig.add_trace(go.Scatter(x=df['Date'], y=df['Total Active'], mode='lines+markers',name ='Total Active'))
