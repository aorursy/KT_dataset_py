...
final_list = ['Brand', 'Screen to Body Ratio (calculated)','Processor_frequency','Internal Memory']

wt_matrix = perceptron.fit(np.array(x_train_bin[final_list]),y_train,1000,0.1)

y_test_pred = perceptron.predict(np.array(x_test_bin[final_list]))

accuracy_test = accuracy_score(y_test_pred,y_test)

print(accuracy_test)
y_test_pred_final = perceptron.predict(np.array(x_test_final_bin[final_list]))
