...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        self.linear4=nn.Linear(500, 320)
        self.linear5=nn.Linear(320,80)
        self.linear6=nn.Linear(80, 10)
...
history
history += fit(40, 0.1, model, train_loader, val_loader)
...
#arch=summary(model,(3, 32*32))
arch= '6 layers ( 2000,1000,500,320,80,10)'
arch
lrs = [0.1,0.3,0.6]
epochs = [40,15,20]
test_acc = 0.5162109136581421
test_loss = 1.7809616327285767
