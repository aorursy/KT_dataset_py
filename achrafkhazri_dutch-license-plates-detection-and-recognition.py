...
plt.show()
step2 = cv2.imread('./temp/2_closing_morphology.png')
plt.axis("off")
plt.imshow(cv2.cvtColor(step2, cv2.COLOR_BGR2RGB))
plt.show()
step3 = cv2.imread('./temp/3_detected_plate.png')
plt.axis("off")
plt.imshow(cv2.cvtColor(step3, cv2.COLOR_BGR2RGB))
plt.show()
step4 = cv2.imread('./temp/4_Brigthness_contrast_adjustment.png')
plt.axis("off")
plt.imshow(cv2.cvtColor(step4, cv2.COLOR_BGR2RGB))
plt.show()
step5 = cv2.imread('./temp/5_gray.png')
plt.axis("off")
plt.imshow(cv2.cvtColor(step5, cv2.COLOR_BGR2RGB))
plt.show()
step5 = cv2.imread('./temp/6_threshold.png')
plt.axis("off")
plt.imshow(cv2.cvtColor(step5, cv2.COLOR_BGR2RGB))
plt.show()