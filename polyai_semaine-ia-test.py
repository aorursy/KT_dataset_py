...
import pandas as pd # pour le traitement de données CSV (e.g. pd.read_csv)
...
train_data=pd.read_csv("/kaggle/input/datasetcompet/data_train.csv") #Importer les données d'entrainement
train_data.head() 
test_data=pd.read_csv("/kaggle/input/datasetcompet/data_test.csv")
...
output.to_csv('my_submissionFab.csv',index=False)
