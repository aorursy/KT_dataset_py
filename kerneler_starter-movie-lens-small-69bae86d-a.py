...
df1 = pd.read_csv('/kaggle/input/ml-latest-small/links.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/ml-latest-small/ratings.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/ml-latest-small/movies.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'movies.csv'
