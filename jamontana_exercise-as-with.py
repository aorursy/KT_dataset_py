...
q_1.check()
#q_1.solution()
table_to_check=client.get_table(dataset_ref.table(table_name))

client.list_rows(table_to_check,max_results=5).to_dataframe()
q_2.solution()
# Your code goes here
...
rides_per_year_query_job =client.query(things_to_query, job_config=safe_config)# Your code goes here
