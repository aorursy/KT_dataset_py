...
sns.heatmap(df_train.isnull(), cbar=False, cmap="rocket")

plt.show()
fig, ax = plt.subplots(figsize=(9,5))

sns.heatmap(df_test.isnull(), cbar=False, cmap="rocket_r")
...
g = sns.FacetGrid(df_train, row='Sex', col='Pclass', hue='Survived', margin_titles=True, height=3, aspect=1.4)
