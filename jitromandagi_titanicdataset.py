...
# 4. COUNT SURVIVED AND DECEASED IN DATASET
...
# 5. COUNT GENDER VS SURVIVAL IN DATASET
...
# 7. COUNT PCLASS VS GENDER IN DATASET
...
# 8. COUNT PCLASS VS SURVIVAL IN DATASET
