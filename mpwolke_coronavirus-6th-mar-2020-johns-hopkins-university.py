...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSgrx_cFtvNYLR0xCTk8vKpQf0nk3iIkKLZrMnOG6KGpLisTk5k',width=400,height=400)
...
df.tail().style.background_gradient(cmap='PRGn')
df.corr()
...
#plt.show()
sns.pairplot(df, x_vars=['3/6/20'], y_vars='1/22/20', markers="+", height=4)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQJLCck6UZbovbF89JePoooZP3cZGhjTtdN3ca2vDpFCt9HJt2b',width=400,height=400)