...
train_data.groupby("category").count()["text"].plot(kind="bar");
train_data.groupby("category").count()["text"]
...
history= model.fit(X_train, y_train, batch_size=1000, epochs=3, verbose=1, validation_data=(X_val, y_val),
