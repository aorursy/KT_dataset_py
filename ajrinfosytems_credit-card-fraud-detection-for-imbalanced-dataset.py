...
data.head()
# Getting the Scaled amount and time to the 1st and 2nd columns for easier understanding
...
# Checking if both the train and test labels are distributed similarly
...
# Considering the complete dataframe
