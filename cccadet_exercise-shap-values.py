...
sample_data_for_prediction1 = val_X.iloc[1].astype(float)
sample_data_for_prediction2 = val_X.iloc[2].astype(float)
...
patient_risk_factors(my_model,sample_data_for_prediction1)
patient_risk_factors(my_model,sample_data_for_prediction2)
q_5.hint()
#q_5.solution()