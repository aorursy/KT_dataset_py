...
# film-permits.csv has 50943 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/film-permits.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'film-permits.csv'
nRow, nCol = df1.shape
