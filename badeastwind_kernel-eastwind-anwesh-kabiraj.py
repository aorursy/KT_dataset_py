...
plt.xlabel('Days after 22nd JAN--2020', size=30)
...
plt.bar(adjusted_dates, world_daily_increase, color='red')
...
plt.plot(adjusted_dates, np.log10(world_cases), color='red')

plt.title('Log of # of Covid-19 Cases Over Time', size=30)
...
plt.bar(adjusted_dates, us_daily_increase, color='red')
...
plt.bar(adjusted_dates, spain_daily_increase, color='red')
...
plt.bar(adjusted_dates, china_daily_increase, color='red')
...
plt.bar(adjusted_dates, france_daily_increase, color='red')
...
plt.title('Recovery Rate of Covid-19s Over Time', size=30)
...
plt.title('Number of Covid-19 Deaths vs. # of Covid-19 Recoveries', size=30)
...
plt.title('Number of Covid-19 Confirmed Cases', size=20)
...
plt.barh(visual_unique_countries, visual_confirmed_cases, color='red')
...
plt.barh(visual_unique_countries, log_country_confirmed_cases, color='red')

plt.title('Log of Common Log # of Covid-19 Confirmed Cases in Countries/Regions', size=20)
...
plt.barh(visual_unique_provinces, visual_confirmed_cases2, color='red')

plt.title('Numbeer of Covid-19 Confirmed Cases in Provinces/States', size=20)
...
plt.barh(visual_unique_provinces, log_province_confirmed_cases, color='red')

plt.title('Log of Number of Covid-19 Confirmed Cases in Provinces/States', size=20)
