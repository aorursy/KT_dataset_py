...
#  really thought this would work - return [num for num in range(0, len(list)) if num % 2 == 0]
...
def only_positive_odds(list):
    ...
    return [num for num in list if num > 0 and num % 2 == 1]
...
def total_of_book_prices(books):
    ...
    total_price = books[0]['price'] + books[1]['price'] + books[2]['price'] + books[3]['price']
...
def get_average_spent_per_item(shopping_cart):
    ...
    item_avg = items_total_price / items_count
