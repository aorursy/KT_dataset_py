...
model.unfreeze()
%%time
history += fit_one_cycle(epochs, 0.0005, model, train_dl, val_dl, 
                         grad_clip=grad_clip, 
                         weight_decay=weight_decay, 
                         opt_func=opt_func)
%%time
history += fit_one_cycle(2, 0.0001, model, train_dl, val_dl, 
                         grad_clip=grad_clip, 
                         weight_decay=weight_decay, 
                         opt_func=opt_func)
%%time
history += fit_one_cycle(2, 0.0003, model, train_dl, val_dl, 
                         grad_clip=grad_clip, 
                         weight_decay=weight_decay, 
                         opt_func=opt_func)
train_time='39:08' #27:50  & 11:28
