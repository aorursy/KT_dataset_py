...
ax0.hist(cereal['sugars'], num_bins, alpha=0.7, label=["sugars"],
...
ax1.hist(cereal['sodium'], num_bins, alpha=0.7, label=["sodium"],
...
ax2.hist(cereal['protein'], num_bins, alpha=0.7, label=["protein"],
...
ax3.hist(cereal['fat'], num_bins, alpha=0.7, label=["fat"], 

        edgecolor = 'black')

ax3.set_title("Gram of fat")
...
print("Mean of the suger content of hot cereal is {:.3f} and mean for the suger content of cold cereal is {:.3f}".format(Suger_hot.mean(), Suger_cold.mean()))
