...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_suffix = missing_values_count_sf_permits['Street Number Suffix']
missing_values_zipcode= missing_values_count_sf_permits['Zipcode']

print((missing_values_suffix/sf_permits.shape[0])* 100)

print((missing_values_zipcode/sf_permits.shape[0])*100)
...
#Removing all the missing values rows deletes entire dataframe
