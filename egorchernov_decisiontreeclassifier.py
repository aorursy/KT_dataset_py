...
#указать максимальную глибину дерева (используется для переопределения дерева решений)
...
#вывести построенную модель дерева решений в текстовом виде
