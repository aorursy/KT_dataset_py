...
df1 = pd.read_csv('/kaggle/input/Forest_Cover_participants_Data/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Forest_Cover_participants_Data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Forest_Cover_participants_Data/test.csv', delimiter=',', nrows = nRowsRead)
