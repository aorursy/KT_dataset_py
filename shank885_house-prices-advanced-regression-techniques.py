...
print("The testing data data size after dropping Id feature is : {} ".format(test.shape))
...
# plot correlation heatmap to see how target variable is correlated with SalePrice
...
all_data["Alley"] = all_data["Fence"].fillna("None")
