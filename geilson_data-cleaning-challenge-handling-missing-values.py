...
# look at the # of missing points in the first ten columns
missing_values_count_sf_permits[:10]
...
# percent of data that is missing
'{:.2%}'.format(total_missing_sf_permits/total_cells_sf_permits)
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print(f"Columns with na's dropped: {columns_with_na_dropped_sf_permits.shape[1]}")
