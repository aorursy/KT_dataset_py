...
#Implemented and Tested by Tampa Keo
...
# Change the graph colour; for example rainbow, deep, muted, pastel, bright, dark, or colorblind.
...
ax.set_xlim(0,20)
M_patch = mpatches.Patch(color='#0fc5d4',label='Male')
...
F_patch = mpatches.Patch(color='blue', label='Female')
ax.legend(handles=[F_patch, M_patch])
# Alcohol Consumption and School Performance
