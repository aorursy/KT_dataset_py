...
cem = train_model(train_encoded, valid_encoded)
# Check your answer (Run this code cell to receive credit!)
...
q_4.solution()
tem = train_model(train_encoded, valid_encoded)
# Check your answer (Run this code cell to receive credit!)
...
q_6.solution()
cbem = train_model(train_encoded, valid_encoded)
