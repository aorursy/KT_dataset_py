...
# train.csv dosyasını nasıl okuruz.
...
train.head()
# test.csv dosyasını nasıl okuruz.
...
# train sette kaç farklı sınıf ve bu sınıfa ait veri var görüntüleyelim.
...
# optimizer tanımlıyoruz...

optimizer = Adam(lr=0.001, beta_1=0.9, beta_2=0.999)
# Compile the model

model.compile(optimizer = optimizer , loss = "categorical_crossentropy", metrics=["accuracy"])
epochs = 20  # en iyi değer için arttırmalısınız...
...
# Eğitim ve doğrulama için kayıp ve doğruluk eğrilerini çizin
