...
pi = 314.159
round(pi)
print(round(pi, 2), round(pi, 0), round(pi,-2))
q2.solution()
def to_smash(total_candies, n_firends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between several friends.
    
    The number of friends can be assigned through parameter `friends`, defaults is 3
    
    >>> to_smash(91)
    1
    """
    return total_candies % n_firends
