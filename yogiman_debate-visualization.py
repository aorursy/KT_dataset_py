...
def plot_line(candidate, color):

    markerline, stemlines, baseline = plt.stem(debate[debate.Speaker == candidate].Line, 

                   debate[debate.Speaker == candidate].Length,

                   markerfmt=' ', label= candidate)
