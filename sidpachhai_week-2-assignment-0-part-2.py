...
edf = pd.read_pickle("../input/ai-c4-0/assignment_0/assignment_0/edf.pkl")

pic = backread("../input/ai-c4-0/assignment_0/assignment_0/connect4.png")

red = backread("../input/ai-c4-0/assignment_0/assignment_0/red.png")

yellow = backread("../input/ai-c4-0/assignment_0/assignment_0/yellow.png")

white = backread("../input/ai-c4-0/assignment_0/assignment_0/white.png")

Data = pd.read_csv("../input/ai-c4-0/assignment_0/assignment_0/Examples.csv")
...
test_data = pd.read_csv("../input/ai-c4-0/assignment_0/assignment_0/AssignmentData.csv")

test = pd.read_csv("../input/ai-c4-0/assignment_0/assignment_0/TestFile.csv")
def classifier(B):
...
This code shows you how to submit your final csv file for the assignment.
...
for i in test_data.file_names:
    ...
    test.at[id_,'state'] = int(np.random.choice([1,2,3,4,5,6]))#classifier(board)
