...
q2.solution()
def to_smash(total_candies, friend_num=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between some friends. The number of friends 
    should be passed in as an argument. Default number of friends is 3.
    ...
    3
    """
    return total_candies % friend_num
