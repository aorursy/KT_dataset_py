...
classif = ICPR(frames_per_video=FRAMES_PER_VIDEO, consecutive_frames=True)
...
p = Pipeline(classif, seg, expl, segmentationDim="3D", explanationMode="frame",
...
dfdc_vidlist = VideoLoader.loadFilenamesDFDC(
    ...
    fakeClassValue=classif.FAKE_CLASS_VAL,

    realClassValue=classif.REAL_CLASS_VAL)[1:]
...
dfdc_vidlist = VideoLoader.loadFilenamesDFDC(
    ...
    realClassValue=classif.REAL_CLASS_VAL)
