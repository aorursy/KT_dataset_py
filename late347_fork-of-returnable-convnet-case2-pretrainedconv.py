...
trainableConvLayers = 6 # variable probably not used anymore?!
...
base_model = VGG19(weights='imagenet', include_top=False, input_shape=(100,100,3)) #imports the VGG19 model and discards the last 1000 neuron layer.
...
model_name = strftime('Case2-%Y-%m-%d-%H%M%S_VGG19_returnableModel.h5', localtime())
