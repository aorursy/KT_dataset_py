...
# double-check that the dtype is correct!) 12/28/2016
...
month_of_month_landslides = landslides['date_parsed'].dt.month
# remove na's
...
# Date is messy, therefore pd.to_datetime not working
import re
import numpy as np
