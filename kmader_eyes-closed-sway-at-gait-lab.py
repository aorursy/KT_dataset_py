...
synced_df = pd.read_csv('../input/2_FEET_CLOSED_01_example.csv')
...
for c_ax, var_name in zip(m_axs, [
    ...
    'ML1_OMEGA_'
     ...
     ['FORCE_ACCEL.A{}'.format(i) for i in [26]]):
...
for c_format_tag in ['ML1_BELTPACK_ACCEL_{}', 'ML1_ACCEL_{}', 'FORCE_ACCEL.A6{}']:
