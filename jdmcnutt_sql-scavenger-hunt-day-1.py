...
# query to select all the pollutants where the value is exactly '0'
...
#now get the unique pollutants that have a value of exactly zero
pollutants_zero_value.pollutant.unique()