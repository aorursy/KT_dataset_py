...
pred_y = kmeans.predict(PCA_components[['pc1', 'pc2']])
...
part_station_info_c_list[49].head(10)
part_station_info_c_list[62].head(10)
part_station_info_c_list[91].head(10)
part_station_info_c_list[73].head(10)