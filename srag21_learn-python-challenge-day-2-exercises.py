...
def to_smash(total_candies, num_of_friends=3):
    ...
    the given number of candies(total_candies) evenly between the friends(num_of_friends in number).
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    pass
    return(max(time_call(fn, arg1), time_call(arg2), time_call(arg3)))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
