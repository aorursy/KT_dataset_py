...
df2 = pd.read_csv('/kaggle/input/train/customer_demographics.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'customer_demographics.csv'
...
df3 = pd.read_csv('/kaggle/input/train/item_data.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'item_data.csv'
