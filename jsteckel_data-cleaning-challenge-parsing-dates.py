...
#a ValueError occured, so need some other formatting

#to find the different formatted rows:
...
#from comments on the original kernel use:
...
#from Gopi Ramena's forked kernel
