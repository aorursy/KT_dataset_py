...
train_data = np.load("/kaggle/input/2020-mpcs53111-hw5-fashionmnist/{}_train.npy".format(dataset_prefix))

test_data = np.load("/kaggle/input/2020-mpcs53111-hw5-fashionmnist/{}_test.npy".format(dataset_prefix))
