...
[print(" {}   vs  {} ".format(x[0],x[1])) for x in zip(y_rf[:10],y_test.values[:10])]
plt.figure(figsize=(10,20))
...
model.add(Dense(256, activation='relu')) # premiere couche

model.add(Dense(64, activation='relu')) # deuxieme couche
