...
print(os.listdir('../input/sample_submission_usrypcc'))

print(os.listdir('../input/test_XEV14AD'))

print(os.listdir('../input/train_3PIRKSI'))
...
df1 = pd.read_csv('../input/sample_submission_usrypCc/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/test_XEV14AD/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/train_3PIRKSI/train.csv', delimiter=',', nrows = nRowsRead)
