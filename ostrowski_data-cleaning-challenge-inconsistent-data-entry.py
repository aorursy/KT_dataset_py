...
# It's a np.array, so .sort() is used not pd.sort_values()
# Why it does not print automatically?
province.sort()
province
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
...
# Further optimization of this is adding .str.lower() and .str.strip() inside the main function
for string in ['kuram agency', 'kurram agency']:
    replace_matches_in_column(df=suicide_attacks, column='City', string_to_match=string)
