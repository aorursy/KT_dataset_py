...
#adding OHed cols back to numerical ones
...
#check if low cardinality cols are in test dataframe

#print(set(low_cardinality_cols).issubset(X_test.columns))   #now one can proceed to OH encoding



#OH encoding of test data
...
#print(X_test[low_cardinality_cols].isnull().sum())    #now one can OH encode



OH_cols_test = pd.DataFrame(OH.transform(X_test[low_cardinality_cols]))
...
#add one-hot encoded columns to numerical ones
