...
bigquery_experts_query = """
                ...
                SELECT answers.owner_user_id as user_id,count(answers.id) as number_of_answers
...
#q_5.solution()
def experts_topic(topic,client):
    ...
    bigquery_experts_query = """
                    ...
                    WHERE questions.tags LIKE '%"""+topic+"""%'
    ...
    return bigquery_experts_results.head()
#q_6.solution()