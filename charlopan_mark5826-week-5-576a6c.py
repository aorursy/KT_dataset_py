...
tally(falling)
# model
model_falling = LinearModel(logistic = True)
model_falling.fit(X, falling)
model_falling.coefficients(plot = True)
# good or bad?
model_falling.plot(model_falling.predict(X), falling)
model_falling.score(model_falling.predict(X), falling)
