...
model_lasso = LassoCV(alphas = [1, 0.0004366, 0.01, 0.005,0.0005] , max_iter=50000).fit(X_train, y)
...
model_xgb = xgb.XGBRegressor(n_estimators=550, max_depth=2, learning_rate=0.1) #the params were tuned using xgb.cv
...
outs = [lasso_preds, ridge_preds, xgb_preds,svm_preds]
...
final = 0.40*lasso_preds + 0.25*ridge_preds + 0.35*xgb_preds
