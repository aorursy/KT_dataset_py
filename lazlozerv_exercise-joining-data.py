...
### Or much more simpler as shown in the solution
...
#### I need to mention that 10^10 bytes are not enough, even though query is correct

#### that's why I put 10^11 bytes
