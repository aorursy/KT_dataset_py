...
df_4.head()
df_5 = df_4.drop(['TransactionStartTime','time'],axis = 1)

df_5.info()
X = df_5.drop(['FraudResult'], axis = 1)
...
tree = DecisionTreeClassifier(max_depth=4, random_state=19) # создали экземпляр класса
...
#precison(tochnost) = TP/(TP+FP) = 1.0

#recall = TP/(TP+FN) = 51/64
