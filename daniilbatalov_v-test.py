...
print("KNN Accuracy: "+repr(round(clf.score(x_test, y_test) * 100, 2)) + "%")
result_knn=cross_val_score(clf,x_train,y_train,cv=10,scoring='accuracy')
...
# Результат после загрузки предсказания на сайт. 
print('Score: 0.62679')