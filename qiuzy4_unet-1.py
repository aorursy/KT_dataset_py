...
def mixedLoss(y_true,y_pred):
    ...
    return loss
def weighted_bce_loss(y_true, y_pred,weight=100.0):
...
seg_model.compile(optimizer=Adam(1e-2, decay=1e-6), loss=weighted_bce_loss, metrics=[IoU, zero_IoU, 'binary_accuracy'])
