...
from tensorflow.keras.applications import Xception #change here if you want to change the network
...
#Choose if you want to perform k-fold crossvalidation
...
def predict(models, crossvalidate = False):
