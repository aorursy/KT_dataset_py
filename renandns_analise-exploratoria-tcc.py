...
telhado = pd.read_csv('../input/tratamento-datasets-tcc/telhado_verde.csv', delimiter=',', decimal='.')
...
clima = pd.read_csv('../input/tratamento-datasets-tcc/clima.csv', delimiter=',', decimal='.')
...
media_clima
media_clima_hora = clima[['hora','radiacao_solar_valor', 'temperatura_ar_vmedio']].groupby(['hora']).mean().reset_index()

media_clima_hora.dropna(inplace=True)
...
x5 = telhado_clima['Delta_1_2']

ax = sns.distplot(x5, bins = 10)
sns.set()

x5 = telhado_clima['Delta_3_4']

ax = sns.distplot(x5, bins = 10)
sns.set()

x5 = telhado_clima['Delta_5_6']
...
plt.tight_layout()
telhado_clima = pd.read_csv('../input/tratamento-datasets-tcc/telhado_clima.csv', delimiter=',', decimal='.')
...
media_clima3
#corr_clima = telhado_clima[['Delta_1_2', 'Delta_3_4', 'Delta_5_6','deficit_vapor_vmedio','ponto_orvalho_vmedio', 'radiacao_solar_valor','temperatura_ar_vmedio', 'umidade_ar_vmedio',]]

corr_clima = telhado_clima
