...
print("labels", number_of_apps_in_category.index,)

print("values", number_of_apps_in_category.values)



plotly.offline.iplot(data, filename='active_category')
df_s = df.sort_values(['Installs'],ascending=False)

category_downloads = []

for category in df_s['Category'].unique():

    df_c = df_s[df_s['Category'] == category]

    downloads = df_c["Installs"].sum()

    category_downloads.append((category, downloads))

    

category_downloads.sort(reverse=True, key=lambda x:x[1])
...
data = [go.Pie(
        ...
        labels = [d[0] for d in category_downloads],

        values = [d[1] for d in category_downloads],
...
print(df_s[df_s['Category']=="GAME"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Communication: ")

print(df_s[df_s['Category']=="COMMUNICATION"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Tools: ")

print(df_s[df_s['Category']=="TOOLS"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Productivity: ")

print(df_s[df_s['Category']=="PRODUCTIVITY"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Social: ")

print(df_s[df_s['Category']=="SOCIAL"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Overall: ")

print(df_s[['Installs','Rating', 'Reviews', 'Price', 'App']].head(10))


df_p = df_s[df_s['Price'] != 0]

category_downloads = []

for category in df_p['Category'].unique():

    df_c = df_p[df_p['Category'] == category]
...
plotly.offline.iplot(data, filename='active_category')
# Most downloaded paid apps by category



print("Game: ")

print(df_p[df_p['Category']=="GAME"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Family: ")

print(df_p[df_p['Category']=="FAMILY"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Personalization: ")

print(df_p[df_p['Category']=="PERSONALIZATION"][['Installs','Rating', 'Reviews', 'Price', 'App']].head(10).to_string(index=False))

print("Overall: ")

print(df_p[['Installs','Rating', 'Reviews', 'Price', 'App']].head(10))
