...
train = pd.read_csv('../input/newdataset/TrainData.csv', sep=';')
test = pd.read_csv('../input/newdataset/TestData.csv', sep=';')


sample = pd.read_csv('../input/jigsaw-unintended-bias-in-toxicity-classification/sample_submission.csv')
small = train[:1]
valid = train[-10000:]
small.to_csv('small.csv', index=False,sep=';')
...
test_data = TabularDataset(
            path="../input/newdataset/TestData.csv",
            format='csv',
            skip_header=True,
