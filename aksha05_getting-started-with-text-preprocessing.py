...
def remove_punctuation(text) : 
    ...
    return text.translate(str.maketrans('', '', PUNCT_TO_REMOVE))   # str1 : Specifies the list of characters that need to be replaced.
...
cnt.most_common(10)        
#get list of frequent words to remove them from array 
