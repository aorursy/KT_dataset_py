...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/ethics.jpg') # intro page to preview later
# Parse a PDF file and convert it to CSV using PyTesseract

import pytesseract

pdfimage = Image.open('/kaggle/working/ethics.jpg')
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 8 of Ethics of Vaccinations")
...
parsed = parser.from_file('/kaggle/working/ethics.jpg') 
...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/ethics.jpg')

pdfimage8 = Image.open('/kaggle/working/ethics.jpg')
# PDF to JPG for p4

pdf = os.path.join(outputFolder,'ethics.pdf[4]')
...
pdfimage4 = Image.open('/kaggle/working/ethics.jpg')



# PDF to JPG for p9

pdf = os.path.join(outputFolder,'ethics.pdf[9]')
...
pdfimage9 = Image.open('/kaggle/working/ethics.jpg')
# Parse a PDF file and convert it to CSV using PyTesseract (p8)
...
parsed2 = parser.from_file('/kaggle/working/ethics.jpg')
...
#Explore page 4 - Mueller Report. Here I don't know how many pages each Cheat Sheet. There are 30 pages 

w, h = pdfimage8.size # crop image

pdfimage8.crop((0, 1240, w, h-1300)) # display exerpt of PDF
# Convert PDF to JPG and then convert JPG to CSV
...
pdfimage9.crop((0, 1240, w, h-1300)) # display exerpt of PDF
# Pages 1, 2, and 3 

dfcombined.head() # preview csv of 2-3
