...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_count_sf_permits[0:20]
...
print("sf_permits columns in original dataset: %d \n" % sf_permits.shape[1])
print("sf_permits columns with na's dropped: %d" % columns_with_na_dropped_sf_permits.shape[1])
...
# Yasu: I tried only replacing "Street Number Suffix" and "Zipcode"
subset_sf_permits = sf_permits.loc[:,["Street Number Suffix","Zipcode"]]
subset_sf_permits.sample(10)
# Replace all NA's with 0
