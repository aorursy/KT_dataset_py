...
rows_with_na_dropped1 = sf_permits.dropna()
print("Rows in original dataset: %d \n" % sf_permits.shape[0])
print("Rows with na's dropped: %d" % rows_with_na_dropped1.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
columns_with_na_dropped1 = sf_permits.dropna(axis=1)
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % columns_with_na_dropped1.shape[1])
...
# subset_sf_permits  # uncomment to inspect
