...
train_path = '../input/airport-dataset-v2/AirportDataset/_上轮档/train'

test_path = '../input/airport-dataset-v2/AirportDataset/_上轮档/test'
...
optimizer = torch.optim.Adam(params, lr=0.0005, betas=(0.9, 0.999), eps=1e-08, weight_decay=0.0005, amsgrad=False)
