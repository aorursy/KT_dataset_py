...
valid_dir = '../input/blue-label-cat/blue_label_cat/valid/'

train_dir = '../input/blue-label-cat/blue_label_cat/train/'
...
def roc_auc(y,prob):
    ...
    plt.show()
model = load_model('../input/blue-label-model-0725-3/blue_label_model_0725_3.h5')
