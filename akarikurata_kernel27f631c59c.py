...
plt.lengend(loc = "upper right" , title = "Survived ~ Sibsp")
...
#Build a logreg and compte the feature importances
...
train_standard
test_coppied = testing.copy()

test_std = train_standard.transform(test_coppied[['Age' , 'Fare']])
