...
print(round(3434, -2),
      ...
      round(-23, -1),
     sep='\n')
def to_smash(total_candies, friends_quantity=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between friends_quantity friends (default 3).
    
    >>> to_smash(91, 4)
    3
    """
    return total_candies % friends_quantity
