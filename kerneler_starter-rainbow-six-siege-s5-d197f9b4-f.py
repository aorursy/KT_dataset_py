...
print(os.listdir('../input/datadump_s5'))
...
df1 = pd.read_csv('../input/datadump_s5/datadump_s5-000.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/datadump_s5/datadump_s5-001.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/datadump_s5/datadump_s5-002.csv', delimiter=',', nrows = nRowsRead)
