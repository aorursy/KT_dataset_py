...
sorted(zip(X_train.columns.values, rfecv.ranking_), key=itemgetter(1))
plt.figure()
...
sorted((zip(X_test.columns.values, pipe.named_steps['clf'].feature_importances_)), key=itemgetter(1))
