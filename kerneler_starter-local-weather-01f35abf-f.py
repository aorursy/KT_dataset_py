...
# portimao_hist_meteoclean.csv has 1176 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/portimao_hist_meteoclean.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'portimao_hist_meteoclean.csv'
nRow, nCol = df1.shape
