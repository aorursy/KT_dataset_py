...
print(sf_missing_value_count[10:20])
# check the percentage of the value that are missing
...
# lets check out the data for which 'Street Number Suffix' is not null.
sf_permits[sf_permits['Street Number Suffix'].notnull()]
sf_permits[sf_permits['Street Number Suffix'].isnull()]
# lets check out the data for which 'Zipcode' is not null.
sf_permits[sf_permits['Zipcode'].notnull()]
