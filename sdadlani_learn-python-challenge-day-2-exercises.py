...
q1.solution()
q2.solution()
def to_smash(total_candies, frndCount = 3):
    ...
    return total_candies % frndCount
...
print('round to 2= ',round_to_two_places(9.9999) )
x = -10
y = 5
# # Which of the two variables above has the smallest absolute value?
smallest_abs = min(abs(x), abs(y))
print('smallest = ', smallest_abs)
def f(x):
    y = abs(x)
    return y
...
def time_call(fn, arg):
    ...
    """
    t1 = round(time(),2)
    # print(t1, "seconds since the Epoch")
    fn(arg)
    t2 = round(time(),2)
    # print(t2, "seconds since the Epoch")
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    first = time_call(fn, arg1)
    second = time_call(fn, arg2)
    third = time_call(fn, arg3)
