...
# note that max_gb_scanned is set to 21, rather than 1
transactions_on_2017 = bitcoin_blockchain.query_to_pandas_safe(year_query, max_gb_scanned=21)
transactions_on_2017
# plotting library is already imported
#import matplotlib.pyplot as plt

# plot daily bitcoin transactions
plt.plot(transactions_on_2017.TX_COUNT)
...
# note that max_gb_scanned is set to 21, rather than 1
merkel_tx = bitcoin_blockchain.query_to_pandas_safe(merkle_query, max_gb_scanned=37)
merkel_tx
# plotting library is already imported
#import matplotlib.pyplot as plt

# plot transactions associated with Merkle
plt.plot(merkel_tx.TX_COUNT)
