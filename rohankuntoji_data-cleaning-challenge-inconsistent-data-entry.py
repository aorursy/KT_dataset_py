...
# take a look at them
matches
# get the top 10 closest matches to "balochistan"
matches_2 = fuzzywuzzy.process.extract("balochistan", provinces, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
