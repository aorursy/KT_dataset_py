...
df1 = pd.read_csv('/kaggle/input/gc/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/gc/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/gc/test.csv', delimiter=',', nrows = nRowsRead)
