...
average=add/len(acc_list)

print(average)
#prediction

#choose one from the test_index 



testX=X[1423].reshape(1,64)
...
print(predY)
#convert the prediction to Y target using argmax()

print("prediction :",predY.argmax())

print("true value: ", Y[1423])