...
file = "/kaggle/input/house-prices-advanced-regression-techniques/data_description.txt"
...
sns.countplot(np.log(train['SalePrice']))
#歪度と尖度を計算
...
SalePrice = clf.feature_importances_
