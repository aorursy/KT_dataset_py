...
open_aq.list_tables()# print all the tables in this dataset (there's only one!)
# query to select all the countries from the "country" column where the "unit" column isn't "ppm"
...
# query to select pollutants having a value of exactly 0
