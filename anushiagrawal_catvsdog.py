...
test_image = image.load_img('../input/prediction-set/cat.jpg')
test_image
test_image = image.load_img('../input/prediction-set/cat.jpg', target_size = (64, 64))
...
print(prediction)
test_image2 = image.load_img('../input/predictionset/dog2.jpg')
test_image2
test_image2 = image.load_img('../input/predictionset/dog2.jpg', target_size = (64, 64))
