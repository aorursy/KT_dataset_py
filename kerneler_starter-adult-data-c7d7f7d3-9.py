...
df1 = pd.read_csv('../input/adult-data.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/adult-test.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'adult-test.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
