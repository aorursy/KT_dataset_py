...
sns.distplot(original_goal_data,ax=ax[0],rug=True,hist=False)

ax[0].set_title("Original Data")

sns.distplot(scaled_goal_data, ax=ax[1],rug=True,hist=False)
