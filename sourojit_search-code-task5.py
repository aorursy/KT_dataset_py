...
q1=['surge capacity and nursing homes',

'allocation of scarce resources',

'personal protective equipment',

'alternative methods to advise on disease management',

'concerning processes of care',

'clinical characterization and management of the virus',

'develop a core clinical outcome set',
...
'mortality data for Acute Respiratory Distress Syndrome (ARDS)',

'Extracorporeal membrane oxygenation (ECMO) outcomes',

'Outcome after mechanical ventilation adjusted for age',
...
'natural history of disease to inform clinical care',

'natural history of disease to inform transmission',

'natural history of disease to inform clinical trials',

'natural history of disease to inform infection prevention control',

'workforce protection, workforce allocation',

'community-based support resource',

'supply chain management to enhance capacity',

'Use of AI in real-time health care delivery',

'home remedies for virus',

'things to do at home for sick people',

'Best telemedicine practices',

'telemedicine remove/expand them  state boundaries',

'encouraging  production of elastomeric respirators',

'manage N95 masks production',

'Application of regulatory standards',

'extrapulmonary manifestations of COVID-19',

'possible cardiomyopathy and cardiac arrest'

]
s1=[ 'What has been published concerning surge capacity and nursing homes?',
...
q2=[ 'What is surge capacity and nursing homes?',

'Allocation of scarce resources?',

'What are personal protective equipment?',

'What are alternative methods to advise on disease management?',

'What are concerning processes of care?',

'What is clinical characterization and management of the virus?',

'Develop a core clinical outcome set?',

'Oral medications that might potentially work?',

'What are resources to support skilled nursing facilities?',

'What are resources to support long term care facilities?',

'Mobilization of surge medical staff?',

'What is Age-adjusted mortality data for Acute Respiratory Distress Syndrome (ARDS)?',

'What is mortality data for Acute Respiratory Distress Syndrome (ARDS)?',

'What are extracorporeal membrane oxygenation (ECMO) outcomes?',

'What is outcome after mechanical ventilation adjusted for age?',

'What are adjunctive and supportive interventions?',

'What are effect of steroids?',

'What are effect of high flow oxygen?',

'What is natural history of disease to inform clinical care?',

'What is natural history of disease to inform transmission?',

'What is natural history of disease to inform clinical trials?',

'What is natural history of disease to inform infection prevention control?',

'workforce protection, workforce allocation?',

'What is community-based support resource?',

'Supply chain management to enhance capacity?',

'How much AI is being in real-time health care delivery?',

'What are home remedies?',

'What are things to do at home for sick people?',

'What are best telemedicine practices?',

'Telemedicine remove/expand them  state boundaries?',

'Encouraging  production of elastomeric respirators?',

'Save N95 masks production?',

'What are application of regulatory standards?',

'What are extrapulmonary manifestations of COVID-19?',
...
new_frame.to_csv("task5_results.csv",index=False)