...
df1 = pd.read_csv('../input/cwurData.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/education_expenditure_supplementary_data.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/educational_attainment_supplementary_data.csv', delimiter=',', nrows = nRowsRead)
