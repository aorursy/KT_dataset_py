...
# 311-service-requests-abandoned-vehicles.csv has 201028 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-alley-lights-out.csv has 208740 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-garbage-carts.csv has 386358 rows in reality, but we are only loading/previewing the first 100 rows
