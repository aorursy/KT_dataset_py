...
# Load data
lowa_train = pd.read_csv('../input/house-prices-advanced-regression-techniques/train.csv')
lowa_test = pd.read_csv('../input/house-prices-advanced-regression-techniques/test.csv')
lowa_train.head()
lowa_train.describe()
lowa_test.head()
lowa_test.describe()
lowa_target = lowa_train.SalePrice
lowa_predictors = lowa_train.drop(['SalePrice'], axis=1)
