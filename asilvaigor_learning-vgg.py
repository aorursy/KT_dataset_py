...
def make_features(cfg, batch_norm=False):
    ...
    for l in cfg:
        ...
        if l == 'M':
            ...
            conv2d = nn.Conv2d(last_size, l, 3, padding=1)
...
def vgg11(num_classes, pretrained=False, **kwargs):
    ...
    model = VGG(make_features(cfg['A'], batch_norm=True), **kwargs)
...
net = vgg11(num_classes=10, pretrained=False)
...
transnet = vgg11(num_classes=10, pretrained=True)
