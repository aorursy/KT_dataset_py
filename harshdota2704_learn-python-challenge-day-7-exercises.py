...
def prettify_graph(graph):
    ...
    label = ['${}'.format(int(amt)) for amt in ticks]
    graph.set_yticklabels(label)
...
def my_agent(wheel):
    ...
    while wheel.num_remaining_spins() > 0:
        ...
        last = wheel.spin(number_to_bet_on = guess)
