...
print('\nThe number of diseased:',data.loc[data.target == 1, 'target'].count())

X_train,X_test,y_train,y_test=train_test_split(dt,data[['target']],test_size=0.33\
...
ab = AdaBoostClassifier(base_estimator=DecisionTreeClassifier(max_depth=120),n_estimators=600)
