...
data.isnull().sum() # to check any Nulls in the data set - # Step 4
#Fetch features of type Object  # Step 5 
...
X_train.info() # 5686 rows - 70%

X_test.info()  # 2438 rows - 30%
...
#Predicting Y value  # Step 8

y_predicted_values = clf.predict(X_test)
y_predicted_values
# % Percentage of prediction accruracy
