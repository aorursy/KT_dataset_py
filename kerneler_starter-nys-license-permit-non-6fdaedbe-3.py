...
# driver-license-permit-and-non-driver-identification-cards-issued-as-of-august-30-2017.csv has 15903561 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/driver-license-permit-and-non-driver-identification-cards-issued-as-of-august-30-2017.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'driver-license-permit-and-non-driver-identification-cards-issued-as-of-august-30-2017.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# driver-license-permit-and-non-driver-identification-cards-issued-by-county-age-and-gender-2011-2015.csv has 426281 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/driver-license-permit-and-non-driver-identification-cards-issued-by-county-age-and-gender-2011-2015.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'driver-license-permit-and-non-driver-identification-cards-issued-by-county-age-and-gender-2011-2015.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
