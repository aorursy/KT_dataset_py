...
missing_values_count_sf_filled = sf_permits_filled.isnull().sum()
total_cells_sf_filled = np.product(sf_permits_filled.shape)
total_missing_sf_filled = missing_values_count_sf_filled.sum()

(total_missing_sf_filled/total_cells_sf_filled)*100
