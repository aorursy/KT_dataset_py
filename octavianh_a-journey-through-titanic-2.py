...
#titanic_df['Title'] = titanic_df['Name'].apply(lambda s: s[s.find(',')+2:s.find('.')])
...
#sns.barplot(x='Title', data=titanic_df)

#sns.countplot(x='Title', data=titanic_df)

#g1 = sns.countplot(x='Survived',hue='Title',data=titanic_df)

#g2 = sns.factorplot('Title',data=titanic_df,kind='count')

#g2.set_xticklabels(rotation=90)

g3 = sns.factorplot(x='Title',y='Age',data=titanic_df)

g3.set_xticklabels(rotation=90)
title_dummies_titanic  = pd.get_dummies(titanic_df['Title'])

title_dummies_titanic.drop(['Other'], axis=1, inplace=True)



title_dummies_test  = pd.get_dummies(test_df['Title'])

title_dummies_test.drop(['Other'], axis=1, inplace=True)
