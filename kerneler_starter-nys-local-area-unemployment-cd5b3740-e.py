...
# local-area-unemployment-statistics-beginning-1976.csv has 74832 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/local-area-unemployment-statistics-beginning-1976.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'local-area-unemployment-statistics-beginning-1976.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# local-area-unemployment-statistics-laus-seasonally-adjusted-data-beginning-1976.csv has 1530 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/local-area-unemployment-statistics-laus-seasonally-adjusted-data-beginning-1976.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'local-area-unemployment-statistics-laus-seasonally-adjusted-data-beginning-1976.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
