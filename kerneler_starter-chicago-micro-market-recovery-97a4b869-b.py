...
nRowsRead = 100 # specify 'None' if want to read whole file
# micro-market-recovery-program-cases.csv has 21403 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# micro-market-recovery-program-permits.csv has 37682 rows in reality, but we are only loading/previewing the first 100 rows
