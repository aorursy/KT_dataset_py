...
plt.plot(store_level_final['date'][0:49], store_level_final['CA_1'][0:49],color='red')
plt.xticks(rotation=45)
plt.plot(store_level_final['weekday'][0:7], store_level_final['CA_1'][0:7],color='blue')
plt.xticks(rotation=45)
...
def test_stationarity(timeseries):
    ...
    orig = plt.plot(timeseries[0:100], color='green',label='Original')
    mean = plt.plot(rolmean[0:100], color='blue', label='Rolling Mean')
    std = plt.plot(rolstd[0:100], color='red', label = 'Rolling Std')
    plt.legend(loc='best')
...
plt.plot(train[1800:1880], label = 'Train',color='green')
...
plt.plot(train2[100:200], label = 'Train',color='green')
plt.legend(loc = "upper left")
plt.plot(results2.predict(start = 380, end = 411), label = 'Predicted')
plt.plot(test2, label = 'Test',color='green')
plt.legend(loc = "upper left")
