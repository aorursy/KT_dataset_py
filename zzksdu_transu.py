    ...
    for step in range(config.total_step):
        ...
        if (step+1) % config.sample_step == 0:
           ...
           # im.save('/output-{}.png'.format(step+1))
            ...
            torchvision.utils.save_image(img, '../working/output-{}.png'.format(step+1))
...
parser.add_argument('--content', type=str, default='../input/c2.jpg')

parser.add_argument('--style', type=str, default='../input/s2.jpg')
...
tran1 = '../working/output-4000.png'

tran1Img = mpimg.imread(tran1)



tran2 = '../working/output-6000.png'

tran2Img = mpimg.imread(tran2)



tran3 = '../working/output-8000.png'

tran3Img = mpimg.imread(tran3)



tran4 = '../working/output-10000.png'
