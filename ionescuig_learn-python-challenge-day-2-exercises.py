...
#q1.solution()
q2.solution()
def to_smash(total_candies, split=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between a certain number of friends (default is 3).
...
print(slowest_call(sleep, 2, 1, 3))
#q6.hint()
q6.solution()
print(print("Spam"))
#q7.hint()
