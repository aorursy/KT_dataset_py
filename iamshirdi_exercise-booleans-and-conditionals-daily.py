...
def wants_plain_hotdog(ketchup, mustard, onion):
    ...
    return not (ketchup or mustard or onion) #we dont want any toppings so no toppings should be true
...
def exactly_one_sauce(ketchup, mustard, onion):
    ...
    return (ketchup and not mustard) or (mustard and not ketchup) #acomplementb plus bcomplementa. and operation multiply
...
def exactly_one_topping(ketchup, mustard, onion):
    ...
    return (int(ketchup) + int(mustard) + int(onion)) == 1 #int bollean true is one: after adding returns True if only one
