...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    a1 = time_call(fn, arg1)

    a2 = time_call(fn, arg2)
    
    a3 = time_call(fn, arg3)
    
    return max(a1, a2, a3)
print(slowest_call(sleep, 1, 3, 2.5))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
...
def smallest_stringy_number(s1, s2, s3):
    ...
    '1'
    """
    get_int = lambda x: int(x)
    
    return str(min(get_int(s1), get_int(s2), get_int(s3)))
