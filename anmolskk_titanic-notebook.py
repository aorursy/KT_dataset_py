...
titanic_df.head()
titanic_df.shape
titanic_df1=pd.read_csv('../input/titanic/test.csv')
...
plt.ylabel('Normalized Count')
Total_survived=train[['Sex','Survived']].groupby('Sex').mean()

print(Total_survived)
Total_survived.value_counts(normalize=True).plot(kind='bar')
...
plt.ylabel('Normalized Count')
train['SibSp'].value_counts(normalize=True).plot(kind='bar', alpha=0.7)
...
plt.ylabel('Normalized Count')
test['SibSp'].value_counts(normalize=True).plot(kind='bar', alpha=0.7)
...
plt.ylabel('Normalized Count')
train['Parch'].value_counts(normalize=True).plot(kind='bar', alpha=0.7)
...
plt.ylabel('Normalized Count')
test['Parch'].value_counts(normalize=True).plot(kind='bar', alpha=0.7)
...
train['Age'].plot(kind='bar',alpha=0.7)
...
scores = cross_val_score(rfclr, X_train, y, cv=12)
