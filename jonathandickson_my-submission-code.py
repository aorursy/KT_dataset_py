...
my_config['attention_probs_dropout_prob']=0.4

my_config['hidden_act']="gelu"

my_config['hidden_dropout_prob'] = 0.4

my_config['initializer_range'] = 0.04

print(json.dumps(my_config,indent=4))
model= mk_model(my_config)
model.summary()
...
def create_short_answer(entry):
    ...
    elif entry["short_answer_score"] < 2:
...
def create_long_answer(entry):
    ...
    elif entry["long_answer_score"] < 2:
...
test_answers_df["short_answer_score"].describe()
import nq_eval

nq_eval.compute_final_f1(long_answers2.values, long_prediction_strings.values)
from sklearn.metrics import f1_score

f1 = f1_score(long_answers2.values, long_prediction_strings.values, average='micro')
