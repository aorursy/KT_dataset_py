...
from keras.layers import Dense, Dropout, Flatten, Conv2D, MaxPool2D, AveragePooling2D, MaxPooling2D, Convolution2D
...
# Set the CNN model 
# my CNN architechture is In -> Conv ==> Pool ==> Conv ==> Pool ==> FC ==> FC ==> softmax 
...
submission.to_csv("cnn_mnist_lenet.csv",index=False)