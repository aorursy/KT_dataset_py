...
#     print(classes[label])
    if not classes[label] in temp_dict: 
        temp_dict[classes[label]] = 1 
    else:
        temp_dict[classes[label]] += 1
print(temp_dict)
...
class CIFAR10Model(ImageClassificationBase):
    ...
    def forward(self, xb):
        ...
        out = F.relu(out) #replace neg num with 0 
...
history
history += fit(100, 0.0001, model, train_loader, val_loader)
...
arch = "one ouput layer (10)"
lrs = [0.0001,0.001,0.01]
epochs = [100,100,100]
test_acc = 0.49365234375
test_loss = 1.4938477277755737

# {'val_loss': 1.4938477277755737, 'val_acc': 0.49365234375}
