...
data_dict = pd.read_csv(r'C:\Users\Puran Prakash Sinha\Desktop\Clustering_Assignment\data-dictionary+.csv')

country_data = pd.read_csv(r'C:\Users\Puran Prakash Sinha\Desktop\Clustering_Assignment\Country-data.csv')
