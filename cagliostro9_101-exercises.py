...
def is_vowel(letter):
    ...
    return vowels.count(letter.lower())
...
def ends_with_vowel(word):
    ...
    return is_vowel(word[len(word)-1])
...
def starts_and_ends_with_vowel(a):
    ...
    return starts_with_vowel(a) and ends_with_vowel(a)
...
def mode(a):
    ...
    for i in a:
        ...
        if a.count(i) > current_max:

            current_max = a.count(i)
...
def get_average_book_price(a):
    ...
    return total_of_book_prices(a) / get_number_of_books(a)
...
def get_average_item_price(a):
    ...
    return total / number_of_item_types(a)
