...
misssing_values_count_sf = sf_permits.isnull().sum()
total_missing_sf = misssing_values_count_sf.sum()
...
sf_columns_na_dropped.head()
print(sf_permits.shape[1], sf_columns_na_dropped.shape[1])
