...
df1 = pd.read_csv('/kaggle/input/covid19-global-forecasting-week-1/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/covid19-global-forecasting-week-1/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/covid19-global-forecasting-week-1/submission.csv', delimiter=',', nrows = nRowsRead)
