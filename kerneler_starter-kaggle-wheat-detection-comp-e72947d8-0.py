...
df1 = pd.read_csv('/kaggle/input/global-wheat-detection/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/global-wheat-detection/sample_submission.csv', delimiter=',', nrows = nRowsRead)
