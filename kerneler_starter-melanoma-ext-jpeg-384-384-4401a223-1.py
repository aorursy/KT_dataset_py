...
# train_isci.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/train_isci.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'train_isci.csv'
