...
query2 = """ SELECT merkle_root, COUNT(transaction_id) AS num_transactions
             FROM `bigquery-public-data.bitcoin_blockchain.transactions`
             GROUP BY merkle_root
         """
transactions_by_merkle_root = bitcoin_blockchain.query_to_pandas_safe(query2, max_gb_scanned=37)
