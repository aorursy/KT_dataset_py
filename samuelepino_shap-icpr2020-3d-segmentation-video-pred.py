...
for sequence_name in sorted(os.listdir(directory))[3:4]:
    ...
    with suppress_stderr():
        ...
        shap_values, segments_slic = explain(net, imageSequence, SHAP_SAMPLES, nSegments=N_SEGMENTS)



    preds = icprPredictFaceImages(net, imageSequence)
    ...
    for idx,img in enumerate(imageSequence):
        ...
        fig_sequence.append(fig2array(fig)[:,:,:3])
