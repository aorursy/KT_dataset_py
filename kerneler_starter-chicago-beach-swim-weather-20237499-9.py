...
# beach-e.-coli-predictions.csv has 2325 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# beach-lab-data.csv has 21638 rows in reality, but we are only loading/previewing the first 100 rows
