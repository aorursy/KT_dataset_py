...
#read images from directory and resize(as done before during convolution) them for training set
training_set = train_datagen.flow_from_directory(path_train,
                                                 target_size = (64, 64),
                                                 batch_size = 32,
                                                 class_mode = 'binary')
#read images from directory and resize(as done before during convolution) them for testing set
