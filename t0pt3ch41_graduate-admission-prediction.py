...
Title='Distribution  Plot of  Predicted Value Using Test Data vs Data Distribution of Test Data'
DistributionPlot(y_test,Yhat_ridgeModel,"Actual Values (Test)","Predicted Values (Test)",Title)
lm1 = LinearRegression()
from sklearn.model_selection import cross_val_score
scores = cross_val_score(lm1, X, y, cv=3)
scores
print("The mean of the folds is", np.mean(scores))
from sklearn.model_selection import cross_val_predict
yhat_cross_val = cross_val_predict(lm1, X, y, cv=3)
yhat_cross_val[0:5]
mean_squared_error(y, yhat_cross_val)
