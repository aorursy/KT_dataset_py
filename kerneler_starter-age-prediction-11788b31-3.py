...
df1 = pd.read_csv('/kaggle/input/age_prediction/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/age_prediction/test.csv', delimiter=',', nrows = nRowsRead)
