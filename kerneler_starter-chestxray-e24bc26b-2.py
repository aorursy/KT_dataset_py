...
df1 = pd.read_csv('/kaggle/input/chestxray/imagetext/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/chestxray/imagetext/test.csv', delimiter=',', nrows = nRowsRead)
