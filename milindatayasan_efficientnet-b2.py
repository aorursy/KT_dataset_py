...
model.save('efficientetB2.h5')  # creates a HDF5 file 'my_model.h5'
#del model  # deletes the existing model
model.save_weights('efficientetB2_weights.h5')
# returns a compiled model
# identical to the previous one
model = load_model('efficientetB2.h5')
model.load_weights('efficientetB2_weights.h5', by_name=True)
acc = hist.history["categorical_accuracy"]
val_acc = hist.history["val_categorical_accuracy"]
loss = hist.history["loss"]
val_loss = hist.history["val_loss"]
