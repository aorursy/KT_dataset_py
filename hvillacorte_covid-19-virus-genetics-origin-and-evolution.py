...
questions = [
    ...
    {"question": "Real-time tracking of whole genomes and a mechanism for coordinating"

                 " the rapid dissemination of that information to inform the"

                 " development of diagnostics and therapeutics and to track variations"

                 " of the virus over time."},

    {"question": "Access to geographic and temporal diverse sample sets to understand"

                 " geographic distribution and genomic differences, and determine"

                 " whether there is more than one strain in circulation. Multi-lateral"

                 " agreements such as the Nagoya Protocol could be leveraged."},

    {"question": "Evidence that livestock could be infected (e.g., field surveillance,"

                 " genetic sequencing, receptor binding) and serve as a reservoir"

                 " after the epidemic appears to be over; Evidence of whether farmers"

                 " are infected, and whether farmers could have played a role in the"
    ...
    {"question": "Evidence that livestock could be infected (e.g., field surveillance,"
                 ...
                 " after the epidemic appears to be over; Surveillance of mixed"

                 " wildlife- livestock farms for SARS-CoV-2 and other coronaviruses"
    ...
    {"question": "Evidence that livestock could be infected (e.g., field surveillance,"
                 ...
                 " after the epidemic appears to be over; Experimental infections to"

                 " test host range for this pathogen."},

    {"question": "Animal host(s) and any evidence of continued spill-over to humans."},

    {"question": "Socioeconomic and behavioral risk factors for this spill-over."},

    {"question": "Sustainable risk reduction strategies."}
