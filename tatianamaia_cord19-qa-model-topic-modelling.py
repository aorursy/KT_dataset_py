...
# Save to CSV
#cord19_df.to_csv('./output/', index=False)
#cord19_df = pd.read_csv('../output/cord19.csv',dtype={'paper_id':str, 'title':str, 'authors':str, 'journal':str, 'abstract':str, 'body_text':str},parse_dates=['publish_time'])
#cord19_df.head()
