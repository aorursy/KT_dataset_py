...
import time
# path_to_file = tf.keras.utils.get_file('../input/shakespeare.txt', 'https://storage.googleapis.com/download.tensorflow.org/data/shakespeare.txt')
...
for item in sequences.take(5):
    ...
    print("Batch:", repr(''.join(idx2char[item.numpy()])))
