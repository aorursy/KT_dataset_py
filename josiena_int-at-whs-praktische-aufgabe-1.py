...
def gib_folgezustaende_alt(zustand):
...
def gib_folgezustaende(zustand):
    ...
    fzustaende = [
        ...
        [m+incr*3,k,b_new], #  3 Missinoare fahren mit dem Boot

        [m,k+incr*3,b_new], #  3 Kannibalen fahren mit dem Boot

        [m+incr*2,k+incr,b_new] # 2 Missionare und 1 Kannibale fahren mit dem Boot
...
suche([4,4,1],[],all_solutions=False,debug=1)