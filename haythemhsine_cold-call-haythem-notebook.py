...
all_df[['CallStart','CallEnd','CallLength','CallStartHour']].head()
...
all_df[['LastContactWkNum','LastContactWk','LastContactMon']].head(10)
...
print(test_df.shape)
# Train test split
x_train, x_test, y_train, y_test = train_test_split(train_df,train_label,test_size = 0.005,random_state=3)
x_train.shape
...
print('Final Model Accuracy: %.5f'%(accuracy_score(y_test, clf_xgb.predict(x_test))))
