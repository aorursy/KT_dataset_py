...
print(os.listdir('../input/Predict Walmart Visits'))
...
df1 = pd.read_csv('../input/Predict Walmart Visits/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Predict Walmart Visits/train.csv', delimiter=',', nrows = nRowsRead)
