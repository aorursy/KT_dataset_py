...
extra_data_df = gpd.read_file("/kaggle/input/week2dataset/enriched_covid_19_week_2.csv")
...
train_df = train_df[train_df['Country_Region'].str.contains("US")]
train_df
...
def display_comparison(region,groundtruth_df):
    groundtruth = groundtruth_df.query("Country_Region=='"+region+"' and Date>='2020-04-01' and Date<='2020-04-10'")
    prediction = copy_df.query("Country_Region=='"+region+"' and Date>='2020-04-01' and Date<='2020-04-10'")
    ...
    plt.legend(['Groundtruth', 'Prediction'], loc='best')
    plt.show()
display_comparison("US_New York", groundtruth_df)
#Display 10 days
display_comparison("US_Texas", groundtruth_df)
#Display 10 days
def display_long_term_prediction(region,groundtruth_df):
    ...
    prediction = copy_df.query("Country_Region=='"+region+"' and Date>='2020-04-01' and Date<='2020-05-01'")
    #changed time to display over the month of April
    ...
    plt.legend(['Groundtruth', 'Prediction'], loc='best')
    plt.show()
display_long_term_prediction("US_New York",groundtruth_df)
display_long_term_prediction("US_Texas",groundtruth_df)
...
#changed to datafram to US only
...
test_df = test_df[test_df['Country_Region'].str.contains("US")]
test_df
