...
df1 = pd.read_csv('../input/Google_Stock_Price_Test.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# Google_Stock_Price_Train.csv has 1258 rows in reality, but we are only loading/previewing the first 1000 rows
df2 = pd.read_csv('../input/Google_Stock_Price_Train.csv', delimiter=',', nrows = nRowsRead)
