...
# micro-market-recovery-program-addresses.csv has 20009 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/micro-market-recovery-program-addresses.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'micro-market-recovery-program-addresses.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# micro-market-recovery-program-cases.csv has 21408 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/micro-market-recovery-program-cases.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'micro-market-recovery-program-cases.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# micro-market-recovery-program-permits.csv has 37685 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/micro-market-recovery-program-permits.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'micro-market-recovery-program-permits.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
