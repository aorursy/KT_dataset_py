...
print(items.loc[items['item_id']==20949])
print(items.loc[items['item_id']==5822])
print(items.loc[items['item_id']==17717])
print(categories.loc[categories['item_category_id']==71])
print(categories.loc[categories['item_category_id']==35])
print(categories.loc[categories['item_category_id']==79])
...
print(items[items['item_id']==2973])
print(items[items['item_id']==11872])
...
categories.head()
#Con esta información se pueden generar las ventas de cada tienda e item en el train set. Se hace para cada mes pensando en el test set
