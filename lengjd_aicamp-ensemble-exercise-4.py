...
np.random.seed(19)
#data_folder = "/Users/jiadileng/Desktop/machine learning/jiuzhang/week7/input"
data_folder = "../input"
...
def create_weighted_tree(data, data_weights, features, target, current_depth = 0, max_depth = 10, min_error=1e-15):
    # 拷贝以下可用特征
    remaining_features = features[:] #初始化
