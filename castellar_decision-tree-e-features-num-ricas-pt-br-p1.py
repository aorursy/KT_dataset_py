...
for i, max_depth in enumerate(max_depth_arr):
    ...
    dt_clf = DecisionTreeClassifier(random_state=42, max_depth=max_depth_arr[i], criterion='entropy')
...
print(accuracy_arr[accuracy_arr.max])
optimal_max_depth = 16 # coloque aqui o max_depth que voce encontrou
