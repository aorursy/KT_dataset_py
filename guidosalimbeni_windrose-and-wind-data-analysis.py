...
df = pd.read_csv("/kaggle/input/hourly-weather-surface-brazil-southeast-region/sudeste.csv")
df["mdct"] = pd.to_datetime(df["mdct"])
df_1 = df[(df['wsid']==384) & (df['mdct'] > '2015-01-01 00:00:00')]
df_1 = df_1.set_index("mdct")
import locale
...
df_1[['wdsp']].isnull().sum()
# zoom in 



df_1[['wdsp']][0:100].plot(figsize = (40,10))
df_1['wdsp'] = df_1['wdsp'].interpolate('linear',  limit_direction='both')
