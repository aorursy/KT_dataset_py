...
noisy_images = show_noisy_images(scale_100 = 1, 
...
for i,filter_size in enumerate(N):
    ...
    for ((snr,img), (ax1,ax2)) in zip(noisy_images.items(),all_axes):
        ...
        ax2.imshow(median_filter(img,filter_size), cmap='gray')
...
for i,filter_size in enumerate(N):
    ...
    for ((snr,img), (ax1,ax2)) in zip(noisy_images.items(),all_axes):
        ...
        ax2.imshow(pywt.dwt(img,'db1'), cmap='gray')
...
for i,filter_size in enumerate(N):
    ...
    for ((snr,img), (ax1,ax2)) in zip(noisy_images.items(),all_axes):
        ...
        ax2.imshow(anisodiff(img), cmap='gray')
