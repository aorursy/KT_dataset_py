...
history += fit(40, 0.05, model, train_loader, val_loader)
history += fit(20, 0.001, model, train_loader, val_loader)
history += fit(30, 0.0005, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
evaluate(model, test_loader)
arch = '4 layers (128,108,64,10)'
lrs = [0.05,0.01,0.005,0.001]
epochs = 100
test_acc = 0.5526367425918579
test_loss = 1.3312543630599976
