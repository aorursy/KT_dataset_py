...
batch_size = 10
xy_train = pd.read_csv("train_sweetpotato_price.csv",header=None, skiprows=1)
xy_train
## data separate (월 정보도 사용)
...
test = pd.read_csv('test_sweetpotato_price.csv',skiprows=1,header=None,usecols=range(0,5))
test
test[0] = test[0]%100
...
! kaggle competitions submit -c 2020termproject-18011826 -f submit.csv -m "17013251"