...
print("Hello Pravin! Happy BLK Anniversary")
print("OK, you have now added a new code cell too Pravin!")
...
#will plot upto 8 images in a column
if (n>7):
    cols = 8
else:
    cols = n
#number of rows should be n/8 if no remainder or 1 extra
rows = n//8
if (n%8 != 0):
    rows += 1
