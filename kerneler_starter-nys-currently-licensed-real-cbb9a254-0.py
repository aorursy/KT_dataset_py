...
# currently-licensed-real-estate-appraisers.csv has 4311 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/currently-licensed-real-estate-appraisers.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'currently-licensed-real-estate-appraisers.csv'
nRow, nCol = df1.shape
