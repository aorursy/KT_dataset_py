...
print(os.listdir('../input/test_3BA6GZX'))

print(os.listdir('../input/train_u5jK80M'))
...
df1 = pd.read_csv('../input/test_3BA6GZX/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/train_u5jK80M/train.csv', delimiter=',', nrows = nRowsRead)
