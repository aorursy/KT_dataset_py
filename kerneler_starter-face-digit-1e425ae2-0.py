...
df1 = pd.read_csv('/kaggle/input/digits/digits/svhn/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/digits/digits/svhn/train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/digits/digits/mnistm/test.csv', delimiter=',', nrows = nRowsRead)
