...
%matplotlib inline
filename_train = '/kaggle/input/learn-together/train.csv'

filename_test = '/kaggle/input/learn-together/test.csv'

filename_submission = '/kaggle/input/learn-together/sample_submission.csv'
train_df = pd.read_csv(filename_train)

test_df = pd.read_csv(filename_test)

smpsb = pd.read_csv(filename_submission)
# Obtain the distribution of the test data by submitting prediction data with all the same purpose variables.
...
# type_ratio = np.array([0.37062, 0.49657, 0.05947, 0.00106, 0.01287, 0.02698, 0.03238]) # test accuracy: 0.84682

# type_ratio = np.array([0.38, 0.50, 0.05947, 0.00106, 0.01287, 0.02698, 0.03238])  # test accuracy: 0.84726 

type_ratio = np.array([0.39, 0.51, 0.05947, 0.00106, 0.01287, 0.02698, 0.03238])
...
def main(train_def, test_df, type_ratio=type_ratio):
...
y = pd.read_csv(filename_train)["Cover_Type"].values
