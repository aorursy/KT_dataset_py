...
# employee-reimbursements.csv has 6435 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/employee-reimbursements.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'employee-reimbursements.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# employee-reimbursements-through-payroll-system.csv has 76501 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/employee-reimbursements-through-payroll-system.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'employee-reimbursements-through-payroll-system.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
