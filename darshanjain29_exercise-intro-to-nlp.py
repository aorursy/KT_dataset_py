...
for idx, review in data.iterrows():
    ...
    found_items_1 = set([doc[match[1]:match[2]] for match in matches])
    ...
    for match, start, end in matches:
        ...
        found_items.add(doc[start:end])

       



    #print (found_items, "000000000000")
    ...
    #item_ratings = pd.DataFrame(columns=['item','rating'])
