...
# current accuracy (balanced): see last run (this is the NBSVM implementation using ktrain) [not optimized]
import time 
...
df.head()
df = df[['text','Mixed','Negative','Positive']]
import ktrain
...
(x_train, y_train), (x_test, y_test), preproc = text.texts_from_df(df, 
                                                                   ...
                                                                   label_columns=['Mixed','Negative','Positive'],
...
print(learner.validate(class_names=['Mixed','Negative','Positive']))
