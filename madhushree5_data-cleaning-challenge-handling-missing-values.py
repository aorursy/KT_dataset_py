...
(total_missing_value/total_cells_sf_per)*100
...
print('Columns in dropped na dataset: %d \n' %columns_with_na_dropped.shape[1])
# Your turn! Try removing all the rows from the sf_permits dataset that contain missing values. How many are left?
col_with_dropped_na = sf_permits.dropna(axis=1)
# Now try removing all the columns with empty values. Now how much of your data is left?
print('cols in original dataset: %d \n' % sf_permits.shape[1])
print('cols with dropped na dataset: %d \n' % col_with_dropped_na.shape[1])
