...
rf_model_pipe = Pipeline(steps=[('preprocessor', preprocessor),('model', model)])



rf_model_pipe.fit(X_train,y_train) # Your code here



pred = rf_model_pipe.predict(X_valid)
...
score = -1*cross_val_score(my_pipeline,X_train,y_valid,cv=5,scoring='neg_mean_absolute_error')
