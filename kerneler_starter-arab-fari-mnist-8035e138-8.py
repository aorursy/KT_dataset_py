...
df1 = pd.read_csv('/kaggle/input/Arab MNIST (test)/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Arab MNIST (train)/train.csv', delimiter=',', nrows = nRowsRead)
