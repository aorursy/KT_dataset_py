...
# Competitions.csv has 940 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Datasets.csv has 9314 rows in reality, but we are only loading/previewing the first 100 rows
