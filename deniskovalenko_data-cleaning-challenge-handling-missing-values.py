...
# percent of  missing data in San Francisco permits dataset
...
sf_permits_with_dropped_columns = sf_permits.dropna(axis=1)
sf_permits_with_dropped_columns.head()
# just how much data did we lose?
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_permits_with_dropped_columns.shape[1])
