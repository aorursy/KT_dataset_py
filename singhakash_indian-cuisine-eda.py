...
fig = px.bar(reg_df,x='region',y='count',title='Number of dishes based on regions',
             color_discrete_sequence=['#316396'])
fig.show()
...
wordcloud = WordCloud(width = 400, height = 400, background_color ='orange', 
...
wordcloud = WordCloud(width = 400, height = 400, background_color ='red', 
                min_font_size = 10).generate(text)                  
plt.figure(figsize = (8, 8), facecolor = None) 
plt.imshow(wordcloud) 
plt.axis('off') 
