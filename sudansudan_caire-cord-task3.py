...
run_example(query)
query = "What do we know about covid-19 genetics?"
run_example(query)
query = "What do we know about covid-19 origin?"
run_example(query)
...
run_example(query)
query = "What do we know about covid-19 evolution?"
run_example(query)
query = "What do we know about covid-19 management measures at the human-animal interface?"
run_example(query)
query = "What do we know about the Real-time tracking of whole genomes of covid-19 and a mechanism for coordinating the rapid dissemination of that information to inform the development of diagnostics and therapeutics?"
run_example(query)
query = "What do we know about the Real-time tracking of whole genomes and a mechanism for coordinating the rapid dissemination of that information to track variations of the covid-19 over time?"
run_example(query)
query = "How is the access to geographic and temporal diverse sample sets to understand covid-19 geographic distribution and genomic differences, and determine whether there is more than one strain incirculation?"
run_example(query)
query = "Do we have any evidence that livestock could be infected (e.g., field surveillance, genetic sequencing, receptor binding)?"
run_example(query)
query = "Does covid-19 infected livestock serve as a reservoir after the epidemic appears to be over?"
run_example(query)
query = "Could farmers be infected by covid-19?"
run_example(query)
query = "What do we know of farmers role in the covid-19 origin?"
run_example(query)
query = "What do we know of surveillance of mixed wildlife- livestock farms for SARS-CoV-2 and other coronaviruses in Southeast Asia?"
run_example(query)
query = "What do we know about the experimental infections of covid-19 to test host range for this pathogen?"
run_example(query)
query = "What evidence do we have of animal host(s) and evidences of continued spill-over to humans?"
run_example(query)
query = "What do we know of socioeconomic and behavioral risk factors for covid-19?"
run_example(query)
query = "what do we know about sustainable covid-19 risk reduction strategies?"
run_example(query)