...
# 511-ny-events-beginning-2010.csv has 1674327 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/511-ny-events-beginning-2010.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = '511-ny-events-beginning-2010.csv'
nRow, nCol = df1.shape
