...
plt.title("Number of Accidents by Rank of Hour 2015\n (Most to least dangerous)")
...
query = """SELECT COUNT(hit_and_run), 
        ...
        """
accidents_by_state = accidents.query_to_pandas_safe(query, max_gb_scanned=0.1)
print(accidents_by_state)
# make a plot to show that our data is, actually, sorted:
plt.plot(accidents_by_state.f0_)
plt.title("Number of Accidents by Rank of State 2015\n (Most to least dangerous)")