...
train_df.head()
#convert "Title" from 1 feature and 4 categories(0,1,2,3) to 4 features and 2 categories (0,1)
...
g.set_xlabels("Family Size categories")
...
train_df["Ticket"] = [i.replace(".","").replace("/","").strip().split(" ")[0] if not i.isdigit() else "x" for i in train_df["Ticket"]]
