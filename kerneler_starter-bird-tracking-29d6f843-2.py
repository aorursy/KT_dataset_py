...
# bird_tracking.csv has 61920 rows in reality, but we are only loading/previewing the first 1000 rows
df1 = pd.read_csv('../input/bird_tracking.csv', delimiter=',', nrows = nRowsRead)
