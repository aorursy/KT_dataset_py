...
mymodel = tf.keras.models.load_model("./barplot_classifier.h5")
...
test_image = image.load_img("../input/supertest/0uRNS.png",target_size =IMAGE_SIZE )
...
for x in data_list:
  ...
  if class_dictionary[x] == (df[df == df.iloc[0]].index[0]):
    ...
    break
net_final.save("barplot_classifier.h5")
