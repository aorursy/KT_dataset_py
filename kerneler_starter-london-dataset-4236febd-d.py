...
# test.csv has 8999 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# train.csv has 999 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# trainLabels.csv has 999 rows in reality, but we are only loading/previewing the first 100 rows
