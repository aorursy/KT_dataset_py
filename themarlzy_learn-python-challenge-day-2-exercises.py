...
def to_smash(total_candies, friends=3):
    ...
    the given number of candies evenly between `friends` friends (default 3).
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    start = time()
    fn(arg1)
    add_timings(timings, start, time())
    start = time()
    fn(arg2)
    add_timings(timings, start, time())
    start = time()
...
def add_timings(timings, start, finish):
...
smallest_stringy_number('12', '2','10')
#q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
