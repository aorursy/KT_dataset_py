...
print("Imputation is better approach")
...
final_immuter = SimpleImputer(strategy = 'median')

final_X_train = pd.DataFrame(final_immuter.fit_transform(X_train))

final_X_valid = pd.DataFrame(final_immuter.transform(X_valid))
