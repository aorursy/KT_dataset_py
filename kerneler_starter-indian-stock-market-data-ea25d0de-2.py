...
df1 = pd.read_csv('/kaggle/input/Data/532746.BO.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Data/5PAISA.NS.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Data/20MICRONS.BO.csv', delimiter=',', nrows = nRowsRead)
