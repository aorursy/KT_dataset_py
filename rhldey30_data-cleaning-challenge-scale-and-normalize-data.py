...
#scale the col from 0 to 1
scaled_data = minmax_scaling(goal_col, columns = [0])

#plot the original & scaled data to compare
fig, ax = plt.subplots(1,2)
