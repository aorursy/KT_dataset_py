...
# Detailed result for the first answer
print(json.dumps(results['ret'][0], indent=4, sort_keys=True))
queries = [
...
for query in queries:
    ...
    results = covidAsk(query)
    print('Answers:', [r['context'][r['sent_start']:r['sent_end']] for r in results['ret']])
    print()
queries = [
