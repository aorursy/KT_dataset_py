...
for dirname, _, filenames in os.walk('/kaggle/input'):
    ...
    for filename in filenames:
        ...
        if '/seg_pred/seg_pred/' not in os.path.join(dirname, filename):
...
model.fit(x=X_train,y=y_train,validation_data=(X_test, y_test),epochs=1000,callbacks=[early_stop])
