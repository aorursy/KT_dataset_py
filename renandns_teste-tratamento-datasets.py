...
x1 = telhado['temperatura']

ax = sns.distplot(x1)
aux_temp = pd.DataFrame(telhado.groupby(['temperatura'])['data'].count())

aux_temp.tail(30)
telhado = telhado[(telhado['temperatura'] >= 6) & (telhado['temperatura'] <= 38)]
#Média - 2 desvios padrão(22 - 16 = 6) e Média + 2 desvios padrão(22 + 16 = 38)
#telhado1 = telhado[(telhado['temperatura'] < 45)]

#telhado1 = telhado[(telhado['sensor'] == 1) | (telhado['sensor'] == 2) | (telhado['sensor'] == 3)]

#telhado1 = telhado[(telhado['sensor'] == 5) | (telhado['sensor'] == 6)]
#telhado1.describe()
#aux_temp1 = pd.DataFrame(telhado1.groupby(['temperatura'])['data'].count())
...
telhado_pivot['Data1'] = telhado_pivot['data']
