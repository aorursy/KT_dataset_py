...
####Die Funktion wurde um weitere zustände erweitert. 3-Platz-Boot. 

## Überlegung wäre dies allgemin zu halten.
        ...
        if z not in history+zustand:
            ...
            if res1: 
                ...
                if all_solutions:
                    ...
                    print("gefundene Loesungen: ",res1,res2)
            ...
            if debug == 2: print((level+1)*' '+"wiederholung",z)
...
print("alle gefundene Loesungen sind " + str(flag) + " Möglichkeiten")