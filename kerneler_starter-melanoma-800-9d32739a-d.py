...
df1 = pd.read_csv('/kaggle/input/melanoma.800/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/melanoma.800/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/melanoma.800/test.csv', delimiter=',', nrows = nRowsRead)
