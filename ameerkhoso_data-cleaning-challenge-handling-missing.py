...
(total_missing_sf/total_cell_sf)*100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print("column in original datasets %d: \n :" % sf_permits.shape[1])
print("column in na's dropped datasets %d" % columns_with_dropped_na_sf.shape[1])
...
subset_sf_data = sf_permits.loc[:, 'Block':'Record ID'].head()
subset_sf_data
