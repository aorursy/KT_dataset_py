...
# final_submission.csv has 418 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/final_submission.csv', delimiter=',', nrows = nRowsRead)
