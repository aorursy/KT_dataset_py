...
# train_binary.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/data/train_binary.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'train_binary.csv'
...
df2 = pd.read_csv('/kaggle/input/data/test.csv', delimiter=',', nrows = nRowsRead)
