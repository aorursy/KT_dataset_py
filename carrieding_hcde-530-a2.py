...
# Make a new list to convert all items in dogList to lower case

doglist = [item.lower() for item in dogList]



# find terrier in new list
...
# for every line in test.txt

# Cut the line into words and store in the list, wordslist

# for loops it runs through each line
