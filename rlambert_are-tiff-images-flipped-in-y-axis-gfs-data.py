...
def overlay_image_on_puerto_rico(file,band_layer):
    ...
    folium.raster_layers.ImageOverlay(
        ...
        bounds = [[im_rio.bounds.bottom, im_rio.bounds.left],[im_rio.bounds.top, im_rio.bounds.right]],

        colormap=lambda x: (2, 0, 0, abs(x)),
...
# check u component of wind (channel 4)

file = '/kaggle/input/ds4g-environmental-insights-explorer/eie_data/gfs/gfs_2019030800.tif'

rio.open(file).read(4)
file = '/kaggle/input/ds4g-environmental-insights-explorer/eie_data/gfs/gfs_2019030800.tif'

overlay_image_on_puerto_rico(file,4)
file = '/kaggle/input/ds4g-environmental-insights-explorer/eie_data/gfs/gfs_2019030800.tif'
...
print(image_rio.xy(row2,col2))
# check v component of wind

overlay_image_on_puerto_rico(file,5)