...
# crisis-data.csv has 38141 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/crisis-data.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'crisis-data.csv'
nRow, nCol = df1.shape
