...
# My turn! I will take a look at all the unique values in the "Province" column. 
# Then I'll convert the column to lowercase and remove any trailing white spaces
# get all the unique values in the 'City' column
provinces = suicide_attacks['Province'].unique()

# I sort them alphabetically and then take a closer look
provinces.sort()
provinces
# We see mix of lower and upper cases. Let us convert to lower case:
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()
# Here are no trailing white spaces, but I will apply the removing method anyway.
