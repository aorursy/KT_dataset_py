...
fashion_model.add(Conv2D(12, 3, activation="relu", input_shape=(img_rows, img_cols, 1)))
...
# added an addition Conv2D layer with less filters

second_fashion_model.add(Conv2D(10, activation='relu', kernel_size=2))
