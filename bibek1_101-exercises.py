...
fruits = ['tomato', 'mango', 'strawberry', 'guava', 'kiwi', 'banana']
...
def has_vowels(value): 
    result = any (c in value for c in 'aeiouAEIOU')
    return result
...
list2 =[1,2,2,3,3,5,5,6,6,7,7]
list3 = ["b", "a", "n", "a", "n", "a", "s"]
def get_unique_values(list1):
    set1 = set((list1))
    return print(set1)
get_unique_values(list2)
get_unique_values(list3)
# Exercise 83
...
def get_values_not_in_common(list1, list2):
    ...
    set4 = set2.difference(set1)
    return set3.union(set4)
get_values_not_in_common(l1,l2)
