...
baseDir =  os.path.join("..", "input", "multiview_hand_pose_dataset_uploaded_v2")
...
for i in range(1,22):
    ...
    c_0_0 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_1/rvec.pkl","rb"), encoding='latin1')

    c_0_1 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_1/tvec.pkl","rb"), encoding='latin1')

    c_1_0 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_2/rvec.pkl","rb"), encoding='latin1')

    c_1_1 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_2/tvec.pkl","rb"), encoding='latin1')

    c_2_0 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_3/rvec.pkl","rb"), encoding='latin1')

    c_2_1 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_3/tvec.pkl","rb"), encoding='latin1')

    c_3_0 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_4/rvec.pkl","rb"), encoding='latin1')

    c_3_1 = pickle.load(open(baseDir+"/calibrations/data_"+str(i)+"/webcam_4/tvec.pkl","rb"), encoding='latin1')
    ...
    for j in range(len(colorFrames)):
        ...
        jointPath = os.path.join(*toks1[:-1], toks2[0]+"_joints.txt")
