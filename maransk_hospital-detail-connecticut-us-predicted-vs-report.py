...
covid_ct=pd.read_csv(base_path+'covidhospitaldata/COVID-19 confirmed cases_CT_usa.csv')

covid_ct.head(2)
ihme_df_04_09.location_name.unique()
ihme_df_04_09_ct=ihme_df_04_09[ihme_df_04_09.location_name=='Connecticut']

ihme_df_03_30_ct=ihme_df_03_30[ihme_df_03_30.location_name=='Connecticut']

ihme_df_04_09_ct.loc[:,'ICUbed_available']=99.0



ihme_df_04_09_ct.loc[:,'allbed_available']=1738.0
ihme_df_04_09_ct.loc[ihme_df_04_09_ct['date']=='2020-04-09'].T[3:12].T
ihme_df_04_09_ct.loc[ihme_df_04_09_ct['date']=='2020-04-09'].T[12:21].T
ihme_df_04_09_ct.loc[ihme_df_04_09_ct['date']=='2020-04-09'].T[21:].T
fig = go.Figure()

fig.add_trace(go.Scatter(

    x=ihme_df_04_09_ct["date"], y=ihme_df_04_09_ct["allbed_mean"],
...
fig.add_trace(go.Scatter(
    ...
    x=ihme_df_03_30_ct["date"], y=ihme_df_03_30_ct["allbed_mean"],
...
fig.add_trace(go.Scatter(
    ...
    x=ihme_df_04_09_ct["date"].tolist()+ihme_df_04_09_ct["date"][::-1].tolist(),

    y=ihme_df_04_09_ct['allbed_upper'].tolist()+(ihme_df_04_09_ct['allbed_lower'][::-1]).tolist(),
...
fig.add_trace(go.Scatter(
    ...
    x=ihme_df_04_09_ct["date"], y=ihme_df_04_09_ct["allbed_available"],

    line_color='rgba(0,100,80,0.5)',

    name='allbed_available',
...
fig.add_trace(go.Scatter(
    ...
    x=pd.to_datetime(covid_ct["Date"]).astype(str), y=covid_ct["HospitalizedCases"],

    line_color='rgb(231,107,243)',

    name='HospitalizedCases',
...
plot_eleven_columns_using_plotly_regular(dataframe=ihme_df_04_09_ct,
                                        ...
                                        title='Mean of Upper and Lower Predictions from IHME for Connecticut as of '+todays_date)
plot_eleven_columns_using_plotly_express(dataframe=ihme_df_04_09_ct,
