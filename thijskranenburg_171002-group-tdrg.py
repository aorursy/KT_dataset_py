...
trace = go.Scatter(
    ...
    x = attacks_north_america,

    y = nkill_north_america,
...
# describe the nkill column



data_terrorism['nkill'].describe()
...
nwound_world_grouped.head()
# merge nattacks and inhabitants
...
merged_data_nattacks.head()
# merge nkill and inhabitants
...
merged_data_nkill.head()
# merge nwound and inhabitants
...
merged_data_nwound.head()
# create scatter plot without distinguishing between areas (x = n attacks, y = nkill)



trace = go.Scatter(

    x = merged_data_nattacks.nattacks_inhabitants,

    y = merged_data_nkill.nkill_inhabitants,
...
print(merged_data_nattacks.head())

print(merged_data_nkill.head())

print(merged_data_nwound.head())
# Plot scatter plot (titel klopt nog niet)
...
trace1 = go.Scatter(                             
         ...
         y = (merged_data_nwound_north_america.nwound_inhabitants / 10),
...
trace2 = go.Scatter(                             
         ...
         y = (merged_data_nwound_asia.nwound_inhabitants / 10),
...
trace3 = go.Scatter(                             
         ...
         y = (merged_data_nwound_oceania.nwound_inhabitants / 10),
...
trace4 = go.Scatter(                             
         ...
         y = (merged_data_nwound_europe.nwound_inhabitants / 10),
...
trace5 = go.Scatter(                             
         ...
         y = (merged_data_nwound_south_america.nwound_inhabitants / 10),
...
trace6 = go.Scatter(                             
         ...
         y = (merged_data_nwound_east_n_africa.nwound_inhabitants / 10),
...
trace7 = go.Scatter(                             
         ...
         y = (merged_data_nwound_sub_africa.nwound_inhabitants / 10),
...
layout = dict(title = 'Number of attacks and number of wounded per citizen',

              yaxis = dict(

                  zeroline = True,

                  title = 'Nr. of wounded per citizen in percentages'),
...
ax.set_ylaabel("Attacktype names", size=10, alpha=1)
