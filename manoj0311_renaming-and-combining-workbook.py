...
# Your code here
#print(check_q4(powerlifting_meets.merge(powerlifting_competitors,on='MeetID')))
#print(check_q4(powerlifting_meets.join(powerlifting_competitors,on='MeetID',lsuffix='_M',rsuffix='_C')))
powerlifting_meets = powerlifting_meets.set_index('MeetID')
powerlifting_competitors = powerlifting_competitors.set_index('MeetID')
print(check_q4(powerlifting_meets.join(powerlifting_competitors,lsuffix='_M',rsuffix='_C')))
