...
df1 = pd.read_csv('/kaggle/input/Data Files/Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Data Files/Sample_Submission.csv', delimiter=',', nrows = nRowsRead)
