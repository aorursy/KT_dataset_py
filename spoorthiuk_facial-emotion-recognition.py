...
x = 0
for expression in os.listdir("../input/new-emo/archive/test/"):
    print(expression)
    for i in range(1,6):
        x += 1
        plt.subplot(7,5,x)
        img_path="../input/new-emo/archive/test/" + expression + "/" +os.listdir("../input/new-emo/archive/test/" + expression)[i]
        print(img_path)
...
train_generator = train_datagen.flow_from_directory("../input/new-emo/archive/train/", target_size = (img_size, img_size),
                                             color_mode = 'grayscale',
                                             batch_size = batch_size,
                                             class_mode = 'categorical',
                                             shuffle = True)

test_generator = test_datagen.flow_from_directory("../input/new-emo/archive/test/", target_size = (img_size, img_size),
                                             color_mode = 'grayscale',
                                             batch_size = batch_size,
                                             class_mode = 'categorical',
                                             shuffle = True)
