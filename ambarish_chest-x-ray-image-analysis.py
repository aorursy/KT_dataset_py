...
%matplotlib inline
listdir('../input/chest_xray')
listdir('../input/chest_xray/chest_xray')
...
listdir(train_path)
listdir(train_path + 'NORMAL/')[:10]
image_path =train_path + 'NORMAL/' +  'NORMAL2-IM-1232-0001.jpeg'
image = cv2.imread(image_path)
plt.figure(figsize=(16,16))
plt.imshow(image)
listdir(train_path + 'PNEUMONIA/')[:5]
image_path =train_path + 'PNEUMONIA/' +  'person63_bacteria_306.jpeg'
image = cv2.imread(image_path)
plt.figure(figsize=(16,16))
plt.imshow(image)
