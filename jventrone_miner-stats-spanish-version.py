...
# Este Dataset se obtuvo de diferentes Dataset si quieres ver como se hizo visita https://github.com/JuanVentrone/Miner_Stat
...
# Si deseas saber como obtuve este dataset por favor visitar: https://github.com/JuanVentrone/
...
# Unificando un Profit % para cada pais y luego comparar.
...
# Este dataset se obtuvo mediante el Srapper de la pagina: https://shop.bitmain.com

# Chequear: https://github.com/JuanVentrone/
...
data_model_new
# Este Dataset fue realizado Manualmente base a precios del Varios Vendedores
