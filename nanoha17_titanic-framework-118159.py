...
acc_score = accuracy_score(val_labels,predictions)
pre_score = precision_score(val_labels,predictions)
rec_score = recall_score(val_labels,predictions)
...
plt.show()
print(np.array(k_scores).argsort()) # argsort result is 0 index. So +1 for the actual "k" value
# 预测
