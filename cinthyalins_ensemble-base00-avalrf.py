...
# print(os.listdir('../input/novas-bases/novas-bases/novas-bases'))
...
pickle_off = open('../input/base00/X_train0s.pickle', 'rb')

X_train = pickle.load(pickle_off)



pickle_off = open('../input/base00/y_train0s.pickle', 'rb')
...
pickle_off = open('../input/base00/X_val0s.pickle', 'rb')

X_val = pickle.load(pickle_off)



pickle_off = open('../input/base00/y_val0s.pickle', 'rb')
...
#     rf = RandomForestClassifier(n_estimators=estimator, max_features='auto', max_depth=50, min_samples_leaf=10, min_samples_split=25)
...
#     rf = RandomForestClassifier(n_estimators=10, max_features='auto', max_depth=depth, min_samples_leaf=10, min_samples_split=25)
...
#     rf = RandomForestClassifier(n_estimators=10, max_features='auto', max_depth=50, min_samples_leaf=10, min_samples_split=sample)

#     rf.fit(X_train, y_train)

#     rf_pred_val = rf.predict(X_val)

#     print("###   min_samples_split: ", sample, '  ###')
...
#     rf = RandomForestClassifier(n_estimators=10, max_features='auto', max_depth=50, min_samples_leaf=leaf, min_samples_split=25)
