...
for i in range(len(contour_level)):
    ...
    plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),contour_level[i])
...
mat2 = loadmat('../input/dataset/ex8data2.mat')
...
mat3 = loadmat('../input/dataset/ex8_movies.mat')

mat4 = loadmat('../input/dataset/ex8_movieParams.mat')
...
movieList = open("../input/dataset/movie_ids.txt","r",encoding = "ISO-8859-1").read().split("\n")[:-1]
