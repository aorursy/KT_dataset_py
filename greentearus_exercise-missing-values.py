...
mis_val_columns = missing_val_count_by_column[missing_val_count_by_column > 0].index # Your code here



# Fill in the lines below: drop columns in training and validation data

reduced_X_train = X_train.drop(mis_val_columns, axis=1)

reduced_X_valid = X_valid.drop(mis_val_columns, axis=1)
