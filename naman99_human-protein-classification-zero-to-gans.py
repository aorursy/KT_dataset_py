import os, torch, pandas as pd, numpy as np, seaborn as sns, matplotlib.pyplot as plt
...
n = 20 #using top 20 value to plot

values = train_df['Label'].value_counts()[:n].keys().tolist()
counts = train_df['Label'].value_counts()[:n].tolist()
sns.set_style("dark")
plt.figure(figsize=(12,7))
g = sns.barplot(y=counts, x=values, palette="pastel")
...
jovian.commit(project='human-protein-classification-zero-to-gans')