...
# connect-chicago-locations.csv has 259 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/connect-chicago-locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'connect-chicago-locations.csv'
nRow, nCol = df1.shape
