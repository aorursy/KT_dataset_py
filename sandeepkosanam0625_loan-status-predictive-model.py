...
#To have a look of how the observations are we will have a look at first five observations
...
print('num of numerical columns are', len(loan_df._get_numeric_data().columns))                  #numerical variables

print('num of categorical columns are',len(loan_df.columns)-len(loan_df._get_numeric_data().columns))    #categorical variables
...
print("Lower limit of IQR is \n", lower_limit)



upper_limit = Q3+1.5*IQR

print("Upper limit of IQR is \n", upper_limit)



print('Count of applicants between upper and lower IQR is : ',((loan_df['ApplicantIncome'] > 10171.250) | (loan_df['ApplicantIncome'] < 1498.750)).sum())      #gives count

print('Count of co-applicants between upper and lower IQR is : ', ((loan_df['CoapplicantIncome'] > 5743.125) | (loan_df['CoapplicantIncome'] < 3445.875)).sum())

print('Count of loan ammount between upper and lower IQR is : ', ((loan_df['LoanAmount'] > 270.000) | (loan_df['LoanAmount'] < 2.000)).sum())

print('Count of loan term between upper and lower IQR is : ', ((loan_df['Loan_Amount_Term'] > 360.000) | (loan_df['Loan_Amount_Term'] < 360.000)).sum())

print('Count of credit history between upper and lower IQR is : ', ((loan_df['Credit_History'] > 1) | (loan_df['Credit_History'] < 1)).sum())
...
loan_df.head()
#dropping columns applicant and coapplicant income as we haev introduced a new variable combining both
...
print('AUC of logistic model is : %.3f' % auc)
...
#This concludes that logistic regression model best suits this loan status prediction problem compared to knn.
