...
sns.jointplot(x='carat' , y='price' , data=diamonds , height=5)
...
sns.catplot(x='color', y='price', data=diamonds, kind='box' ,aspect=2.5 )
...
price_submission.to_csv("XC.csv", index=False)
