...
def ResNet50V2_TL(input_shape=(224,224,3),classes=80):
    ...
    for layer in model_base.layers[:40]:
...
model.compile(loss='categorical_crossentropy',optimizer='adam',metrics=['accuracy', top_k_categorical_accuracy, acc_top3])
...
# test_data = "../input/mydataset/test_a/"

# test_annotation_file ="../input/mydataset/json/scene_test_a_annotations_20180103.json"
...
# model_file = "../input/output/model_best.h5"
