...
fnTrain = 'perceptron1.txt' #name of train data 
...
testPS = 5000 #maximum count for upper limit of recursive
...
py4 = [1,-12,-34]
#pla =  plt.plot(x1,y1, label = "-0.8x+1.0y+-0.2=0", color='blue',linewidth = 0.5)

pla = plt.axvline(x=1/1.6 )
