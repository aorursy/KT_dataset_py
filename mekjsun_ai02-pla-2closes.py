...
fnTrain = '2CloseS.txt' #name of train data 
...
testPS = 50000 #maximum count for upper limit of recursive
...
y1 = np.add( np.multiply(x1,2.696)  , 0.2 ) / -0.448

#2.696 X0  + 0.448 * X1  + 0.2
...
py4 = [1,-12,-34]
pla =  plt.plot(x1,y1, label = "2.696 X0  + 0.448 * X1  + 0.2", color='blue',linewidth = 0.5)
