...
df_master=pd.read_csv('../input/aipowered-literature-review-csvs/kaggle/working/Risk Factors/Smoking Status.csv')
...
for keyword in keywords:
    ...
    search_words = 'severe risk factor'
    ...
    df_table_show.to_csv('Smoking Status.csv', index = False)
