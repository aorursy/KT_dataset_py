...
print(os.listdir("/kaggle/input/flower-recognition/he_challenge/data"))

os.chdir("/kaggle/input/flower-recognition/he_challenge/data")
...
model.summary()
history=model.fit(X_train,y_train,epochs=150,batch_size=100,validation_data=(X_test,y_test),callbacks=[EarlyStopping(min_delta=0.01)])
...
with pd.option_context('display.max_rows', None, 'display.max_columns', None):  # more options can be specified also
    ...
    print(final_submission)
final_submission.to_csv('/kaggle/input/final_submission_antara.csv',index=False)