...
%matplotlib inline
temp = pd.read_csv(r"/kaggle/input/consumer-reviews-of-amazon-products/1429_1.csv")
...
pickle.dump(logreg, open(mod_file, 'wb'))
...
sample = "the whole experience was horrible and product is worst"



# make a prediction

print(loaded_model.predict(loaded_vectorizer.transform([sample])))



sample = "The product was good and easy to  use"
