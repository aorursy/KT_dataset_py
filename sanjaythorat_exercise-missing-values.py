...
# columns_with_missing_values = missing_val_count_by_column[missing_val_count_by_column > 0].index # Your code here #["LotFrontage", "MasVnrArea", "GarageYrBlt"]



columns_with_missing_values = [col for col in X_train.columns 
