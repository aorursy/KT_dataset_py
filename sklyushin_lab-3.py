...
# train_images_1 = train_images.reshape(train_images.shape[0], img_rows, img_cols)

# for i in range(25):

#     plt.subplot(5, 5, i+1)

#     plt.imshow(train_images_1[i])
...
plt.show()
# Оптимизатор Adadelta и функция активации relu - показали наилучший результат 
...
# строки - классы точных данных

# столбцы - распознанные классы

# пересечения - количество распознанных элементов класса
...
print(conf_matrix)
# Матрица ошибок в процентном эквиваленте

# По диагонали процент распознавания каждого класса
...
# Введение dropout для минимизации переобучения
