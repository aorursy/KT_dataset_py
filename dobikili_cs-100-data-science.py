...
for idx, passenger in test_data.iterrows():

    # make your changes in this cell!

        if passenger['Sex'] == 'female' and passenger['Ticket'] != 35000:

            predictions.append(1)

        elif (passenger['Sex'] == 'male') & (passenger['Age'] <= 10) & (passenger['Embarked'] != "Q"):
