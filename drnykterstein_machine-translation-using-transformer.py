...
data_path='../input/engfra/eng-fra.txt'
...
for line in lines[10001: 10001+2000]:
    input, target = line.split('\t')    
    inputss.append(input)
    targetss.append(target)
lines[10001]
inputss[0]

targetss[0]
val_examples = tf.data.Dataset.from_tensor_slices((inputss,targetss))
