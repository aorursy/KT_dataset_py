...
windowSize = 25
data_path = os.path.join('/kaggle/input')



X = sio.loadmat(os.path.join(data_path, 'Indian_pines_corrected.mat'))['indian_pines_corrected'] #data

y = sio.loadmat(os.path.join(data_path, 'Indian_pines_gt.mat'))['indian_pines_gt'] #labels
print(X.shape)
