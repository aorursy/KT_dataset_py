...
df1 = pd.read_csv('../input/youtube-trending-video-dataset/KR_youtube_trending_data.csv', delimiter=',', nrows = nRowsRead)
...
for sentence in df1.channelTitle: 
    morphs.append(twitter.pos(sentence))
    
for sentence in df1.tags: 
    morphs.append(twitter.pos(sentence))
...
# Install fonts for Korean expression in graphs.
