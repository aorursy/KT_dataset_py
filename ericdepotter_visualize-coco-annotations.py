...
annotation_path = r'../input/synthetic-gloomhaven-monsters/annotations.json'

image_dir = r'../input/synthetic-gloomhaven-monsters/images/train'
...
html = coco_dataset.display_image('image_78', use_url=False)
