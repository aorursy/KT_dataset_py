...
data=pd.read_csv("/kaggle/input/table1/data.csv")
...
df_out.to_csv('kruskaltesttable1.csv', index=False)
from scipy.stats import pearsonr
from scipy.stats import spearmanr
from scipy.stats import kendalltau
from scipy.stats import mannwhitneyu
...
df_out['p_p_values'] = p_p_list
df_out['p_r_values'] = p_r_list
df_out.to_csv('pearsortable1.csv', index=False)
from scipy.stats import pearsonr
from scipy.stats import spearmanr
from scipy.stats import kendalltau
from scipy.stats import mannwhitneyu
...
df_out['p_p_values'] = p_p_list
df_out['p_r_values'] = p_r_list
df_out.to_csv('indttest.csv', index=False)
...
while i < 118:
    ...
    sonuc=stats.ttest_1samp(data.iloc[:,[i]], 0)   
    i=i+1
    print(sonuc)
...
data1=x.iloc[:,[109,82,37,80,111,105,92,114,33,20]]
# split data train 80 % and test 20 %
...
data2=x.loc[:,['diagnostics_Image-original_Mean', 'diagnostics_Image-original_Minimum',
       ...
       'original_shape_Maximum2DDiameterSlice', 'original_shape_Flatness',
       'original_shape_SurfaceArea', 'original_shape_MinorAxisLength',
       ...
       'original_gldm_DependenceVariance', 'original_glcm_JointAverage',
       'original_glcm_SumAverage', 'original_glcm_ClusterShade',
       'original_glcm_MaximumProbability', 'original_glcm_Idmn',
       'original_glcm_Contrast', 'original_glcm_DifferenceEntropy',
       'original_glcm_InverseVariance', 'original_glcm_Idm',
       'original_glcm_Correlation', 'original_glcm_Autocorrelation',
       'original_glcm_MCC', 'original_glcm_Imc2', 'original_glcm_Imc1',
       'original_glcm_DifferenceAverage', 'original_glcm_ClusterTendency',
       'original_firstorder_Skewness', 'original_firstorder_Median',
       'original_firstorder_Energy', 'original_firstorder_TotalEnergy',
       'original_firstorder_Maximum', 'original_firstorder_RootMeanSquared',
       ...
       'original_ngtdm_Strength', 'original_ngtdm_Contrast',
