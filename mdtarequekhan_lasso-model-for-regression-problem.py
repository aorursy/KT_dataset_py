...
model_lasso = LassoCV(alphas = [1, 0.0004436, 0.01, 0.005,0.0005] , max_iter=50000).fit(X_train, y)
...
outs = [lasso_preds, ridge_preds, svm_preds, rfr_preds, dtr_preds]
...
final = 0.33*lasso_preds + 0.33*ridge_preds + 0.33*svm_preds
