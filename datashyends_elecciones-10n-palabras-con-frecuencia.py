...
show_df_as_bubble(tdidf_all_party_words, num_words = 100, normalize = False, standard_sizeref = False,
...
show_df_as_bubble(tdidf_all_party_2_words, num_words = 100, normalize = False, standard_sizeref = False,

                  title = 'Binomios de palabras con mayor score por partido', 
