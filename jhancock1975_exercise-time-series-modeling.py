...
y_hat_avg['moving_average_forecast'] = Train['Count'].rolling(5).mean().iloc[-1]
plt.figure(figsize = (15,5))
plt.plot(Train['Count'], label = 'Train')
plt.plot(valid['Count'], label = 'Validation')
plt.plot(y_hat_avg['moving_average_forecast'], label = 'Moving Average Forecast with 5 Observations')
plt.legend(loc = 'best')
plt.show()
