...
df1 = pd.read_csv('/kaggle/input/Identify_the_digits/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Identify_the_digits/Test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Identify_the_digits/Train/train.csv', delimiter=',', nrows = nRowsRead)
