...
before3 = "你好"
before4 = "नमस्ते"
# encode them to a different encoding, replacing characters that raise errors
...
police_killings = pd.read_csv("../input/kickstarter-projects/ks-projects-201612.csv",encoding=result['encoding'])
