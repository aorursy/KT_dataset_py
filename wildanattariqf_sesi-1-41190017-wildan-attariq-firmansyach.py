...
a*f
a**f
#universal functio(ufuncs) pada numpy seperti sin

np.sin(a)
#mengakses elemen pada index ke - 0
...
#slincing dari indeks ke 1, dan batas indeks ke 2

a[1:2]
#slicing dari indeks ke 1, dan batas indeks ke 1
...
frame['populasi']
#akses data pada baris ke 3, berarti indeksk ke 2
...
_=ax.set_ylabel('x axis')
#membuat bar plot

kategori = ['Panas','Dinginn']
