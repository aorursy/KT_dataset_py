...
print("media da amostra {}:".format(media_amostra))
...
print("numero de desvios {}:".format(confiança,tamanho_amostra))
...
print("desvio das amostras {}:".format(desvio_amostra/(tamanho_amostra)))
...
print('A média da população estará entre {} e {} com confiaça {}'.format(inferior,superior,confiança))
