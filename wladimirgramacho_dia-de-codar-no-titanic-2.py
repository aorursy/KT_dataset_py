...
X_train, X_test, y_train, y_test = train_test_split(predictors, target, test_size = 0.22, stratify=target, random_state = 0)
...
predictions = dectree_grid.predict(test.drop('PassengerId', axis=1))
