...
row_to_show = 18
sample_data_for_prediction = val_X.iloc[row_to_show].astype(float)  # to test function
sample_data_for_prediction_array = sample_data_for_prediction.values.reshape(1, -1)

# Create object that can calculate shap values
explainer = shap.TreeExplainer(my_model)
shap_values = explainer.shap_values(sample_data_for_prediction)

my_model.predict_proba(sample_data_for_prediction_array)
