...
def convert_image_to_array(image_dir):
    ...
    try:
        ...
        return None
directory_root = '../input/plantdiseasedataset/plantdiseasedataset'
X=[]
...
history = model.fit_generator(DataAugmentation.flow(x_train, y_train,batch_size=32),validation_data=(x_test,y_test),steps_per_epoch=len(x_train)/32, epochs=25, verbose=1)
