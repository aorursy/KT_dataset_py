...
class ResNet(nn.Module):
    ...
    def __init__(self, block, blocks_num, num_classes=3755, include_top=True):
...
def resnet34(num_classes=3755, include_top=True):
...
# net.load_state_dict(torch.load('../input/ccr-resnet34/resnet34_model.pth'))
# import logging
...
plt.legend()
torch.save(net.state_dict(), './resnet34_model.pth')