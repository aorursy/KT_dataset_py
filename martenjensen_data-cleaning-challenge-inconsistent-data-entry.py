...
province2 = suicide_attacks['Province'].unique()

province2.sort()

province2

# still a spelling mistake (balochistan/baluchistan) but fata is now unique
# get all the unique values in the 'City' column
...
# Replace with right spelling all 'kuram agency'
