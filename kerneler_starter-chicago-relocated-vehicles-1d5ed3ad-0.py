...
# relocated-vehicles.csv has 5910 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/relocated-vehicles.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'relocated-vehicles.csv'
nRow, nCol = df1.shape
