...
class LogsiticRegression(object):
    ...
    def sigmodFormatrix(self,x_data):
    ...
    def costFunc(self,Xb,y_total):

        yPre = list(self.sigmodFormatrix(Xb))
    ...
    def fit(self,x_total,y_total,alpha = 0.01,accuracy = 0.00001):
        ...
        oldJ = self.costFunc(x_data, y_total)

        self.loss_list.append(oldJ)
    ...
    def my_logsitic_regression(self,x_total,y_total):
        ...
        return np.round(self.sigmodFormatrix(x_data))
