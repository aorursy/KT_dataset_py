...
# ground_truth.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/ground_truth.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'ground_truth.csv'
