...
# Your code goes here
tally(data['country'],top = 10, graph = True, percent = True). head(10)
# Your code goes here
query(data = data, column = 'brand', condition = '=="Ve Wong"')
# Your code goes here

sort(data, by = 'stars', how = 'descending', inplace = False). tail(12)
#Your code goes here
query(data = data, column = 'stars', condition = '>3')
stars = query(data = data, column = 'stars', condition = '>3')
number = tabulate(stars['country'], stars['style'], method = 'count')
plot(data = number, x = 'country', y = 'count', colour = 'style', style = 'lineplot')
