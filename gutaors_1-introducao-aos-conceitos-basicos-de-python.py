...
#abs só trabalha com um valor, também tem a ver com interacao
# Qual o erro deste código abaixo?
...
pessoas = ['Gates', 'Madog', 'Bob Esponja', 'Fabio Assunção', 'Alan Turing']
