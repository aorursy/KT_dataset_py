...
sns.lineplot(x = 'quality', y = 'fixed acidity', data = wine)
...
fig = plt.figure(figsize = (10,6))
sns.lineplot(x = 'quality', y = 'residual sugar', data = wine)
#Composition of chloride also go down as we go higher in the quality of the wine
fig = plt.figure(figsize = (10,6))
sns.lineplot(x = 'quality', y = 'chlorides', data = wine)
fig = plt.figure(figsize = (10,6))
sns.lineplot(x = 'quality', y = 'free sulfur dioxide', data = wine)
fig = plt.figure(figsize = (10,6))
sns.lineplot(x = 'quality', y = 'total sulfur dioxide', data = wine)
