...
MyQuery1 = """ WITH time AS 
            ...
            ORDER BY DayOfYear, year
        """
transactions_per_dayofyear = bitcoin_blockchain.query_to_pandas(MyQuery1)

import matplotlib.pyplot as plt

# plot monthly bitcoin transactions
plt.plot(transactions_per_dayofyear)
plt.title("Daily Bitcoin Transcations in 2017")
# Q2
MyQuery2 = """ WITH merkle_transactions AS 
            (
        ...
        """
how_much_merkle = bitcoin_blockchain.query_to_pandas(MyQuery2)
