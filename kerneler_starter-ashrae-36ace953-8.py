...
# weather_test.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/weather_test.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'weather_test.csv'
