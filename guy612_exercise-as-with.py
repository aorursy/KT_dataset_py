...
speeds_query = """
               ...
               (
                   ...
                   SELECT trip_start_timestamp,unique_key,trip_miles,trip_seconds
               ...
               SELECT EXTRACT(HOUR FROM trip_start_timestamp) as hour_of_day,count(unique_key) as num_trips,3600*(SUM(trip_miles)/SUM(trip_seconds)) as avg_mph
...
safe_config = bigquery.QueryJobConfig(maximum_bytes_billed=50**10)
