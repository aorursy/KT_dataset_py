...
# !pip install '../input/simpletransformers0272/simpletransformers-0.27.2-py3-none-any.whl' -q
...
The cleaning code is taken from Gunes Evitan's Notebook
...
m = '/kaggle/input/pretrained-roberta-pytorch/roberta-base'
...
model = ClassificationModel(arch, m,
                            ...
                            args = {
                                ...
                                'best_model_dir': 'output/outputs-optim-params/best_model',
