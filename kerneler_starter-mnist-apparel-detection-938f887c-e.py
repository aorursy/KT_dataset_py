...
df1 = pd.read_csv('/kaggle/input/test_ScVgIM0/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/train_LbELtWX/train.csv', delimiter=',', nrows = nRowsRead)
