...
# install the efficientnet architecture, this is pretty much the only difference with the VGG-16 version

# EfficientNet is supposed to perform better on this problem as well :)
...
base_model = efn.EfficientNetB0(weights='imagenet', include_top=False, input_shape=(img_size, img_size, channels))
