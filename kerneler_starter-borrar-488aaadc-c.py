...
df1 = pd.read_csv('/kaggle/input/data_selected/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/data_selected/test.csv', delimiter=',', nrows = nRowsRead)
