...
dates
last_amount = test.loc[(test['Country_Region']=='Italy')&(test['Date']=='2020-04-07'),'ConfirmedCases_x']

last_fat = test.loc[(test['Country_Region']=='Italy')&(test['Date']=='2020-04-07'),'Fatalities_x']
last_fat.values[0]
last_amountntntnt.values[0]
len(dates)
i = 0
...
test.loc[(test['Country_Region']=='Spain')] #&(test['Date']==date),'ConfirmedCases_x' 
last_amount = test.loc[(test['Country_Region']=='Spain')&(test['Date']=='2020-04-07'),'ConfirmedCases_x']
...
for date in dates:
    ...
    test.loc[(test['Country_Region']=='Spain')&(test['Date']==date),
             ...
             'Fatalities_x'] =  last_fat.values[0]+i*(800-(10*i))
last_amount = test.loc[(test['Country_Region']=='China')&(test['Province_State']!='Hubei')&(test['Date']=='2020-04-07'),'ConfirmedCases_x']

last_fat = test.loc[(test['Country_Region']=='China')&(test['Province_State']!='Hubei')&(test['Date']=='2020-04-07'),'Fatalities_x']
i = 0
