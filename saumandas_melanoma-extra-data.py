...
model.add(InceptionResNetV2(input_shape=(224, 224, 3), include_top=False, weights='imagenet'))
...
model.fit(train_generator, epochs=10, steps_per_epoch=train_generator.n//train_generator.batch_size)#,
