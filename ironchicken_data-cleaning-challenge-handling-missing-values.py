...
rows_with_droped_na = sf_permits.dropna()
rows_with_droped_na.head()
print("rows_with_droped_na:%d \n" % 
      sf_permits.shape[1])
...
subset_sf_permits = sf_permits.loc[:, 'Existing Construction Type':'Proposed Construction Type'].head()
subset_sf_permits
