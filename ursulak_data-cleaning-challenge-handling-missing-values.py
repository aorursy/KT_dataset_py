...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_sf_permits[0:50]
...
empty_rows_dropped = sf_permits.dropna(axis=0)
empty_rows_dropped.head()
print("Rows in original dataset: %d \n" % sf_permits.shape[0])
print("Rows with na's dropped: %d" % empty_rows_dropped.shape[0])
