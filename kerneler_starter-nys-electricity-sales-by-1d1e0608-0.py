...
df1 = pd.read_csv('../input/electricity-sales-by-sector-gwh-beginning-1980.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'electricity-sales-by-sector-gwh-beginning-1980.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/electricity-sales-by-sector-tbtu-beginning-1980.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'electricity-sales-by-sector-tbtu-beginning-1980.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
