...
df1 = pd.read_csv('/kaggle/input/Participants_Data_HPP/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Participants_Data_HPP/Train.csv', delimiter=',', nrows = nRowsRead)
