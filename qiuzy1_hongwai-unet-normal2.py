...
seg_model.load_weights("../input/hongwai-unet-normal/seg_model_weights.best.hdf5")
...
print(a)
##binary_crossentropy() 可换交叉熵损失函数

seg_model.compile(optimizer=Adam(1e-2, decay=1e-6), loss='binary_crossentropy', metrics=[IoU,dice_coef,'binary_accuracy'])#tversky_loss
