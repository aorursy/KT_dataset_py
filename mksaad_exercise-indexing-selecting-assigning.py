...
df
# select 'country', 'province', 'region_1', 'region_2' where country == Italy
...
pysqldf("SELECT * FROM reviews;").head()
pysqldf("SELECT * FROM reviews where country=='Italy';").head()
type(pysqldf("SELECT * FROM reviews where country=='Italy';").head())
#q6.hint()
