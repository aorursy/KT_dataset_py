...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQmzU4Y5rRmpINpQi6cjSi1F9xPd3OF3BPwAnX-M52bUqBa4xc4&usqp=CAU',width=400,height=400)
...
for col in ['SPECIAL_DAY_SK', 'SPECIAL_DAY_SK2' ]:
...
plt.xlabel('DAY_OF_WEEK_SK Distribution ')
...
df['DAY_OF_MONTH'].hist(figsize=(10,4), bins=20)
ax = df['RAMADAN_FLAG'].value_counts().plot.barh(figsize=(10, 4))

ax.set_title('RAMADAN_FLAG Distribution', size=18)

ax.set_ylabel('RAMADAN_FLAG', size=10)

ax.set_xlabel('DAY_OF_WEEK_SK', size=10)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRua6jVejV3qiUrYR25U44p-Wh5IkfofC19ZMa6uNkhMyWGk7vq&usqp=CAU',width=400,height=400)