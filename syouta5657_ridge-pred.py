...
features1 =["OverallQual","GrLivArea", "GarageCars","TotalBsmtSF","FullBath", "YearBuilt"]

#features2 =  ["OverallQual","GrLivArea", "GarageCars",

                   #"TotalBsmtSF","FullBath", "YearBuilt",'1stFlrSF','FuseA', 'FuseF', 'FuseP', 'SBrkr']



train_data = df_train[features1]
...
df_test[features1].isnull().sum()  #there are missing data (´;ω;｀)
X_test = df_test[features1].fillna(df_test[features1].mean())
...
output.to_csv("regression_by_Ridge.csv", index= False)