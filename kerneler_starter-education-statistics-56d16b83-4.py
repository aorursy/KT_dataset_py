...
# EdStatsCountry.csv has 241 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/EdStatsCountry.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'EdStatsCountry.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# EdStatsCountry-Series.csv has 613 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/EdStatsCountry-Series.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'EdStatsCountry-Series.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# EdStatsData.csv has 886930 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/EdStatsData.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'EdStatsData.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
