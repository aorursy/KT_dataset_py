...
folds = KFold(n_splits=20, shuffle=True, random_state=37)
...
for fold_, (trn_idx, val_idx) in enumerate(folds.split(df_train)):
    ...
    clf = lgb.train(param, trn_data, num_round, valid_sets = [trn_data, val_data], verbose_eval=1000, early_stopping_rounds = 400)
