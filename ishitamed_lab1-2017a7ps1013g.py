...
df = pd.read_csv("/kaggle/input/nnfl-lab1-data/train.csv", sep=",")

df_test = pd.read_csv("/kaggle/input/nnfl-lab1-data/test.csv", sep=",")
...
print(y_classes)
df_submission = pd.read_csv('/kaggle/input/nnfl-lab1-data/sample_submission.csv', sep=',')
df_submission.head()
