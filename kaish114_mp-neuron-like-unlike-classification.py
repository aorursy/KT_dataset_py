...
y_trainn.head()
y_train = y_trainn.map(lambda x: 0 if x<4 else 1)
print(y_train.head())
...
plt.show()
x_binarised_test = test_new.apply(pd.cut , bins = 2 , labels = [0,1]) #binarised test data
...
#y_train_pred=mp_neuron.predict(x_binarised_train)
