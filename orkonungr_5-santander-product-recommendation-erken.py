...
df_train = pd.read_csv('../input/train_ver2.csv.zip',usecols=usecols)#, nrows=10000
...
# check if customer already have each product or not. / проверка, есть ли у клиента каждый продукт или нет.
already_active = {}
