...
with Img(filename=pdf, resolution=300) as img:
    ...
    img.convert("RGBA").save(filename='/kaggle/working/200503_rce_assembler_benchmark_notes.jpg') # intro page to preview later
...
wordBarGraphFunction(df.T,0,"Most Common Words on Page 3 of Bencmark Notes")
...
pdfimage3 = Image.open('/kaggle/working/200503_rce_assembler_benchmark_notes.jpg')
# PDF to JPG for p1
...
pdfimage2 = Image.open('/kaggle/working/200503_rce_assembler_benchmark_notes.jpg')
