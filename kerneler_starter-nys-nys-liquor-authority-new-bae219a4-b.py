...
# nys-liquor-authority-new-applications-received.csv has 1839 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/nys-liquor-authority-new-applications-received.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'nys-liquor-authority-new-applications-received.csv'
nRow, nCol = df1.shape
