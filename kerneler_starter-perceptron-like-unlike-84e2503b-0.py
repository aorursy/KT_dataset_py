...
# test (2).csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/test (2).csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'test (2).csv'
