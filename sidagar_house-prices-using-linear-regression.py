...
df_train_y.describe()
x_train,x_test,y_train,y_test = train_test_split(df_train_x, df_train_y,test_size=0.15,
...
predicted_train = reg.predict(df_train_x)
...
for i in useful:
    ...
    if i != 'SalePrice':
        ...
        useful1.append(i)
pre = reg.predict(df_test[useful1])
