...
df1 = pd.read_csv('../input/red-light-camera-locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'red-light-camera-locations.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# red-light-camera-violations.csv has 394428 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/red-light-camera-violations.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'red-light-camera-violations.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
df3 = pd.read_csv('../input/speed-camera-locations.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'speed-camera-locations.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
