...
for dataset in data:
    ...
    # fill NaN values in Age Column with random values generted
...
for dataset in data:
    ...
    dataset['Embarked'] = dataset['Embarked'].fillna(commen_value)
train_df.info()
data = [train_df,test_df]
...
# let's take alast look at the training set,before we start training the models
...
pd.read_csv('../input/titanic/gender_submission.csv').to_csv('the_solution.csv')