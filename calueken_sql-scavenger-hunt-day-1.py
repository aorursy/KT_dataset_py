...
countries_other_ppm = open_aq.query_to_pandas_safe(query1)

#countries_other_ppm.country.value_counts().head()

countries_other_ppm.country.unique()
...
pollutant0 = open_aq.query_to_pandas_safe(query2)

#countries_other_ppm.country.value_counts().head()

pollutant0.pollutant.unique()
