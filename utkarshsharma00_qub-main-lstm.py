...
filename = 'imdb_embedding_word2vec_lstm.txt'
...
f = open(os.path.join('', 'imdb_embedding_word2vec_lstm.txt'), encoding = 'utf-8')
...
model.fit(X_train_pad, y_train, batch_size = 128, epochs = 50, validation_data = (X_val_pad, y_val), verbose = 2, callbacks = [es])
