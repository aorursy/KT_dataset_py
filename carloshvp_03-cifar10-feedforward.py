...
counter_class = np.zeros(10,dtype=int)
counter_class
for img, label in dataset:
    counter_class[label] = counter_class[label] + 1
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        # hidden layer 7
        self.linear7 = nn.Linear(2048, 2048)
        # output layer
        self.linear8 = nn.Linear(2048, output_size)
...
test_loss, test_acc
arch = "7 layers (8192,8192,8192,2048,2048,2048,2048)"
lr = [0.6,0.4,0.2,0.1,0.05]
