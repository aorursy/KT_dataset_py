...
y.shape
datagen = ImageDataGenerator(horizontal_flip=True, vertical_flip=True, rescale=1.0/255.0, zoom_range = [0.2, 1.2])
new_input = tf.keras.layers.Input(shape = (224, 224, 3))
vgg16 = tf.keras.applications.vgg16.VGG16(include_top=False, input_tensor=new_input)
vgg16.summary()
