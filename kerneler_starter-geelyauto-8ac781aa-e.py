...
# CarPriceAssignment.csv has 205 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/CarPriceAssignment.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'CarPriceAssignment.csv'
nRow, nCol = df1.shape
