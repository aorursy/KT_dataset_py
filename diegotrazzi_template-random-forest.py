...
rf_model_on_full_data_val_predictions = rf_model_on_full_data.predict(X)
rf_model_on_full_data_mae = mean_absolute_error(rf_model_on_full_data_val_predictions, y)
