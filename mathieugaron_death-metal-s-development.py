...
_ = ax.annotate("Nirvana's \"nevermind\" was released", xy=(1991, 950), xytext=(1980, 1600), arrowprops={"width": 2.0, "headwidth": 8})
ax = bands[["formed_in", "genre"]].drop_duplicates().groupby("formed_in")["genre"].count().loc[:2015].plot(color="#ee7621", marker="h", ylim=[0, 400])
