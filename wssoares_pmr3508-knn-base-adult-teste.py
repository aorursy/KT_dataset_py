...
adult = pd.read_csv("../input/teste1/train_data.csv",na_values="?")
testadult = pd.read_csv("../input/teste1/test_data.csv",na_values="?")
...
melhorneighbors = 0
#procura pelo melhor k para os classificadores escolhidos
