...
# model_xgb = xgb.XGBRegressor(max_depth=2,learning_rate=0.05,n_estimators=1000,reg_alpha=0.001,reg_lambda=0.000001,n_jobs=-1,min_child_weight=3)

model_xgb = xgb.XGBRegressor(max_depth=2,learning_rate=0.05,n_estimators=1000, min_child_weight=3, reg_lambda=2) # Score: 0.129869
...
pred_train, preds_test, model = predict_cv(model_xgb, train, y, test)
