...
#svd = TruncatedSVD(n_components=11, n_iter=10, random_state=50)

#svd_heart=svd.fit(x_std).transform(x_std)
from sklearn.model_selection import train_test_split

X_train, X_test, y_train, y_test = train_test_split(lda_heart,y,test_size=0.3,random_state=1)
#from sklearn.discriminant_analysis import LinearDiscriminantAnalysis as LDA
...
print("The score for Random Forest Classifier is {}% with {} estimators.".format(rf_scores[0]*100, [ 5]))
# precision tp / (tp + fp)
...
classifier.add(Dense(output_dim = 5, init = 'uniform', activation = 'relu', input_dim = 1))
