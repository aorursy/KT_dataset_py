...
plt.title('my id')# TODO
plt.plot([3,2,4,1])
x = np.arange(6)
plt.plot(x, [i**2 for i in x])# TODO
x = np.arange(0.0, 0.6, 0.01)# TODO
y = [i**2 for i in x]
plt.plot(x, y)
# TODO
...
cos_y = np.cos(x)
# TODO
plt.plot(x, sin_y, color = 'r', linewidth = 3.0, label = 'Sin', linestyle = ':')
plt.plot(x, cos_y, color = 'b', linewidth = 2.0, label = 'Cos', linestyle = '-')
plt.legend(loc = (0, 1))
