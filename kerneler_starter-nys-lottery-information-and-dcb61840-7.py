...
# lottery-cash-4-life-winning-numbers-beginning-2014.csv has 430 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# lottery-daily-numbers-win-4-winning-numbers-beginning-1980.csv has 13757 rows in reality, but we are only loading/previewing the first 100 rows
