...
# test (1).csv has 16280 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# train (1).csv has 32560 rows in reality, but we are only loading/previewing the first 100 rows
