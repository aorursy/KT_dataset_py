...
numpy.random.seed(0)
# Importing the file
data = pandas.read_csv("../input/PakistanSuicideAttacks Ver 11 (30-November-2017).csv")
...
print(result)
# read in our dat
suicide_attacks = pandas.read_csv("../input/PakistanSuicideAttacks Ver 11 (30-November-2017).csv", 
...
cities.sort()
cities
# Replacing the string "baluchistan" in Province column
