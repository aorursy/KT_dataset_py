...
tree_grid_1 = GridSearchCV(tree, tree_params, cv=5, scoring='f1')
...
tree_grid_2 = GridSearchCV(tree, tree_params, cv=5, scoring='f1')
...
tree_grid_3 = GridSearchCV(tree, tree_params, cv=5, scoring='f1')
...
rf_1 = GridSearchCV(rf, rf_params, cv=5, scoring='f1')
...
rf_2 = GridSearchCV(rf, rf_params, cv=5, scoring='f1')
...
rf_3 = GridSearchCV(rf, rf_params, cv=5, scoring='f1')
...
rf_4 = GridSearchCV(rf, rf_params, cv=5, scoring='f1')
...
rf_5 = GridSearchCV(rf, rf_params, cv=5, scoring='f1')
