...
clf = RandomForestClassifier(n_estimators=30,random_state =1029)
...
random_search = RandomizedSearchCV(clf, param_distributions=param_dist,
                                   n_iter=n_iter_search,random_state =9102)

#cross-validation and hyper parameter explore extratrees
clfe = ExtraTreesClassifier(n_estimators=30,random_state =1123)
...
random_search_e = RandomizedSearchCV(clfe, param_distributions=param_dist,
                                   n_iter=n_iter_search,random_state =3211)
#voting

logreg = LogisticRegression(random_state =31395)
rf=random_search #from cross-validation
extree = random_search_e
svc=svm.SVC(random_state =234)
xg=XGBClassifier(random_state =543)

ada=AdaBoostClassifier(random_state =345)
...
n_iter_search = 20
random_search = RandomizedSearchCV(clf, param_distributions=param_dist,
                                   n_iter=n_iter_search,random_state =98765)
rf=random_search
