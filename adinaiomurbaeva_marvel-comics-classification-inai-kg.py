...
sns.factorplot('ALIGN',data=data,kind="count")
...
data.ALIVE[data['SEX'] == 'Female Characters'].value_counts().plot(kind='pie')
fig = plt.figure(figsize=(10,4))
...
data.ALIGN[data['ALIVE'] == 'Deceased Characters'].value_counts().plot(kind='pie')
...
trainX, testX, trainY, testY = train_test_split(data[['GSM', 'SEX', 'ALIGN','ID']], data['ALIVE'], test_size = 0.3)
