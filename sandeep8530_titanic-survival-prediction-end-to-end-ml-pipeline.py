...
fill1=np.array(['ny1','ny2','ny3'])

fill2=['n1','n2','n3']

print(type(fill1))

df.loc[df['location'] == 'New_York', 'pets'] = fill2
...
#note their is no Survived column here which is our target varible we are trying to predi
...
##title_search1 = re.search('([M]+)', 'Mr. sandeep')

##if title_search1:

##    print(title_search1.group(2))
