...
cities.sort()
cities
# Let count unique value in cities
collections.Counter(cities)
...
provinces.sort()
provinces
collections.Counter(provinces)
# let convert province to lower case
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()

# now we remove trailing white spaces, not necessary in that case
...
for province in suicide_attacks['Province'].unique():
    replace_matches_in_column(df=suicide_attacks, column='Province', string_to_match=province)
provinces = suicide_attacks['Province'].unique()
provinces.sort()
provinces
# get all the unique values in the 'City' column
