...
Challenge1_upload = pd.read_csv("../input/regular-train-valid5fold/Challenge1_upload.csv")

regular_train_valid_5fold = pd.read_csv("../input/regular-train-valid5fold/regular_train_valid_5fold.csv")





fold_set = pd.read_csv('../input/deepdrid-weights/regular_train_valid_challenge2_Clarity.csv')
...
results = pd.DataFrame({'image_id':test['image_id'], 'Clarity':predictions})
...
results.to_csv('Challenge2_upload_Clarity.csv', index=False)

display(results.head())
results['Clarity'].value_counts()