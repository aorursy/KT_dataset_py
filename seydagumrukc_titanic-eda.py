...
def bar_plot(variable):
    ...
    #number of categorical variable(value/sample)
...
train_df=train_df.drop(detect_outlier(train_df,['Age','SibSp','Fare','Parch']),axis=0).reset_index()
