...
ax[1].plot(model_with_data_augmentation.history['acc'], color='b', label="Training accuracy")
ax[1].plot(model_with_data_augmentation.history['val_acc'], color='r',label="Validation accuracy")
