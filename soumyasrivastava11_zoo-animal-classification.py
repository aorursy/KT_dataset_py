...
# It is defined by the kaggle/python Docker image: https://github.com/kaggle/dockezr-python
...
train_df
del train_df["animal_name"]
train_df.isna().sum()
train_df.skew()
train_df["class_type"].unique()

target=train_df["class_type"]
del train_df["class_type"]
train_df
