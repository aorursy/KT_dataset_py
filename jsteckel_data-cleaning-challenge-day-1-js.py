...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
#check missing amounts for the columns of interest
missing_values_count_sf

#Street Number Suffix is St, Av etc.  Probably replace this with "Other", or the median value.  Zip would probably be replaced by median value.  Or some work to figure it out based on street etc.
