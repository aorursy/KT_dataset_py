...
# Police Fatalities.csv has 12491 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Police Fatalities.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Police Fatalities.csv'
nRow, nCol = df1.shape
