...
lVar=['race', 'age', 'class_', 'educ', 'income', 'region', 'news']
...
my_variable = 'age' # Replace VAR with the name of a numeric variable.
...
my_variable = 'educ' # Replace VAR with the name of a numeric variable.
plt.hist(dfGSS[my_variable])
plt.xlabel(my_variable)
plt.ylabel('Frequency')
plt.title('Histogram of '+my_variable)
...
my_variable = 'class_' # Replace VAR with the name of a categorical variable.
...
plt.show()
my_variable = 'race' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
...
plt.xticks(locs, my_xticks, rotation=90)
plt.show()
my_variable = 'region' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('bar chart of '+my_variable)
plt.xlabel(my_variable)
...
# Replace INDEPENDENT_VARIABLE and DEPENDENT_VARIABLE with the names of 
# your independent and dependent variables from the worksheet.
varA=dfGSS.loc[:,'class_']
varB=dfGSS.loc[:,'income']
