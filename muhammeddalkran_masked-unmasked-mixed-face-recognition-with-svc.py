...
# resize pixels to the model size
    ...
    return face_array
img = extract_face('/kaggle/input/masked-unmasked-mixed/mixed/train/chenhe/1_0_chenhe_0195.jpg')
...
# load train dataset
trainX, trainy = load_dataset('/kaggle/input/masked-unmasked-mixed/mixed/train/')
...
# load train dataset
testX, testy = load_dataset('/kaggle/input/masked-unmasked-mixed/mixed/test/')
print(testX.shape, testy.shape)
# save and compress the dataset for further use
np.savez_compressed('extracted_masked_unmasked.npz', trainx, y_train, valid, y_valid,testX, testy)
data = np.load('extracted_masked_unmasked.npz')
