...
print("examples of test data set")
...
sns.factorplot('Embarked','Survived', data=titanic_df,size=4,aspect=3, kind = 'point')
...
sns.countplot(x='Survived', hue = "Pclass",data=titanic_df,order = [1,0], ax=axis2)

sns.countplot(x='Survived', hue = "Embarked",data=titanic_df,order = [1,0], ax=axis3)
fig, (axis11,axis22) = plt.subplots(1,2,figsize =(12,5))

# group by embarked, and get the mean for survived passengers for each value in Embarked

embark_perc = titanic_df[["Embarked", "Survived"]].groupby(['Embarked'],as_index=False).mean()

sns.barplot(x='Embarked', y='Survived', data=embark_perc,order=['S','C','Q'],ax=axis11)



# group by passenger class, and get the mean for survived passengers for each value in Pclass

pclass_perc = titanic_df[["Pclass", "Survived"]].groupby(['Pclass'],as_index=False).mean()

sns.barplot(x='Pclass', y='Survived', data=pclass_perc, ax=axis22)

# we can drop the 'Embarked' column
...
axis2.set_title('New Age values - Training set')
...
labelencoder_Xp = LabelEncoder()



# Encode 'Person' for X_train

X_train[['Person']] = labelencoder_Xp.fit_transform(X_train[['Person']])
...
labelencoder_Xp1 = LabelEncoder()

X_test[['Person']] = labelencoder_Xp1.fit_transform(X_test[['Person']])

onehotencoder4 = OneHotEncoder(categorical_features = [3])
