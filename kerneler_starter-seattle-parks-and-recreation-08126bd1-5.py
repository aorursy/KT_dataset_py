...
# seattle-parks-and-recreation-class-registration-data.csv has 4928 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/seattle-parks-and-recreation-class-registration-data.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'seattle-parks-and-recreation-class-registration-data.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# seattle-parks-and-recreation-community-center-people-counter-data.csv has 1652 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/seattle-parks-and-recreation-community-center-people-counter-data.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'seattle-parks-and-recreation-community-center-people-counter-data.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
df3 = pd.read_csv('../input/seattle-parks-and-recreation-lifelong-recreation-50-class-participation.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'seattle-parks-and-recreation-lifelong-recreation-50-class-participation.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
