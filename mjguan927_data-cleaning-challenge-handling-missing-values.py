...
# percent of data that is missing
print('Percentage of data missing is:', (total_missing2/total_cells2) * 100)
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_count2['Street Number Suffix']
missing_values_count2['Zipcode']
sf_permits[['Zipcode','Street Number Suffix']].head(20)
