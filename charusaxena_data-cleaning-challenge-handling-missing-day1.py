...
#Percentage of data empty fro the dataset:
total_cell =np.product(sf_permits.shape)
total_miss  = missing_val.sum()
percent = (total_miss/total_cell)*100
print("percentage missing",percent)
...
columns_dropped_nan = sf_permits.dropna(axis=1)
print("remaining columns are:",sf_permits.shape[1]-columns_dropped_nan.shape[1])
columns_dropped_nan.head()
