...
fashion_model.add(Dense(100))#defualt is 'relu'
...
fashion_model.fit(x,y,batch_size=100,
...
second_fashion_model.add(Conv2D(33,
...
second_fashion_model.add(Conv2D(20, activation='relu', kernel_size=5))

second_fashion_model.add(Conv2D(10, activation='relu', kernel_size=3))

second_fashion_model.add(Conv2D(10, activation='relu', kernel_size=5))

second_fashion_model.add(Conv2D(20, activation='relu', kernel_size=3))
...
#second_fashion_model.fit(x, y, batch_size=100, epochs=5, validation_split=0.2)



second_fashion_model.fit(x, y, batch_size=200, epochs=5, validation_split=0.2)
