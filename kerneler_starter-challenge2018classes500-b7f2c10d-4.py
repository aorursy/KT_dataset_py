...
# challenge-2018-class-descriptions-500.csv has 499 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/challenge-2018-class-descriptions-500.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'challenge-2018-class-descriptions-500.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# checked_files.csv has 52458 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/checked_files.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'checked_files.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# files_names.csv has 99998 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/files_names.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'files_names.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
