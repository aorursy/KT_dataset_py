...
movie.plot(y= 'imdb_score', x ='gross',kind='hexbin',gridsize=35, sharex=False, colormap='cubehelix', title='Hexbin of Imdb_Score and Gross')
...
sns.heatmap(movie_num.astype(float).corr(),linewidths=0.25,vmax=1.0, square=True, cmap="YlGnBu")
...
plt.scatter(x_9d[:,0],x_9d[:,1], c='goldenrod')
...
sns.pairplot(df, hue='X_cluster',diag_kind='kde',size=1.85)
