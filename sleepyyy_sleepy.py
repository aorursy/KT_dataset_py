...
diamonds_num = diamonds.drop(["cut", "color", "clarity","depth"], axis = 1)
diamonds_num.head()
...
diamonds_submission_num = diamonds_submission.drop(["cut", "color", "clarity","depth"], axis = 1)
...
price_submission.to_csv("submission2.csv", index=False)