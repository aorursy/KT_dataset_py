...
df = pd.read_excel("../input/Turkey_cities.xls")
...
!pip install bubbly
# Since kaggle does not install bubbly module I will copy all of it to here. You can find it in:https://github.com/AashitaK/bubbly
