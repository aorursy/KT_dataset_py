...
# city-of-seattle-neighborhood-matching-funds.csv has 4086 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/city-of-seattle-neighborhood-matching-funds.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'city-of-seattle-neighborhood-matching-funds.csv'
nRow, nCol = df1.shape
