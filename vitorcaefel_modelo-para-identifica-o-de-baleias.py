...
img_treino= "../input/treino-foto/"
img_test= "../input/test-foto/"
base_treino="../input/treino/treino.csv"
IMG_SIZE = 64
...
plt.plot(history1.history['acc'], color='blue', linewidth = 2, label="batch_size - 20%") 
plt.plot(history2.history['acc'], color='red', linewidth = 2, label="batch_size - 10%") 
plt.plot(history3.history['acc'], color='green', linewidth = 2, label="batch_size - 5%") 
plt.plot(history4.history['acc'], color='orange', linewidth = 2, label="batch_size - 1,62%") 
plt.plot(history5.history['acc'], color='yellow', linewidth = 2, label="batch_size - 0,5%")
plt.plot(history6.history['acc'], color='black', linewidth = 2, label="batch_size - 2,5%")
plt.title('Acurácia do Modelo CNN - 100 Épocas')
plt.ylabel('Acurácia')
plt.xlabel('Épocas')
plt.legend()
plt.show()
plt.plot(history7.history['acc'], color='blue', linewidth = 2, label="batch_size - 5%") 
plt.plot(history8.history['acc'], color='red', linewidth = 2, label="batch_size - 2,5%") 
plt.plot(history9.history['acc'], color='green', linewidth = 2, label="batch_size - 1,2%")
plt.plot(history10.history['acc'], color='yellow', linewidth = 2, label="batch_size - 10%")
plt.legend()
...
plt.xlabel('Épocas')
plt.show()
plt.plot(history1.history['loss'], color='blue', linewidth = 2, label="batch_size - 20%") 
plt.plot(history2.history['loss'], color='red', linewidth = 2, label="batch_size - 10%") 
plt.plot(history3.history['loss'], color='green', linewidth = 2, label="batch_size - 5%") 
plt.plot(history4.history['loss'], color='orange', linewidth = 2, label="batch_size - 2,5%") 
plt.plot(history5.history['loss'], color='yellow', linewidth = 2, label="batch_size - 0,6%")
plt.legend()
...
plt.xlabel('Épocas')
plt.show()
plt.plot(history7.history['loss'], color='blue', linewidth = 2, label="batch_size - 10%") 
plt.plot(history8.history['loss'], color='red', linewidth = 2, label="batch_size - 5%") 
plt.plot(history9.history['loss'], color='green', linewidth = 2, label="batch_size - 2,5%") 
plt.plot(history10.history['loss'], color='yellow', linewidth = 2, label="batch_size - 1,2%") 
plt.legend()
...
def cnn1():
    modelo = Sequential()
    modelo.add(Conv2D(32, (3, 3), strides = (1, 1), input_shape = (IMG_SIZE, IMG_SIZE, 1)))
    modelo.add(BatchNormalization(axis = 3))
    modelo.add(Activation('relu'))
    modelo.add(MaxPooling2D((2, 2)))
    modelo.add(Conv2D(64, (3, 3), strides = (1,1)))
    modelo.add(Conv2D(64, (3, 3), strides = (1,1)))
    modelo.add(Conv2D(64, (3, 3), strides = (1,1)))
    modelo.add(Activation('relu'))
    modelo.add(AveragePooling2D((3, 3)))
    modelo.add(Flatten())
    modelo.add(Dense(500, activation="relu"))
    modelo.add(Dropout(0.6))
    modelo.add(Dense(5005, activation='softmax'))
...
modelo11 = cnn1()
history11 = modelo11.fit(X_train, Y_train, epochs=100, batch_size=250, verbose=2, callbacks=[learning_rate_reduction])
#Decimo modelo com 200 Epocas e batch_size de aproximadamente 5% do tamanho da base
modelo12 = cnn1()
history12 = modelo12.fit(X_train, Y_train, epochs=100, batch_size=125, verbose=2, callbacks=[learning_rate_reduction])
#Decimo modelo com 200 Epocas e batch_size de aproximadamente 2,5% do tamanho da base
modelo13 = cnn1()
history13 = modelo13.fit(X_train, Y_train, epochs=100, batch_size=60, verbose=2, callbacks=[learning_rate_reduction])
...
plt.plot(history11.history['acc'], color='blue', linewidth = 2, label="batch_size - 10%") 
plt.plot(history12.history['acc'], color='red', linewidth = 2, label="batch_size - 5%") 
plt.plot(history13.history['acc'], color='green', linewidth = 2, label="batch_size - 2,5%")
plt.plot(history14.history['acc'], color='yellow', linewidth = 2, label="batch_size - 1,62%")
plt.title('Acurácia do Modelo CNN - 100 Épocas e 14 camadas')
plt.legend()
plt.xlabel('Épocas')
plt.ylabel('Acurácia')
plt.xlabel('Épocas')
plt.show()
plt.plot(history11.history['loss'], color='blue', linewidth = 2, label="batch_size - 10%") 
plt.plot(history12.history['loss'], color='red', linewidth = 2, label="batch_size - 5%") 
plt.plot(history13.history['loss'], color='green', linewidth = 2, label="batch_size - 2,5%") 
plt.plot(history14.history['loss'], color='yellow', linewidth = 2, label="batch_size - 1,62%") 
plt.title('Perda do Modelo CNN - 200 Épocas - 14 Camadas')
plt.legend()
plt.xlabel('Épocas')
plt.ylabel('Acurácia')
plt.xlabel('Épocas')
