...
x_data = df.drop(["sex","restecg","exang","slope","ca","thal","target","oldpeak"],axis =  1)
...
logistic_regression(x_train, y_train, x_test, y_test,learning_rate = 1, num_iterations = 70)
