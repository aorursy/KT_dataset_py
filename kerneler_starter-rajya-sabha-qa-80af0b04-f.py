...
df1 = pd.read_csv('../input/India_2011census_state.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'India_2011census_state.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# rajyasabha_member_details_allyears.csv has 3261 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/rajyasabha_member_details_allyears.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'rajyasabha_member_details_allyears.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# rajyasabha_questions_and_answers_2009.csv has 271 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/rajyasabha_questions_and_answers_2009.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'rajyasabha_questions_and_answers_2009.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
