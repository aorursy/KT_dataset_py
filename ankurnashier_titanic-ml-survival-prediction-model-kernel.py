...
#test_df.loc[(test_df['Fare'] > 8 ) &(test_df['Fare'] <=15),'Fare']=1
#test_df.loc[(test_df['Fare'] > 15 ) &(test_df['Fare'] <=30),'Fare']=2
#test_df.loc[(test_df['Fare'] > 30 ) &(test_df['Fare'] <=513),'Fare']=3
...
z={'PassengerId':list(test_df_t['PassengerId']) , 'Survival':list(y_pred)}
pd.DataFrame(z)
