...
df1 = pd.read_csv('/kaggle/input/2009.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/2010.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/2011.csv', delimiter=',', nrows = nRowsRead)
