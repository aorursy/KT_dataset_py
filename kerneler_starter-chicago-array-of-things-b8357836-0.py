...
# array-of-things-locations.csv has 106 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/array-of-things-locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'array-of-things-locations.csv'
nRow, nCol = df1.shape
