...
!rm -rf /kaggle/tmp/fastai/weights.tgz
!mkdir /kaggle/tmp/data/dogbreed
!cp -r ../input/dog-breed-identification/* /kaggle/tmp/data/dogbreed
!ls /kaggle/tmp/data/dogbreed/
...
len(data.classes), data.classes[:6]
...
#File:      fastai/dataset.py
data = get_data(sz, bs)
!ls /kaggle/tmp/fastai/weights/
...
#        else:
#            self.freeze()
#File:      fastai/conv_learner.py
# learn.summary() # uncommnet to see the complete model summary of all layers
learn.fit(1e-2, 1, cycle_len=1)
# When you are under fitting, it means cycle_len=1 is too short (learning rate is getting reset before it had the chance to zoom in properly).
# learn.fit(1e-2, 3, cycle_len=1, cycle_mult=2) # 1+2+4 = 7 epochs (Uncommnet for better accuracy)
