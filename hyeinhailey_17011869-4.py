...
train = pd.read_csv('../input/2020-ai-exam-fashionmnist-4/mnist_train_label.csv', header=None)
...
lin4 = nn.Linear(512,512,bias=True)

lin5 = nn.Linear(512, 10, bias=True)
...
nn.init.kaiming_uniform(lin4.weight)

nn.init.kaiming_uniform(lin5.weight)
...
print('Finished')
test = pd.read_csv('../input/2020-ai-exam-fashionmnist-4/mnist_test.csv', header=None, usecols=range(1,785))
