...
filenames = ['googl.us.txt','prk.us.txt', 'bgr.us.txt', 'jci.us.txt', 'aa.us.txt', 'fr.us.txt', 'star.us.txt', 'sons.us.txt', 'ipl_d.us.txt', 'sna.us.txt', 'utg.us.txt']
...
temp1 = training_set['Volume'].reshape(-1,1)

temp2 = test_set['Volume'].reshape(-1,1)
...
training_set['Volume'] = temp1

test_set['Volume'] = temp2
