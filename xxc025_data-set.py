...
train_images_path='../input/data_set/data_set/train'

train_labels_path='../input/data_set/data_set/label'

# val_images_path='../input/adechallengedata2016/ADEChallengeData2016/images/'

# val_labels_path='../input/adechallengedata2016/ADEChallengeData2016/annotations/'

test_images_path='../input/data_set/data_set/test'
...
#             print('{} loss: {}'.format(epoch+1,epoch_losses/3))
...
#             pred_out[i,:,:]=torch.max(out,1)[1].cpu().numpy()

#             pred_outcls[i,:,:]=torch.max(out_cls,1)[1].cpu().numpy()
...
ax[0].imshow(pred_out[2].reshape((473,473)),cmap='gray')

ax[1].imshow(pred_outcls[2].reshape((473,473)),cmap='gray')
