...
# read in our dat
suicide_attacks6 = pd.read_csv("../input/PakistanSuicideAttacks Ver 11 (30-November-2017).csv", 
                              encoding='Windows-1252')
suicide_attacks6.head()
cities = suicide_attacks6['City'].unique()
# sort them alphabetically and then take a closer look
cities.sort()
cities
suicide_attacks6['City'] = suicide_attacks6['City'].str.lower()
# remove trailing white spaces
suicide_attacks6['City'] = suicide_attacks6['City'].str.strip()
...
replace_matches_in_column(df=suicide_attacks6, column='City', string_to_match="kuram agency")
replace_matches_in_column(df=suicide_attacks6, column='City', string_to_match="d.i khan")
