...
tally(data['country'],percent = True, top = 10)
query(data = data, column = 'brand', condition = '=="Ve Wong"')
star_sort = sort(data['stars'],how = 'descending')
index(star_sort)[988:1000]

data_2=query(data = data, column = 'stars', condition = '>3')
table = tabulate(data_2['country'], data_2['style'])
plot(data = table, x = 'country', y = 'count', colour = 'style', style = 'lineplot')
