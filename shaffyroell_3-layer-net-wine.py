...
def forward_prop(model,a0):
    ...
    cache = {'a0':a0,'z1':z1,'a1':a1,'z1':z1,'a2':a2, 'a3':a3}
    return cache
...
def backward_prop(model,cache,y):
 ...
 # Calculate loss derivative with respect to output
    ...
    db1 = np.sum(dz1, axis=0)
     ...
     # loss derivative of step 3
    dz3 = log_loss_derivative(y=y,y_hat=a3)
    
    # calculate third layer weights
    dW3 = (a2.T).dot(dz2)
    
    # calculate loss derivative w.r.t third layer weights
