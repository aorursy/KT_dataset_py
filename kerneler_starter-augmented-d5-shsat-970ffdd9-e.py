...
# augmented_D5_SHSAT_Registrations_and_Testers.csv has 140 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/augmented_D5_SHSAT_Registrations_and_Testers.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'augmented_D5_SHSAT_Registrations_and_Testers.csv'
nRow, nCol = df1.shape
