...
# work-order-management-module.csv has 146096 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/work-order-management-module.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'work-order-management-module.csv'
nRow, nCol = df1.shape
