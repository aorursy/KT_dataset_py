...
kickstarters_2017.sample(5) # a glance to data 
...
sns.distplot(scaled_data, ax=ax[1])
ax[1].set_title("Scaled data")
# Your turn! We just scaled the "usd_goal_real" column. What about the "goal" column?
...
sns.distplot(scaled_data, ax=ax[1])
ax[1].set_title("Scaled data")
# We just scaled the "usd_goal_real" column. You scaled the "goal" column
