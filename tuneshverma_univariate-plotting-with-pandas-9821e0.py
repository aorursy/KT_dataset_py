...
pokemon['experience_growth'].value_counts().plot.bar()
pokemon['percentage_male'].value_counts().plot.bar()
pokemon['base_egg_steps'].value_counts().plot.bar()
pokemon['base_happiness'].value_counts().plot.bar()
pokemon['generation'].value_counts().plot.bar()
pokemon['against_bug'].value_counts().plot.bar()
pokemon['base_total'].value_counts().sort_index().plot.line()
pokemon['hp'].value_counts().sort_index().plot.line()
pokemon['hp'].value_counts().sort_index().plot.line()
pokemon['capture_rate'].value_counts().sort_index().plot.line()
pokemon['classfication'].value_counts().sort_index().plot.line()
pokemon['defense'].value_counts().sort_index().plot.line()
pokemon['height_m'].value_counts().sort_index().plot.line()
pokemon['sp_attack'].value_counts().sort_index().plot.line()
pokemon['sp_defense'].value_counts().sort_index().plot.line()
pokemon['speed'].value_counts().sort_index().plot.line()
pokemon['weight_kg'].plot.hist()
pokemon['attack'].plot.hist()
pokemon['height_m'].plot.hist()
pokemon['speed'].plot.hist()
pokemon['height_m'].plot.hist()
pokemon['base_total'].plot.hist()
