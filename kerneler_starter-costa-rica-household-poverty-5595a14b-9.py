...
# payamr_submission.csv has 23856 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/payamr_submission.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'payamr_submission.csv'
nRow, nCol = df1.shape
