...
n, bins, patches = plt.hist(df_train['SalePrice'], num_bins, density=True)
...
n, bins, patches = plt.hist(sale_price_norm, num_bins, density=True)
...
def plot_distribution(to_be_plotted):
    ...
    for i, entry in enumerate(to_be_plotted):
        ...
        n, bins, patches = plt.hist(dataset[entry], num_bins, density=True)
