...
fold_set = pd.read_csv('../input/deepdrid-weights/regular_train_valid_5fold_test_pseudolabel.csv')
...
train_dir ='../input/deepdrid-weights/regular_train_valid_test/regular_train_valid_test'
