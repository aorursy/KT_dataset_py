...
df.groupby(df['Club'])["Nationality"].nunique().sort_values(ascending = False).head(20)
def club(x):
...
club('Galatasaray SK').head(30)
df[(df['Nationality'] == "Turkey")][['Name','Nationality','Club','Overall','Skill Moves','Position']].head(30)
...
df[df['Age']<22].sort_values(by = 'Potential' , ascending = False).head(10)
...
df_nations[(df_nations['Nation'] == 'Turkey') ]
