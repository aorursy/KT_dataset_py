...
# maximaler Wert von Personen die auf einer Seite sein können
max_value = 4
startzustand = [4,4,1]
zielzustand  = [0,0,0]
...
def gib_folgezustaende(zustand):
    ...
    # Alle Folgezustände die bei einer 4-4 Konstellation valide sind. Annahme: Kanibalen in der Mehrheit überfallen auch auf dem Boot Missionare.
    fzustaende = [
        [m+incr, k, b_new],
        [m+incr*2, k, b_new],
        [m+incr*3, k, b_new],
...
suche(startzustand,[],True,debug=0) # One solution
