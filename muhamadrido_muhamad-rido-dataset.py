...
data_train = pd.read_csv('/kaggle/input/datatest/ridho.csv')

data_test = pd.read_csv('/kaggle/input/on-time-graduation-classification/data_lulus_tepat_waktu.csv')
...
x_test = data_train_df_encoded.drop(['Tepat'],axis=1)

y_test = data_train_df_encoded['Tepat']
model = GaussianNB()
