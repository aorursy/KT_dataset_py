...
# Add points of berkeley Starbucks locations to the map
...
# merge several dataframes into one based on the index GEOID
...
CA_stats.head()
CA_stats[(CA_stats.high_earners >= 100000) & (CA_stats.median_age < 38.5) & (CA_stats.density >= 285) & ((CA_stats.high_earners >= 500000) | (CA_stats.median_age < 35.5) | (CA_stats.density >= 1400))]
# Your code here
...
selected_stores = gpd.sjoin(sel_counties,starbucks_gdf)
...
m_6 = folium.Map(location=[36,-120], zoom_start=6)
