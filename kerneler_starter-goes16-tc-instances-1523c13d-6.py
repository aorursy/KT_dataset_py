...
# TC_Instances_Since_GOES16_Launch.csv has 979 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/TC_Instances_Since_GOES16_Launch.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'TC_Instances_Since_GOES16_Launch.csv'
nRow, nCol = df1.shape
