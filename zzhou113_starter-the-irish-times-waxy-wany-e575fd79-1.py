...
df1 = pd.read_csv('/kaggle/input/irishtimes-date-text.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/w3-latnigrin-text.csv', delimiter=',', nrows = nRowsRead)
