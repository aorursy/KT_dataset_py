...
titanic = pd.read_csv(r"C:\Users\HP\Downloads\train.csv")
# Print the first 5 rows of the dataframe.
titanic.head()
import os
os.getcwd()
titanic_test = pd.read_csv(r"C:\Users\HP\Downloads\test.csv")
#transpose
titanic_test.head().T
...
rf = RandomForestClassifier(random_state=1, n_estimators=10, min_samples_split=2, 
                            min_samples_leaf=1)
kf = KFold(titanic.shape[0], n_splits=5, random_state=1)
cv = ShuffleSplit(n_splits=10, test_size=0.3, random_state=50)
