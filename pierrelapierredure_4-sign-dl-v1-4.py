...
X_test = X_test/255
from sklearn.neural_network import MLPClassifier #Réseau de neuronne : méthode 1
mlp = MLPClassifier(hidden_layer_sizes=(200,60))
mlp.fit(X,y)
y_mlp = mlp.predict(X_test)

pd.crosstab(y_test, y_mlp, rownames=['Reel'], colnames=['Prediction'], margins=True)
from keras.utils.np_utils import to_categorical #Réseau de neuronnes : méthode 2
