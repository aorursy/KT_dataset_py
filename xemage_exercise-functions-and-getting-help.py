...
def to_smash(total_candies, numFriends=3):
    ...
    the given number of candies evenly between the given number of freinds (default: 3).
...
duration = time_call(sleepFor, 10)
endTime = time()
print("End time: ", endTime)
print("time_call return: ", duration)
...
smallest_stringy_number('one', '3','0.5')
q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
