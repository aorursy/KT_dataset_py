...
def build_model():
    ...
    return model
model_1 = build_model()
utils.plot_model(model_1, to_file='model_1_plot.png', show_shapes=True, show_layer_names=True)
...
for a in MLA:
    ...
    time_now = time.time()
algorithms.sort_values(by=['Accuracy' , 'Cross_val_score'] ,  ascending = False , inplace = True)
