...
out_layer = Dense(x_train.shape[5], activation = 'softmax')(dr_steps)
...
pneu_model.compile(optimizer = Adam(lr = LEARN_RATE), loss = 'sparse_categorical_crossentropy',
...
weight_path="../input/resnet50/resnet50_weights_tf_dim_ordering_tf_kernels.h5".format('lung_opacity')
...
pred=pneu_model.predict(x_test)
