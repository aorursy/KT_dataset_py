...
subset_nfl_data = subset_nfl_data.loc[:, 'Existing Construction Type Description': 'Supervisor District'].head()
subset_nfl_data.fillna(method = 'bfill', axis=0).fillna('N')