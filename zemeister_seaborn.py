...
ax.legend(loc='lower right',frameon = True)     # legendaryning alfaligi
...
plt.text(40,0.6,'high school graduate ratio',color='red',fontsize = 17,style = 'oblique')
