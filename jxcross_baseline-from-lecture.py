!pwd
!ls -al /kaggle/input/kisti-kaggle-competition-2/
...
%matplotlib inline
df_train = pd.read_csv('/kaggle/input/kisti-kaggle-competition-2/train.csv')

df_test = pd.read_csv('/kaggle/input/kisti-kaggle-competition-2/test.csv')
# 데이터 셋 살펴보기
...
plt.show()
submission = pd.read_csv('/kaggle/input/kisti-kaggle-competition-2/sample_submission.csv')
submission.head()
prediction = model.predict(X_test)

submission['Survived'] = prediction

# 파일이름을 날짜, 시간을 활용하여 자동으로 생성

from datetime import datetime

dt_str = datetime.now().strftime("%Y%m%d%H%M")

out_file = "titanic_submission_" + dt_str + ".csv"
