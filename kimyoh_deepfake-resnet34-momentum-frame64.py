...
class MyResNeXt(models.resnet.ResNet):
    ...
    def __init__(self, training=True):
        ...
        super(MyResNeXt, self).__init__(block=models.resnet.BasicBlock,
...
checkpoint = torch.load("/kaggle/input/train-after-best/6 epoch res34 0.4236 momentum.pth", map_location=gpu)
