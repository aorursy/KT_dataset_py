...
# active-real-estate-salespersons-and-brokers.csv has 166673 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/active-real-estate-salespersons-and-brokers.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'active-real-estate-salespersons-and-brokers.csv'
nRow, nCol = df1.shape
