...
for train, test in kfold.split(ids):
    ...
    conv_layer1 = Conv3D(filters=32, kernel_size=(2, 2, 2))(input_layer)
    ...
    conv_layer2 = Conv3D(filters=32, kernel_size=(3, 3, 3))(conv_layer2)
    conv_layer2 = BatchNormalization()(conv_layer2)
    conv_layer2 = Activation('relu')(conv_layer2)

    ## add max pooling to obtain the most imformatic features
    pooling_layer1 = MaxPool3D(pool_size=(2, 2, 2))(conv_layer2)
    pooling_layer1 = Dropout(0.4)(pooling_layer1)

    conv_layer3 = Conv3D(filters=64, kernel_size=(2, 2, 2))(pooling_layer1)
    ...
    conv_layer4 = Conv3D(filters=64, kernel_size=(3, 3, 3))(conv_layer4)
    conv_layer4 = BatchNormalization()(conv_layer4)
    conv_layer4 = Activation('relu')(conv_layer4)


    pooling_layer2 = MaxPool3D(pool_size=(2, 2, 2))(conv_layer4)
    pooling_layer2 = Dropout(0.4)(pooling_layer2)
    ...
    dense_layer2 = Dropout(0.7)(dense_layer2)
    ...
    model.fit(X, Y, batch_size=64, epochs=20, callbacks=[model_checkpoint, reduce_lr], validation_data=(x_val, y_val), shuffle=True)
