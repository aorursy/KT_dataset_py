...
df1 = pd.read_csv('/kaggle/input/Covid-19/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Covid-19/sample_submission.csv', delimiter=',', nrows = nRowsRead)
