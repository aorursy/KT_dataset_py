...
X=df[['OverallQual','GrLivArea','GarageCars','GarageArea',
      ...
      'GarageYrBlt','Fireplaces','BsmtFinSF1','YearBuilt',

      'YearRemodAdd','LotFrontage','WoodDeckSF','2ndFlrSF',

      'OpenPorchSF', "LotArea", "PoolArea",
...
test_X=test[['OverallQual','GrLivArea','GarageCars','GarageArea',
...
test_y=test_X.values.reshape(-1,27)
