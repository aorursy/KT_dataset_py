...
# US_cases.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/US_cases.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'US_cases.csv'
