# CHRISTIAN MEDINA y WILLIAM RAMIREZ 
...
# Category distribution on 2020-02-20

data= pd.DataFrame({'count':base[base['date']==20200220].groupby(['subcategory','tags']).size()}).reset_index()
