...
sf_permits.sample(5) # yes some data are missing
# your code goes here :)
...
(total_missing_sf/total_cells_sf) * 100 # 26%
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
sf_permits.dropna() # none are left because every row contains a column with atleast one nan value
