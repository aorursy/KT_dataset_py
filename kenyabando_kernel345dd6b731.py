...
train = train.drop(train[(train['TotalSF']>4000) & (train['SalePrice']<300000)].index)
...
train = train.drop(train[(train['YearRemodAdd']<1990) & (train['SalePrice']>320000)].index)

train = train.drop(train[(train['YearRemodAdd']<2000) & (train['SalePrice']>400000)].index)
...
plt.ylabel("SalePrice")
train = train.drop(train[(train['GarageCars']>3.5) & (train['SalePrice']<400000)].index)
