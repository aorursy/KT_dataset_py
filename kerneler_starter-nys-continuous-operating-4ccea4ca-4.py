...
df1 = pd.read_csv('../input/continuously-operating-reference-stations-cors-network.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'continuously-operating-reference-stations-cors-network.csv'
nRow, nCol = df1.shape
