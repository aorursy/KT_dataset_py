...
def train_test():
	...
	df_submit = pd.read_csv('../input/jinnan-tianchi/FuSai.csv', encoding='gb18030')

	df_opt = pd.read_csv('../input/jinnan-tianchi/optimize.csv', encoding='gb18030')

	df_submit = df_submit.append(df_opt)

	df_submit['收率'] = 0

	df_train = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_train_20181227.csv', encoding='gb18030')

	df_A = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_testA_20181227.csv', encoding='gb18030')

	df_A_ans = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_ansA_20190125.csv', header=None)

	df_A['收率'] = df_A_ans[1]

	df_B = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_testB_20190121.csv', encoding='gb18030')

	df_B_ans = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_ansB_20190125.csv', header=None)

	df_B['收率'] = df_B_ans[1]

	df_C = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_test_20190201.csv', encoding='gb18030')

	df_C_ans = pd.read_csv('../input/jinnan-tianchi/jinnan_round1_ans_20190201.csv', header=None)
