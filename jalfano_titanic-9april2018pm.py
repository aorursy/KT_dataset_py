...
#PENG# embark_dummies_titanic  = pd.get_dummies(titanic_df['Embarked'])
#$# embark_dummies_titanic.columns = ['3','17','19']
#$# embark_dummies_titanic.drop(['S'], axis=1, inplace=True)
#PENG# titanic_df = titanic_df.join(embark_dummies_titanic)

#PENG# embark_dummies_test  = pd.get_dummies(test_df['Embarked'])
#$# embark_dummies_test.columns = ['3','17','19']
#$# embark_dummies_test.drop(['S'], axis=1, inplace=True)
#PENG# test_df    = test_df.join(embark_dummies_test)

#PENG# embark_dummies_titanicANDtest  = pd.get_dummies(titanicANDtest_df['Embarked'])
#$# embark_dummies_titanicANDtest.columns = ['3','17','19']
#$# embark_dummies_titanic.drop(['S'], axis=1, inplace=True)
#PENG# titanicANDtest_df = titanicANDtest_df.join(embark_dummies_titanicANDtest)
...
#PENG# tickettype_dummies_titanicANDtest = \
#PENG#     pd.get_dummies(titanicANDtest_df['TicketType'])
#PENG# titanicANDtest_df = titanicANDtest_df.join(tickettype_dummies_titanicANDtest)
...
titanicANDtest_TickettypePclassSize_df['Pclass'] = titanicANDtest_TickettypePclassSize_df['Pclass'].astype(int)
...
#PENG# ticketId_dummies_titanicANDtest = \
#PENG#     pd.get_dummies(titanicANDtest_df['TicketId'])
#PENG# titanicANDtest_df = titanicANDtest_df.join(ticketId_dummies_titanicANDtest)
