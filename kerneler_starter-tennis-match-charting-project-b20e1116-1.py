...
# charting-m-matches.csv has 513 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/charting-m-matches.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'charting-m-matches.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# charting-m-points.csv has 331720 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/charting-m-points.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'charting-m-points.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# charting-m-stats-KeyPointsReturn.csv has 16680 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/charting-m-stats-KeyPointsReturn.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'charting-m-stats-KeyPointsReturn.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
