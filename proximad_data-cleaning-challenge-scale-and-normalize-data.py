...
# Check out the data before diving in
...
# normalize using Box-cox, which returns two values: an array of normalized values and the lambda that maximizes the log-likelihood function
