...
!cp -r stylegan2/dnnlib/ .
import dnnlib
!gdown https://drive.google.com/uc?id=1iLjnWoxwldKG2ty85MRnIa6mfmzPtI_4
...
try:
    ...
    with open('/kaggle/working/stylegan2-ffhq-config-a.pkl', 'rb') as file:
