...
cosm= pd.read_csv('../input/cosmosds/train.csv')
cosm.head()
cosm= cosm.drop('id', axis=1)
cosm['answer']=''
for i in range(len(cosm)):
    ...
    if cosm['label'][i]==0:
        ...
        cosm['answer'][i]=cosm['answer3'][i]
cosm= cosm.drop(['answer0','answer1','answer2','answer3','label'],axis=1)
cosm.head()
train=cosm
train= train[train.answer!='None of the above choices .']
...
!mkdir result
#dataset = GrammerDataset(tokenizer, '/kaggle/working', 'valid')

#print("Val dataset: ",len(dataset))
args_dict.update({'data_dir': '/kaggle/working', 'output_dir': '/kaggle/working/result', 'num_train_epochs':1,'max_seq_length':256})
