...
# sample_submission (2).csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/sample_submission (2).csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'sample_submission (2).csv'
...
df3 = pd.read_csv('/kaggle/input/train.csv/train.csv', delimiter=',', nrows = nRowsRead)
