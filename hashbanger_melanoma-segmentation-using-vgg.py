...
from keras.layers import Activation, Dense, Flatten,ZeroPadding2D,BatchNormalization, concatenate, Dropout, Conv2D, Conv2DTranspose, MaxPooling2D, UpSampling2D, Input, Reshape
...
model.compile('Adam', loss=[jaccard_distance], metrics=[iou])
model.fit(
    x=x_train,
    y=y_train,
    batch_size=18,
