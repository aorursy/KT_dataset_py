...
#we have to use dictionary to achieve this task
...
for img, label in dataset:
    ...
    if classes[label] in number:

        number[classes[label]]+=1
...
history += fit(10, 0.06, model, train_loader, val_loader)
history += fit(20, 0.065, model, train_loader, val_loader)
history += fit(10, 0.068, model, train_loader, val_loader)
history += fit(20, 0.001, model, train_loader, val_loader)
history += fit(10, 0.008, model, train_loader, val_loader)
plot_losses(history)
plot_accuracies(history)
evaluate(model, test_loader)
arch = "4 layers (1024,512,128,10)"
lrs = [0.05, 0.06, 0.005, 0.008, 0.01, 0.008]
epochs = [5, 10, 20, 10, 20, 10]
test_acc = 0.4426
