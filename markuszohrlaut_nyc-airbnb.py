...
! ls /kaggle/input/new-york-city-airbnb-open-data
...
# Let see  all Diffrent types rooms available at Airbnb of NewYork

print(nyc_airbnb.room_type.unique())
print(nyc_airbnb['neighbourhood_group'].unique())

#print(num_nyc_airbnb.columns)
