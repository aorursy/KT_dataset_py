...
Image(url = 'https://image.slidesharecdn.com/calpercorporainlanguageteachingbluemel-140211135554-phpapp01/95/how-to-use-corpora-in-language-teaching-3-638.jpg?cb=1392826645',width=400,height=400)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSOISgc5rCQ0axyOcX5mv71sW1H3Ei3wfrLFWM9Hob6QcYlDBeW',width=400,height=400)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQjqb_ONwh4_EnYcZkUtA2DXMcJ-bED_nSScSuNyxtv8Bae95TA',width=400,height=400)
#codes from Rodrigo Lima  @rodrigolima82

from IPython.display import Image

Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT17WJhydrgMiFRGqqH_YFqO32yhDJURHPAonij1mLcfJdM5KqX',width=400,height=400)