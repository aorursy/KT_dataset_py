...
df1 = pd.read_csv('/kaggle/input/COMP5329S1A2Dataset/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/COMP5329S1A2Dataset/test.csv', delimiter=',', nrows = nRowsRead)
