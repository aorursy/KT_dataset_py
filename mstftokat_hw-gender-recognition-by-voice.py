...
data.info()
# object to int transform same time x and y data preparation
...
# normalization to x_data 

x = (x_data - np.min(x_data)) / (np.max(x_data) - np.min(x_data)).values
# preparation to x_train, x_test, y_train, y_test datasets
...
#forward and bacward propagations, gradient descent and predict process.
...
#forward and bacward propagation process
