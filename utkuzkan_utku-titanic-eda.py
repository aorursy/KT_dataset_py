...
sns.factorplot(x ="Parch", y = "Age",hue="Sex",  data = train_df,kind="box")

sns.factorplot(x ="SibSp", y = "Age",hue="Sex",  data = train_df,kind="box")
...
for i in index_nan_age:
    ...
    if not np.isnan(age_pred):
        ...
        train_df["Age"].loc[i] = age_pred

    else:

        train_df["Age"].loc[i] = age_med
