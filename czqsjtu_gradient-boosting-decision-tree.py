...
param = {
    ...
    'booster': 'gbtree', # gbtree or gblinear gbtree is better than gblinear
...
bst = xgb.train(param, dtrain, num_round, evallist, early_stopping_rounds=7)
...
bst = lgb.train(param, dtrain, num_round, valid_sets=[dtest], early_stopping_rounds=8)
...
class my_gbdt(object):
    ...
    def predict(self, x):
        ...
        for tree in self.trees:
            ...
            y_pred-=np.multiply(self.lr,tree.predict(x))
