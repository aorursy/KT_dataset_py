...
df1 = pd.read_csv('/kaggle/input/AV/sample.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/AV/train.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/AV/test.csv', delimiter=',', nrows = nRowsRead)
