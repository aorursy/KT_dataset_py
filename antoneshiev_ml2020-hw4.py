...
merged_test['first_issue_date'] = (merged_test['first_issue_date'].apply(pd.to_datetime).dt.dayofweek > 4).astype(int)
merged_test['first_redeem_date'] = (merged_test['first_redeem_date'].apply(pd.to_datetime).dt.dayofweek > 4).astype(int)
...
merged_train['first_issue_date'] = (merged_train['first_issue_date'].apply(pd.to_datetime).dt.weekday > 4).astype(int)
merged_train['first_redeem_date'] = (merged_train['first_redeem_date'].apply(pd.to_datetime).dt.weekday > 4).astype(int)
