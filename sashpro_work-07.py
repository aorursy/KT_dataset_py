...
import tqdm
model_dir = './'
size_suffix = '256_CPU_Wall_Epoch1'
model_name = 'UNet'
dataset_name = 'JSRT'
...
#batch_size = 8  # 512
#batch_size = 2  # 1024
batch_size = 8  # for the initial time test and you should find the MAXIMAL number, which is possible within MEMORY limit (10 GB)

epochs_all = 1024 # for the initial time test and you should find the MAXIMAL number, which is possible within RUNTIME limit (1 hour)
