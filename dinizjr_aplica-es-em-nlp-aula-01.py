...
wn.synsets('dog')#sinonimos com significados semânticos diferentes
wn.synsets('dog', pos=wn.NOUN)#somente os sinônomos substantivos
...
import pandas as pd
tokens = nlp("Eles não vão trabalhar hoje")
...
for t in tokens:
    ...
    f = wn.synsets(t.text,lang='por')

    for i in f:

        lemma += i.lemma_names('eng')
