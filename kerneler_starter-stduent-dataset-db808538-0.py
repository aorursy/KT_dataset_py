...
# dumyMarks1.csv has 355 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/dumyMarks1.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'dumyMarks1.csv'
nRow, nCol = df1.shape
