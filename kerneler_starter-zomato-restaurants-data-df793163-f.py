...
# zomato.csv has 9551 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/zomato.csv', delimiter=',', nrows = nRowsRead, encoding='latin-1')
