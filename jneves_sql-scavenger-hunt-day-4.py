...
# Your code goes here :)
query3 = """SELECT merkle_root, COUNT(DISTINCT transaction_id) as transactions
            FROM `bigquery-public-data.bitcoin_blockchain.transactions`
            GROUP BY merkle_root
        """

# max_gb_scanned is set to 40, rather than 1
transactions_merkle_root = bitcoin_blockchain.query_to_pandas(query3)
