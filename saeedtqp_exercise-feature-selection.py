...
def select_features_l1(X, y):
    ...
    logic = LogisticRegression(C = 0.1,penalty='l1',random_state=7).fit(X,y)

    model = SelectFromModel(logic , prefit = True)
...
# q_4.solution()
# # dropped_columns = feature_cols.drop(selected_featurese)
