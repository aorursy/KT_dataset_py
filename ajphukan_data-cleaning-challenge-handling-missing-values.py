...
sf_columns_with_na_droped = sf_permits.dropna(axis=1)
sf_columns_with_na_droped.head()


print ('sf_permits columns with na {}'.format(sf_permits.shape[1]))
print ('sf_permits columns without na {}'.format(sf_columns_with_na_droped.shape[1]))
