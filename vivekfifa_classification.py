...
classes_count = dict([class_,0] for class_ in classes)
...
class CIFAR10Model(ImageClassificationBase):
    ...
    def __init__(self):
        ...
        self.linear1 = nn.Linear(input_size, 1530)

        self.linear2 = nn.Linear(1530, 760)

        self.linear3 = nn.Linear(760, output_size)
