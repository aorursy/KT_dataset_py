...
sf_permits.sample(5)
#Though most of the time I use df.head() instead of df.sample(), I think df.sample sometimes is more possible to see different data missing situation or something else.
...
nfl_data[nfl_data.down.isnull()][:5]
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
subset_sf_data = nfl_data.iloc[:, 1:10].head()
