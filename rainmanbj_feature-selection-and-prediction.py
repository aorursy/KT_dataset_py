...
f, axrrr = plt.subplots(1, 2, sharey=True)



axrrr[0].hist('salary', data = left, bins = 5)

axrrr[0].set_title('Left')

axrrr[0].set_xlabel('Salary')

axrrr[0].set_ylabel('Number of Observations')

axrrr[1].hist('salary', data = not_left, bins = 5)

axrrr[1].set_title('Not Left')

axrrr[1].set_xlabel('Salary')
...
axrrr[0].hist('Work_accident', data = left, bins = 3)

axrrr[0].set_title('Left')

axrrr[0].set_xlabel('Work accident')

axrrr[0].set_ylabel('Number of Observations')

axrrr[1].hist('Work_accident', data = not_left, bins = 3)

axrrr[1].set_title('Not Left')

axrrr[1].set_xlabel('Work_accident')
