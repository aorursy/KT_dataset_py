...
nRowsRead = 100 # specify 'None' if want to read whole file
# lottery-daily-numbers-win-4-winning-numbers-beginning-1980.csv has 13758 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# lottery-mega-millions-winning-numbers-beginning-2002.csv has 1689 rows in reality, but we are only loading/previewing the first 100 rows
