...
# ordinance-violations.csv has 625340 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/ordinance-violations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'ordinance-violations.csv'
nRow, nCol = df1.shape
