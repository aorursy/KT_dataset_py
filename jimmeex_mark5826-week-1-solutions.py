...
print("Hello! Welcome to MARK5826!")
print(1+2)
1+2
(1+2)/3
print(hello)
...
b = 10
c = 204
print("Hello, a = {}, b = {}, c = {}".format(a,b,c))
counter = 10
while counter < 50:
    print("Hello {}".format(counter))
    counter = counter * 2
...
while counter < 50:
    print("Hello {}".format(counter))
    counter = counter * 2
for counter in range(10,50,10):
    print("Hello {}".format(counter))
fruits = ['apples', 'bananas', 'oranges']
fruits
random_data = [1,2,0.23,"apple",'data',24]
random_data
random_data[0]
random_data[5]
random_data = [1,2,0.23,"apple",'data',24]
...
if fruit == 'apple':
    ...
    print('hmmmm ok not an apple at all')
fruit = 'apple'

fruit == 'apple' and len(fruit) == 5
fruit == 'apple' or len(fruit) == 6
fruit == 'apple' and len(fruit) == 5 and fruit[0] == 'a'
empty_list = []
# You code goes here
value = 0
while value <= 20:
...
while value <= 50:
    if value == 0:
        ...
        print("Kinda half way")
    elif value == 40:
        print("Nearly at 50")
    else:
        print("At {}".format(value))
    value += 10
