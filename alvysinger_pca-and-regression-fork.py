...
from sklearn.metrics import make_scorer,mean_squared_log_error ##评价需要
...
def lets_try(train,labels):
    ...
    def test_model(clf):
        ...
        r2 = make_scorer(mean_squared_log_error)#
    ...
    results.columns=["mean_squared_log_error Score"] 

    results=results.sort(columns=["mean_squared_log_error Score"],ascending=False)
