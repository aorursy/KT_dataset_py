...
#sub_columns = ['age', 'name_len', 'pclass_1st', 'pclass_2nd', 'pclass_3rd', 
...
sub_columns = ['age', 'name_len', 'pclass_3rd', 
...
dot_data = tree.export_graphviz(sub_model, out_file=None, feature_names=sub_trainX.columns) 
...
pd.concat([pd.DataFrame(sub_trainX.columns, columns=['variable']),

         pd.DataFrame(sub_model.feature_importances_, columns=['importance'])],
