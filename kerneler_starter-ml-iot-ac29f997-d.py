...
df1 = pd.read_csv('/kaggle/input/sample_submission_ML_IOT.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/test_ML_IOT.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/train_ML_IOT.csv', delimiter=',', nrows = nRowsRead)
