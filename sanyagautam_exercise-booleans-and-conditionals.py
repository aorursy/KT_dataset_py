...
def should_hit(player_total, dealer_total, player_aces):
    ...
    elif (player_total == 12 or player_total == 13) and dealer_total >= 7:

        return True

    elif player_total == 14 and (dealer_total >= 7 or dealer_total <= 9):

        return True

    elif player_total == 15 and (dealer_total == 7 or dealer_total == 8):
