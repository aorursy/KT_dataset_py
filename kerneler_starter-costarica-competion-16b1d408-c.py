...
# sample_submission.csv has 23856 rows in reality, but we are only loading/previewing the first 1000 rows
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# test.csv has 23856 rows in reality, but we are only loading/previewing the first 1000 rows
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# train.csv has 9557 rows in reality, but we are only loading/previewing the first 1000 rows
