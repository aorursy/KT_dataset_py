...
train_df[["Pclass","SibSp"]].groupby(["Pclass"],as_index=False).mean().sort_values(by="SibSp",ascending=False)
#Parch vs Pclass

train_df[["Pclass","Parch"]].groupby(["Pclass"],as_index=False).mean().sort_values(by="Parch",ascending=False)
