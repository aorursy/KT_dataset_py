...
# images_train = read_all("dataset_train/"+LEVEL+"/"+"background", key_prefix='bgr_')
...
sn_ce.fit(X_scaled_train, Y_train, epochs=90, learning_rate=0.25, loss_fn="ce", display_loss=True)
