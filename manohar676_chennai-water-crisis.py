...
Image(url= "https://cdn.dnaindia.com/sites/default/files/styles/full/public/2019/06/30/842570-water-crisis-afp.jpg")
import numpy as np
...
trace1 = scatter_plot(cnt_srs, 'cyan')
...
trace4 = scatter_plot(cnt_srs, 'tan')
...
trace5 = scatter_plot(cnt_srs, 'gold')
...
rain_df = pd.read_csv("../input/chennai-water-management/chennai_reservoir_rainfall.csv")
...
trace5 = bar_plot(cnt_srs, 'hotpink')
