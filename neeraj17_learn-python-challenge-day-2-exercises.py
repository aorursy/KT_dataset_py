...
#q1.solution()
#experimant with negative argument"
print(round(15.66666,-1))    
print(round(55.66666,-2))
print(round(499.999,-3))
print(round(555.6666,-3))
print(round(5555.66,-4))
print(help(round))
# 10^-1 nearest 10th 10^-2 nearest 100th and so on
q2.solution()
def to_smash(total_candies,no_of_friends=3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between (no_of_friends>1)friends.
