...
missing_values_count[0:10]
# if zipcode doesn't exist, that must be because it wasn't recorded

sf_permits['Zipcode'].isna().sum()
# if street number suffix doesn't exist, that means it doesnot exist

sf_permits['Street Number Suffix'].isna().sum()
