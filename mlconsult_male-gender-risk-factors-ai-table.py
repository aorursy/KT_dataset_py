...
df_master=pd.read_csv('../input/aipowered-literature-review-csvs/kaggle/working/Risk Factors/Male gender.csv')
...
for keyword in keywords:
    ...
    df_table_show.to_csv('Male gender.csv', index = False)
