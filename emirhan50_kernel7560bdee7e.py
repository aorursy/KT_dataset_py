import pandas as pd 
v_dict1 = { "COUNTRY" : ["TURKEY","AFRICA","FRANCE","IRAN","AZERBAIJAN","SYRIA","GERMANY"],

           "CAPITAL":["ISTANBUL","PRETORİA","PARIS","TAHRAN","BAKU","ŞAM","BERLIN"],

           "POPULATION":[15.7,8.13,3.57,2.12,8.62,4.3,8.69]}
...
v_currencyList1 = ["TRY","RND","EUR","IRR","AZN","SYP","EUR"]

v_dataFrame1["CURRENCY"] = v_currencyList1
...
v_CityCountry = v_dataFrame1.loc[:,["CAPITAL","COUTRY","BLABLA"]]
...
print(v_dataFrame1.columns)
v_dataFrame1.drop([],axis=1,inplace = True)
...
v_dataConcat2 = pd.concat([v_data2,v_data1],axis=0)# axis = 0 --> VERTICAL 
