...
import jovian
#jovian.log_hyperparams(arch='linearregression-feedforward', lr=lr, opt_func = opt_func)
#jovian.log_metrics(epochs=num_epochs, train_loss=0.5, val_loss=0.3, val_accuracy=0.9)
