...
#ดาวน์โหลดไลบรารี่ที่เกี่ยวข้องกับข้อมูล
...
#ทำให้วนลูปเพื่อแสดงค่าและดูข้อมูลตามปกติของ contour_level

for x in contour_level:

  plt.contour(X1,X2,p2[:,np.newaxis].reshape(X1.shape),x)
...
#วนลูปเพื่อบอกว่าอันใหนที่ผิดปกติ (ในวงกลมสีแดงคือผิดปกติ)
...
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat('../input/dataset/ex8data1.mat')
...
mat4 = loadmat("../input/dataset1/ex8_movieParams.mat")
...
#encoding เหมือนเป็นการเข้ารหัสพวก csv..
...
#ข้อมูลค่าเริ่มต้นของหนังและคะแนนการดูหนังเต็ม 5 คะแนน
