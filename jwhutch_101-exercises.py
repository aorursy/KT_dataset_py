...
def identity(arg):
    ...
    elif arg == positive_odd_number:

        return positive_odd_number

    elif arg == positive_even_number:

        return positive_even_number

    elif arg == negative_odd_number:

        return negative_odd_number

    elif arg == negative_even_number:

        return negative_even_number
...
assert get_values_in_common([1, 1], [2, 2, 3]) == {} #couldn't figure out how to get it to return a blank set {}
...
def total_of_book_prices(x):
    ...
    return sum([i['price'] for i in x if 'price' in i])
...
def get_average_book_price(x):
    ...
    return Avg([i['price'] for i in x if 'price' in i])
...
def highest_priced_book(x):
    ...
    return max([i['price'] for i in x if 'price' in i])

    #max_price = max([i['price'] for i in x if 'price' in i])
...
def total_number_of_items(x):
    ...
    q1 = x['items'][0]['quantity']

    q2 = x['items'][1]['quantity']

    q3 = x['items'][2]['quantity']

    q4 = x['items'][3]['quantity']

    q5 = x['items'][4]['quantity']
...
def get_average_spent_per_item(x):
    ...
    q1 = (x['items'][0]['quantity']) * (x['items'][0]['price'])

    q2 = (x['items'][1]['quantity']) * (x['items'][1]['price'])

    q3 = (x['items'][2]['quantity']) * (x['items'][2]['price'])

    q4 = (x['items'][3]['quantity']) * (x['items'][3]['price'])

    q5 = (x['items'][4]['quantity']) * (x['items'][4]['price'])

    return (q1 + q2 + q3 + q4 + q5)/ total_number_of_items(x)
...
def most_spent_on_item(x):
    ...
    for i in x['items']:
        ...
        if most_spent < int(i['price'] * i['quantity']):

            most_spent = int(i['price'] * i['quantity'])
