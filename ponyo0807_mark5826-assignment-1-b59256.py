...
tally(  data['style']  )
# Your code goes here
Stars = tally(  data['stars']  )
plot(x = 'stars', data = Stars, style = 'histogram')
# Your code goes here
goal = tabulate(data['brand'], data['stars'], method = 'mean')
plot(x = 'brand', y = 'mean', data = goal, style = 'boxplot')
# Your code goes here
tally(data['country'], percent = True, graph = True, top = 10)
query(data, column = 'brand', condition = '=="Ve Wong"')
# Your code goes here
sort(data['stars'], how = 'descending') [-12:]
#Your code goes here
query(data, column = 'stars', condition = '>3')
data = query(data, column = 'stars', condition = '>3')
count_style = tabulate(data['country'], data['style'], method = 'count')
plot(data = count_style, x = 'country', y = 'count', colour = 'style', style = 'lineplot')
