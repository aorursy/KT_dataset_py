...
data.loc[:, 'SeniorCitizen'].value_counts()
sns.countplot(x = "InternetService", data = data)

data.loc[:, 'InternetService'].value_counts()
sns.countplot(x = "PhoneService", data = data)

data.loc[:, 'PhoneService'].value_counts()
plt.figure()

Corr=data[data.columns].corr()

sns.heatmap(Corr,annot=True)
data['TotalCharges'].value_counts().sort_index().plot.hist()
data['MonthlyCharges'].value_counts().sort_index().plot.hist()
data['tenure'].value_counts().sort_index().plot.hist()
data['PaymentMethod'].value_counts().plot.pie()

plt.gca().set_aspect('equal')
sns.kdeplot(data['tenure'], data['MonthlyCharges'])
