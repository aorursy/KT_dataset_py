...
print(t/60, "minutes since the Epoch")

print(t/3600, "hours since the Epoch")

print(t/(3600*24), "days since the Epoch")

print(t/(3600*24*365.25), "years since the Epoch")
...
def time_call(fn, arg):
    ...
    amount_of_time = finish - start

    return amount_of_time

#     print("Time taken for", fn, "to run is:", amount_of_time )
