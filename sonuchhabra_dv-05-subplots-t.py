...
fig, axarr = plt.subplots(2, 1, figsize = (8,8))
pokemon['Attack'].plot.hist(ax=axarr[0], bins=10)
axarr[0].set_title('Pokemon Attack Rating', fontsize=15)
pokemon['Defense'].plot.hist(ax=axarr[1], bins=10)
axarr[1].set_title('Pokemon Defense Rating', fontsize=15)
