...
dataset_size = len(dataset) - len(test_dataset)
dataset_size
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        ...
        self.linear2 = nn.Linear(72,144)
        
        
        
        self.linear3 = nn.Linear(144,output_size)
...
arch = "2 hideen layers (72,144)"
lrs = [0.1,0.001,0.001,0.0001]
epochs = [10,10,20,10]
test_acc = 0.51
test_loss = 1.47
