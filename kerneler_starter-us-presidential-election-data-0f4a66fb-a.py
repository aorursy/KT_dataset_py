...
df1 = pd.read_csv('/kaggle/input/county_facts.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/county_facts_dictionary.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/us_county_level_presidential_results_12_16.csv', delimiter=',', nrows = nRowsRead)
