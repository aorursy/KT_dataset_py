...
sns.countplot(data['diagnosis']) # TODO
# TODO
...
for feature in features:
    ...
    # 将特征的直方图画出来
    # TODO
    plt.hist(data[data[target]==+1][feature], bins=bins, color='lightblue', label= 'B-healthy', alpha=0.5)
    plt.hist(data[data[target]==-1][feature], bins=bins, color='k', label= 'M-bad', alpha=0.5)
