...
print(fill_mask("Eyi de ɔhaw kɛse baa [MASK] hɔ.")) # if using ABENA
...
input_ids = tokenizer("Eyi de ɔhaw kɛse baa fie hɔ", return_tensors="pt")["input_ids"] # these are indices of tokens in the vocabulary
