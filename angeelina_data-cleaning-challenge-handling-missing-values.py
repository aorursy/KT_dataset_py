...
total_shape_sf=np.product(sf_permits.shape)
#total_shape_sf
total_missing_sf=missing_values_count_sf.sum()

#percent of data that is missing
(total_missing_sf/total_shape_sf)*100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
missing_values_count_sf[0:60]
...
columns_with_na_dropped_sf=sf_permits.dropna(1)
