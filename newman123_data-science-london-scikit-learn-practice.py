...
train = pd.read_csv('../input/data-science-london-scikitlearn/train.csv', header=None)

trainLabel = pd.read_csv('../input/data-science-london-scikitlearn/trainLabel.csv', header=None)

test = pd.read_csv('../input/london-sklearn/test.csv', header=None)
