...
#missing_values_count[0:10]
#sf_permits.describe()
#sf_permits.rename(columns={'Street Number Suffix': 'StreetNumberSuffix'}, inplace=True)
sf_permits.StreetNumberSuffix.unique()
...
subset_sf_permits = sf_permits.loc[:, 'StreetNumberSuffix':'Description'].head()
subset_sf_permits
subset_sf_permits.fillna(method = 'bfill', axis=0).fillna("A")