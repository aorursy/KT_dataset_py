...
# 311-service-requests-abandoned-vehicles.csv has 200973 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-alley-lights-out.csv has 208702 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# 311-service-requests-garbage-carts.csv has 386313 rows in reality, but we are only loading/previewing the first 100 rows
