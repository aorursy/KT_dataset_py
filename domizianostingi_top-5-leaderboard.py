...
import pandas as pd 
df1 = pd.read_csv('/kaggle/input/best-subs-moa/submission_over_over.csv')

df2 = pd.read_csv('../input/notebook31e74ea284/submission.csv')

df3=pd.read_csv('../input/moa-ensemble/submission.csv')
def order_sub(sub) : 
...
BLEND.iloc[:,1:] =  df1.iloc[:,1:]*0.25 +df2.iloc[:,1:]*0.3 +df3.iloc[:,1:]*0.45
