...
filenames = []
num_of_images = 0
# Preprocessing the images from the DUT-OMRON database that are already subject to popular Saliency models - DRFI, DSR, GMR, MC, RBD.
...
def reverseProcessImage(finalImgArr, no_images=None):
    ...
    if no_images is None:
        no_images = num_of_images
    for cnt in range(no_images):
