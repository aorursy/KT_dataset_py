...
provincies = suicide_attacks['Province'].unique()
provincies.sort()
...
cities.sort()
cities
#'balochistan', 'baluchistan', look similar  after some googling there is no baluchistan  
#means both are same with a typo 
