...
plt.imshow(-dcm.dcmread("../input/rsna-str-pulmonary-embolism-detection/train/0003b3d648eb/d2b2960c2bbf/00ac73cfc372.dcm").pixel_array, cmap='bone');
tr.head()
cat = []
...
print(f"{len(cat)} categorical targets are present in the data.")
zero_count_list = []
...
for i in range(20):
    ...
    plots[i // 5, i % 5].imshow(dicom_to_image(np.random.choice(files[0:20]), ),cmap='turbo') # first twenty images
FNAME = dcm.dcmread("../input/rsna-str-pulmonary-embolism-detection/train/0003b3d648eb/d2b2960c2bbf/00ac73cfc372.dcm")

print(FNAME.file_meta)
print(f"{FNAME.pixel_array.shape} is the size of the images provided.")
...
fig, (ax1, ax2) = plt.subplots(2,1, sharex='col', figsize=(9,9), gridspec_kw={'hspace': 0.1, 'wspace': 0})
...
ax2.imshow(FNAME.pixel_array,cmap='Spectral');
fig, (ax1, ax2) = plt.subplots(2,1, sharex='col', figsize=(9,9), gridspec_kw={'hspace': 0.1, 'wspace': 0})
