...
image_path = sorted(os.listdir("../input/t91-image-dataset/T91"))





image =load_images("../input/t91-image-dataset/T91/", image_path, IMAGE_SIZE)
...
image.shape
label= np.zeros((91,128,128,3), np.float32)
