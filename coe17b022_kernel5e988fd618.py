...
import time
#
from kernel32218d3865 import RGMP
from kernel53f022bf21 import ToCudaVariable, ToLabel, DAVIS, upsample, downsample



### set pathes
DAVIS_ROOT = '../input/davisvos/DAVIS/'
...
model.load_state_dict(torch.load('../input/weightspth/weights.pth'))
