...
print('Length of image:', len(all_image_paths))

"""
Thêm cột đường dẫn vào tập dữ liệu
"""
data['Path'] = data['Image Index'].map(all_image_paths.get)

data.sample(5, random_state=3)
"""
Lấy ra list bệnh trong data
"""
import numpy as np
...
print(f'({len(all_labels)}): {all_labels}')
"""
Thêm 1 cột cho mỗi bệnh
"""
...
print(f"Image size: {train_x[1].shape}")
