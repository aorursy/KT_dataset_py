...
print("Initial counting of classes",class_count,sep='\n')

for img,label in dataset:
    class_count[classes[label]]+=1
print("Count of classes",class_count,sep='\n')
...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        super().__init__()
        self.linear1 = nn.Linear(input_size, 700)
        self.linear2 = nn.Linear(700, 300)
...
arch = "4 Layer (700,300, 50, 10)"
lrs = [0.1, 0.01, 0.05, 0.01, 0.001]
epochs = [10, 8, 5, 15, 15]
test_acc = 0.554
test_loss = 1.26
...
jovian.commit(message="4 layer network" ,project=project_name, outputs=['cifar10-feedforward.pth'], environment=None)
