...
class SnapshotCallbackBuilder:
    ...
    def get_callbacks(self, model_prefix='Model'):
        ...
        callback_list = [
            ...
            callbacks.ModelCheckpoint("best_resnet18_model.h5",monitor='val_dice_coef', 
...
def keras_fit_generator(img_rows=256, img_cols=256, n_imgs=15 * 10 ** 4, batch_size=32, epochs = 50, regenerate=True):
    ...
    model = sm.Unet('resnet18', input_shape=(img_rows, img_cols, 1), encoder_weights=None)

    model.load_weights('../input/prostate-resnet18/best_resnet18_model.h5')
   ...
   # model.summary()
    ...
    pd.DataFrame(history.history).to_hdf("Resnet18_hist.h5",key="history")
import segmentation_models as sm

model = sm.Unet('resnet18', input_shape=(None, None, 1), encoder_weights=None)
from keras.utils import plot_model

plot_model(model, to_file='resnet18Model.png')
import time

epochs = 7

swa = SWA('best_resnet18_model_weights.h5',epochs - 1)
