...
scaled_goal_data = minmax_scaling(goal_column, columns = [0])
...
p_pledges = kickstarters_2017.pledged.loc[index_pledged]
#print(p_pledges)

normal_pledged = stats.boxcox(p_pledges)[0]
#print(normal_pledged)
