...
# test.csv has 3999 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# train.csv has 599 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# train_labels.csv has 599 rows in reality, but we are only loading/previewing the first 100 rows
