...
reduced_X_train = X_train.drop(bad_label_cols, axis=1)

reduced_X_valid = X_valid.drop(bad_label_cols, axis=1)
...
# test data have OH-columns that have missing values NaN. 
