...
for country in countries:
    average_temp.append(temp_by_country[temp_by_country['Country'] == country]['AverageTemperature'].mean())
...
texts = ax.set(ylabel="", xlabel="Temperature", title="Average temperature in countries")
max_min_list = []
...
sns.barplot(x=differences[:185], y=res_countries[:185], palette=sns.color_palette("coolwarm", 25), ax=ax)
