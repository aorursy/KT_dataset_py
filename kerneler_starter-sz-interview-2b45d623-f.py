...
print(os.listdir('../input/Cristano_Ronaldo_Final_v1'))
...
df1 = pd.read_csv('../input/Cristano_Ronaldo_Final_v1/data.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Cristano_Ronaldo_Final_v1/sample_submission.csv', delimiter=',', nrows = nRowsRead)
