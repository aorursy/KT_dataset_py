...
NUM_CLASSES = 2
os.listdir("../input/nckh-20/nckh")
filenames = os.listdir("../input/nckh-20/nckh")
...
for filename in filenames:
    ...
    for file in os.listdir("../input/nckh-20/nckh/"+filename):

        file_path.append("../input/nckh-20/nckh/"+filename+"/"+file)
