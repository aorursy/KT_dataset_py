...
df1 = pd.read_csv('/kaggle/input/AppleWatch - HeartRate StepCount etc 8440 rows - analysis.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/AppleWatch - HeartRate StepCount etc 92406 rows - export20200620105726.csv', delimiter=',', nrows = nRowsRead)
