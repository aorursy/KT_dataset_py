...
df2.to_csv (r'/kaggle/working/export_recovered_df2.csv', header=True)
...
df2a.to_csv (r'/kaggle/working/export_recovered_df2a.csv', header=True)
T1=df2.loc['4q50tw3d',:]
...
df3.to_csv (r'/kaggle/working/export_recovery_df3.csv', header=True)
df3a=df1[df1['abstract'].str.contains('recovery', na = False)]
df3a.shape
df3a.to_excel (r'/kaggle/working/export_recovery_df3a.xlsx', header=True)
df3a.to_csv (r'/kaggle/working/export_recovery_df3a.csv', header=True)
T6=df3.loc['owjgs6ja',:]
...
df4.to_csv (r'/kaggle/working/export_treatment_df4.csv', header=True)
...
df4a.to_csv (r'/kaggle/working/export_treatment_df4a.csv', header=True)
