...
# farmers-markets-in-new-york-state.csv has 732 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/farmers-markets-in-new-york-state.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'farmers-markets-in-new-york-state.csv'
nRow, nCol = df1.shape
