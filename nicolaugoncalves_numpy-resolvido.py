...
ExC = np.dot(ExA,ExB)
print('ExC:\n',ExC)
DesvioLinhaExA = np.std(ExA, axis = 1, ddof = 1)
MediaLinhaExA = np.mean(ExA, axis = 1)
DesvioColunaExA = np.std(ExA, axis = 0, ddof = 1)
MediaColunaExA = np.mean(ExA, axis = 0)
print('ExA')
print('Media Linha:')
print(MediaLinhaExA)
print('Desvio padrão Linha:')
print(DesvioLinhaExA)

print('Media Coluna:')
print(MediaColunaExA)
print('Desvio padrão Coluna:')
print(DesvioColunaExA)
print('\n')

DesvioLinhaExC = np.std(ExC, axis = 1, ddof = 1)
MediaLinhaExC = np.mean(ExC, axis = 1)
DesvioColunaExC = np.std(ExC, axis = 0, ddof = 1)
MediaColunaExC = np.mean(ExC, axis = 0)

print('ExC')
print('Media Linha:')
print(MediaLinhaExC)
print('Desvio padrão Linha:')
print(DesvioLinhaExC)

print('Media Coluna:')
print(MediaColunaExC)
print('Desvio padrão Coluna:')
print(DesvioColunaExC)
print('\n')

ExD = ExA[:,-2:]
ExDMedia = np.mean(ExD)
print(ExDMedia)
print(ExD)
ExE = ExA[1:3,1:3]
print(ExE)
