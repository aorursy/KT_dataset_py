...
# lead-in-schools.csv has 4671 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/lead-in-schools.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'lead-in-schools.csv'
nRow, nCol = df1.shape
