...
plt.scatter(range(mcr_df.shape[0]), np.sort(mcr_df.Age.values))
...
layout = go.Layout(
    ...
    title='Code Writers to analyze data'
...
layout = go.Layout(
    ...
    title='ML Tool / Technology to learn'
...
layout = dict(
    ...
    title='Which language do you recommend?',
...
layout = go.Layout(
    ...
    title='Most important way to prove knowledge of ML / DS'
