...
related_articles_index_file_bio = pd.read_csv("/kaggle/input/article-ref-bio-task3/article_indexes_bio_task3.csv",sep=";")

related_articles_index_file_comm = pd.read_csv("/kaggle/input/article-ref-comm-task3/article_indexes_comm_task3.csv")

related_articles_index_file_noncomm = pd.read_csv("/kaggle/input/article-ref-noncomm-task3/article_indexes_noncomm_task3.csv")
###bio
...
with open('/kaggle/input/vectorizer-bio-task3/article_bio_vectorizer_task3.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-bio-task3/abstract_bio_vectorizer_task3.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-comm-task3/article_comm_vectorizer_task3.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-comm-task3/abstract_comm_vectorizer_task3.pickle', 'rb') as tf_abs:
...
with open('/kaggle/input/vectorizer-noncomm-task3/article_noncomm_vectorizer_task3.pickle', 'rb') as tf_art:

    tfidf_vect_text = pickle.load(tf_art)

    

with open('/kaggle/input/vectorizer-noncomm-task3/abstract_noncomm_vectorizer_task3.pickle', 'rb') as tf_abs:
