...
subset_sf_permits = sf_permits.loc[:, 'Permit Number':'Record ID']
subset_sf_permits
#
subset_sf_permits.fillna(0)
# 
subset_sf_permits_fillna = subset_sf_permits.fillna(method = 'bfill', axis=0).fillna("0")
subset_sf_permits_fillna
