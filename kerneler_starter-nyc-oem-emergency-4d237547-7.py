...
# oem-emergency-notifications.csv has 10978 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/oem-emergency-notifications.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'oem-emergency-notifications.csv'
nRow, nCol = df1.shape
