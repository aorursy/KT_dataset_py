...
# Créer une nouvelle colonne pour déstinguer les spécies en utilisant booléan
iris['classe'] = iris.species.map({"setosa":0, "versicolor":1, "virginica":2})
# Description
iris.describe()
# Transmettre les classes en entier
iris = iris.drop(['species'], axis=1)
iris.head(100)
# diviser les données en 2 parties, train et test
data_train = iris.sample(frac=0.8)          
data_test = iris.drop(data_train.index)
# retirer x et y des données
