...
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
sf_permits.loc[sf_permits['Street Number Suffix'].isnull(),:].head(4)
sf_permits.loc[sf_permits['Zipcode'].isnull(),:].head(4)
...
subset_sf_permits = sf_permits.loc[:, 'Street Number Suffix':'Zipcode'].head(80)
subset_sf_permits
