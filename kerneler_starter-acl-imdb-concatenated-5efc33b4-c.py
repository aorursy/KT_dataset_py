...
print(os.listdir('../input/aclImdb_v1'))
...
df1 = pd.read_csv('../input/aclImdb_v1/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/aclImdb_v1/train.csv', delimiter=',', nrows = nRowsRead)
