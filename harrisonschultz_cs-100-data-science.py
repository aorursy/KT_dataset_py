...
men[['Pclass', 'Survived']].groupby(['Pclass']).mean()
train_data[['Sex', 'Fare']].groupby(['Sex']).mean()
...
for idx, row in train_data.iterrows():
    ...
    if row['Sex'] == 'female':
        ...
        women_class_count[row['Pclass']-1] += 1

women_survived_count / women_count

#for count in women_class_count:

    #print(count / women_count)
children_count = 0

children_survived_count = 0
...
for idx, row in train_data.iterrows():
    ...
    if row['Age'] <= 7:
        ...
        if row['Survived'] == 1:
            ...
            children_survived_count += 1

children_survived_count / children_count
predictions = []
