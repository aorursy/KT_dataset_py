...
original = "../input/enron-data/final_project_dataset.pkl"
...
fig,box =  plt.subplots(2,2,squeeze=False,figsize=(17,10))

box[0][1].set(ylim=(0, 20000000))

box[1][0].set(ylim=(0, 20000000))

box[1][1].set(xlim=(0,210), ylim=(0,320))

for key in range(len(f1)):

    if f1[key][0] == True:

         box[0][0].scatter(f1[key][1],f1[key][2],color = 'g')

    else:

        box[0][0].scatter(f1[key][1],f1[key][2],color = 'b')
...
for key in range(len(f2)):
    ...
    if f2[key][0] == True:
        ...
        if f2[key][3]==0:
             ...
             box[0][1].plot(f2[key][1],f2[key][2],'g^')

        else:

            box[0][1].plot(f2[key][1],f2[key][2],'go')

    else:

        if f2[key][3]==0:

            box[0][1].plot(f2[key][1],f2[key][2],'b^')

        else:

            box[0][1].plot(f2[key][1],f2[key][2],'bo')
...
for key in range(len(f3)):
    ...
    if f3[key][0] == True:
        ...
        if f3[key][3]==0:
             ...
             box[1][0].plot(f3[key][1],f3[key][2],'g^')

        else:

            box[1][0].plot(f3[key][1],f3[key][2],'go')

    else:

        if f3[key][3]==0:

            box[1][0].plot(f3[key][1],f3[key][2],'b^')

        else:

            box[1][0].plot(f3[key][1],f3[key][2],'bo')
...
for key in range(len(f4)):
    ...
    if f4[key][0] == True:
         ...
         box[1][1].scatter(f4[key][1],f4[key][2],color = 'g')

    else:

        box[1][1].scatter(f4[key][1],f4[key][2],color = 'b')
