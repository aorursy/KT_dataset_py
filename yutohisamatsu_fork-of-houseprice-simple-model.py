...
# train_x, test_x, train_y, test_y = train_test_split(train, y, test_size=0.3, random_state=3)
...
# predict_cv(ENet, train, y, test)
# 係数,率

# coef = pd.Series(ENet.coef_, index = train.columns)
# coef.sort_values()
# テストデータ 推測
