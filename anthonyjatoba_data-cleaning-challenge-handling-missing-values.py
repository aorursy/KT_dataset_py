...
print("\nStreet Number Suffix missing: ", missing_values_count_sf[0:10]['Street Number Suffix']/sf_permits.shape[0])
print("\nStreet Suffix: ", missing_values_count_sf[0:10]['Street Suffix']/sf_permits.shape[0])
...
print("Total data left:", (sf_permits.shape[1] - columns_with_na_dropped_sf.shape[1])/sf_permits.shape[1])
