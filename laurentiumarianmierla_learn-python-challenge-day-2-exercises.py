...
def time_call(fn, arg):
    ...
    return end - start
idle = lambda s: sleep(s)
execution_time = time_call(idle, 5)
...
def slowest_call(fn, arg1, arg2, arg3):
    ...
    """
    time_call1 = time_call(fn, arg1)
    time_call2 = time_call(fn, arg2)
    time_call3 = time_call(fn, arg3)
    
    return max(time_call1, time_call2, time_call3)

slowest_time = slowest_call(idle, 1, 2, 3)
print("Slowest call:", slowest_time, "seconds")
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
