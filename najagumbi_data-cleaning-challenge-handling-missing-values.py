...
# Now to see how many total missing values we have
...
# i'll get a subset of the sf_permits dataset first

subset_sf_permits = sf_permits.loc[:, 'Street Number':'Site Permit'].head()
subset_sf_permits
