...
# Fill in the line below: get names of columns with missing values # Your code here
...
myimputer1 = SimpleImputer(strategy='median')

final_X_train = pd.DataFrame(myimputer1.fit_transform(X_train))

final_X_valid = pd.DataFrame(myimputer1.transform(X_valid))
...
final_X_test  =  pd.DataFrame(myimputer1.fit_transform(X_test))
