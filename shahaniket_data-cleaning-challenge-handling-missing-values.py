...
(total_missing/sf_total_cells)*100
# look at the # of missing points in the first ten columns
...
print('Total Columns in original dataset', len(sf_permits.columns))
print('Total Columns after null columns removal', len(sf_columns_na_dropped.columns))
