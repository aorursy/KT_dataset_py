...
plt.figure(figsize=(12,12))
sns.kdeplot(df.SepalLengthCm, df.SepalWidthCm,  shade=True)
plt.figure(figsize=(12,12))
sns.kdeplot(df[Irisvirginica].SepalLengthCm, df[Irisvirginica].SepalWidthCm, cmap="Reds",  shade=True, alpha=0.3, shade_lowest=False)
sns.kdeplot(df[Irissetosa].SepalLengthCm, df[Irissetosa].SepalWidthCm, cmap="Greens", shade=True, alpha=0.3, shade_lowest=False)
sns.kdeplot(df[Irisversicolor].SepalLengthCm, df[Irisversicolor].SepalWidthCm, cmap="Blues", shade=True, alpha=0.3, shade_lowest=False)
