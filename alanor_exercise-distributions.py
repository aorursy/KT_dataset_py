...
sns.kdeplot(data=cancer_b_data['Area (mean)'],label="benign",shade=True) # Your code here (benign tumors)

sns.kdeplot(data=cancer_m_data['Area (mean)'],label="malignant",shade=True) # Your code here (malignant tumors)
