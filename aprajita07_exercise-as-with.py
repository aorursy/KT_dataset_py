...
tableData = client.get_table(table_ref)

client.list_rows(tableData,max_results=5).to_dataframe()
#q_2.solution()
# Your code goes here
...
speeds_query = """
               ...
               SELECT EXTRACT(hour from trip_start_timestamp) hour_of_day,COUNT(1) as num_trips,
