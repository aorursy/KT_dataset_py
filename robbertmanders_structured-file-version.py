...
%matplotlib inline
# movie_num['vote_classes'] = pd.cut(movie_num['vote_average'],20, labels=["0-0.5",'0.5-1','1-1.5','1.5-2','2-2.5','2.5-3','3-3.5','3.5-4','4-4.5','4.5-5','5-5.5','5.5-6','6-6.5','6.5-7','7,7.5','7.5-8','8-8.5','8.5-9','9-9.5','9.5-10'])

movie_num['vote_classes'] = pd.cut(movie_num['vote_average'],100, labels=range(100))
...
X2 = my_imputer.fit_transform(movie_num[['runtime']])

movie_num['runtime'] = X2
...
# df2['budget'] = df2['budget']/100000000
