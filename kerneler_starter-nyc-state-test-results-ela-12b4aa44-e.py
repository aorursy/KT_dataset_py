...
# ela.csv has 23988 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/ela.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'ela.csv'
nRow, nCol = df1.shape
