...
df['sharma'] = sharma
df
mean = np.mean(df['kohli'])

median = np.median(df['kohli'])

plt.figure(figsize=(8,8))

sns.distplot(df['kohli'],bins=6,rug=True)
...
plt.plot(years,shreyas,label = "Shreyas")

plt.plot(years,jadeja,label = "Jadeja")

plt.plot(years,dhoni,label = "Dhoni")

plt.plot(years,sharma,label = "Sharma")
...
plt.title("Indian Cricket Player's Average Runs Over Time")
