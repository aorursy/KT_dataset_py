...
temp_df = pd.read_csv("/kaggle/input/dummy-sub-for-ufc-fight-night-overeem-vs-sakai/task-dummy.csv")

sub_list.append(temp_df)



temp_df = pd.read_csv("/kaggle/input/mdabbert-ufc-contest-10-submission/ufc-9-5-20-sub.csv")
