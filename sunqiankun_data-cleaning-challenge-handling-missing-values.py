...
per_missing_values_count = sf_permits.isnull().sum()
per_total_cells = np.product(sf_permits.shape)
per_total_missing = per_missing_values_count.sum()
(per_total_missing*1.0/per_total_cells)*100.0
