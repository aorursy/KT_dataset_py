...
cm_lr = confusion_matrix(y_test,gscv_GBM.predict(x_test))
...
#final_mod_GBM = GradientBoostingClassifier(max_depth = 3, min_samples_leaf = 8, n_estimators = 100)
...
skplt.metrics.plot_roc_curve(y_test,final_mod_GBM.predict_proba(x_test))
...
#final_mod = XGBClassifier(max_depth = 3, min_samples_leaf = 4, n_estimators = 100)
