...
#-----------------Testing 3 different Theories for highest results ---------------
...
#-----Most Accurate was Random Forest, so that's what would be used for testing purposes---------

#-----The results was a score of about 0.8137-----------------------