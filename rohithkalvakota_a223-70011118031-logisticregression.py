...
LR3 = LogisticRegression(C=0.02, solver='newton-cg').fit(X_train,y_train)
yhat3 = LR3.predict(X_test)
yhat_prob3 = LR3.predict_proba(X_test)
log_loss(y_test, yhat_prob3)
LR4 = LogisticRegression(C=0.03, solver='lbfgs').fit(X_train,y_train)
yhat4 = LR4.predict(X_test)
yhat_prob4 = LR4.predict_proba(X_test)
log_loss(y_test, yhat_prob4)