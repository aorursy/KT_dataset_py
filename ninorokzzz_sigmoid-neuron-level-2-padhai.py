!ls /kaggle/input/padhai-module1-level2/

!unzip /kaggle/input/padhai-module1-level2/level_2_test.zip

!unzip /kaggle/input/padhai-module1-level2/level_2_train.zip
import os
