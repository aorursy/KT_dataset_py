...
# taxable-sales-and-purchases-quarterly-data-beginning-sales-tax-year-2013-2014.csv has 335160 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/taxable-sales-and-purchases-quarterly-data-beginning-sales-tax-year-2013-2014.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'taxable-sales-and-purchases-quarterly-data-beginning-sales-tax-year-2013-2014.csv'
nRow, nCol = df1.shape
