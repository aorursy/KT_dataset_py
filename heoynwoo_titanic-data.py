...
for col in df_test.columns:
    ...
    print(msg)
msno.matrix(df=df_train.iloc[:, :], figsize=(8, 8), color=(0.8, 0.9, 0.2))
msno.bar(df=df_train.iloc[ : , : ], figsize=(8, 8), color=(0.8, 0.9, 0.2))
msno.bar(df=df_test.iloc[ : , : ], figsize=(8, 8), color=(0.8, 0.9, 0.2))
...
submission.to_csv('./my_first_submissio.csv', index=False)