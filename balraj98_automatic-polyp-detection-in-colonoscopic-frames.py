...
if os.path.exists('../input/automatic-polyp-detection-in-colonoscopic-frames/best_model.pth'):

    model = torch.load('../input/automatic-polyp-detection-in-colonoscopic-frames/best_model.pth', map_location=DEVICE)
...
elif os.path.exists('../input/automatic-polyp-detection-in-colonoscopic-frames/best_model.pth'):

    best_model = torch.load('../input/automatic-polyp-detection-in-colonoscopic-frames/best_model.pth', map_location=DEVICE)
