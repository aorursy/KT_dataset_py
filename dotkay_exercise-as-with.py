...
rides_per_year_query_job = rides_per_year_query # Your code goes here



# API request - run the query, and return a pandas DataFrame

rides_per_year_result = client.query(rides_per_year_query, job_config=safe_config).to_dataframe() # Your code goes here
