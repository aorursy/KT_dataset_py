...
unique_provinces = suicide_attacks['Province'].unique()
unique_provinces.sort()
unique_provinces
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip()
# check if the 'Province' column is converted into lowercase
...
cities.sort()
cities
# I will do an example on the province column 
# It looks like 'balochistan', 'baluchistan' are the same province (https://en.wikipedia.org/wiki/Balochistan,_Pakistan)
