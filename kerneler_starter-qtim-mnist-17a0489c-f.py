...
# mnist.csv has 7867 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/mnist.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'mnist.csv'
nRow, nCol = df1.shape
