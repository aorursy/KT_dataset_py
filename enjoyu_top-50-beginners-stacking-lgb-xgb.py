...
# 이 열들이 범주형변수이기 때문에 숫자를 쓰면 러닝모델들이 숫자라고 인식할 것이기 때문에 string으로 바꿔준다.
...
## mode(제일 열에서 많은 빈도를 보이는 것)로 채우는 중..
...
### 'GarageYrBlt', 'GarageArea', 'GarageCars' 들은 0으로

### 'GarageType', 'GarageFinish', 'GarageQual', 'GarageCond' 들은 'None'으로 채움..
...
### 'BsmtQual', 'BsmtCond', 'BsmtExposure', 'BsmtFinType1', 'BsmtFinType2' 들을 'None'으로 채움..
...
## 예를 들어 PoolArea가 0이면 HasPool도 0 처럼 바꾸기
