...
def modelRegularized(): 
    ...
    a=Dense(50, activation = "relu", kernel_regularizer = regularizers.l2(0.01))(X)

    a=Dropout(0.3)(a)

    a=Dense(50, activation = "relu", kernel_regularizer = regularizers.l2(0.01))(a)
...
train_history_tam1 = modelF.fit(train_dfX, train_dfY, epochs=200, validation_data=(val_dfX, val_dfY), verbose=0)
