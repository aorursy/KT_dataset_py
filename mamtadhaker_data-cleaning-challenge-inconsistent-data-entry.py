...
suicide_attacks['Province'] = suicide_attacks['Province'].apply(lambda x : 'baluchistan' if x =='balochistan' else x)
...
suicide_attacks = replace_matches_in_column(df=suicide_attacks, column='City', string_to_match="d.i khan")
# get all the unique values in the 'City' column
...
suicide_attacks['City'] = suicide_attacks['City'].apply(lambda x : 'kurram agency' if x =='kuram agency' else x)
