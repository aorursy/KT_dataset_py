...
df1 = pd.read_csv('../input/chicago-department-of-public-health-clinic-locations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'chicago-department-of-public-health-clinic-locations.csv'
nRow, nCol = df1.shape
