...
# q_1.solution()
# Calculate and show partial dependence plot (for number_inpatient)
...
# q_2.solution()
# Your Code Here
# Create the data that we will plot (for time_in_hospital)
...
# q_3.solution()
# Average readmission rate for each time_in_hospital

# Concat train_X, train_y
