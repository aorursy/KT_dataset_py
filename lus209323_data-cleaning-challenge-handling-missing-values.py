...
missing_values_count[0:10]
sf_permits.head()
sf_missing_values_count.loc["Zipcode",]
...
sf_columns_dropna = sf_permits.dropna(axis = 1)
sf_columns_dropna.head()
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_columns_dropna.shape[1])
