...
def should_hit(player_total, dealer_total, player_aces):
    ...
    """
    #print("number of aces player has",player_aces, " player total ", player_total);
    should_hit = False;
    for ace in range(1,player_aces):
        player_total = player_total + 11 if 11 + player_total  < 21 else player_total + 1;
    if player_total <= 17:
        should_hit = True;
