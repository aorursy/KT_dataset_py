...
# for key, value in zip(item_ratings.keys(), item_ratings.values()):

#         item_ratings[key] = sum(value)/len(value)



# Another way of finding out mean
