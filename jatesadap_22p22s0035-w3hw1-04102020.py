...
os.listdir("../input/super-ai-image-classification/val/val/")
image_train1 = pd.read_csv("../input/super-ai-image-classification/train/train/train.csv")
image_train1.head(10)
...
def prepareImages(data, m, dataset):
    ...
    return X_train
X = prepareImages(image_train1, image_train1.shape[0], "train/train")
X /= 254
y, label_encoder = prepare_labels(image_train1['category'])
y.shape
model = Sequential()
...
test_df['category'] = ''
X = prepareImages(test_df, test_df.shape[0], "val/val")
X /= 1
