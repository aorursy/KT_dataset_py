...
inter2 = pdp.pdp_interact(model=first_model, dataset = val_X, model_features=base_features, features=feature_names)
pdp.pdp_interact_plot(pdp_interact_out = inter2, feature_names=feature_names, plot_type = 'contour')
plt.show()

#q_2.solution()
savings_from_shorter_trip = 14
