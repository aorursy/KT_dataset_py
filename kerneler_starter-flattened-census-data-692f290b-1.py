...
# flattened_census_data.csv has 48842 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/flattened_census_data.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'flattened_census_data.csv'
nRow, nCol = df1.shape
