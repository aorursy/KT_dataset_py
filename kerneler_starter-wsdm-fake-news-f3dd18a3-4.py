...
df1 = pd.read_csv('../input/all/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/all/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/all/train.csv', delimiter=',', nrows = nRowsRead)
