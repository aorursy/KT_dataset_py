...
Action_Sales = np.sum(Action['Global_Sales'])

Adventure_Sales = np.sum(Adventure['Global_Sales'])

Fighting_Sales = np.sum(Fighting['Global_Sales'])

Misc_Sales = np.sum(Misc['Global_Sales'])

Platform_Sales = np.sum(Platform['Global_Sales'])

Puzzle_Sales = np.sum(Puzzle['Global_Sales'])

Racing_Sales = np.sum(Racing['Global_Sales'])

RolePlaying_Sales = np.sum(RolePlaying['Global_Sales'])

Shooter_Sales = np.sum(Shooter['Global_Sales'])

Simulation_Sales = np.sum(Simulation['Global_Sales'])

Sports_Sales = np.sum(Sports['Global_Sales'])

Strategy_Sales = np.sum(Strategy['Global_Sales'])
...
df = data_set.groupby('Platform')['Genre'].nunique()
