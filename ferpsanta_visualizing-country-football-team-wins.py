...
league_code = 21518 # For the spanish LIGA BBVA
...
team_number = len(df['home_team'].value_counts())



teams = team_encoder.inverse_transform(range(team_number))



plt.xticks(np.arange(team_number),teams,rotation = 90)

plt.yticks(np.arange(team_number),teams)
