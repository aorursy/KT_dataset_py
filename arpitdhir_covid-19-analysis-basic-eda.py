...
for dirname, _, filenames in os.walk('/kaggle/input/input1/merged1.csv'):
...
data = pd.read_csv('/kaggle/input/input1/merged1.csv')
...
temp=data.loc[data['Date'] == '3/18/2020']
...
temp=temp.loc[data['Date'] == '3/18/2020']
...
for dirname, _, filenames in os.walk('/kaggle/input/complete/complete.csv'):
...
# Any results you write to the current directory are saved as output.
India=pd.read_csv('/kaggle/input/complete/complete.csv')
