...
day_of_month_landslides_earthqauke = earthquakes['date_parsed'].dt.day
day_of_month_landslides_earthqauke
...
day_of_month_landslides = day_of_month_landslides_earthqauke.dropna()
sns.distplot(day_of_month_landslides, kde=False, bins=31)
