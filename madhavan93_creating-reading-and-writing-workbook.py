...
# Your code here
import pandas as pd
check_q2(pd.DataFrame({'Apples':[35,41], 'Bananas':[21,34]}, ['2017 Sales', '2018 Sales']))
# Your code here
...
import pandas as pd
q6_df = pd.DataFrame({'Cows': [12, 20], 'Goats': [22, 19]}, index=['Year 1', 'Year 2'])
check_q6( q6_df.head().to_csv('cows_and_goats.csv') )
# Your Code Here
import pandas as pd
import sqlite3
con = sqlite3.connect('../input/pitchfork-data/database.sqlite')
check_q7(pd.read_sql_query('SELECT * from artists', con))