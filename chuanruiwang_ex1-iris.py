...
Vir = df.species=='virginica'

Ver = df.species=='versicolor'

Set = df.species=='setosa'
plt.figure(figsize=(12,12))

sns.kdeplot(df[Vir].sepal_length, df[Vir].sepal_length, cmap="Reds",  shade=True, alpha=0.3, shade_lowest=False)

sns.kdeplot(df[Ver].sepal_length, df[Ver].sepal_length, cmap="Greens",  shade=True, alpha=0.3, shade_lowest=False)

sns.kdeplot(df[Set].sepal_length, df[Set].sepal_length, cmap="Blues",  shade=True, alpha=0.3, shade_lowest=False)
