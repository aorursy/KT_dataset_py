...
data = pd.read_csv('../input/sentiment140/training.1600000.processed.noemoticon.csv', encoding='latin-1', names=['target','id','date','flag','user','text'])
data
...
# Here's the results of how well our model performed at predicitng
