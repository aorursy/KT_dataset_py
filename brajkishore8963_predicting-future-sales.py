...
items_df = pd.read_csv(os.path.join('/kaggle/input/competitive-data-science-predict-future-sales','items.csv'))

#items_df.head()

shops_df = pd.read_csv('/kaggle/input/competitive-data-science-predict-future-sales/items.csv')
