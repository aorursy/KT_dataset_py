...
a[0]
#melakukan assign pada elemen array dengan element baru
...
a.ndim
#mengetahui nilai baris ke-1 dan kolom ke-3 dari sebuah array
...
a[1:2]
#slicing dari indeks ke-1, dan batas indeks ke-1 dari 
...
#membuat berwarna (custom grafik)
