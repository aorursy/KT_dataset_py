...
def bar_plot(variable):
    ...
    # count number of caterogical variable (value/sample)
...
g.set_ylabels("Survived Proabability")

plt.show()
g = sns.factorplot( x = "Parch", y = "Survived", kind = "bar", data = train_df, size = 9)
...
plt.show()
g = sns.FacetGrid(train_df, col = "Survived", size = 10)
