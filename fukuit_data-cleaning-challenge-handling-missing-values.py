...
# your code goes here :)
sf_permits.sample(5)
#print(sf_permits.sample(50)[['Street Number Suffix', 'Zipcode']])
...
print(sf_permit_missing_values_count[0:10])

sf_permit_total_cells = np.product(sf_permits.shape)
sf_permit_total_missing = sf_permit_missing_values_count.sum()
print('total_cells:\t{}'.format(sf_permit_total_cells))
print('total_missing:\t{}'.format(sf_permit_total_missing))

missing_rate = (sf_permit_total_missing/sf_permit_total_cells) * 100
...
print('Columns in original dataset:\t{}'.format(nfl_data.shape[1]))
