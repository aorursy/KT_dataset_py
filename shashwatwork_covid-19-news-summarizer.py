...
os.listdir('/kaggle/input/cbc-news-coronavirus-articles-march-26/')

df_news = pd.read_csv('/kaggle/input/cbc-news-coronavirus-articles-march-26/news.csv',usecols=[2,5])

df_news.head()
df_news.info()
df_news.isna().sum()
data = df_news[['title','text']]
data.head()
data.info()
...
plot_wordcloud(data['text'].values, title="Word Cloud of News Text",color = 'black')
