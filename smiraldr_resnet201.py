...
model =torchvision.models.resnet201(pretrained=True)   
...
!kaggle competitions submit -c qstp-deep-learning-2019 -f submission.csv -m "resnet201 0.005 normalised adagrad"