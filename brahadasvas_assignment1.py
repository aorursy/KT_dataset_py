...
filename='../input/sample1/file_example_XLSX_10.xlsx'
...
for chunk in pd.read_csv('TestData.csv', chunksize=chunksize):
    ...
    chunk.to_sql(name=db_name, con=conn, if_exists='append')

#write the query to execue

cur.execute('SELECT * FROM vnurt WHERE Age>25')
