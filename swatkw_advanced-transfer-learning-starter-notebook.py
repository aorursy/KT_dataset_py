...
stats=([0.00505, 0.00344, 0.00519], [0.10038, 0.08284, 0.10179])
...
#     T.ColorJitter(brightness=0.1, contrast=0.1, saturation=0.1, hue=0.1),
    ...
    T.RandomRotation(30),    #realier 10
    T.ToTensor(), 
...
def F_score(output, label, threshold=0.5, beta=1):
    ...
    return F2.mean(0)
'''
def FocalLoss(outs, targets):
    BCE_loss = F.binary_cross_entropy(outs, targets)
...
jovian.log_metrics(val_loss=history[-1]['val_loss'], 
                   ...
                   time=train_time)
project_name='protein-advanced-project'
