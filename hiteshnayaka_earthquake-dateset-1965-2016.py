...
df.info()    # This will show us the summary of our dataset
df.head(10)
df.tail(10)
df.describe()
print(len(df))
...
df.iloc[:,0:3]
df.pivot_table(index = "Type", values = "Magnitude", aggfunc = max)
df.pivot_table(index = "Type", values = "Magnitude", aggfunc = min)
df = pd.read_csv('../input/earthquake-19652016/earthquake.csv')
df.columns   # Gives all columns in our dataset
