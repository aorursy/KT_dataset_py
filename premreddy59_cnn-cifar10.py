...
print(model.similarity('airplane', 'bird'))

print(model.similarity('airplane', 'automobile'))

print(model.similarity('cat', 'dog'))
similar_with_airplane = model.similar_by_word('airplane',topn = 100)

print(similar_with_airplane)
similar_with_cat = model.similar_by_word('cat', topn = 100)

print(similar_with_cat)
...
for v in similar_with_airplane:

    vectors.append(model[v[0]])

    labels.append('red')

for v in similar_with_cat:
...
"""scatter plot through matplotlib"""
