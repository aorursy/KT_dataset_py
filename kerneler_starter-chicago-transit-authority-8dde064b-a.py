...
df1 = pd.read_csv('../input/cta-list-of-cta-datasets.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'cta-list-of-cta-datasets.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# cta-list-of-fare-media-sales-outlets-deprecated-august-2014.csv has 1584 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/cta-list-of-fare-media-sales-outlets-deprecated-august-2014.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'cta-list-of-fare-media-sales-outlets-deprecated-august-2014.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
df3 = pd.read_csv('../input/cta-ridership-annual-boarding-totals.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'cta-ridership-annual-boarding-totals.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
