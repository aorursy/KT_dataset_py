...
permits_data_nadrop = sf_permits.dropna(axis=1)
permits_data_nadrop.head()
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % permits_data_nadrop.shape[1])
