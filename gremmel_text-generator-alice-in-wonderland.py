...
with open("../input/alice_wonderland.txt", 'r') as file:
...
x_data = to_categorical(x_data, num_classes=47)
y_data = to_categorical(y_data, num_classes=47)
...
modelo.fit(x_data, y_data, epochs=5)
import sys
next_chars = 1000
