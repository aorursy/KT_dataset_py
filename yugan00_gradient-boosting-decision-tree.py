...
param = {
    ...
    'max_depth': 8, # 构建树的深度，越大越容易过拟合,取值范围为：[1,∞],取8效果最好
    ...
    'min_child_weight': 1, #孩子节点中最小的样本权重和，取值范围[0,∞],取1效果最好
...
class my_gbdt(object):
    ...
    def __init__(self):
        ...
        self.tree = DecisionTreeRegressor(min_samples_split=6)#, max_depth=100)
