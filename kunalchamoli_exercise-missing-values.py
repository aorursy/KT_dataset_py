...
drop_col = [col for col in X_train.columns if X_train[col].isnull().any()]

# Fill in the lines below: drop columns in training and validation data

reduced_X_train = X_train.drop(drop_col, axis =1)



reduced_X_valid = X_valid.drop(drop_col, axis =1)
...
final_X_test = X_test.drop(drop_col, axis =1)
