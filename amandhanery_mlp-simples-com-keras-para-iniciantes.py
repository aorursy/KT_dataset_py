...
# Manipulação de dados #lerdataset

import pandas as pd

# Redes Neurais  #bliblioteca de deep da google
...
# Plot #plotar graficos

import matplotlib.pyplot as plt

%matplotlib inline

# Avaliação #fuções de calcular metrica

from sklearn.metrics import classification_report, confusion_matrix

# Lendo o dataset Kaggle #criando variavel de treino com pandas, lendo CSV(dataset)
...
print(train.head())
# Separando x_train e y_train  #dados de entrada y - dado de saida x
...
#ele ta tirando os labels e deixando só os pixels
...
#Normalizando para valores entre 0 e 1  #colocar os dados para uma escala parecida
...
#transformando o dado em uma saida vetorizada para os diferente neoronios
...
#Dropout é uma tecnica, que em cada rodade de treino ela escolhe um eprcentual de ligações para ignorar durante o treino

# para que obrigue a rede neural a aprender formas alternativas de reconhecer padrão (para reduzir overfeat)
...
model.compile(loss='categorical_crossentropy',
              ...
              metrics=['accuracy']) #percentual de acerto
# Treina com os parte dos dados

batch_size = 32 #quantos exemplos joga de uma vez pra ajuste dos pesos? influencia na velocidade de treino

epochs = 50  # numero de epocas

#epochs = 10

history = model.fit(x_train, y_train, #ememplos treino, saidas

                    batch_size=batch_size, 

                    epochs=epochs,

                    verbose=1, #imprimir tela passo a passo

                    validation_data=(x_val, y_val))
#Vamos ver como foi o treino?  #plotando grafico para observar
