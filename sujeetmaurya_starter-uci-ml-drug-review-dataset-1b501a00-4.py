...
df1 = pd.read_csv('/kaggle/input/drugsComTest_raw.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/drugsComTrain_raw.csv', delimiter=',', nrows = nRowsRead)
