...
print(missing_val_count_by_column.shape)

print("number of missing",missing_val_count_by_column[missing_val_count_by_column > 0])
...
missing_val_count_by_column.shape
# Fill in the line below: get names of columns with missing values

cols = missing_val_count_by_column[missing_val_count_by_column>0].index.tolist() # Your code here
