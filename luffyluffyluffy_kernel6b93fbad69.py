...
# !cp -r /kaggle/input/pylibtiff/pylibtiff-master/* ./
# import libtiff
# /kaggle/input/eye-in/eye-in-the-sky-master/
!cp -r /kaggle/input/eye-in/eye-in-the-sky-master/* ./
# import libtiff
%cd eye-in-the-sky
...
p  =os.getcwd()
p=''
p=os.path.join(p, 'Inter-IIT-CSRE/The-Eye-in-the-Sky-dataset/sat/2.tif')
os.listdir('Inter-IIT-CSRE/The-Eye-in-the-Sky-dataset/sat/')
os.rename(p,  p+'f')
