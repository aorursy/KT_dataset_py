...
def GridSearchCV_work(pipeline, train_x, train_y, test_x, param_grid, score = 'accuracy'):
...
for model, model_name, model_param_grid in zip(classifiers, classifier_names, classifier_param_grid):
    ...
    result = GridSearchCV_work(pipeline,X_train, Y_train, X_test, model_param_grid , score = 'accuracy')