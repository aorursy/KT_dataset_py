...
# Now, similarly take a look at all the unique values in the "Province" column.
province = suicide_attacks['Province'].unique()
province
# Convert the column to lowercase
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()
# Remove the trailing white spaces as former
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip()
# Check into your data
province = suicide_attacks['Province'].unique()
province
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
...
def replace_matches_in_column(df, column, string_to_match, min_ratio = 90):
    ...
    # let us get confirmation that function is done
    print("All done!")
...
# function to replace rows in the provided column of the provided dataframe
# that match the provided string above the provided ratio with the provided string
def replace_matches1_in_column(df, column, string_to_match, min_ratio = 80):
    # get a list of unique strings
    strings = df[column].unique()
