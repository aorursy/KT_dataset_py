...
# current-certified-pesticide-applicators.csv has 33405 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/current-certified-pesticide-applicators.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'current-certified-pesticide-applicators.csv'
nRow, nCol = df1.shape
