...
#Predict Output 
target_pred = NModel.predict(X_test)
print(accuracy_score(Y_test, target_pred,normalize = True))

NModel_pNone = GaussianNB()

# Train the model using the training sets 
NModel_pNone.fit(X_train, Y_train)
GaussianNB(priors=None)
#Predict Output 
target_pred_pNone = NModel_pNone.predict(X_test)
print(accuracy_score(Y_test, target_pred_pNone,normalize = True))
