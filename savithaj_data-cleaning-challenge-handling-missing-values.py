...
columns_na_sf=sf_permits.dropna()
columns_na_sf.head()
print("Rows in original dataset: %d \n" % sf_permits.shape[0])
print("Rows with na's dropped: %d" % columns_na_sf.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
columns_na_sf=sf_permits.dropna(axis=1)
columns_na_sf.head()

print("Column in original dataset: %d \n" % sf_permits.shape[1])
print("Column with na's dropped: %d" % columns_na_sf.shape[1])
