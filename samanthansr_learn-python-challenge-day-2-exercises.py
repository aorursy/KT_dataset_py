...
def to_smash(total_candies, num=3):
    ...
    the given number of candies evenly between a number of friends. Default number of friends = 3.
...
#smallest_abs = min(x,y,key=absolute)
...
print(smallest_stringy_number('-3', '2', '1'))
print(smallest_stringy_number('0', '-3', '-5'))
print(smallest_stringy_number('0', '1', '2'))
print(smallest_stringy_number('10', '2', '3'))
print(smallest_stringy_number('3', '2', '11'))
print(smallest_stringy_number('2', '1', '3'))
q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
