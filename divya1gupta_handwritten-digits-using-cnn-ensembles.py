...
test = test / 255.0
# Reshape image (height = 28px, width = 28px , channel = 1)
...
X_train, X_val, Y_train, Y_val = train_test_split(X_train, Y_train, test_size = 0.1, random_state=234)
# Some examples
...
submission.to_csv("MNIST-submission-cnn.csv",index=False)
#accuracy plots fo all models:
