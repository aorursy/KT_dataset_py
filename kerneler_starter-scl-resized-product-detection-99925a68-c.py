...
df1 = pd.read_csv('/kaggle/input/shopee-product-detection-dataset-resized/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/shopee-product-detection-dataset-resized/test.csv', delimiter=',', nrows = nRowsRead)
