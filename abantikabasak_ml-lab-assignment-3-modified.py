...
import os 
print(os.listdir("../input")) #Contains train(1).csv

# Any results you write to the current directory are saved as output.
import tensorflow as tf
Dataframe=pd.read_csv("../input/mnistdata/train(1).csv")
...
print(temp)
print(temp.shape)
for i in range(0,5): #Displaying 5 images
        X=temp[i,0:temp.shape[1]-10] #Last 10 : label columns
        #print(X)
        I=X.reshape((28,28))
...
mu=kmeans.cluster_centers_ #Find cluster centres
...
with tf.Session() as sess:
    ...
    X1=plt.imread("../input/images/img_0.jpg")
    ...
    X2=plt.imread("../input/images/img_1.jpg")
    ...
    X3=plt.imread("../input/images/img_2.jpg")
