...
trace2 = go.Bar(
    ...
    y = df2014.teaching,
    name = "teaching",
    marker = dict(color = "rgba(255,255,126,0.5)",
                 line = dict(color = "rgb(0,0,0)",width=1.5)),
    text = df2014.country
)
data = [trace1,trace2]
...
x_saving = [x for x in df2016.university_name]
x_net_worth = [x for x in df2016.university_name]

trace0 = go.Bar(
    x=y_saving,
    y=x_saving,
    marker=dict(color="rgba(171,50,98,0.6)",line=dict(color="rgba(171,50,96,1.0)",width=1)),
    name="research",
    orientation="h",
)
trace1 = go.Scatter(
