...
print(football)
edu = pd.read_csv('/kaggle/input/guithub-import-ense3/files/ch02/educ_figdp_1_Data.csv',
...
pivedu.rank(ascending=True, method='first').head()
