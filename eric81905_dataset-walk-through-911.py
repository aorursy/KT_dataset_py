...
g=d[(d['type'] == 'EMS') & (d['timeStamp'] >= '2016-05-2 00:00:00') & (d['timeStamp'] <= '2016-05-23 00:00:00')]

p=pd.pivot_table(g, values='e', index=['timeStamp'], columns=['title'], aggfunc=np.sum)



# Resampling every hour 'H'.  This is very powerful

pp=g.resample('6H', how=[np.sum]).reset_index()
...
ax.plot_date(pp['index'], pp['e'],'k')

ax.plot_date(pp['index'], pp['e'],'ro')





ax.set_title("Number of Emergency Medical Service ")
...
g=d[(d['type'] == 'Traffic') & (d['timeStamp'] >= '2016-05-2 00:00:00') & (d['timeStamp'] <= '2016-05-23 00:00:00')]
...
ax.set_title("Number of Traffic Accident")
...
g=d[(d['type'] == 'Fire') & (d['timeStamp'] >= '2016-05-2 00:00:00') & (d['timeStamp'] <= '2016-05-23 00:00:00')]
...
ax.set_title("Number of Fire Accident")
...
g_ems=d[(d['type'] == 'EMS') & (d['timeStamp'] > '2016-03-1 00:00:00') & (d['timeStamp'] < '2016-08-29 00:00:00')]



# Resampling every hour 'H'.  This is very powerful

pp_ems=g_ems.resample('W', how=[np.sum]).reset_index()
...
g_traffic=d[(d['type'] == 'Traffic') & (d['timeStamp'] > '2016-03-1 00:00:00') & (d['timeStamp'] < '2016-08-29 00:00:00')]



# Resampling every hour 'H'.  This is very powerful

pp_traffic=g_traffic.resample('W', how=[np.sum]).reset_index()
...
g_fire=d[(d['type'] == 'Fire') & (d['timeStamp'] > '2016-03-1 00:00:00') & (d['timeStamp'] < '2016-08-29 00:00:00')]



# Resampling every hour 'H'.  This is very powerful

pp_fire=g_fire.resample('W', how=[np.sum]).reset_index()
...
ax.plot_date(pp_ems['index'], pp_ems['e'],'k')

ax.plot_date(pp_ems['index'], pp_ems['e'],'ro')



ax.plot_date(pp_traffic['index'], pp_traffic['e'],'g')

ax.plot_date(pp_traffic['index'], pp_traffic['e'],'bo')



ax.plot_date(pp_fire['index'], pp_fire['e'],'y')

ax.plot_date(pp_fire['index'], pp_fire['e'],'mo')
...
green_line = mlines.Line2D([], [], color='green', marker='o',markerfacecolor='blue',
                          ...
                          markersize=7, label='Traffic')

black_line = mlines.Line2D([], [], color='black', marker='o',markerfacecolor='darkred',

                          markersize=7, label='EMS')

yellow_line = mlines.Line2D([], [], color='y', marker='o',markerfacecolor='m',

                          markersize=7, label='Fire')



ax.legend(handles=[green_line,black_line,yellow_line], loc='best')
