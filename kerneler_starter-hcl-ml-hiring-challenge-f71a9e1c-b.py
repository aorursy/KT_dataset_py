...
df1 = pd.read_csv('/kaggle/input/HCL ML Challenge/Results.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/HCL ML Challenge/sample_submission.csv', delimiter=',', nrows = nRowsRead)
