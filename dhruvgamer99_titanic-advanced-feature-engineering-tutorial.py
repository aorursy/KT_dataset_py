...
df_all_corr.columns = ['Feature_1', 'Feature_2', 'Correlation_Coefficient']
...
df_all.loc[df_all['Age'].isnull(), 'Age'] = df_all.groupby(['Sex', 'Pclass'])['Age'].transform('median')
df_all['Age'].unique()
df_all[df_all['Embarked'].isnull()]
df_all.query('Embarked.isnull()', engine = 'python')
#Alternative way
# Filling the missing values in Embarked with S
df_all['Embarked'] = df_all['Embarked'].fillna('S')
df_all[df_all['Fare'].isnull()]
df_all.query('Fare != Fare')
