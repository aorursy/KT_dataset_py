...
second_fashion_model.add(Conv2D(10,kernel_size=(4,4),activation='relu'))

second_fashion_model.add(Conv2D(10,kernel_size=(4,4),activation='relu'))

second_fashion_model.add(Flatten())

second_fashion_model.add(Dense(100))

second_fashion_model.add(Dense(num_classes,activation='softmax'))

# compiling the model

second_fashion_model.compile(loss='categorical_crossentropy',optimizer='adam',metrics=['accuracy']) #why this loss function always for categorical variables
