...
MaxTemp.fillna(MaxTemp.mean(), inplace=True)

MinTemp.fillna(MinTemp.mean(), inplace=True)
from sklearn.model_selection import train_test_split

x_train, x_test, y_train, y_test = train_test_split(MaxTemp,MinTemp,test_size=0.33,random_state=0)
