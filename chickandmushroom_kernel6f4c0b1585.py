    ...
    def create_Ck(self, Lksub1, k):
        ...
        for i in range(len_Lksub1):
            ...
            for j in range(1, len_Lksub1):
                ...
                if not(i == j): #never choose the same 2 lists
                    ...
                    if k == 2:
                        ...
                        for t in range(k-2):
                            ...
                            if not(l1[t]==l2[t]):
                                ...
                                equal = False  #the first k-2 items are the same
                        ...
                        #pruning
                            ...
                            for m in range(k-2):
                                ...
                                del tmp[m] #delete one element to form a subset with length of k-1

                                tmp = set(tmp)

                                if tmp not in Lksub1:
        ...
        for i in range(0, len(L)):
            ...
            for freq_set in L[i]:
                ...
                for sub_set in sub_set_list:
                    ...
                    if sub_set.issubset(freq_set) and not(sub_set==freq_set):
