...
data["class"]= [ 2 if (each == "Spondylolisthesis") else 0 if (each=="Hernia") else 1  for each in data["class"]]
y=data["class"].values
...
plt.title('Biomechanical features of orthopedic patients Dataset ile Sınıflandırma',fontsize = 20,color='blue')
