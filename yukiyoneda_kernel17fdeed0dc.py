...
plt.ylabel("SalePrice")
#GrLiv > 4000 && SalePrice <300000 を外れ値として除去
...
plt.ylabel("SalePrice")
#GarageArea <1000 && SalePrice >700000 を外れ値として除去
...
plt.ylabel("SalePrice")
#FullBath <0.5 && SalePrice >300000 を外れ値として除去
...
plt.ylabel("SalePrice")
#TotRmsAbvGrd > 13 を外れ値として除去

train = train.drop(train[(train['TotRmsAbvGrd'] > 13) & (train['SalePrice']<400000)].index)
...
plt.ylabel("SalePrice")
#YearBuilt <1920 && SalePrice >300000 を外れ値として除去

train = train.drop(train[(train['YearBuilt']<1920) & (train['SalePrice']>300000)].index)
