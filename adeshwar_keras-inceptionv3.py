...
from keras.applications import DenseNet121, DenseNet169, InceptionV3
...
for epoch in range(0, 10):
    ...
    if epoch != 0:
        ...
        model.load_weights('inception_momentum_model.h5')    
    ...
    model.fit_generator(generator = data_generator_train,
                        ...
                        callbacks = [ModelCheckpointFull('inception_momentum_model.h5')],
...
test_df.to_csv('inception_momentum_submission.csv', index = False)
