...
#it shows posssible styles that can we use
...
train_df.head()
#check if there is any missing value,in which columns
...
train_df[train_df["Embarked"].isnull()]
#check the nan ones in Fare

train_df[train_df["Fare"].isnull()]
#fill the nan ones with 3nd class people's average
