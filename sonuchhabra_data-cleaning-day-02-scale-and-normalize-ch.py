...
# plotting the distributions of original and scaled data
fig, ax=plt.subplots(1,2)
...
normalized_pos_pledges = stats.boxcox(pos_pledges)[0]

# plot original and normalized positive pledges to compare
fig, ax=plt.subplots(1,2)
sns.distplot(pos_pledges, ax=ax[0])
ax[0].set_title("Positive Pledges")
sns.distplot(normalized_pos_pledges, ax=ax[1])
