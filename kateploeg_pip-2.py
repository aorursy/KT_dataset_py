...
steps_rev = 5000                                # This steps_rev amount was changed from the original 1000 to 5000 in order to make the numerical solution smaller.
...
plt.show()
        #code snippet 7 - same as above, in Task 3
...
radius_exact = np.sqrt((exact_position_x - rxc)**2 + (exact_position_y - ryc)**2)

radius_numerical = np.sqrt((position_x - rxc)**2 + (position_y - ryc)**2)



numerical_error = radius_numerical - radius_exact



print("numerical error in the radii = ", numerical_error)



plt.figure(10)

plt.plot(numerical_error)
...
average = sum(numerical_error)/N_loops/steps_rev



print("average numerical error = ", average)
