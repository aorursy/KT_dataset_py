...
df_cloudfound = pd.read_csv("../1_data/ks-projects-201801.csv")[['state', 'category', 'main_category', 'currency', 'country', 'usd_goal_real']]

df_cloudfound['state'] = df_cloudfound['state'].replace('canceled', 'failed')
...
rfecv = RFECV(estimator, cv=30, scoring='accuracy')
