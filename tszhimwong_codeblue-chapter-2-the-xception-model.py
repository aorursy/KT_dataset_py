...
#Adding dense layers into the pretrained Xception model
...
val_seq = fold_seq[0] #Using the first fold as validation 
...
checkpt = ModelCheckpoint(monitor='val_loss',
                        ...
                        filepath = 'best_Xception_final.h5',
...
model = keras.models.load_model('best_Xception_final.h5', custom_objects={'focal_crossentropy': focal_loss})
