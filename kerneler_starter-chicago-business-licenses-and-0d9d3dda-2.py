...
# business-licenses.csv has 943703 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# business-owners.csv has 272487 rows in reality, but we are only loading/previewing the first 100 rows
