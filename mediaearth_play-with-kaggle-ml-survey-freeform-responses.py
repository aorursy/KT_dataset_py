...
mcr_df = pd.read_csv("../input/freeformResponses.csv", encoding="ISO-8859-1", low_memory=False)

mcr_df.shape
mcr_df.head()
temp_series = mcr_df['CurrentJobTitleFreeForm'].value_counts()
...
py.iplot(fig, filename="jobtitle")
temp_series = mcr_df['ImpactfulAlgorithmFreeForm'].value_counts()
