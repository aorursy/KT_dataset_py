...
# local-government-efficiency-program-grants-beginning-2005.csv has 526 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/local-government-efficiency-program-grants-beginning-2005.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'local-government-efficiency-program-grants-beginning-2005.csv'
nRow, nCol = df1.shape
