...
# nys-attorney-registrations.csv has 365181 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/nys-attorney-registrations.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'nys-attorney-registrations.csv'
nRow, nCol = df1.shape
