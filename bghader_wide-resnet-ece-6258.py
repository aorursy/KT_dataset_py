...
# Any results you write to the c urrent directory are saved as output.
...
model.save_weights('../model_adam60_weights.h5')
0
# Save the model architecture
with open('../model_adam60_architecture.json', 'w') as f:
