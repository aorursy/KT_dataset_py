...
sn_mse.fit(X_scaled_train, Y_train, epochs=600, learning_rate=0.015, loss_fn="mse", display_loss=True)
sn_ce = SigmoidNeuron()

sn_ce.fit(X_scaled_train, Y_train, epochs=400, learning_rate=0.015, loss_fn="ce", display_loss=True)
