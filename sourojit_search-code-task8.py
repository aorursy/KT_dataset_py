...
q1=['Are there geographic variations in the rate of COVID-19 spread?',
...
s1=['Are there geographic variations in the rate of COVID-19 spread?',
...
q2=['Are there geographic variations in the rate of COVID-19 spread?',
...
new_frame.to_csv("task8_results.csv",index=False)