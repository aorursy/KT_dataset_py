...
#setting up the hardware and appropriate distribution strategy
...
histories_inception, inception_model = train_and_predict(folds = FOLDS)
...
# histories_NasNet, NasNet_model = train_and_predict(folds = FOLDS)
