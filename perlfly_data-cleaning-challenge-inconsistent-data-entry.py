...
provinces.sort()
provinces
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower() # convert to lower case
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip() # removes leading or trailing white symbols
...
replace_matches_in_column(df=suicide_attacks, column='City', string_to_match='kurram agency') # From a simple web search the correct city name should be 'kurram agency'
cities = suicide_attacks['City'].unique()
cities.sort()
cities