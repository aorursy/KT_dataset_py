...
fuzzywuzzy.process.extract("kuram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
# Correct the dataframe
replace_matches_in_column(df=suicide_attacks, column='City', string_to_match="kuram agency", min_ratio=90)

# Check that 'kurram agency' has disappeared
sorted(suicide_attacks['City'].unique())
