...
X_train2 = data_train.drop(['species'], axis=1)
y_train2 = data_train['species']
X_test2 = data_test.drop(['species'], axis=1)
y_test2 = data_test['species']
lr2 = LogisticRegression()
lr.fit(X_train2,y_train2)
y_lr_2 = lr.predict(X_test2)
lr_score2 = accuracy_score(y_test2, y_lr_2)
print(lr_score2)
cm = confusion_matrix(y_test, y_lr)
print(cm)