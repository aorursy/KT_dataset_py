...
# west-nile-virus-wnv-mosquito-test-results.csv has 26449 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/west-nile-virus-wnv-mosquito-test-results.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'west-nile-virus-wnv-mosquito-test-results.csv'
nRow, nCol = df1.shape
