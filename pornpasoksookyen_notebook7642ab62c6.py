...
data = pd.read_csv("../input/titanic-train/titanic_train.csv")
print(data.info())
...
data_optimized = pd.read_csv("../input/titanic-train/titanic_train.csv",dtype=optimized_dtypes)
test_optimized = pd.read_csv("../input/titanic-test/titanic_test.csv",dtype=optimized_dtypes)
