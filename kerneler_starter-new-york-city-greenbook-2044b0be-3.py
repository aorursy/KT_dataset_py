...
# greenbook.csv has 4912 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/greenbook.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'greenbook.csv'
nRow, nCol = df1.shape
