...
df1 = pd.read_csv('../input/nlp/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/nlp/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/nlp/train.csv', delimiter=',', nrows = nRowsRead)
