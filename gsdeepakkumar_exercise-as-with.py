...
rides_per_year_query = """SELECT EXTRACT(YEAR FROM trip_start_timestamp) as year,count(1) as 

                        num_trips from `bigquery-public-data.chicago_taxi_trips.taxi_trips`
...
rides_per_month_query = """SELECT EXTRACT(MONTH FROM trip_start_timestamp) as month,count(1) as 
