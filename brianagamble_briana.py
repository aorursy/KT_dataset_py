...
lVar=['race', 'age', 'fear', 'news', 'natcrimy', 'concourt', 'courts']
...
for var in lVar:
    ...
    lLen = lFreq / len(dfGSS.loc[:,var].index)
...
plt.hist(dfGSS['age']) # Replace VAR with the name of a numeric variable.
plt.xlabel('age') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of VAR_LABEL') # Replace VAR_LABEL with the label of your variable
...
plt.hist(dfGSS['courts']) # Replace VAR with the name of a numeric variable.
plt.xlabel('courts') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of VAR_LABEL') # Replace VAR_LABEL with the label of your variable
...
plt.hist(dfGSS['natcrimy']) # Replace VAR with the name of a numeric variable.
plt.xlabel('natcrimy') # Replace VAR_LABEL with the label of your variable (ex. Sex).
plt.ylabel('Frequency')
plt.title('Histogram of VAR_LABEL') # Replace VAR_LABEL with the label of your variable
...
test['helpsick']={1:'Govt should help',3:'Agree with both',5:'People help selves'}
...
my_variable = 'natcrimy' # Replace VAR with the name of a categorical variable.
...
my_variable = 'concourt' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
...
plt.xticks(locs, my_xticks, rotation=90)
plt.show()
my_variable = 'courts' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
...
plt.xticks(locs, my_xticks, rotation=90)
plt.show()
my_variable = 'socbar' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
