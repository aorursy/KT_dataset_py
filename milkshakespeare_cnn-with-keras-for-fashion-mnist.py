...
from keras.layers import Conv2D, Dense, Dropout, Flatten, MaxPooling2D, ZeroPadding2D,BatchNormalization
...
plt.show()
model = Sequential([
    #ZeroPadding2D((1, 1), input_shape=im_shape),
    Conv2D(32, (3, 3), activation='relu', padding = 'same', input_shape=im_shape),
    BatchNormalization(),
    Dropout(0.15),
