cd /Users/akash-5162/Desktop/DS/Git/Projects
import pandas as pd
...
chess_years['standard_rating'].plot(kind='bar',grid=True,title='Standard rating vs year of birth',figsize=(25,5))
chess_years['rapid_rating'].plot(kind='bar',grid=True,title='Rapid rating vs year of birth',figsize=(25,5))
chess_years['blitz_rating'].plot(kind='bar',grid=True,title='Blitz rating vs year of birth',figsize=(25,5))