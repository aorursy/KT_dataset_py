...
# Copy the above code again to check the removal of inconsistencies
# get all the unique values in the 'City' column
cities_new = suicide_attacks['City'].unique()
...
province.sort()
province
# Lower case and removing any trailing spaces
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()
suicide_attacks['Province'] = suicide_attacks['Province'].str.strip()

province_updated = suicide_attacks['Province'].unique()
province_updated.sort ()
province_updated
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
