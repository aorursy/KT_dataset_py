...
useless = ['PassengerId', 'Pclass', 'Name', 'Ticket', 'Fare']

all_df = all_df.drop(useless, axis = 1)
all_df.head(2)
...
categorical.head(3)
categorical.shape
# get dummies value for categorical data
...
pd.DataFrame(outcome, columns=["PassengerId", "Survived"]).to_csv("submission.csv", index=None)
