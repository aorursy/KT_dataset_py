...
valloader = torch.utils.data.DataLoader(trainset, batch_size=32, shuffle=False, num_workers=4) #Train loader, can change the batch_size to your own choice
...
model.fc = torch.nn.Linear(num_ftrs, 67)
...
# Optimizer to be used, replace "your_model" with the name of your mode1l and enter your learning rate in lr=0.001

optimiser = torch.optim.SGD(filter(lambda p: p.requires_grad, model.parameters()), lr=0.0006, momentum=0.9)
epochs = 10 #I actually had no of epochs as 150
...
for epoch in range(epochs):
    ...
    for i, (images, labels) in enumerate(trainloader):
        ...
        myoutputs = model(images)

        loss = criterion(myoutputs, labels)
        ...
        if iter % 500 == 0:
            ...
            for images, labels in valloader:
                ...
                _, predicted = torch.max(myoutputs.data, 1)
...
#The rest is commented because the competition is closed

'''import os

os.environ['KAGGLE_USERNAME']="asmital"

os.environ['KAGGLE_KEY']="cb2a23fdb06fe8c975719e917de6a436"

!pip install kaggle



!kaggle competitions submit -f submission.csv -m SUBMISSION qstp-deep-learning-2019'''