...
# sidewalk-cafe-permits.csv has 16770 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/sidewalk-cafe-permits.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'sidewalk-cafe-permits.csv'
nRow, nCol = df1.shape
