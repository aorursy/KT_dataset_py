...
wine_counts.plot.line(stacked=False)
...
pokemon.head()
pokemon.plot.scatter(x='Attack', y='Defense', stacked=False)
pokemon.plot.hexbin(x='Attack', y='Defense', gridsize=15, stacked=False)
...
pokemon_stats_by_generation.plot.line(stacked=False)