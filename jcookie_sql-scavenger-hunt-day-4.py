...
#bitcoin transacton per day, WITH, AS
...
# safe limitation as above and plot
...
#merkle root , transaction ID
query4 = """ SELECT merkle_root,
                   COUNT(transaction_id) AS transactions
            FROM `bigquery-public-data.bitcoin_blockchain.transactions`
            GROUP BY merkle_root
            ORDER BY 2 DESC
        """
transactions_per_merkle_root = bitcoin_blockchain.query_to_pandas_safe(query4, max_gb_scanned=37)
