...
# loading databases
adult = pd.read_csv('../input/adult-data-5/train_data.csv',names=[
...
adultTest = pd.read_csv('../input/adult-data-5/test_data.csv',names=["Age", "Workclass", "fnlwgt", "Education", "Education-Num", "Marital Status",
        "Occupation", "Relationship", "Race", "Sex", "Capital Gain", "Capital Loss",
        "Hours per week", "Country", "Target"],
        sep=r'\s*,\s*',
        engine='python',
...
testData = pd.read_csv( '../input/adult-data-5/submitTest.csv',names=["Age", "Workclass", "fnlwgt", "Education", "Education-Num", "Marital Status",
        "Occupation", "Relationship", "Race", "Sex", "Capital Gain", "Capital Loss",
...
refData = pd.read_csv('../input/adult-data-5/train_data.csv',names=[
        "Age", "Workclass", "fnlwgt", "Education", "Education-Num", "Marital Status",
        "Occupation", "Relationship", "Race", "Sex", "Capital Gain", "Capital Loss",
        "Hours per week", "Country", "Target"],
        sep=r'\s*,\s*',
        engine='python',
        na_values="?", skiprows = 0).dropna()
for i in (1,3,5,6,7,8,9,13):
...
finalPrediction = bestClass.predict(testData[["Age", "Workclass", "Marital Status",
