...
# -*- coding: utf-8 -*-
"""
Created on Wed May 27 15:13:29 2020
...
data = pd.read_csv("/kaggle/input/heart_son.csv")
...
models = pd.DataFrame({
    ...
    'Score_train': [acc_log, acc_knn, acc_gaussian,  
              ...
              acc_gradient_boosting, acc_bagging_classifier,acc_AdaBoost],
    'Score_test': [acc_test_log, acc_test_knn, acc_test_gaussian, 
              ...
              acc_test_gradient_boosting, acc_test_bagging_classifier,acc_test_AdaBoost]
                    })
...
plt.legend()
plt.title('Score of 10 models for train and test datasets')
plt.xlabel('Models')
plt.ylabel('Score, %')
