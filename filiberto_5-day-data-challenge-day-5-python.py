...
surveyData.head()
# first let's do a one way squared test for stats background
...
# now let's do a two-way chi-square test. Is there a relationship between 

# programming background and stats background? 
