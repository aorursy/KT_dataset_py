...
X_train = X_train.drop('MasVnrArea', axis='columns')

X_train = X_train.fillna(X_train.mean())

# X_train.isnull().sum()

X_valid['GarageYrBlt'] = X_valid.fillna(0)

X_valid['LotFrontage'] = X_valid['LotFrontage'].fillna(X_valid['LotFrontage'].mean())

X_valid = X_valid.drop('MasVnrArea', axis='columns')
...
X_test = X_test.drop('MasVnrArea', axis='columns')
