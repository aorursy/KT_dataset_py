...
df1 = pd.read_csv('/kaggle/input/E-Commerce/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/E-Commerce/sample.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/E-Commerce/test.csv', delimiter=',', nrows = nRowsRead)
