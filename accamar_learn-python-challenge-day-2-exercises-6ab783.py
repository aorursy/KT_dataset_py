...
#q1.solution()
# -1 returns nearest 10, -2 returns nearest 100 etc. Useful when dealing with large numbers where lower digits are not significant.
#q2.solution()
def to_smash(total_candies, no_of_players=3):
    ...
    1
    """
    return total_candies % no_of_players
