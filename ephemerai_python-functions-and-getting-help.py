...
names = ['jacques', 'Ty', 'Mia', 'pui-wab']
print("Longest name is:", max(names, key=lambda name: len(name))) # or just key=len, and returns the first longest name
print("Names sorted case insensitive:", sorted(names, key=lambda name: name.lower()))
print("Names sorted case insensitive:", sorted(names)) # Upper-case comes first