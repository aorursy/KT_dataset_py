...
x_train, x_test, y_train, y_test = train_test_split(df_train.loc[:,df_train.columns != 'price_range'],
...
forest_model = RandomForestClassifier(n_estimators=700,random_state=1)
