...
def is_positive_odd(num):
    ...
    return is_odd(num) and is_positive(num)
...
def median(seq):
    ...
    if is_odd(length):
        ...
        # Find center term on list and reduce by 0.5 for use in calling a item from the sequence

        center = int((length / 2) - 0.5)

        return seq[center]

    else:

        # Record the low and high term in the list since it is of even length and then find their average using our mean() function

        center_low = int((length / 2) - 1)

        center_high = int(length / 2)

        return mean([seq[center_high],seq[center_low]])
...
def only_odd_numbers(seq):
    ...
    return [num for num in seq if is_odd(num)]
...
def only_even_numbers(seq):
    ...
    return [num for num in seq if is_even(num)]
...
def only_positive_numbers(seq):
    ...
    return [num for num in seq if is_positive(num)]
...
def only_negative_numbers(seq):
    ...
    return [num for num in seq if is_negative(num)]
...
def has_evens(seq):
    ...
    return len(only_even_numbers(seq)) > 0
...
def count_evens(seq):
    ...
    return len(only_even_numbers(seq))
...
def has_odds(seq):
    ...
    return len(only_odd_numbers(seq)) > 0
...
def count_odds(seq):
    ...
    return len(only_odd_numbers(seq))
...
def count_negatives(seq):
    ...
    return len(only_negative_numbers(seq))
...
def count_positives(seq):
    ...
    return len(only_positive_numbers(seq))
...
def only_positive_evens(seq):
    ...
    return [num for num in seq if is_even(num) and is_positive(num)]
...
def only_positive_odds(seq):
    ...
    return [num for num in seq if is_odd(num) and is_positive(num)]
...
def only_negative_evens(seq):
    ...
    return [num for num in seq if is_even(num) and is_negative(num)]
...
def only_negative_odds(seq):
    ...
    return [num for num in seq if is_odd(num) and is_negative(num)]
