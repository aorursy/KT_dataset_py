...
# ethics-pledge.csv has 3974 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/ethics-pledge.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'ethics-pledge.csv'
nRow, nCol = df1.shape
