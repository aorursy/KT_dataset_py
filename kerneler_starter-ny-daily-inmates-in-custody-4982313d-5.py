...
# daily-inmates-in-custody.csv has 8165 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/daily-inmates-in-custody.csv', delimiter=',', nrows = nRowsRead)
