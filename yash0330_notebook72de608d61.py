...
# load data
train = pd.read_csv('/kaggle/input/movie-review-text-classification/train.csv')
test = pd.read_csv('/kaggle/input/movie-review-text-classification/test.csv')
...
submission = pd.read_csv('/kaggle/input/movie-review-text-classification/sample_submission.csv')
