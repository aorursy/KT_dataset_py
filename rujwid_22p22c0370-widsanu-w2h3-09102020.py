...
sns.scatterplot(x1, y1, color='violet', label='Cluster1', s=70, alpha=0.7)
sns.scatterplot(x2, y2, color='pink', label='Cluster2', s=70, alpha=0.7)
sns.scatterplot(x3, y3, color='orange', label='Cluster3', s=70, alpha=0.7)
plt.title('Clusters of Neighbourhood', size=30)
df_g = df.groupby('neighbourhood').agg({'number_of_reviews':'mean',
...
scaler = MinMaxScaler()
df_scaled = scaler.fit_transform(df_g)
