...
# Eth_Txs.csv has 499466 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/Eth_Txs.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'Eth_Txs.csv'
nRow, nCol = df1.shape
