...
# nyc-permitted-event-information.csv has 7447 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/nyc-permitted-event-information.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'nyc-permitted-event-information.csv'
nRow, nCol = df1.shape
