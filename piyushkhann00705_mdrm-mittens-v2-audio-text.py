...
def train(duration,t_bilstm1,fc1,a_bilstm1, c_bilstm, c_fc ,y_train, y_val, y_test, batch_size, epochs, learning_rate):
    ...
    T_bilstm1=Bidirectional(LSTM(units=t_bilstm1, dropout=0.5, recurrent_dropout=0.5, activation='tanh' ,return_sequences=True))(mask_text)

    T_drop1=Dropout(0.5)(T_bilstm1)
    ...
    A_bilstm1=Bidirectional(LSTM(units=a_bilstm1, dropout=0.6, recurrent_dropout=0.6, return_sequences=True))(mask_audio)

    A_drop1=Dropout(0.6)(A_bilstm1)
    ...
    return
train(duration=3,t_bilstm1=100,fc1=50,a_bilstm1=100,c_bilstm=100,c_fc=100 ,y_train=y_train3days, y_val=y_val3days, y_test=y_test3days, batch_size=32, epochs=80, learning_rate=0.001)
train(duration=7,t_bilstm1=100,fc1=50,a_bilstm1=100,c_bilstm=100,c_fc=100  ,y_train=y_train7days, y_val=y_val7days, y_test=y_test7days, batch_size=32, epochs=80, learning_rate=0.001)
train(duration=15,t_bilstm1=100,fc1=50,a_bilstm1=100,c_bilstm=100,c_fc=100 ,y_train=y_train15days, y_val=y_val15days, y_test=y_test15days, batch_size=32, epochs=80, learning_rate=0.001)
