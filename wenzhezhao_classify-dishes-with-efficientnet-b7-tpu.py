...
os.listdir("/kaggle/input/tfrecord-food/commit_dataset")
...
GCS_DS_PATH = KaggleDatasets().get_gcs_path("tfrecord-food")
...
BATCH_SIZE = 16 * strategy.num_replicas_in_sync ### 16x8=128
GCS_PATH = GCS_DS_PATH + '/commit_dataset'
...
CLASSES=["QieZi","ShanYao","KuGua","XiLanHua"]
...
mcp = tf.keras.callbacks.ModelCheckpoint(filepath='food_tpu_model_best.hdf5',
...
best_alpha = 0.37 ### 0.44

print(best_alpha) ### ratio of mix models
# def lrate(epoch):
...
# )
model.save_weights("food_tpub7_model_last.hdf5")
model2.save_weights("food_tpuds_model_last.hdf5")
