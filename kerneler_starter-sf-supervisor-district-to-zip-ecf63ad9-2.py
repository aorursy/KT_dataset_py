...
df1 = pd.read_csv('../input/supervisor-district-to-zip-code-crosswalk.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'supervisor-district-to-zip-code-crosswalk.csv'
nRow, nCol = df1.shape
