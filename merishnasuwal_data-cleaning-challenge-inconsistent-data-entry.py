...
suicide_attacks['Targeted Sect if any'].unique()
suicide_attacks['Targeted Sect if any'] = suicide_attacks['Targeted Sect if any'].str.lower()
...
# check what the character encoding might be
print(result)
ver6suicide_attacks = pd.read_csv("../input/PakistanSuicideAttacks Ver 6 (10-October-2017).csv", encoding='Windows-1252')
ver6suicide_attacks.columns
ver6suicide_attacks.head()
city = ver6suicide_attacks['City'].unique()
city.sort
city
ver6suicide_attacks['City']= ver6suicide_attacks['City'].str.lower()
ver6suicide_attacks['City']= ver6suicide_attacks['City'].str.strip()
city = ver6suicide_attacks['City'].unique()
city.sort
city
replace_matches_in_column(df=ver6suicide_attacks, column='City', string_to_match="d.i khan")
city = ver6suicide_attacks['City'].unique()
city.sort
city
