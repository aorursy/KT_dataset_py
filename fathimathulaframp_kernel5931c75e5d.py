...
class CIFAR10Model(ImageClassificationBase):
    def __init__(self):
        super().__init__()
        self.linear1 = nn.Linear(input_size, 82)
        self.linear2 = nn.Linear(82, 46)
...
history
history += fit(13, 0.2, model, train_loader, val_loader)
...
arch = "3 layers (82,46,10)" 
lrs = [0.2, 0.1, 0.01, 0.001]
epochs = [13, 10, 5]
test_acc = evaluate(model, val_loader)['val_acc']
test_loss = evaluate(model, val_loader)['val_loss']
