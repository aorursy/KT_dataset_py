...
batch_size = 100
train=pd.read_csv('/kaggle/input/2020-ai-term-project-18011759/train.CSV', encoding='euc-kr',header=None, skiprows=1, usecols=range(0,8))
...
linear5 = torch.nn.Linear(530,1, bias = True)
...
test_xy = pd.read_csv("/kaggle/input/2020-ai-term-project-18011759/test.CSV", encoding='euc-kr',header=None, skiprows=1, usecols=range(0,7))
...
submit=pd.read_csv('/kaggle/input/2020-ai-term-project-18011759/submit_sample.CSV')
