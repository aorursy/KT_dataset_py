...
rose = femmes & classe1
#on ajoute .Sex pour compter uniquement sur une colonne (mais une colonne quelconque qui n'a pas de valeur manquantes donc Sex par exemple)
...
print(p_rose)
t.columns
sns.jointplot("Survived","Pclass",t,kind='kde')
sns.violinplot(x="Sex",y="Age",data=t)
fig = sns.FacetGrid(t, hue="Pclass", aspect=3, palette="Set2") # aspect=3 permet d'allonger le graphique

fig.map(sns.kdeplot, "Age", shade=True) #doit etre numérique
