...
for feat_name in base_features:
    ...
    plt.show()
q_1.solution()
feat_name = ['pickup_longitude', 'dropoff_longitude']
pdp_dist = pdp.pdp_interact(model=first_model, dataset=val_X, model_features=base_features, features=feat_name)

pdp.pdp_interact_plot(pdp_interact_out=pdp_dist, feature_names=feat_name, plot_type='contour')
plt.show()
q_2.solution()
savings_from_shorter_trip = 25 - 10
