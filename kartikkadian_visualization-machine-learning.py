...
LogReg=accuracy_score(lr_predict,y_test)
...
SVM_sc=accuracy_score(svc_predict,y_test)
nb_model = GaussianNB()
...
Naive_bayes_score=accuracy_score(nb_predict,y_test)
...
Decision_Tree_score=accuracy_score(dt_predict,y_test)
...
Random_Forest_score=accuracy_score(rfc_predict,y_test)
...
print("The accuracy of Logistic Regression Model is: ",LogReg)
...
print("The accuracy of Extra Tree Classifier is: ",Extra_Tree_Classifier_score)