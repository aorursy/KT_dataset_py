...
plt.plot(epochs, val_precision_Aug_Inc, 'c', label='Validation Precision Augmentation ResNet50')

plt.plot(epochs, val_recall_Aug_Inc, 'm', label='Validation Recall Augmentation ResNet50')

plt.plot(epochs, val_auc_Aug_Inc, 'g', label='Validation AUC Augmentation ResNet50')
