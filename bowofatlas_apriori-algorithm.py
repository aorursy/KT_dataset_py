...
class Apriori:
            ...
            for j in range(1, len_Lksub1):
                ...
                if l1[0:k-2] == l2[0:k-2]:
                    ...
                    for item_ck in Ck:
                        ...
                        for item_lksub1 in l1:

                            if item_lksub1 in item_ck == 0:
    ...
    def generate_rules(self):
        ...
        for i in range(0, len(L)):  # every Lk

            for freq_set in L[i]:   # every frequent set in Lk

                for sub_set in sub_set_list:    # if one subset exists in frequent set
                    ...
                    if sub_set.issubset(freq_set):
                        ...
                        for transaction in self.transactions:
                            ...
                            if sub_set.issubset(transaction):

                                tn_with_sub_set += 1

                            if freq_set.issubset(transaction):

                                tn_with_freq_set += 1

                        conf = tn_with_freq_set / tn_with_sub_set
