#cette script a pour role du calculé f  d'apres  w  sans passer par les calcules matricielles intenses  qui prend beacoup de temps

#en utilisant une approche  d'intelligence artificielle qui donnes des resultats robustes  dans quelques fraction de  seconde

#importation des bibs pour algebre linaire
...
#importation de donnees du fichier excel  contenant w et f

data=pd.read_csv("../input/geniecivile/home/mohaned/Downloads/e5.csv")
#visualization du donnees

data

#information sur les types de donnes
...
#repartition du donnees entre train et test pour evaluer le model mathematique developpé d'une maniere  correcte
...
def calcul(input_r,input_t,start_l,end_l,num_pts):
    ...
    kk=np.linspace(start = start_l, stop = end_l, num = num_pts)

    w=kk/np.sqrt(input_r*input_t)
...
#exemple:  l varie entre 10 et 2000 et  on veut prendre 20 point dans cette intervale equi-espacés

input_w,output_force=calcul(200,2.2,100,2000,20)
