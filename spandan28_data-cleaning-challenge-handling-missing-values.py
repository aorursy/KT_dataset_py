...
shape_sf = np.product(sf_permits.shape)
sum_missing_data_sf = missing_data_sf.sum()
percentage_null = sum_missing_data_sf / shape_sf *100
...
row_na_sf = sf_permits.dropna()
row_na_sf.shape

# Now try removing all the columns with empty values. Now how much of your data is left?
col_na_sf = sf_permits.dropna(axis=1)
col_na_sf.shape
