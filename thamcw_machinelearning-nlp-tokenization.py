...
#It makes use of tokenization package from the Natural Language Toolkit (nltk) in Python to

#breakdown the speech into its constituent sentences and words and count them.
...
#use """ to allow speech to span multiple lines.
...
len(sentences)
#break the paragraph into its constituent words

words=nltk.word_tokenize(paragraph)
#find the total words in the paragraph
