...
#     intersection.to_csv("intersection-files\\raw-intersection\\intersection for "+str(city)+".csv")
#     intersection_set[city] = intersection
# list of column names of census data to use
...
SeaGroup = SeaGroup.assign(**{'Race_Bi-Racial': np.nan, 'Crime_Violent': np.nan, 'Crime_Non-Violent':np.nan, 'Crime_Non-Criminal':np.nan})
SeaGroup = SeaGroup.reset_index(level=['District', 'Date'])
SeaGroup = SeaGroup[['District', 'Date', 'UOF_Use of Physical Force', 'UOF_Use of Non-Lethal Weapon', 'UOF_Use of Lethal Weapon', 'UOF_Fatal Use of Weapon', 'Crime_Violent', 'Crime_Non-Violent', 'Crime_Non-Criminal', 'Race_Native American', 'Race_Asian', 'Race_Black', 'Race_Latinx', 'Race_Pacific Islander','Race_Not Listed','Race_White', 'Race_Bi-Racial', 'Gender_Male', 'Gender_Female', 'Gender_Not Listed']].copy()
...
IndGroup = IndGroup.assign(**{'Race_Bi-Racial': np.nan, 'Crime_Violent': np.nan, 'Crime_Non-Violent':np.nan, 'Crime_Non-Criminal':np.nan, 'UOF_Fatal Use of Weapon':np.nan})
IndGroup = IndGroup.reset_index(level=['District', 'Date'])
IndGroup = IndGroup[['District', 'Date', 'UOF_Use of Physical Force', 'UOF_Use of Non-Lethal Weapon', 'UOF_Use of Lethal Weapon', 'UOF_Fatal Use of Weapon', 'Crime_Violent', 'Crime_Non-Violent', 'Crime_Non-Criminal', 'Race_Native American', 'Race_Asian', 'Race_Black', 'Race_Latinx', 'Race_Pacific Islander','Race_Not Listed','Race_White', 'Race_Bi-Racial', 'Gender_Male', 'Gender_Female', 'Gender_Not Listed']].copy()
...
MinnGroup = MinnGroup.assign(**{'Race_Bi-Racial': np.nan, 'Crime_Violent': np.nan, 'Crime_Non-Violent':np.nan, 'Crime_Non-Criminal':np.nan, 'UOF_Fatal Use of Weapon':np.nan, 'Race_Latinx':np.nan})
MinnGroup = MinnGroup.reset_index(level=['District', 'Date'])
MinnGroup = MinnGroup[['District', 'Date', 'UOF_Use of Physical Force', 'UOF_Use of Non-Lethal Weapon', 'UOF_Use of Lethal Weapon', 'UOF_Fatal Use of Weapon', 'Crime_Violent', 'Crime_Non-Violent', 'Crime_Non-Criminal', 'Race_Native American', 'Race_Asian', 'Race_Black', 'Race_Latinx', 'Race_Pacific Islander','Race_Not Listed','Race_White', 'Race_Bi-Racial', 'Gender_Male', 'Gender_Female', 'Gender_Not Listed']].copy()
...
LaGroup = LaGroup.assign(**{'UOF_Use of Physical Force':np.nan, 'UOF_Use of Non-Lethal Weapon':np.nan, 'UOF_Fatal Use of Weapon':np.nan, 'UOF_Use of Lethal Weapon':np.nan, 'Race_Bi-Racial':np.nan, 'Gender_Not Listed':np.nan})
LaGroup = LaGroup.reset_index(level=['District', 'Date'])
LaGroup = LaGroup[['District', 'Date', 'UOF_Use of Physical Force', 'UOF_Use of Non-Lethal Weapon', 'UOF_Use of Lethal Weapon', 'UOF_Fatal Use of Weapon', 'Crime_Violent', 'Crime_Non-Violent', 'Crime_Non-Criminal', 'Race_Native American', 'Race_Asian', 'Race_Black', 'Race_Latinx', 'Race_Pacific Islander','Race_Not Listed','Race_White', 'Race_Bi-Racial', 'Gender_Male', 'Gender_Female', 'Gender_Not Listed']].copy()
...
OakGroup = OakGroup[['District', 'Date', 'UOF_Use of Physical Force', 'UOF_Use of Non-Lethal Weapon', 'UOF_Use of Lethal Weapon', 'UOF_Fatal Use of Weapon', 'Crime_Violent', 'Crime_Non-Violent', 'Crime_Non-Criminal', 'Race_Native American', 'Race_Asian', 'Race_Black', 'Race_Latinx', 'Race_Pacific Islander','Race_Not Listed','Race_White', 'Race_Bi-Racial', 'Gender_Male', 'Gender_Female', 'Gender_Not Listed']].copy()
