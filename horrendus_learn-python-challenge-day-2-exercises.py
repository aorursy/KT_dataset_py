...
#q1.solution()
round(123456.789012345, -2)
# may be useful for data science application to get the data into "buckets" (e.g. 1 - 99, 100 - 199, 200 - 201)
#q2.solution()
def to_smash(total_candies, number_of_friends = 3):
    """Return the number of leftover candies that must be smashed after distributing
    the given number of candies evenly between number_of_friends friends (default: 3)
...
print(slowest_call(sleep, 4, 1, 3))
print(slowest_call(sleep, 4, 5, 3))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
