...
#Use the SQLit Table to read the data
...
def partition(x):
    ...
    return 'positive'
#implementing the change and adding an additonal column
...
plt.show()
standardized_data_tfidf = StandardScaler().fit_transform(final_tf_idf)

print(standardized_data_tfidf.shape)

type(standardized_data_tfidf)
