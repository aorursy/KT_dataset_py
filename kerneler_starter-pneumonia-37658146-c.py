...
# train_bboxes.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df2 = pd.read_csv('/kaggle/input/train_bboxes.csv', delimiter=',', nrows = nRowsRead)

df2.dataframeName = 'train_bboxes.csv'
