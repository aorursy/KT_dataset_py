...
super_bowls = pd.read_csv('../input/tv-halftime-shows-and-the-big-game-dataset/super_bowls.csv')

tv = pd.read_csv('../input/tv-halftime-shows-and-the-big-game-dataset/tv.csv')

halftime_musicians = pd.read_csv('../input/tv-halftime-shows-and-the-big-game-dataset/halftime_musicians.csv')
