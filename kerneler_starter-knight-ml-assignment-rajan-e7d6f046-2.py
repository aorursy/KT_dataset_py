...
df1 = pd.read_csv('/kaggle/input/Knight ML Assignment/Data/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Knight ML Assignment/Data/test.csv', delimiter=',', nrows = nRowsRead)
