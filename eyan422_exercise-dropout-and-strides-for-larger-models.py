...
fashion_model_1.add(Conv2D(12, kernel_size=(3, 3),
                 strides=2,
                 activation='relu',
...
# Specify the rest of the model
fashion_model_2.add(Conv2D(24, kernel_size=(3, 3),
                 strides=2,
                 activation='relu',
                 input_shape=(img_rows, img_cols, 1)))
#fashion_model_2.add(Dropout(0.5))
fashion_model_2.add(Conv2D(24, kernel_size=(3, 3), strides=2, activation='relu'))
#fashion_model_2.add(Dropout(0.5))
#fashion_model_2.add(Conv2D(24, kernel_size=(3, 3), strides=1, activation='relu'))
...
# Specify the rest of the model
fashion_model_3.add(Conv2D(24, kernel_size=(3, 3),
                 strides=2,
                 activation='relu',
                 input_shape=(img_rows, img_cols, 1)))
...
fashion_model_3.add(Dropout(0.5))
#fashion_model_3.add(Conv2D(24, kernel_size=(3, 3), strides=1, activation='relu'))
