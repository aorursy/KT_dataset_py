...
for depth in NN_depths:
    ...
    for dr in decay_rates:
        ...
        metric_train, metric_test, model = grid_search_mode_and_size(depth, initial_layer_sizes, epochs=epochs, dropout=dropout, maxnorm=maxnorm, learning_rate=learning_rate, decay_rate=dr)
