...
reviews = pd.read_csv("../input/winefirst150/winemag-data_first150k.csv", index_col=0)
...
pokemon['Attack'].plot.hist(ax=axarr[0], title='Pokemon Attack Ratings', bins=13)

pokemon['Defense'].plot.hist(ax=axarr[1], title='Pokemon Defense Ratings', bins=13)