...
timesData.head()
timesData.columns
#2011 YILINDAKİ ALINTI YAPMA VE ÖĞRETİM SKORLARINI KONTROL EDECEĞİZ
...
iplot(fig)
timesData.head()
#2014-2015-2016 Dünyadaki ilk 100 üniversitenin alıntısını inceleyeceğiz.
...
iplot(fig)
df2016=timesData[timesData.year==2016].iloc[:4,:]
...
iplot(fig)
df2016
#2016 YILINDA ÖĞRENCİLERİN SAYISINI KARŞILAŞTIRMA İLK 7 ÜNİVERSİTE
...
iplot(data)
#neden hata veriyor çözemiyorum aynısını yapmam rağmen
...
#2 den fazla feauture karşılaştırmak için kullanıyoruz.
...
iplot(fig)
#Bu plotta önemli olan bizim için büyük gösteriliyor.Önemsiz olan küçük oluyor.
