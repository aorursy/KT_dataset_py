...
cities_cleaner = suicide_attacks['City'].unique()
len(cities)
len(cities_cleaner)
...
province_cleaner = suicide_attacks['Province'].unique()
province_cleaner
len(province_cleaner)
...
matches = fuzzywuzzy.process.extract("d.i khan", cities_cleaner, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
...
# get all the unique values in the 'City' column
cities_cleaner2 = suicide_attacks['City'].unique()

# sort them alphabetically and then take a closer look
cities_cleaner2.sort()
cities_cleaner2
...
cities_cleaner3 = suicide_attacks['City'].unique()

# sort them alphabetically and then take a closer look
cities_cleaner3.sort()
cities_cleaner3
