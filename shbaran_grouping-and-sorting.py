...
best_wine2 = reviews.groupby('price').points.max().sort_index()
print (best_wine)
print (best_wine2)
check_q2(best_wine)
# Your code here
...
# Your code here
#reviews['n'] = 0
country_variety_pairs = reviews.groupby(['country', 'variety']).description.agg([len]).sort_values(by = 'len', ascending=False)
