...
# cats-permits.csv has 97326 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/cats-permits.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'cats-permits.csv'
nRow, nCol = df1.shape
