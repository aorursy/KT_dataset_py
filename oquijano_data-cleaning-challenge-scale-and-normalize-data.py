...
# scale the goals from 0 to 1
scaled_goal = minmax_scaling(goal_data, columns = [0])
...
ax[1].set_title("Normalized data")
kickstarters_2017.usd_pledged_real.equals(kickstarters_2017.pledged)
# Your turn! 
# We looked as the usd_pledged_real column. What about the "pledged" column? Does it have the same info?

if kickstarters_2017.usd_pledged_real.equals(kickstarters_2017.pledged) == True:
    print ("usd_pledged_real column has the same info as pledged column")
else:
    print ("usd_pledged_real column does not have the same info as pledged column")

    # get the index of all positive values from pledged column
index_of_positive_pledged = kickstarters_2017.pledged > 0

# get only positive pledged column
