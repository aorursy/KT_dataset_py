...
# beach-e.-coli-predictions.csv has 2340 rows in reality, but we are only loading/previewing the first 100 rows
...
nRowsRead = 100 # specify 'None' if want to read whole file
# beach-lab-data.csv has 21655 rows in reality, but we are only loading/previewing the first 100 rows
