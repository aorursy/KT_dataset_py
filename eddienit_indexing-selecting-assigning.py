...
q8.check()
q8.solution()
top_oceania_wines_points = reviews[(reviews['points'] >= 95)]
top_oceania_wines = top_oceania_wines_points[(top_oceania_wines_points['country'] == 'Australia') | (top_oceania_wines_points['country'] == 'New Zealand')]
q9.check()
top_oceania_wines
q9.solution()