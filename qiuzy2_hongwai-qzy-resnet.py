...
def conv_block1(input_tensor, kernel_size, filters, stage, block, strides=(2, 2)):
...
def get_resnet50_encoder(input_shape=[256, 320, 3], classes=2,target=2):
    ...
    x = conv_block1(x, 3, [64, 64, 256], stage=2, block='a', strides=(1, 1))
    ...
    x = conv_block1(x, 3, [128, 128, 512], stage=3, block='a')
    ...
    x = conv_block1(x, 3, [256, 256, 1024], stage=4, block='a')
...
def _unet(n_classes=2, encoder=get_resnet50_encoder,  input_height=256, input_width=320):
