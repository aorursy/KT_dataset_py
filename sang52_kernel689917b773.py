...
plt.ylabel("Throughput (mb/s)")
mat2 = loadmat("../input/mydataset3/ex8data2.mat")
...
mat3 = loadmat("../input/mydataset2/ex8_movies.mat")

mat4 = loadmat("../input/mydataset2/ex8_movieParams.mat")
...
num_users, num_movies, num_features = 20,50,3
...
movieList = open("../input/mydataset2/movie_ids.txt","r", encoding="ISO-8859-1").read().split("\n")[:-1]
