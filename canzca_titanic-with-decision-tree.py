...
inputs["Age"].median()
inputs["Age"].mean()
k1=inputs["Age"][inputs.Sex=="female"].mean()

k1
len(inputs["Age"][inputs.Sex=="male"])
len(inputs["Age"][inputs.Sex=="female"])
