...
# certified-plant-dealers.csv has 6096 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/certified-plant-dealers.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'certified-plant-dealers.csv'
nRow, nCol = df1.shape
