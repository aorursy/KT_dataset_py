...
df.head()
df_train=df.drop(["ajcc_pathologic_tumor_stage"],axis=1)

df_train=df.drop(["bcr_patient_uuid"],axis=1)

df_train=df.drop(["bcr_patient_barcode"],axis=1)
...
plt.title("Random Forest for 72")
