...
research_dataframe = readExcelToDataFrame('/kaggle/input/coviddata21/data.csv')
...
meta_data = readExcelToDataFrame('/kaggle/input/metadata/meta.csv')
meta_data.head()
...
import joblib
lda_model = joblib.load('/kaggle/input/coviddata21/lda_model.jl')
...
def show_wordcloud(data, title = None):
    ...
    plt.imshow(wordcloud)
    plt.show()
with open("/kaggle/input/coviddata21/Topic_paper_07042020_v4.csv",encoding = 'utf8', errors='ignore') as f:
...
print("=================================================================")
print(word_model.predict_output_word(a,topn=30)) 
# Risk of COVID-19 in Neonates and pregnant women
...
print("=================================================================")
print(word_model.predict_output_word(a,topn=40)) 
...
final_data =searc_by_keys_as_excel('interventions|policies|quarantine|awareness|preparedness|restrictions|campaigns|behaviors|biosecurity|governmental|search_data',search_data)
...
final_data.head()
final_data =searc_by_keys_as_excel('comorbidities|mellitus|cardiovascular|vulnerability|hypertension|pneumonia|chronic',search_data)

final_data =searc_by_keys_as_excel('severe|fatal|coinfection|contagious|susceptible|merscov|sftsv|highly|ibv|pedv|csfv|pathogenicity|eiav|prrsv|prv|h1n1pdm|hepatatis|lethalmhv|',search_data)
final_data =searc_by_keys_as_excel('stillbirth|miscarriage|congenital|malformations|microcephaly|abortion|obstetric|lbw|covid19',search_data)
final_data =searc_by_keys_as_excel('lessen | productivity|macroeconomic | affecting|vulnerability|devastating|reducing|recession|unemployment',search_data)