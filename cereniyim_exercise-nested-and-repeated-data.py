...
client.query(max_commits_query).result().to_dataframe()
...
pop_lang_query = """
                    ...
                    SELECT la.name AS language_name,
...
client.query(pop_lang_query).result().to_dataframe()
...
client.query(all_langs_query).result().to_dataframe()
