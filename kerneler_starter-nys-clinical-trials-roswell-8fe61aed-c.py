...
# current-active-clinical-trials-roswell-park-cancer-institute.csv has 424 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/current-active-clinical-trials-roswell-park-cancer-institute.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'current-active-clinical-trials-roswell-park-cancer-institute.csv'
nRow, nCol = df1.shape
