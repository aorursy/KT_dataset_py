...
def prettify_graph(graph):
    ...
    newlabels = ["${}".format(i) for i in ticks]
...
def blackjack_hand_greater_than(hand_1, hand_2):
    ...
    False
    """
    h1 = help_greater(hand_1)
    h2 = help_greater(hand_2)
    if h1 > 21:
        return False
    elif h2 > 21:
        return True
