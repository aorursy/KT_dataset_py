...
def train_model(siamese_net,data_loader,fold,best_acc,f1score,iter,step):
...
for i in range(fold):
    ...
    loss,acc,score,b,s=train_model(model,data_loader,i+1,best_acc,f1score,n_iter,step)
