...
da = pd.read_csv("/kaggle/input/nhanes/NHANES.csv") # data used here is taken from my dataset so you can check it from there
...
da = da[vars].dropna()
model = sm.OLS.from_formula("BPXSY1 ~ RIDAGEYR", data=da)    ##OLS stands Ordinary Linear Squared
