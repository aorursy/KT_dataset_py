...
X = train_data.drop(['PassengerId','Cabin','Ticket','Fare', 'Parch', 'SibSp'], axis=1)
...
got= train_data.Name.str.split(',').str[1]
...
n_traning= train_data.shape[0]   #number of rows
...
output.to_csv('my_submission RandomForest.csv', index=False)
