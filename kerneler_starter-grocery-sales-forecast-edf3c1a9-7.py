...
df1 = pd.read_csv('/kaggle/input/Grocery_Sales_ParticipantsData/Train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Grocery_Sales_ParticipantsData/Test.csv', delimiter=',', nrows = nRowsRead)
