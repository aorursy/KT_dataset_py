...
# beach-e.-coli-predictions.csv has 2310 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/beach-e.-coli-predictions.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'beach-e.-coli-predictions.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# beach-lab-data.csv has 21618 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/beach-lab-data.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'beach-lab-data.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# beach-swim-advisories.csv has 981 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/beach-swim-advisories.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'beach-swim-advisories.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
