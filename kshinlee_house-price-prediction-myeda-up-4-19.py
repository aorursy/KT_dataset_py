...
import gc
df_train = pd.read_csv('../input/2019-2nd-ml-month-with-kakr/train.csv')

df_test  = pd.read_csv('../input/2019-2nd-ml-month-with-kakr/test.csv')
!ls -al ../input/myfirst-house-price-prediction
