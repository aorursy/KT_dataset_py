...
images_array = [0 for i in range(len(classes))]
cls = dict(zip(classes, images_array))
...
arch_1 = "3 hidden layers (64,32,16) and used sigmoid activation with accuracy 47%"
arch_2 = "3 hidden layers (1024,512,128) and used relu activation with accuracy 51%"
arch_3 = "4 hidden layers (2048,1024,512,256) and used tanh activation with accuracy 53%"
arch=[arch_1, arch_2, arch_3]
lrs = [0.5,0.1,0.01,0.001]
epochs = [20,15,10,5]
test_acc = 0.536816418170929
test_loss = 1.3135212659835815
