...
df1 = pd.read_csv('/kaggle/input/Assignment3Data/Assignment3Data/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Assignment3Data/Assignment3Data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/assignment4-data/Assignment4/test.csv', delimiter=',', nrows = nRowsRead)
