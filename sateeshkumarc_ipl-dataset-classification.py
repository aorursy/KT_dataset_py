...
matches.info()
# Step 4 - Check for thumb rull 1 - Nulls
...
matches.info()
#Step 5 Check Thumb rule 5 - for all the Data is Numeris??
# Needed Features -season, city, team1, team2, toss_winner, oss_decision, winner
df = matches.drop(['id', 'date', 'result', 'dl_applied', 'win_by_runs','win_by_wickets','player_of_match', 'venue','umpire1', 'umpire2'],axis = 1)
...
teamMapper = {"Mumbai Indians": 0, "Chennai Super Kings": 1, "Kings XI Punjab":2, "Royal Challengers Bangalore" : 3,"Kolkata Knight Riders" : 4,"Delhi Daredevils" : 5,"Rajasthan Royals" : 6,"Sunrisers Hyderabad" :7,"Deccan Chargers" : 8,
"Pune Warriors" : 9,"Gujarat Lions" : 10,"Rising Pune Supergiant" : 11, "Kochi Tuskers Kerala":12,"Rising Pune Supergiants": 13, 'DRAW': 14}
for dataset in [df]:
...
df.head(5)
#Step 6  Features & Label ( X & Y Selection)
#X and Y
#First Iteration
...
print (accuracy_score_gnb)
# 1st Iteration 32.58426966292135
# 2nd Iteration 32.80898876404494
#2 KNN
