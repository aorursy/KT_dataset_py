...
latest_data=pd.read_csv('../input/corona-virus-report/covid_19_clean_complete.csv')
latest_data.head()
confirmed_df.head()
...
X_train_confirmed, X_test_confirmed, y_train_confirmed, y_test_confirmed = train_test_split(a[0], uk_cases, test_size=0.10, shuffle=False) 
...
country_plot(adjusted_dates, uk_cases, uk_daily_increase, uk_daily_death, uk_daily_recovery, 'Bangladesh')
plt.figure(figsize=(16, 9))
