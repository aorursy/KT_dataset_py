...
sf_rows_with_na_dropped = sf_permits.dropna(axis = 0, how = 'any')

sf_rows_with_na_dropped.head()

print("Rows original dataset: %d \n" % sf_permits.shape[0])
print("Rows with na's dropped: %d" % sf_rows_with_na_dropped.shape[0])
# Now try removing all the columns with empty values. Now how much of your data is left?
sf_columns_with_na_dropped = sf_permits.dropna(axis = 1, how = 'any')
...
sf_back_filled = sf_permits.fillna(method = 'bfill', axis = 0).fillna("0")
sf_back_filled_null = sf_back_filled.isnull().sum()
print(sf_back_filled_null[0:10])