...
diab = pd.read_csv("../input/diabetes/diabetes.csv")
diab
hist_data = [diab[diab["Outcome"]==0]["Pregnancies"], diab[diab["Outcome"]==1]["Pregnancies"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on Preganancies','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="Pregnancies",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["Glucose"], diab[diab["Outcome"]==1]["Glucose"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on Glucose','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="Glucose",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["BloodPressure"], diab[diab["Outcome"]==1]["BloodPressure"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on BloodPressure','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="BloodPressure",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["SkinThickness"], diab[diab["Outcome"]==1]["SkinThickness"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on SkinThickness','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="SkinThickness",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["Insulin"], diab[diab["Outcome"]==1]["Insulin"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on Insulin','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="Insulin",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["BMI"], diab[diab["Outcome"]==1]["BMI"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on BMI','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="BMI",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["DiabetesPedigreeFunction"], diab[diab["Outcome"]==1]["DiabetesPedigreeFunction"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on DiabetesPedigreeFunction','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="DiabetesPedigreeFunction",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
hist_data = [diab[diab["Outcome"]==0]["Age"], diab[diab["Outcome"]==1]["Age"]]
group_labels = ["0", "1"]
fig = ff.create_distplot(hist_data, group_labels, show_hist=False, show_rug=False)
fig['layout'].update(title={"text" : 'Distribution of outcome count based on Age','y':0.9,'x':0.5,'xanchor': 'center','yanchor': 'top'}, xaxis_title="Age",yaxis_title="probability density")
fig.update_layout(width=500,height=500)
fig
