...
df1 = pd.read_csv('../input/SpotifyAudioFeaturesApril2019.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/SpotifyAudioFeaturesNov2018.csv', delimiter=',', nrows = nRowsRead)
