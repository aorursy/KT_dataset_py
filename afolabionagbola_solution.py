...
df = pd.read_csv('../input/employee-data/Data.CSV', index_col=None)
...
print( 'The average satisfaction level for the employee population is: ' + str(emp_population_satisfaction) )

print( 'The average satisfaction level for the employees that left is: ' + str(emp_turnover_satisfaction) )
