...
#q3.hint()
#q3.solution()
round_to_two_places(9.9999999, ndigits=3)
"%.2f" % round_to_two_places(9.9999999, ndigits=2)
"{0:.2f}".format(round_to_two_places(9.9999999,2))
# x = -10
# y = 5
...
print("elapsed in " + format(time_call (round_to_two_places, arg=(4.000))))
q5.hint()
#q5.solution()
def slowest_call(fn, arg1, arg2, arg3):
    ...
    return (min(t1,t2,t3))
print("slowest " + format(slowest_call (round_to_two_places, arg1=4.000, arg2=6.09908674927, arg3=67.183752682)))
#q6.hint()
#q6.solution()
print(print("Spam"))
#q7.hint()
