...
#Survived is traget attribute
test = pd.read_csv('../input/test.csv', header = 0, dtype={'Age': np.float64})

test.head(10)
gender_meta = pd.read_csv('../input/gendermodel.csv')
...
print (result)
#ypred = pd.DataFrame({'PassengerId': test['PassengerId']},{'survived': pd.Series(candidate_classifier.predict(test))})
