...
def fit(epochs, lr, model, train_loader, val_loader, 
    ...
    return history
# epochs = 5
# history += fit(epochs, 0.0002, model, train_dl, val_dl, 
#                          grad_clip=grad_clip, 
#                          weight_decay=weight_decay, 
#                          opt_func=opt_func)
train_time='54:00'
...
sub_fname = 'submission_shiladitya_bose.csv'
submission_df.to_csv(sub_fname, index=False)
weights_fname = 'protein-resnet_new.pth'
...
jovian.log_metrics(val_loss=history[-1]['val_loss'], 
                   ...
                   time=train_time)
project_name='protein-resnet34-new'
