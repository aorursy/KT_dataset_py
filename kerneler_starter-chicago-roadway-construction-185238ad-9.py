...
# roadway-construction-moratoriums.csv has 13069 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/roadway-construction-moratoriums.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'roadway-construction-moratoriums.csv'
nRow, nCol = df1.shape
