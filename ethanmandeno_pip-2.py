...
plt.plot(x_error,linewidth=1,label='x error')

plt.plot(y_error,linewidth=1,label='y error')

plt.legend()

plt.title(f"x and y error")
...
e = (position_y**2 + position_x**2)**(1/2) - (exact_position_y**2 + exact_position_x**2)**(1/2)



plt.figure(6)

plt.plot(time,e,linewidth=1,label='timestep error')
