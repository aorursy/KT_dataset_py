...
missing_columwise = sf_permits.isnull().sum()
total_cells = np.product(sf_permits.shape)
total_missing = missing_columwise.sum()

# Percent of missing data
print((total_missing)*100/total_cells)
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
print(missing_columwise['Zipcode'])
print(missing_columwise['Street Number Suffix'])
