...
df1 = pd.read_csv('../input/77_cancer_proteomes_CPTAC_itraq.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/clinical_data_breast_cancer.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/PAM50_proteins.csv', delimiter=',', nrows = nRowsRead)
