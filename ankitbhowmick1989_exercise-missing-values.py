...
col1 = [ col for col in X_train.columns if X_train[col].isnull().any()]

# print(col)

# print(len(col))

num_cols_with_missing = len(col1)
...
# print(missing_val_count_by_column[missing_val_count_by_column > 0].values)
