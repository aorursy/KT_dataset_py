...
print('Left player: reward = %d, status = %s, info = %s' % (output[0]['reward'] or -100, output[0]['status'], output[0]['info']))
print('Right player: reward = %d, status = %s, info = %s' % (output[1]['reward'] or -100, output[1]['status'], output[1]['info']))
