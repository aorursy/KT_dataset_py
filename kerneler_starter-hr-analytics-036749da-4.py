...
# HR_submission.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df1 = pd.read_csv('/kaggle/input/HR_submission.csv', delimiter=',', nrows = nRowsRead)

df1.dataframeName = 'HR_submission.csv'
