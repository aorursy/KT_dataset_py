...
# dropping missing values and replacing categorical data with numbers
...
features = ['LotArea', 'YearBuilt', '1stFlrSF', 'OverallQual', 'OverallCond', 'Fireplaces', 

            'PavedDrive_N', 'PavedDrive_P', 'PavedDrive_Y',

            '2ndFlrSF', 'FullBath', 'BedroomAbvGr','GrLivArea','KitchenAbvGr', 'TotRmsAbvGrd']
