...
df1 = pd.read_csv('../input/ex1data1.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/ex1data2.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'ex1data2.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
