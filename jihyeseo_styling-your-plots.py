...
reviews['points'].value_counts().sort_index().plot.bar(figsize=(23, 7))
reviews['points'].value_counts().sort_index().plot.bar(
    figsize=(12, 6),
...
pokemon.columns
pokemon.Total.value_counts().plot.bar()
pokemon.Total.plot.hist( title = 'Pokemon by Stat Total', bins = 50 , figsize = (16,8), color = 'gray')
pokemon['Type 1'].value_counts().plot.bar(color = 'blue', figsize = (16,5))
