...
def count_vowels(value):
    ...
    return len([x for x in value if is_vowel(x) == True])
...
def starts_with_vowel(string):
    ...
    return string.lower().startswith("a") or string.lower().startswith("e") or string.lower().startswith("i") or string.lower().startswith("o") or string.lower().startswith("u")
...
assert get_highest_number([1, 4, 3]) == 4
...
def only_positive_evens(sequence):
    ...
    return only_even_numbers(only_positive_numbers(sequence))
...
def only_positive_odds(sequence):
    ...
    return only_odd_numbers(only_positive_numbers(sequence))
...
def only_negative_evens(sequence):
    ...
    return only_even_numbers(only_negative_numbers(sequence))
...
def only_negative_odds(sequence):
    ...
    return only_odd_numbers(only_negative_numbers(sequence))
...
def get_average_book_price(dictionaries):
    ...
    return total_of_book_prices(dictionaries) / get_number_of_books(dictionaries)
