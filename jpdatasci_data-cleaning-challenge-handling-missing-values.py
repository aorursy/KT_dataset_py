...
sf_drop_columns_with_missing = sf_permits.dropna()
sf_drop_columns_with_missing.head()
sf_drop_columns_with_missing.shape[1]
# Now try removing all the columns with empty values. Now how much of your data is left?
sf_drop_columns_with_na = sf_permits.dropna(axis=1)
sf_drop_columns_with_na.head()
sf_drop_columns_with_na.shape[1]
...
subset_sf_permits = sf_permits.loc[:,'Existing Construction Type': 'Record ID'].head(20)
subset_sf_permits
