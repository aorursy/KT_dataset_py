...
result = client.query(usertbl).result().to_dataframe()
...
query = '''
                ...
                select q.owner_user_id, q.creation_date
...
resultext = client.query(query).result().to_dataframe()

resultext
len(resultext.owner_user_id.unique())
query = '''
...
resultd = client.query(query).result().to_dataframe()

resultd
resultd[~resultd.owner_user_id.isin(resultext.owner_user_id)]
result.notnull().sum()
# Your code here
