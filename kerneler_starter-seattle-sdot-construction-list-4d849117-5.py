...
# sdot-construction-list.csv has 212 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/sdot-construction-list.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'sdot-construction-list.csv'
nRow, nCol = df1.shape
