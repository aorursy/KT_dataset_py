...
accidents = bq_helper.BigQueryHelper(active_project="biqquery-public-data",
                                    dataset_name="nhtsa_traffic_fatalities")
...
ax = sns.barplot(data=accidents_by_hour, x="f1_", y="f0_")
...
sns.set_style("whitegrid")
ax = sns.barplot("f0_", y="registration_state_name", data=hit_and_run, palette="RdBu_r")