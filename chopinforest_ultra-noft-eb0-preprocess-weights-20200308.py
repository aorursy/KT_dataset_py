...
train_data = '../input/ultrapreprocess/ultra_process/train_dir/'

valid_data = '../input/ultrapreprocess/ultra_process/valid_dir/'

test_data = '../input/ultrapreprocess/ultra_process/test_dir/'



train_df = pd.read_csv('../input/ultrapreprocess/ultra_process/ultra-widefield-training.csv')

valid_df = pd.read_csv('../input/ultrapreprocess/ultra_process/ultra-widefield-validation.csv')

test_df = pd.read_csv('../input/ultrapreprocess/ultra_process/Challenge3_upload.csv')
...
#model.summary()
#class_weights = class_weight.compute_class_weight('balanced', np.unique(train_df['DR_level'].astype('int').values), train_df['DR_level'].astype('int').values)
...
model.save_weights('../working/1st-EB3-finetuning-np-weights-20200308.h5')
