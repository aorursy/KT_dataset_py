...
#os.rename("/kaggle/working/best_model_todate","/kaggle/working/best_of_my_model_mod_minus_tl.hdf5")
import os
...
model.load_weights("/kaggle/working/best_of_my_model_mod_minus_tl_97.04_acc_adam.hdf5")
