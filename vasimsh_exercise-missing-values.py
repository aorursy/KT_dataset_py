...
imputed_X_train_plus = pd.DataFrame(my1_imputer.fit_transform(X_train_plus))

imputed_X_valid_plus = pd.DataFrame(my1_imputer.transform(X_valid_plus))
