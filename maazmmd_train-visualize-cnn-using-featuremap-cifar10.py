...
"""Showing first 10 images from the Training Dataset"""
...
opt = tf.train.AdamOptimizer(0.0001).minimize(loss) # Global optimizer
...
for i in range(10):
    ...
    plt.imshow(conv1_w_extract[:,:,1,i])
...
for i in range(10):
    ...
    plt.imshow(np.reshape(conv1_fmaps[0,:,:,i]*1000, [32,32]))
