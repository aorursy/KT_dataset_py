...
df = pd.read_csv('../input/predicting-student-performance/amsPredictionSheet11-201010-101537.csv')
...
std_df
std_df.describe()
df1 = pd.read_csv('../input/predicting-students-mars/stdcat-201010-101522.csv')
