...
# house-votes-84.csv has 435 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/house-votes-84.csv', delimiter=',', nrows = nRowsRead)
