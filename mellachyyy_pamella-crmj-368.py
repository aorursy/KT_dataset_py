...
lVar=['race', 'age', 'class_', 'sex', 'grass', 'natdrug', 'health1']
...
my_variable = 'sex' # Replace VAR with the name of a categorical variable.
...
my_variable = 'natdrug' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
...
my_variable = 'health1' # Replace VAR with the name of a categorical variable.
count=dfGSS[my_variable].value_counts()
sns.barplot(count.index, count.values, alpha=0.9, color='steelblue')
plt.title('Bar chart of '+my_variable)
plt.xlabel(my_variable)
