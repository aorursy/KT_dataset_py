...
if __name__ == "__main__":
    ...
    out= generator.predict_mcq(payload)
if __name__ == "__main__":
    ...
    out1= generator.predict_bool(payload)
if __name__ == "__main__":

    generator = PythonPredictor()

    payload={
    "input_text" : '''What are the best datascience Courses available?''',
    "max_questions" : 8
    }

    out2= generator.paraphrase(payload)
out2
out1
import gc
gc.collect()
