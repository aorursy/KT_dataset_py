...
parser.add_argument('-c', '--content-image',
    ...
    default="./input/Images/1280px-bernard_harris_and_michael_foale_prepare_to_leave_airlock_-_gpn-2006-000022.jpg",
...
parser.add_argument('-s', '--style-image',
    ...
    default="./input/Images/wiki-media-style.jpg",    
...
for ii in range(1, epochs+1):
    ...
    if ii % show_every == 0:
        ...
        plt.imsave('./output/{}-{}.png'.format(ii, total_loss), im_image)
...
plt.imsave('./output/{}-{}.png'.format(ii, total_loss), im_target)
