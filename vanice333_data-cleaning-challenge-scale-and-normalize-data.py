...
scaled_data = minmax_scaling(original_data, columns = [0])# scale the 0th column
...
normalized_pledges2,_ =stats.boxcox(positive_pledges2)
# or normalized_pledges=stats.boxcox(positive_pledges)[0]
