...
with open("../input/fatal-police-shootings-in-the-us/PoliceKillingsUS.csv","rb") as rawdata_my:
    result_my = chardet.detect(rawdata_my.read(10000))
print(result_my)    
