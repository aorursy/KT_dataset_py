...
# print all the unique values in province column and mannually examine them
print(" province names eneterd in sheet :",province)

#Convert all province names to lowercase
suicide_attacks['Province']=suicide_attacks['Province'].str.lower()

# Remove whitespaces ( not in this column)
suicide_attacks['Province']=suicide_attacks['Province'].str.strip()

#Change all names Baluchistan to Balochistan as this is a typo
suicide_attacks['Province']=suicide_attacks['Province'].str.replace('baluchistan','balochistan')

# You can see that all the province names are now corrected
province
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
