...
total_missing = sf_missing.sum()
total_missing/total_count * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sf_permits_dropna.shape[1])
...
sf_permits.dropna(axis=1).columns
subset_sf_permits = sf_permits.loc[:,'Street Number Suffix':'Location']
