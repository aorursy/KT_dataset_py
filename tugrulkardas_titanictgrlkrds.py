...
for c in category2:
    ...
    #Çok karmaaşık o yüzden bunları plot edemiyoruz
...
# Cabin - Survived 
train_df[["Cabin","Survived"]].groupby("Cabin").mean().sort_values(by="Survived",ascending=False)
# Age - Survived
...
plt.show()
# C limanı olarak estimate edebiliyoruz.
train_df["Embarked"] = train_df["Embarked"].fillna("C")
train_df[train_df["Fare"].isnull()]
avgFare_3 = np.mean(train_df[train_df["Pclass"]==3]["Fare"])
train_df["Fare"] = train_df.fillna(avgFare_3)