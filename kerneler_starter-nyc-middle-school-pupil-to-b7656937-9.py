...
# ptr.csv has 1536 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/ptr.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'ptr.csv'
nRow, nCol = df1.shape
