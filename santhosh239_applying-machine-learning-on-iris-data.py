...
X_train_S, X_test_S, y_train_S, y_test_S = train_test_split(sepal,y,test_size=0.3,random_state=42)



X_train_P, X_test_P, y_train_P, y_test_P = train_test_split(petal,y,test_size=0.3,random_state=42);
