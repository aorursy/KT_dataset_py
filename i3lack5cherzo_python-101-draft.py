...
# Quiz: Evaluate the sum of squares till 5. Example, 1**2 + 2**2 + ... + 5**2
sum_squares = 'insert code here'
...
# check answer
if sum_squares == sum(map(lambda x: x**2, list(range(1, 6)))):
    print('correct!')
else: 
...
# Quiz: what is the fourth letter of the word 'anaconda'?
anaconda_fourth = 'anaconda'
anaconda_fourth = 'insert code here'




# check answer
if anaconda_fourth == 'c':
    print('correct!')
else: 
    print('wrong answer, try again!')
...
# Quiz: what does this code do? (run to find out)
planets[-999999:]
# Quiz: what is 'Racecar' spelled backwards?
racecar = 'insert code here'
...
planets
# Quiz: fix this list using slicing, append(), and remove():
integer_list = [2, 4, 6, 81948023567, 10, 12, 14, 16, 18, 20]
integer_list = 'insert code here'




# check answer
if integer_list == list(range(2, 22, 2)):
    print('correct!')
else: 
    print('wrong answer, try again!')
# assign a list of strings to the variable "planets"
...
print(planets)
# Quiz: remove all spaces from the string 'a    lp hab  et'
alphabet = 'a    lp hab  et'
alphabet = 'insert code here'
...
# check answer
if alphabet == ''.join([x for x in 'a    lp hab  et' if x != ' ']):
    print('correct!')
else: 
    print('wrong answer, try again!')
# Quiz: how many letter 'a's are in the word 'abracadabra'?
number_of_a = 'insert code here'




# check answer
if number_of_a == len([x for x in 'abracadabra' if x == 'a']):
    print('correct!')
else: 
    print('wrong answer, try again!')
# Quiz: Evaluate 2**2 + 4**4 + 6**6 + 8**8 + ... + 98**98 + 100*100.
exponent = 'insert code here'



# check answer
if number_of_a == sum([x**x for x in range(2, 102, 2)]):
    print('correct!')
else: 
    print('wrong answer, try again!')
