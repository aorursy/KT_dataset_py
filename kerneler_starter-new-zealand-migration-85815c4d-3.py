...
# migration_nz.csv has 86526 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/migration_nz.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'migration_nz.csv'
nRow, nCol = df1.shape
