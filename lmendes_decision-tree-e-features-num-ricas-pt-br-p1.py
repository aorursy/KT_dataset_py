...
for i, max_depth in enumerate(max_depth_arr):
    ...
    print(max_depth, i, test.score(train_X, train_y))
...
optimal_max_depth = 10 # coloque aqui o max_depth que voce encontrou
...
sample_submission_df.to_csv('basic_decision_tree2.csv', index=False)