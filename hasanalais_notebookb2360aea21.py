...
csv_data = []
import csv
file = open("IntrotoPython",encoding='utf-8-sig')
...
#your code here
make_pancakes ("all purpose flour","filtered water",add_ins="chocolate chips and bananas")
import numpy
...
print(difference_between_averages(my_data, more_data))
# define your own data set:
my_data2= np.array([12,8,9.6,13,5.4,23])
# write a function call:
difference_between_averages(my_data2,my_data)