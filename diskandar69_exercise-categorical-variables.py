...
X_train, X_valid, y_train, y_valid = train_test_split(X, y,
                                                      ...
                                                      random_state=0)
print("X.shape:",X.shape), print("X_train.shape:",X_train.shape), print("X_valid.shape:",X_valid.shape),print("X_test.shape:",X_test.shape)
...
step_1.check()
drop_X_train.shape, drop_X_valid.shape
...
X_train['MSZoning'].unique(),X_valid['MSZoning'].unique()
step_2.a.hint()
step_2.a.solution()
...
step_2.b.check()
good_label_cols
label_X_train.shape, X_train.shape, label_X_valid.shape, X_valid.shape
label_X_train.head()
X_train.head()
# Lines below will give you a hint or solution code
...
#X_test = X_test.fillna(X_test['MSZoning'].value_counts().index[0])
...
missing_val_count_by_column = (OH_X_test_noobj.isnull().sum())
...
preds_test = model.predict(OH_X_test_noobj)