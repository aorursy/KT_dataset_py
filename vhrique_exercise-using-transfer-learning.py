...
train_generator = data_generator.flow_from_directory(
        directory = '../input/amalceu/alceu/train',
        target_size=(image_size, image_size),
        batch_size=10,
        class_mode='categorical')

validation_generator = data_generator.flow_from_directory(
        directory = '../input/amalceu/alceu/test',
        target_size=(image_size, image_size),
        class_mode='categorical')
...
results = my_new_model.evaluate_generator(test_generator)
results[1]
import numpy as np
...
Y_pred = my_new_model.predict_generator(test_generator)
