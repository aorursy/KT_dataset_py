...
train = pd.read_csv(r'/kaggle/input/covid19-global-forecasting-week-4/train.csv', parse_dates=['Date'])

test = pd.read_csv(r'/kaggle/input/covid19-global-forecasting-week-4/test.csv',parse_dates=['Date'])
