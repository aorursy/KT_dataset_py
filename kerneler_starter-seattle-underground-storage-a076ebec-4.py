...
# underground-storage-tank-ust-records-residential.csv has 40141 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/underground-storage-tank-ust-records-residential.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'underground-storage-tank-ust-records-residential.csv'
nRow, nCol = df1.shape
