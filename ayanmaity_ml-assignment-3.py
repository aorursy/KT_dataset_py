...
img = []
img.append(imread('../input/digit1/digit1.jpg'))
img.append(imread('../input/digit1/digit2.jpg'))
img.append(imread('../input/digit1/digit3.jpg'))
for i in range(3):
...
for i in range(33600):
    for j in range(784):
        train_rbf[i,j] = rbf(train_x[i],cl_cen[j],100)
    print(i)
train_rbf
