...
df_capa = pd.read_csv('../input/dataset-all-capa/dataset_total_adrien.csv', encoding="windows-1252", sep=';')
df_capa.head()
X1 = list()
...
data_test = pd.read_csv('../input/data-test-tension-3-capa-1/tension3capa1.csv', encoding="windows-1252", sep=';')
