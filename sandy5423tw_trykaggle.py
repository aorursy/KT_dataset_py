...
#fixed_z_ = torch.Tensor(np.random.normal(loc= -10.0,scale=1.0, size =(5 * 5, 100)) ).view(-1, 100, 1, 1)

fixed_z_ = fixed_z_.to(device)#.cuda()
...
data_dir = '../input/hw3123456/t/'          # this path depends on your computer

#data_dir = '../input/ccuhw3changedata/'          # this path depends on your computer
