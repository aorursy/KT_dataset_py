...
# scale the goals from 0 to 1
scaled_data_s = minmax_scaling(goal_s, columns = [0])

# plot the original & scaled data together to compare
fig, ax=plt.subplots(1,2)
sns.distplot(kickstarters_2017.goal, ax=ax[0])
ax[0].set_title("Original Data")
sns.distplot(scaled_data_s, ax=ax[1])
ax[1].set_title("Scaled data")
#Scaling didn't impact the shape of the plot but there is no change in the scale of the data.
...
ax[1].set_title("Normalized data")
#Shape of the data changed it looks like a normalized curve after normalization