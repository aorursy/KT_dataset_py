...
print(os.listdir('../input/Cats_and_Dogs_Datasets'))
...
df1 = pd.read_csv('../input/Cats_and_Dogs_Datasets/test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/Cats_and_Dogs_Datasets/train.csv', delimiter=',', nrows = nRowsRead)
