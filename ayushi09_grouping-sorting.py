...
# Your code here
common_wine_reviewers = reviews.groupby('taster_twitter_handle').taster_name.count()
check_q1(common_wine_reviewers)
# Your code here
best_wine = reviews.groupby('price').points.max()
#best_wine.sort_values(by=['price']) ------- This should work !
check_q2(best_wine)
# Your code here
...
# Your code here
country_variety_pairs = reviews.groupby(['country','variety']).variety.count()
