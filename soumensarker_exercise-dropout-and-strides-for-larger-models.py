...
# Fit fashion_model_1
fashion_model_1.fit(x,y, batch_size=100, epochs = 3, validation_split=0.2)
...
fashion_model_2.fit(x,y,batch_size=100, epochs=4, validation_split=0.2)# Your code for fashion_model_2 below
from tensorflow.python.keras.models import Sequential
from tensorflow.python.keras.layers import Dense, Flatten, Conv2D, Dropout
...
fashion_model_3.add(Dropout(0.7))
...
fashion_model_3.fit(x,y,batch_size=100, epochs=4, validation_split=0.2)# Your code for fashion_model_2 below


# Specify the rest of the model# Your code for fashion_model_3 below