...
df = pd.read_excel('../input/pokernow-73181/PokerNow Data Clean 2020-07-31.xlsx', sheet_name='Clean Log')
...
tbl = tbl.reindex(columns=["Player's Name",'No. Hands Played','Total Hands','Hands Played %','Total Wins',"Player's Winning %",'Total Pot Amount Won','Highest Pot Amt Won','Avg Pot Amt Won'])
...
dfavgamt['Avg Amt'] = dfavgamt['Avg Amt'].astype(float).map("{:.2f}".format)
...
dfchipcount = pd.read_excel('../input/pokernow-73181/PokerNow Data Clean 2020-07-31.xlsx', sheet_name="Chip Count")
...
buyinlog = pd.read_excel('../input/pokernow-73181/PokerNow Data Clean 2020-07-31.xlsx', sheet_name="Buy in Log")
...
tbl2
HvsH = pd.read_excel('../input/pokernow-73181/PokerNow Data Clean 2020-07-31.xlsx', sheet_name="HvsH" ,index_col=0)



HvsH
HvsHvar = pd.read_excel('../input/pokernow-73181/PokerNow Data Clean 2020-07-31.xlsx', sheet_name="HvsH Var" ,index_col=0)
