...
# Gettin only unique values from the column province
province = suicide_attacks['Province'].unique()

# Sorting the province by ascending 
province.sort()
province
# Changing everything to lower case
suicide_attacks['Province'] = suicide_attacks['Province'].str.lower()

# Removing the trailing white spaces from the provinces
...
replace_matches_in_column(df=suicide_attacks, column='City', string_to_match='kurram agency', min_ratio = 90)
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
...
cities.sort()
cities
# As we have seen, province column has inconsistent data entry
