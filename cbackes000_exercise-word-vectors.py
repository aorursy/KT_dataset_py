...
# It's like normalizing a matrix or standardizing a curve. It makes it so that the comparisons are more

# obvious, and are adjusted to give info about the specific data set.
...
# Coffee and tea are very similar, so reviews describing it would also be similar in word choice.
