...
plt.title('Avaliando a importância das variáveis')



feat_imp = pd.DataFrame(rfc.feature_importances_,feats, columns=['Feat']).sort_values('Feat', ascending=False )
...
sns.barplot(x='Feat', y='index', data=feat_imp, palette='hot')
