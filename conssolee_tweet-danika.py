...
twitter_data = pd.read_csv('../input/auspol2019.csv')
...
trace1 = go.Scatter(x = cnt_.index,
...
plotly.tools.set_credentials_file(username='Ratan2513', api_key='Dtd2OOgevG7BGPdBW3bs')
