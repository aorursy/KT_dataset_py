...
# equine-death-and-breakdown.csv has 3379 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/equine-death-and-breakdown.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'equine-death-and-breakdown.csv'
nRow, nCol = df1.shape
