...
# Download MNIST traing data to directory ../input for the first time
# Read the training dataset from directory ../input if there was such data
...
my_mnist = MyMNIST(csv_file='../input/mnist_seven.csv',
                data=MyMNIST.TEST,
                one_hot=False,
...
train_data = MyMNIST(csv_file='../input/mnist_seven.csv',
                    data=MyMNIST.TRAIN,
                    one_hot=False,
                    transforms=[Normalizer(),
                                ToTensor()])
...
# Test
test_data = MyMNIST(csv_file='../input/mnist_seven.csv',
                    data=MyMNIST.TEST,
                    one_hot=False,
                    transforms=[Normalizer(),
                                ToTensor()])
