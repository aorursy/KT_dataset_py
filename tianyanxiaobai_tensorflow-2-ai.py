...
images_A = get_image_paths("/kaggle/input/trump")

images_B = get_image_paths("/kaggle/input/cage")
...
plt.imshow(cv2.cvtColor(figure, cv2.COLOR_BGR2RGB)) #这里需要指定利用 cv 的调色板，否则 plt 展示出来会有色差
def random_warp( image ):
    ...
    range_ = np.linspace( 128-80, 128+80, 5 )#设置 range_ = [ 48.,  88., 128., 168., 208.]    
...
print("warpe 前图片大小{}\nwarpe 后图片大小{}".format(transform_image.shape,warped_image.shape))
...
epochs = 10000 #这里只用作演示，请在实际训练的时候，至少将其调到10000以上
