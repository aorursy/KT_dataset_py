...
def get_smallest_number(mylist):
...
def only_positive_numbers(mylist):
...
def only_negative_numbers(mylist):
...
def only_positive_evens(mylist):
...
def only_negative_evens(mylist):
...
#len(min(test_list, key = len))   *this will tell me how long it is
...
def get_number_of_books(dictionary_list):
...
def total_of_book_prices(dictionary_list):
...
def get_average_book_price(dictionary_list):
    ...
    return final_price/len(dictionary_list)
...
def highest_priced_book(dictionary_list):

    return max(dictionary_list, key=lambda book: book['price'])
...
def lowest_price_book(dictionary_list):

    return min(dictionary_list, key=lambda book: book['price'])
...
def total_number_of_items(cart):
    ...
    return items[0]['quantity'] + items[1]['quantity'] + items[2]['quantity'] + items[3]['quantity'] + items[4]['quantity']
...
def get_average_item_price(cart):
    ...
    return items_total_price/(len(items))
...
def get_average_spent_per_item(cart):
    ...
    return items_total_price/items_count
...
def most_spent_on_item(cart):
    ...
    return max(items, key=lambda item: item['price'] * item['quantity'])
