...
cv_score=cross_validate_sklearn(rf, train_input, y, kf)
# Regenerate the input data for ML pipeline
...
traintest_log_feature['log_feature_pattern_id'].value_counts().describe()
...
rf_submission.to_csv('rf_submission_feateng1_alldata.csv.gz', compression='gzip', index=False)