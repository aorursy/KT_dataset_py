...
def create_model(_p,_kr,_bi,_br, _nbn=0): # _nbn is not used
    ...
    model.add(layers.Conv2D(64, (3, 3), padding=_p, activation='relu', kernel_regularizer=_kr, bias_initializer=_bi, bias_regularizer=_br, input_shape=(28, 28, 1)))

    model.add(BatchNormalization())

    model.add(layers.MaxPooling2D((2, 2)))

    model.add(layers.Conv2D(128, (3, 3), padding=_p, activation='relu', kernel_regularizer=_kr, bias_initializer=_bi, bias_regularizer=_br))
...
def create_model2(_p,_ki, _kr,_bi,_br, _nbn=0): # _nbn is not used
    ...
    model.add(layers.Conv2D(64, (3, 3), padding=_p, activation='relu', kernel_initializer=_ki, kernel_regularizer=_kr, bias_initializer=_bi, bias_regularizer=_br, input_shape=(28, 28, 1)))

    model.add(layers.Conv2D(128, (3, 3), padding=_p, activation='relu', kernel_initializer=_ki, kernel_regularizer=_kr, bias_initializer=_bi, bias_regularizer=_br))
...
create_model2( 'same', 'glorot_uniform', None, 'zeros', regularizers.l2(0.005), 4 )
