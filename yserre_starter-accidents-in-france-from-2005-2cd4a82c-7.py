...
# caracteristics.csv has 839985 rows in reality, but we are only loading/previewing the first 1000 rows
...
# places.csv has 839985 rows in reality, but we are only loading/previewing the first 1000 rows
