...
# haberman.csv has 306 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/haberman.csv', delimiter=',', nrows = nRowsRead)
