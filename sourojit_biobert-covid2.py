...
embeddings=bc.encode(data_list1[0:18500])

with open('/kaggle/working/embeddings18499.pickle', 'wb') as handle:

    pickle.dump(embeddings, handle)

meta_df_title_abstract.to_csv("title_abstract_data1.csv",index=False)