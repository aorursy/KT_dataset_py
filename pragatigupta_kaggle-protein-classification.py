...
def decode_target(target, text_labels=False, threshold=0.38):
    result = []
...
def show_batch(dl, invert=True):
    for images, labels in dl:
        ...
        ax.imshow(make_grid(data[:64], nrow=16).permute(1, 2, 0))
        break
...
# change grad clippping
# change max lr
# change weight decay

# change resnet layers

# change optimiser

# learning rate finder

# try changing threshold like <0.35
