...
copyfile(src = "/kaggle/usr/lib/opt_utils_v1a/opt_utils_v1a.py", dst = "../working/opt_utils_v1a.py")

copyfile(src = "/kaggle/usr/lib/testcases_optimization/testcases_optimization.py", dst = "../working/testcases_optimization.py")
