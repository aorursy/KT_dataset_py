...
from keras.layers import SpatialDropout2D, Input,LeakyReLU,Conv2D, BatchNormalization, Activation,Dense,MaxPooling2D,Flatten,Dropout,GlobalAveragePooling2D,AveragePooling2D,MaxPool2D
...
model.add(Conv2D(64, (7,3),strides = (1,1),use_bias=False,activation ='relu', input_shape=(IMG_WIDTH,IMG_HEIGTH, 1),kernel_initializer='glorot_uniform'))

model.add(BatchNormalization())

model.add(Conv2D(64, (7,3),activation ='relu',use_bias=False,strides = (1,1),kernel_regularizer=Regularizer))
...
model.add(Conv2D(128, (3,3),activation ='relu',use_bias=False,strides = (1,1),kernel_regularizer=Regularizer))
...
model.add(Conv2D(256, (3,3),activation ='relu',use_bias=False,strides = (1,1),kernel_regularizer=Regularizer))
...
model.add(Dense(64,activation ='relu',activity_regularizer=Regularizer))
