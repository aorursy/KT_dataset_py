...
input_img, input_tensor, input_np = load_image('../input/images/tiger.jpeg', size=[1024, 1024])
...
dream = tensor_to_img(dream)
dream.save('dream02.jpg')
dream
input_img, input_tensor, input_np = load_image('../input/images/city_road.jpg', size=[1024, 1024])
print(input_img.size)
input_img
dream = deepdream(model, input_np, end=14, step_size=0.06, octave_n=6)
dream = tensor_to_img(dream)
