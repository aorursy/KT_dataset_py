...
missing_percent = (sf_permit_total_missing / sf_permit_total_cells) * 100
missing_percent
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
...
print("Columns before dropping na's :", sf_permits.shape[1])
print("Columns left :", sf_permits_with_na_dropped.shape[1])
