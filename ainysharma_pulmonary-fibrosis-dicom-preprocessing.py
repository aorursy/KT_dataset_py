...
locations[np.argsort(numbers)[::-1]]
...
class ImageObserver:
    ...
    def get_loader(self):
        ...
        if idx > 0:
            yield images
my_choice = image_sizes.index.values[9]
print(my_choice)
to_display = 4
...
generate_hu_scans=True
if generate_hu_scans:
    ...
    for i, patient in enumerate(tqdm(scan_properties.patient.values)):
        ...
        # just resize the images:
            ...
            print("Unknown image size format of patient ".format(patient))