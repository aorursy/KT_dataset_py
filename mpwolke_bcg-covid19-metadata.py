...
df = pd.read_csv('../input/hackathon/task_1-google_search_english_original_metadata.csv', encoding='ISO-8859-2')
...
plt.xlabel('char_number Distribution ')
...
df['char_number'].hist(figsize=(8,3), bins=20)
ax = df['language'].value_counts().plot.barh(figsize=(10, 4))

ax.set_title('language Distribution', size=18)

ax.set_ylabel('language', size=10)

ax.set_xlabel('char_number', size=10)
...
Image(url = 'https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQiLK5MpXbZBg2pHK73UhS4x4533r7l1pJ4CnQLgfGO63qq2xef&usqp=CAU',width=400,height=400)