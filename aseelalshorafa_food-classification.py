...
model.add(Conv2D(filters=32, kernel_size=(4,4),input_shape=(300,300,3), activation='relu',padding = 'same'))
...
model.fit(train_data_gen, epochs=100, callbacks= [early_stopping],validation_data=val_ds,batch_size = 32)
