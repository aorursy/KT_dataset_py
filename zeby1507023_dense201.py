...
dense = DenseNet201(input_shape =IMAGE_SIZE+[3],weights='imagenet',include_top = False)
for layer in dense.layers:

    layer.trainable = False

folder = glob("../input/final-dataset/chest_xray/train")
...
model =Model(inputs =dense.input,outputs =predition)
...
print(features1)
img = "../input/chest-xray-pneumonia/chest_xray/chest_xray/test/NORMAL/IM-0067-0001.jpeg"
...
print(features)
Dir="../input/chest-xray-pneumonia/chest_xray/test/NORMAL"
