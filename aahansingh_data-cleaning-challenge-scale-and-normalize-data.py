...
normalized_pledged_indices = kickstarters_2017.pledged>0
normalized = stats.boxcox(kickstarters_2017.pledged.loc[normalized_pledged_indices])[0]
fig,ax = plt.subplots(1,2)
