...
# It still fails! It seems ascii is not the right enconding.
# look instead at the first hundred thousand bytes to guess the character encoding
with open("../input/fatal-police-shootings-in-the-us/PoliceKillingsUS.csv", 'rb') as rawdata:
...
# It seems to have worked now! Let's check the first few lines
