...
class MnistModel(MnistModelBase):
    ...
    def __init__(self):
        ...
        self.conv1 = nn.Sequential(
            nn.Conv2d(in_channels = 1, out_channels = 32, kernel_size=3),   #RF - 3x3 # 26x26
            nn.ReLU(),
            nn.BatchNorm2d(32),

            nn.Conv2d(32, 32, 3),   #RF - 5x5 # 24x24
            nn.ReLU(),
            nn.BatchNorm2d(32),

            nn.Conv2d(32, 64, 3),   #RF - 7x7 # 22x22
            nn.ReLU(),
            nn.BatchNorm2d(64),
        )
        ...
        self.conv2 = nn.Sequential(
            nn.Conv2d(32,32,3),   #RF - 16x16 #output- 9x9
            nn.ReLU(),
            nn.BatchNorm2d(32),

            nn.Conv2d(32, 64, 3),   #RF - 18x18 #output- 7x7
            nn.ReLU(),
            nn.BatchNorm2d(64),
        ) 
        ...
        self.conv3 = nn.Sequential(
            nn.Conv2d(64,64,3),   #RF - 20x20  #output- 5x5
            nn.ReLU(),
            nn.BatchNorm2d(64),

            nn.Conv2d(64, 64, 3),   #RF - 22x22  #output- 3x3
            nn.ReLU(),
            nn.BatchNorm2d(64),
        )   
