...
async def main(loop, start, end, data):
    async with aiohttp.ClientSession(headers=headers) as session:
        ...
        with open("/kaggle/working/findTitleUrl_0707_"+str(start)+"-"+str(end)+".txt", "w", encoding="utf-8") as f:
...
start_from, end_from = 0,90000
step = 2500
res = "/kaggle/input/notfindurllist/notFindUrlList.pickle"
data = readPickle(res)
print(len(data))
urlSet = []
nest_asyncio.apply()
