...
df1 = pd.read_csv('/kaggle/input/interactions_test.csv', delimiter=',', nrows = nRowsRead)
...
# interactions_validation.csv has 7023 rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/interactions_validation.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'interactions_validation.csv'
