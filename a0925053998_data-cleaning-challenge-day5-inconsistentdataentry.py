...
cities_P = suicide_attacks['Province'].unique()
...
Province_uniq = suicide_attacks['Province'].unique()
...
# After investigation, the name of the city and the agency of Pakistan did not have the 'Kuram agency', 
# just have 'Kurram agency', so I decided to replace 'Kuram agency' with 'Kurram agency'.
...
cities.sort()
cities
# After observing that the name of the province of Pakistan did not have 'baluchistan' but have 'balochistan', 
# I decided to replace 'baluchistan' with 'balochistan'.

# get the top 5 closest matches to "balochistan"
matches_b = fuzzywuzzy.process.extract("balochistan", Province_uniq, limit=5, 
