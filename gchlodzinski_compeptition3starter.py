...
#train_data_df[feature_columns] = scaler.fit_transform(train_data_df[feature_columns])
...
model = Sequential()
model.add(LSTM(hidden_size, input_shape=(None, len(train_data_df.columns) - 1), return_sequences=False))
...
history = model.fit_generator(
    train_data_gen,
    steps_per_epoch=num_train_of_sessions // batch_size,
    epochs=2,
...
test_labels_df['buy']=predict>0.5
