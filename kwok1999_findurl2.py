...
async def main(loop, start, end, data):
    ...
    async with aiohttp.ClientSession(headers=headers) as session:
        ...
        tasks = [loop.create_task(getContent(session, line, index))
        ...
        with open("/kaggle/working/findTitleUrl_0107_"+str(start)+"-"+str(end)+".txt", "w", encoding="utf-8") as f:
...
start_from, end_from = 180000,270000

step = 2500

res = "/kaggle/input/url-list-desc/url_list_bm.pickle"
