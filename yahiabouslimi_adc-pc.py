...
TRAIN_PATH = '../input/prostate-adc-mri/data/train/x_train/'
Y_TRAIN_PATH = '../input/prostate-adc-mri/data/train/y_train/'
TEST_PATH = '../input/prostate-adc-mri/data/test/x_test/'
Y_TEST_PATH = '../input/prostate-adc-mri/data/test/y_test/'
...
# evaluateModel(model,X_test, Y_test,batch_Size)
...
plt.show()
# loss = ['0.6925', ' 0.6467','0.6143', '0.0885', ' 0.0920',]
plt.plot(history.history['accuracy'])
plt.plot(history.history['val_accuracy'])
plt.title('model accuracy')
plt.ylabel('accuracy')
