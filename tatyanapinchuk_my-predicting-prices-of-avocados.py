...
X = df.drop(['Date', 'AveragePrice', 'Total Bags','Small Bags', 'Large Bags', 'XLarge Bags', 'type', 'year','region',], axis=1)
...
print('Score:', metrics.mean_absolute_error(y_test, linearpredictions))
...
print('Score:', metrics.mean_absolute_error(y_test, ridgepredictions))
plt.scatter(y_test,ridgepredictions)
...
baggpredictions = bagg.predict(X_test)

print(baggpredictions)
from sklearn import metrics



print('Score:', metrics.mean_absolute_error(y_test, baggpredictions))
plt.scatter(y_test,baggpredictions)
