...
train["SalePrice"] = boxcox1p(train["SalePrice"], lam)
### If we use the numpy fuction log1p which  applies log(1+x) to all elements of the column, then:
...
all_data   # it is interesting to compare this table below with its previous version above
