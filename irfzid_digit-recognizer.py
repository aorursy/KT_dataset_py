...
print(train_labels.head(60))
nmbr = [12, 4, 18, 2, 42, 9, 44, 14, 11, 7] #<- index yang berisikan angka
...
data = np.append(train_images.iloc[nmbr[0]], (train_images.iloc[nmbr[1:]]))
plt.figure()
plt.hist(data)
plt.show()
plt.close()
