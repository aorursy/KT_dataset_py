...
print("Rows left in dataset: %d \n" % (sf_permits.shape[1] - sf_permits.dropna().shape[1]))
...
print("Columns with sf's dropped: %d" % columns_with_na_dropped_sf.shape[1])
