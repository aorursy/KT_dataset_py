...
train_data = pd.read_csv('/kaggle/input/house-prices-advanced-regression-techniques/train.csv', low_memory = False)

train_data.head()
test_data = pd.read_csv('/kaggle/input/house-prices-advanced-regression-techniques/test.csv', low_memory = False)
...
test_data.head()
train_data.Street.cat.categories
X_train, Y_train, nas = proc_df(train_data, 'SalePrice')
X_train.head()

print(Y_train)
X_test, _, nas = proc_df(test_data, na_dict=nas)
