...
def to_smash(total_candies, total_friends=3):
    ...
    If the number of friends is not specified, 3 friends are assumed.
    >>> to_smash(91)
    1
    >>> to_smash(91,11)
    3
...
def time_call(fn, arg):
    ...
    """
    time_when_called = time()
    fn(arg)
    time_after_called = time()
    return time_after_called - time_when_called

print (time_call(sleepy, 2))
q5.hint()
q5.solution()
...
print (slowest_call(sleepy, 1, 2, 3))
#q6.hint()
q6.solution()
print(print("Spam"))
q7.hint()
...
smallest_stringy_number('100', '10', '2')
q8.a.solution()
def smallest_stringy_number(s1, s2, s3):
    """Return whichever of the three string arguments represents the smallest number.
