...
if use_gpu:
    ...
    print("Using CUDA")
!ls ../input/flowercategories
data_dir = '../input/flowers'
...
with open('../input/flowercategories/cat_to_name.json', 'r') as f:
...
features.extend([nn.Linear(num_features, len(class_names))]) # Add our layer with # features outputs
...
if resume_training:
    ...
    vgg16.load_state_dict(torch.load('VGG16_v2-OCT_flowers_dataset.pt'))
...
torch.save(vgg16.state_dict(), 'VGG16_v2-OCT_flowers_dataset.pt')
eval_model(vgg16, criterion)
