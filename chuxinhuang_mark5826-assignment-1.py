...
plot(x = data['brand'], y = data['stars'], style = 'boxplot')
tally(data['country'], percent = True, graph = True)
query(data = data, column = 'brand', condition = '=="Ve Wong"' )
sort(data = data, by = 'stars', how = 'descending').tail(12)
data_2 = data.loc[data['stars'] > 3]
data_3 = tabulate(data_2['country'], data_2['style'])
plot(x = 'country', y = 'count', colour = 'style', style = 'lineplot', data = data_3, top = 10)
