...
all_data['TotalSF'] = all_data['1stFlrSF'] + all_data['GrLivArea'] + all_data['WoodDeckSF'] + all_data['GarageArea'] + all_data['OpenPorchSF'] + all_data['ScreenPorch'] - all_data['EnclosedPorch'] - all_data['LowQualFinSF']
