...
missing_values_counts = sf_permits.isnull().sum()
missing_values_counts
missing_values_counts[0:10]
sf_permits.shape

total_cellss=np.product(sf_permits.shape)
total_cellss
total_missing_values=missing_values_counts.sum()
total_missing_values
(total_missing_values/total_cellss) * 100
# look at the # of missing points in the first ten columns
missing_values_count[0:10] 
...
subset_sf_permits= sf_permits.loc[:].head(5)
subset_sf_permits
