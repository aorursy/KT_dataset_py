...
fasttext.wv['england']
vocab = set(list(fasttext.wv.vocab.keys()))
'anarachy'in vocab
fasttext.wv['anarchy']
fasttext.wv.similar_by_vector(fasttext.wv['anarchy'])
fasttext = FastText.load('../input/english-wikipedia-articles-20170820-models/enwiki_2017_08_20_fasttext.model')
fasttext.wv.similar_by_vector(fasttext.wv['anarchy'])
vect = fasttext.wv['england'] - fasttext.wv['london'] + fasttext.wv['paris']
fasttext.wv.similar_by_vector(vect)
