...
def load_data(data_dir, train_row):
    ...
    print(train.shape)
    X_train = train.values[0:train_row, 1:] # (pixel 0 - pixel 783)
...
for y, cls in enumerate(classes):
    idxs = np.nonzero([i == y for i in Origin_y_train]) # index of non-zeroes
...
d = 10
print(y_pred[d])
plt.imshow(Origin_X_test[d].reshape(28, 28))
plt.show()
