...
# analyse the how data fit by Visualisation 
plot_loss_accuracy(history)
plot_decision_boundary(lambda x: model.predict(x), X, y)

# 2. analyse the how data fit by Visualisation 
y_pred = model.predict_classes(X, verbose=0)
print(classification_report(y, y_pred))
plot_confusion_matrix(model, X, y)
X, y = make_circles(n_samples=1000, noise=0.05, factor=0.3, random_state=0)
...
# 1. analyse the how data fit by Visualisation 
plot_loss_accuracy(history)
plot_decision_boundary(lambda x: model.predict(x), X, y)
# 2. analyse the how data fit by Visualisation 
y_pred = model.predict_classes(X, verbose=0)
...
del X,y
X, y = make_sine_wave()
# Visualising input with target column
...
# Visualising how the model fit and training accuracy and loss
plot_loss_accuracy(history)
...
# 1. Visualise the accuracy and loss of training dat after model fit
plot_loss_accuracy(history)
