...
# bridge-conditions-nys-department-of-transportation.csv has 17504 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/bridge-conditions-nys-department-of-transportation.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'bridge-conditions-nys-department-of-transportation.csv'
nRow, nCol = df1.shape
