...
df1 = pd.read_csv('/kaggle/input/Price/Train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Price/Test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Price/sample_submission.csv', delimiter=',', nrows = nRowsRead)
