...
array2
array2_cpy = array2[:, 1:] # 浅拷贝

array2_cpy
array2_cpy[:1,:1] = 1 # 将0行0列赋值为1
array2_cpy # 浅拷贝的结果发生了变化
array2 # 原来的数组也发生了变化
array2[array2==1] = 0

array2_cpy = array2[:,1:].copy() # 深拷贝

array2_cpy[:1,:1] = 666

array2_cpy
array2 # 深拷贝后, 原数组并不会发生变化
array2
array2.shape
...
array2_flatten_result = array2.flatten() # 拉平
array2_ravel_result
