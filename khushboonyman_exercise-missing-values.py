...
num_cols_with_missing = len(list(missing_val_count_by_column[missing_val_count_by_column > 0]))
...
#print(X_valid.columns[X_valid.isna().any()])
...
#print(si.fit(X_train).transform(X_train))
...
final_X_test = pd.DataFrame(si.transform(X_test))

#print(X_test.shape,final_X_test.shape)
