...
# API_YEM_DS2_en_csv_v2_10049258.csv has 1582 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/API_YEM_DS2_en_csv_v2_10049258.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'API_YEM_DS2_en_csv_v2_10049258.csv'
nRow, nCol = df1.shape
...
nRowsRead = 100 # specify 'None' if want to read whole file
# data_2017.csv has 15489 rows in reality, but we are only loading/previewing the first 100 rows
df2 = pd.read_csv('../input/data_2017.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'data_2017.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
...
nRowsRead = 100 # specify 'None' if want to read whole file
# Metadata_Indicator_API_YEM_DS2_en_csv_v2_10049258.csv has 1580 rows in reality, but we are only loading/previewing the first 100 rows
df3 = pd.read_csv('../input/Metadata_Indicator_API_YEM_DS2_en_csv_v2_10049258.csv', delimiter=',', nrows = nRowsRead)
df3.dataframeName = 'Metadata_Indicator_API_YEM_DS2_en_csv_v2_10049258.csv'
nRow, nCol = df3.shape
print(f'There are {nRow} rows and {nCol} columns')
df3.head(5)
