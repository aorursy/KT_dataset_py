...
sn_mse.fit(X_scaled_train, Y_train, epochs=500, learning_rate=0.01, loss_fn="mse", display_loss=True)
sn_ce = SigmoidNeuron()

sn_ce.fit(X_scaled_train, Y_train, epochs=2000, learning_rate=0.001, loss_fn="ce", display_loss=True)
...
submission.to_csv("submisision_level3.csv", index=False)