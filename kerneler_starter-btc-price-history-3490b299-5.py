...
# BTC_price_history.csv has 1293166 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/BTC_price_history.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'BTC_price_history.csv'
nRow, nCol = df1.shape
