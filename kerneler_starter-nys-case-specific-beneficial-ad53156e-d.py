...
# case-specific-beneficial-use-determinations-beginning-1988.csv has 1028 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/case-specific-beneficial-use-determinations-beginning-1988.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'case-specific-beneficial-use-determinations-beginning-1988.csv'
nRow, nCol = df1.shape
