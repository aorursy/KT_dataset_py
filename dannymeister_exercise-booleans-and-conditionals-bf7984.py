...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if player_total <= dealer_total: return True
    
    if(player_aces > 2): return player_total < 17
    else: return player_total < 18
...
def should_hit(player_total, dealer_total, player_aces):
    ...
    #this version is 17.17
    if(player_aces > 2): return player_total < 17
    else: return player_total < 17
