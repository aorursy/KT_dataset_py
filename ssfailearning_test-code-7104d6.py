    ...
    def _train_epoch(self, epoch):
        ...
        for batch_idx in tbar:
            if self.mode == 'supervised':
                ...
                if self.no_label:
                    (input_l, target_l,l_labels), (input_ul) = next(dataloader)
            ...
            print(self.loss_sup.value)
            print(self.loss_unsup.value)
    ...
    def _valid_epoch(self, epoch):
        ...
        with torch.no_grad():
            ...
            for batch_idx, (data, target) in enumerate(tbar):
                ...
                tbar.set_description('EVAL ({}) | Loss: {:.3f}, Mean IoU: {:.2f} |Class IOUL{:.2f}'.format(epoch,
...
def main():
    ...
    supervised_loader=create_dataloader('train',4)
    unsupervised_loader=create_dataloader('unlabel',4,no_label=True)
