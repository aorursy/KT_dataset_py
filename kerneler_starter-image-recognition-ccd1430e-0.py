...
print(os.listdir('../input/vn_celeb_face_recognition'))
...
df1 = pd.read_csv('../input/vn_celeb_face_recognition/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/vn_celeb_face_recognition/train.csv', delimiter=',', nrows = nRowsRead)
