...
print("Total count: ",len(province))
...
#'balochistan' and 'baluchistan' were the same cities spelled differently. The same has been corrected.
replace_matches_in_column(df=suicide_attacks, column='Province', string_to_match="balochistan")
province = suicide_attacks['Province'].unique()
province.sort()
print("Total values: ",len(province))
province