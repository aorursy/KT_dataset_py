...
sns.barplot(train['target'].value_counts().index,train['target'].value_counts(),palette='coolwarm')
# Let Look at what disaster andn non disaster tweet looks like
...
train.columns
# Exploring the location columns
...
train['text'][:5]
# Applyig=ng a first round of text cleaning technique
