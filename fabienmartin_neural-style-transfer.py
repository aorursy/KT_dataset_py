...
def run(content_path, style_path, num_iters=1000, content_weight=1e3, style_weight=1e-2, lr=10):
    ...
    for i in range(num_iters):
        ...
        if (i + 1) % eval_steps == 0:
            ...
            display_image(plot_image, width=20)
...
!wget -O content_image.jpg https://cdn.pixabay.com/photo/2016/11/08/04/49/jungle-1807476__340.jpg

!wget -O style_image.jpg https://www.pablopicasso.org/images/paintings/girl-before-a-mirror.jpg
...
display_image(deprocess(content_image), deprocess(style_image), col=2, width=20)
...
best_image, best_loss = run(
    ...
    num_iters=1000, lr=learning_rate,
