...
# coban-logs.csv has 51296535 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/coban-logs.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'coban-logs.csv'
nRow, nCol = df1.shape
