...
# toy_data.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/toy_data.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'toy_data.csv'
