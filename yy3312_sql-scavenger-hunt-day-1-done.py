...
print(  countries.country.size, 'countries use a unit other than ppm to measure any type of pollution:\n ', countries.country.values)
...
unique_pollutants = pollutants.pollutant.unique()
print( unique_pollutants.size, "pollutants have a value of exactly 0:\n", unique_pollutants)