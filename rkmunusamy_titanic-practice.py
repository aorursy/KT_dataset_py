...
gender_model = pd.read_csv("../input/titanic/gendermodel.csv")
...
X_train1['Sex1'] = a1.transform(X_train1['Sex'])

a2 = le.fit(X_train1['Pclass'])

X_train1['Pclass1'] = a2.transform(X_train1['Pclass'])



c1 = le.fit(X_test1['Sex'])

X_test1['Sex1'] = c1.transform(X_test1['Sex'])

c2 = le.fit(X_test1['Pclass'])

X_test1['Pclass1'] = c2.transform(X_test1['Pclass'])



X_train1 = X_train1[['Age', 'SibSp','Parch','Fare','Sex1', 'Pclass1']]

X_test1 = X_test1[['Age', 'SibSp','Parch','Fare','Sex1', 'Pclass1']]
...
test['Sex1'] = b1.transform(test['Sex'])

b2 = le.fit(test['Pclass'])

test['Pclass1'] = b2.transform(test['Pclass'])
