...
train_df = pd.read_csv('/kaggle/input/news-classfiy/train_set.csv/train_set.csv', sep='\t', nrows=100)
print(train_df)
train_df.head()
...
# 转换为FastText需要的格式
train_df = pd.read_csv('/kaggle/input/news-classfiy/train_set.csv/train_set.csv', sep='\t', nrows=15000)
...
fold_num = 10
data_file = '/kaggle/input/news-classfiy/train_set.csv/train_set.csv'
import pandas as pd
...
# test
test_data_file = '/kaggle/input/news-classfiy/test_a.csv/test_a.csv'
