...
df1 = pd.read_csv('/kaggle/input/PREPROCESSED-covid-sentiment.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/RAW-covid-sentiment.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/TRANSLATED-covid-sentiment.csv', delimiter=',', nrows = nRowsRead)
