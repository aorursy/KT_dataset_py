...
def should_hit(player_total, dealer_total, player_aces):
    ...
    if player_total < 12:
        ...
        return True
    elif player_total > 17 and dealer_total <= 7:
        return False
    elif player_total > 18 and dealer_total <= 8:
        return False
    elif player_total < 14 and dealer_total >= 7:
        return True
    elif player_total > (dealer_total + 11) and player_total > 17:
        return False
    else:
        return False
