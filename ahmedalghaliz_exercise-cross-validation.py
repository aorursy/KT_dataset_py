...
#step_1.solution()
candidate_max_leaf_nodes = [50,100, 150, 200, 250, 300, 350, 400]

results  = {}

for i  in range (len(candidate_max_leaf_nodes)):

    mae = get_score(candidate_max_leaf_nodes[i])

    results [candidate_max_leaf_nodes[i]] = mae

best_tree_size = sorted([(v,k) for k,v in mae_dict.items()])

print(results )

print (best_tree_size[0][1])  # Your code here
