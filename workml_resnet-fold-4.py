...
np.save('best_accuracy_last_fold4.npy',best_accuracy_last)

np.save('final_accuracy_last_fold4.npy',final_accuracy_last)

np.save('history_last_fold4.npy',history_last)

np.save('answers_last_fold4.npy',answers_last)

np.save('predictions_last_fold4.npy',predictions_last)

np.save('predictions_last_best_fold4.npy',predictions_last_best)

np.save('times_last_fold4.npy',times_last)