...
#My code for the same kde plots without FacetGrid

fig, axarr = plt.subplots(1, 2, figsize=(12,4))

sns.kdeplot(footballers[footballers.Position.isin(['ST'])]['Overall'], ax=axarr[0]).set_title("Position = ST")

sns.kdeplot(footballers[footballers.Position.isin(['GK'])]['Overall'], ax=axarr[1]).set_title("Position = GK")
df = footballers
