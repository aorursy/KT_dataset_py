...
missing_values_count = nfl_data.isnullll().sum()
# your code goes here :)
...
#total_miss = sf_permits.isnull().sum()

#
total_cell
total_miss = sf_permits.isnull().sum().sum()
total_miss
100 * (total_miss/total_cell)
# look at the # of missing points in the first ten columns
missing_values_count[0:10]
