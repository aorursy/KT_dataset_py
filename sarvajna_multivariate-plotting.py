...
#My code to plot a hex plot of Value vs Overall

sns.jointplot(x='Value', y='Overall', data=footballers, kind='hex', gridsize=20)
f = (footballers
...
sns.heatmap(data=pokemon[['HP', 'Attack', 'Sp. Atk', 'Defense', 'Sp. Def', 'Speed']].corr(), annot=True)
import pandas as pd
...
parallel_coordinates(pokemon[['Attack', 'Sp. Atk', 'Defense', 'Sp. Def', 'Type 1']][pokemon['Type 1'].isin(['Fighting', 'Psychic'])], 
