...
sf_total_cells = np.prod(sf_permits.shape)
...
sa_cols_with_na_dropped = sf_permits.dropna(axis=1)
sa_cols_with_na_dropped.shape[1]
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % sa_cols_with_na_dropped.shape[1])
#31 columns dropped..ohhh
