...
df1 = pd.read_csv('/kaggle/input/upvotes/train.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/upvotes/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/upvotes/sample_submission.csv', delimiter=',', nrows = nRowsRead)
