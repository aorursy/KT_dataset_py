...
columns_with_na_dropped_sf = sf_permits.dropna(axis=0)
columns_with_na_dropped_sf.head()
# Now try removing all the columns with empty values. Now how much of your data is left?
columns_with_na_dropped_sf = sf_permits.dropna(axis=1)
print("Columns in original dataset (sf): %d \n" % sf_permits.shape[1])
print("Columns with na's dropped (sf): %d" % columns_with_na_dropped_sf.shape[1])
...
subset_sf_data = sf_permits.loc[:, 'Street Number':'Street Suffix']
subset_sf_data
