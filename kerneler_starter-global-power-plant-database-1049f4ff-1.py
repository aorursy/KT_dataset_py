...
print(os.listdir('../input/globalpowerplantdatabasev110'))
...
df1 = pd.read_csv('../input/globalpowerplantdatabasev110/global_power_plant_database.csv', delimiter=',', nrows = nRowsRead)
