...
df1 = pd.read_csv('/kaggle/input/Participants_Data_WH18/Sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/Participants_Data_WH18/Test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/Participants_Data_WH18/Train.csv', delimiter=',', nrows = nRowsRead)
