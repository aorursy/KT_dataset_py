...
train = pd.read_csv('/kaggle/input/bikesharing-for-education/train.csv')

test = pd.read_csv('/kaggle/input/bikesharing-for-education/test.csv')

sample_submission = pd.read_csv('/kaggle/input/bikesharing-for-education/sample_submission.csv')
#必要な列だけ残す
