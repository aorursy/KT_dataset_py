...
# model = train(model,X,y,learning_rate=learning_rate,epochs=1000000,print_loss=False, stopatacc=100)
model = train(model,X,y,learning_rate=learning_rate,epochs=1000000,print_loss=False, stopatloss=.00001)
