...
OH_cols_train = pd.DataFrame(OH_encoder.fit_transform(drop_X_train[low_cardinality_cols]))

OH_cols_valid = pd.DataFrame(OH_encoder.transform(drop_X_valid[low_cardinality_cols]))
