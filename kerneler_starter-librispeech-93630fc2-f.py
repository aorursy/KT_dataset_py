...
df1 = pd.read_csv('/kaggle/input/asset/data/preprocess/meta/valid.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/asset/data/preprocess/meta/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/asset/data/preprocess/meta/train.csv', delimiter=',', nrows = nRowsRead)
