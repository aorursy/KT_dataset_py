...
oedata = alldata.groupby('TEAM',as_index=False)['ADJOE'].max()



plottingdata = oedata.sort_values('ADJOE',ascending=False).head(10)



print(plottingdata.plot(kind='line',x='TEAM',y='ADJOE',figsize=(15,5)))