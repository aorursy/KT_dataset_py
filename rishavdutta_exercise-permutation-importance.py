...
new_train_X_1, new_val_X_1, new_train_y_1, new_val_y_1 = train_test_split(X, y, random_state=1)

third_model = RandomForestRegressor(n_estimators=30, random_state=1).fit(new_train_X_1, new_train_y_1)
...
perm3 = PermutationImportance(third_model, random_state=1).fit(new_val_X_1, new_val_y_1) 



# show the weights for the permutation importance you just calculated

eli5.show_weights(perm3, feature_names = new_val_X_1.columns.tolist())
