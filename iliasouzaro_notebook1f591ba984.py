...
from keras import backend as K 
folder_benign_train = '../input/cancers/Train/Train/benin'
folder_malignant_train = '../input/cancers/Train/Train/malin'

folder_benign_test = '../input/cancers/Test/Test/benin'
folder_malignant_test = '../input/cancers/Test/Test/malin'
...
for i in range(1, columns*rows +1):
    ...
    if y_train[i] == 0:
        ax.title.set_text('Benin')
    else:
        ax.title.set_text('Malin')
...
def build(input_shape= (244,244,3), lr = 1e-3, num_classes= 2,
