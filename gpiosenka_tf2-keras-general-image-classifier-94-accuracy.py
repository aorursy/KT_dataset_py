...
import random as rd
def process_data(source_dir,output_dir, subject,image_size,t_split, v_split,rand_seed):
    ...
    class_list.remove ('flowers') # get rid of extraneous flower directory which shows up?
