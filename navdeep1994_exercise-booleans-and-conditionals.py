...
def should_hit(dealer_total, player_total, player_low_aces, player_high_aces):
    ...
    if(player_total<21 and player_total< dealer_total and dealer_total<21):
...
def should_hit(dealer_total, player_total, player_low_aces, player_high_aces):
    ...
    if(player_total<21 and player_total< dealer_total and dealer_total<21 and player_high_aces==0 and dealer_total<17):
