...
#train and test's data's shape

train.shape,test.shape
#A quick look at train and test's data
...
#train.drop(['MSSubClass'], axis = 1)
#分布直方图

train['SalePrice'].hist(bins = 40)
train['GrLivArea'].hist(bins = 40)
train = train[train.GrLivArea < 4000]#此处原来为< 4500
