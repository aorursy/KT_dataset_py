...
count_word_in_questions('fastapi', 'Title') + count_word_in_questions('fastapi', 'Body') + count_word_in_questions('fast api', 'Title') + count_word_in_questions('fast api', 'Body')
