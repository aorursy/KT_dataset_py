...
#What i learnt: if u select more that one column, wheen u group and order by, u need to put all columns selected

# if u select count(1), u must include group by clause
