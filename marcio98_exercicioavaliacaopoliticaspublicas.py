...
#3-Calcule quantos desvios precisará para seu grau de confiânça ex. numero_desvios = calcula_numero_desvios_tstudent_para_confianca(confiança, tamanho_amostr
...
media_amostra+margem_erro

inferior = media_amostra-margem_erro

print ("Intervalo inferior {}:". format (media_amostra-margem_erro))

superior = media_amostra+margem_erro

print ("Intervalo superior {}:". format (media_amostra+margem_erro))
...
print ("Amostra {}:". format (populacao, tamanho_amostra))
