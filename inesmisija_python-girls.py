...
labels = byregion_overall.reset_index()['Region']
plt.pie(values, labels= values)
plt.title('Number of death  by COVID-19  in Brasil per region')
plt.legend(labels,loc=3, bbox_to_anchor=(1, -0.2, 0.5, 1))
...
recent["NewCases-Yes/No"] = customized_bin(recent["New cases"], cuttingpoints, custom_labels)
...
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredNORTE.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
...
recent_filteredNORDESTE = recent[recent['Region'] =='Nordeste']
recent_filteredNORDESTE
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ## predict train-data
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredNORDESTE.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredNORDESTE, predictor_var, outcome_var, 5)
outcome_var = "NewdeathYesNo"
predictor_var = ["New death"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredNORDESTE, predictor_var, outcome_var, 5)
recent_filteredSUL = recent[recent['Region'] =='Sul']
recent_filteredSUL 
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredSUL.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredSUL, predictor_var, outcome_var, 5)
recent_filteredSUDESTE = recent[recent['Region'] =='Sudeste']
recent_filteredSUDESTE
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ## predict train-data
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredSUDESTE.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredSUDESTE, predictor_var, outcome_var, 5)
recent_filteredCENTROOESTE = recent[recent['Region'] =='Centro-Oeste']
recent_filteredCENTROOESTE
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ## predict train-data
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredCENTROOESTE.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredCENTROOESTE, predictor_var, outcome_var, 5)
recent_filteredSP = recent[recent['state'] =='SP']
recent_filteredSP
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredSP.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredSP, predictor_var, outcome_var, 5)
recent_filteredRJ = recent[recent['state'] =='RJ']
recent_filteredRJ
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredRJ.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredRJ, predictor_var, outcome_var, 5)
recent_filteredAM = recent[recent['state'] =='AM']
recent_filteredAM
def classification_model(model, data, predictors, outcome, kfoldnumber):
    ## fit data
    model.fit(data[predictors], data[outcome])
    ...
    ##
    model.fit(data[predictors], data[outcome])
recent_filteredAM.rename(columns={"NewDeaths-Yes/No":"NewdeathYesNo"},inplace=True)
outcome_var = "NewdeathYesNo"
predictor_var = ["New cases"]
model = LogisticRegression(solver="lbfgs")
##
classification_model(model,recent_filteredAM, predictor_var, outcome_var, 5)
