...
help(tally)
tally(data['state'])
tally(data['state'], percent = True, graph = True)
...
plot(data = goal, y = 'mean', x = 'state', style = 'lineplot', logy = True)
tally(data['country'])
help(query)
wrong = 'N,0"'
data = query(data = data, column = 'country', condition = "!= '{}'".format(wrong))
tally(data['country'])
...
help(sort)
sorts = sort(data['launched'], how = 'ascending')
launched = tabulate(year(data['launched']), data['main_category'], method = 'count_percent')
head(launched, 10)
launched = tabulate(year(data['launched']), data['main_category'], method = 'count_percent')
launched = query(data = launched, column = 'launched', condition = '>2000')
head(launched, 10)
...
head(year_month(data['launched']), 10)
...
data = locate(data, year_month(data['launched']) > 2000)
# You code goes here
project_year_month = tabulate(year_month(data['launched']), method='count')
plot(data = project_year_month, x = 'launched', y = 'count', style = 'regplot')
# Your code goes here
country_category = tabulate(data['country'], data['main_category'], data['state'], method='count_percent')
country_category_success = query(country_category, column = 'state', condition = '=="successful"')
plot(data = country_category_success, x = 'main_category', y = 'Percent%', column = 'country', style='barplot')