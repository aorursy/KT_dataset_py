...
# valid1.csv may have more rows in reality, but we are only loading/previewing the first 1000 rows

df3 = pd.read_csv('/kaggle/input/valid1.csv', delimiter=',', nrows = nRowsRead)

df3.dataframeName = 'valid1.csv'
