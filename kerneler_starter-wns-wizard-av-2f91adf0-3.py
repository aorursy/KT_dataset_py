...
print(os.listdir('../input/WNS Wizard 2019'))
...
df1 = pd.read_csv('../input/WNS Wizard 2019/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/WNS Wizard 2019/test.csv', delimiter=',', nrows = nRowsRead)
