...
apple_mobility = pd.read_csv('https://covid19-static.cdn-apple.com/covid19-mobility-data/2019HotfixDev15/v3/en-us/applemobilitytrends-2020-10-21.csv')
latest_data.head()
latest_data.tail()
latest_data.describe()
latest_data.corr()
latest_data.columns
sns.jointplot(x='Incidence_Rate',y='Case-Fatality_Ratio',data=latest_data)
sns.jointplot(x='Confirmed',y='Deaths', data=latest_data)
sns.jointplot(x='Recovered',y='Confirmed', data=latest_data)
sns.jointplot(x='Active',y='Confirmed', data=latest_data)
sns.jointplot(x='Case-Fatality_Ratio',y='Confirmed', data=latest_data)
sns.jointplot(x='Deaths',y='Recovered', data=latest_data)
sns.jointplot(x='Deaths',y='Active', data=latest_data)
sns.jointplot(x='Case-Fatality_Ratio',y='Recovered', data=latest_data)
sns.jointplot(x='Active',y='Recovered', data=latest_data)
sns.jointplot(x='Case-Fatality_Ratio',y='Active', data=latest_data)
confirmed_df.head()
confirmed_df.tail()
confirmed_df.corr()
