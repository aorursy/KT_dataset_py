...
cities_cleaned = suicide_attacks['City'].unique()
...
provinces_cleaned = suicide_attacks['Province'].unique()
provinces_cleaned.sort()
provinces_cleaned
# get all the unique values in the 'City' column
cities = suicide_attacks['City'].unique()
...
cities.sort()
cities
matches_1 = fuzzywuzzy.process.extract("kuram agency", cities, limit=10, scorer=fuzzywuzzy.fuzz.token_sort_ratio)
