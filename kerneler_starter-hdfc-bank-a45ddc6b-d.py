...
df1 = pd.read_csv('/kaggle/input/hdfc bank/Test.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/hdfc bank/Sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/hdfc bank/Train.csv', delimiter=',', nrows = nRowsRead)
