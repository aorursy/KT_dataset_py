...
df1 = pd.read_csv('/kaggle/input/category_tree.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('/kaggle/input/item_properties_part1.csv', delimiter=',', nrows = nRowsRead)
