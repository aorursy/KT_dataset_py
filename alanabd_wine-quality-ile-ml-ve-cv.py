...
def yenimetot(y_test,y_score):
    ...
    y_test = label_binarize(y_test, classes=[3,4,5,6,7,8,9])

    y_score = label_binarize(y_score, classes=[3,4,5,6,7,8,9])
    ...
    return roc_auc[6],fpr[6],tpr[6],thr[6]
...
plt.title('Wine quality Dataset ile Sınıflandırma',fontsize = 20,color='blue')
