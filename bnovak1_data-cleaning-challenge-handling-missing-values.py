...
# look at the # of missing points in the first ten columns
missing_values_count_nfl
print(sf_permits['Street Number Suffix'].sample(10))
print('\nPercent of missing street number suffixes:', 100*missing_values_count_permits['Street Number Suffix']/sf_permits.shape[0])
print(sf_permits['Zipcode'].sample(10))
print('\nPercent of missing zip codes:', 100*missing_values_count_permits['Zipcode']/sf_permits.shape[0])
...
'Percent of columns dropped: ' + str(round(100*sf_permits.dropna(axis=1).shape[1]/sf_permits.shape[1], 1)) + '%'
...
print(sf_permits['Proposed Construction Type'].head(6), '\n')
print('After imputing:')
print(sf_permits.fillna(method = 'bfill', axis=0).fillna("0")['Proposed Construction Type'].head(6))