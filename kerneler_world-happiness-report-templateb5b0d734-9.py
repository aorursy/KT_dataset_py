...
df0 = pd.read_csv('../input/2015.csv', delimiter=',', nrows = nRowsRead)
df0.name = '2015.csv'
# 2015.csv has 158 rows in reality, but we are only loading/previewing the first 100 rows
nRow, nCol = df0.shape
...
df1.name = '2016.csv'
# 2016.csv has 157 rows in reality, but we are only loading/previewing the first 100 rows
nRow, nCol = df1.shape
print(f'There are {nRow} rows and {nCol} columns')
...
df2.name = '2017.csv'
# 2017.csv has 155 rows in reality, but we are only loading/previewing the first 100 rows
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
