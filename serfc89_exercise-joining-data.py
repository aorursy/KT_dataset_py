...
answers_query = """
                  ...
                  FROM `bigquery-public-data.stackoverflow.posts_questions` as quest

                  INNER JOIN `bigquery-public-data.stackoverflow.posts_answers` AS ans

                  ON quest.id = ans.parent_id

                  WHERE quest.tags LIKE '%bigquery%'
...
bigquery_experts_query = """
                  ...
                  SELECT DISTINCT ans.owner_user_id as user_id,
