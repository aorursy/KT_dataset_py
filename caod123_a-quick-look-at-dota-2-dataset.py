...
chat.head()
bad_flags = chat.key.str.contains("stfu|fat|kill yourself|gay|homo|loser|jerk|dick|whore|bitch|tits|boobs|fag|faggot|cock|cunt|nigger|chink")

#bad_flags = chat.key.str.contains("i just fuked yo bitch in some gucci flip flops")



print(bad_flags.sum())

print(bad_flags.count())
chat[bad_flags.fillna(False)].head(100)
chat[bad_flags.fillna(False)].unit.value_counts()