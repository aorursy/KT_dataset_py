...
second_fashion_model.add(Conv2D(16,activation='relu',kernel_size=3,

                         input_shape = (img_rows, img_cols, 1)))

# Changed kernel sizes to be 2

second_fashion_model.add(Conv2D(16, activation='relu', kernel_size=2))

second_fashion_model.add(Conv2D(32, activation='relu', kernel_size=2))
