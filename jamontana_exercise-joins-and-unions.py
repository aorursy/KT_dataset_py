...
correct_query = """
                ...
                SELECT question.id AS question_id,
                    ...
                    MIN(TIMESTAMP_DIFF(answer.creation_date, question.creation_date, SECOND)) as time_to_answer
                ...
                WHERE question.creation_date >= '2018-01-01' and question.creation_date < '2018-02-01'
