...
# broadband-speed-test.csv has 4068 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/broadband-speed-test.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'broadband-speed-test.csv'
nRow, nCol = df1.shape
