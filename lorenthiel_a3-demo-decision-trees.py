...
gain_handsome = IG([entropy(p), S_h0, S_h1], [7, 3, 4])
...
dot_data = export_graphviz(model,
                         feature_names=["Looks_repulsive", "Money_spent_little","Eloquence_average", "Alcoholic_beverage_no", "Alcoholic_beverage_yes", "Money_spent_lots", "Eloquence_high", "Looks_handsome"],  
                         class_names=["Will_go"],  
                         filled=True,
                         rounded=True,  
