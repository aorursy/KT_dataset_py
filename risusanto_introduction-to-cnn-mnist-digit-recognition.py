...
try:
    ...
    os.mkdir('train_results/models')

    print(" Pretrained models directory Created ") 
...
trained_models_path = base_path + 'models/'
...
submission.to_csv("kaggle_digit_recognizer_submission.csv",index=False)