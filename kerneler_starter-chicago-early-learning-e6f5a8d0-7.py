...
# chicago-early-learning-programs.csv has 706 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/chicago-early-learning-programs.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'chicago-early-learning-programs.csv'
nRow, nCol = df1.shape
