...
total_missing_sf = missing_sf.sum()
...
drop_sf_permits = sf_permits.dropna(axis=1)
drop_sf_permits.head()
# Now try removing all the columns with empty values. Now how much of your data is left?
print("Columns in original dataset: %d \n" % sf_permits.shape[1])
print("Columns with na's dropped: %d" % drop_sf_permits.shape[1])
...
subset_sf_permits = sf_permits.loc[:, 'Permit Number':'Current Status'].head()
subset_sf_permits
