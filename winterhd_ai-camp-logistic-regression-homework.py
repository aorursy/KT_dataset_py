...
plt.xlabel('satisfaction level')
plt.ylabel('total number')
plt.title('satisfaction level distribution for not left staff')
plt.show()
data[data.left==1].satisfaction_level.hist()
plt.xlabel('satisfaction level')
plt.ylabel('total number')
plt.title('satisfaction level distribution for left staff')
plt.show()
y, X = dmatrices('left\
                 ~ satisfaction_level\
                 + last_evaluation\
                 ...
                 + C(sales)\
                 + C(salary)', data, return_type='dataframe')
X = X.rename(columns = {
