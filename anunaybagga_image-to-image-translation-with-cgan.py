...
train("edges2shoes",epochs=51, batch_size=32, show_interval=5)
generator.save("SHOE_GAN.h5")
discriminator.save("dis.h5")
generator.save('gan_model_shoe.h5')
train("edges2shoes",epochs=1, batch_size=32, show_interval=5)