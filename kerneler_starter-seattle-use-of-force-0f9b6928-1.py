...
# use-of-force.csv has 8129 rows in reality, but we are only loading/previewing the first 100 rows
df1 = pd.read_csv('../input/use-of-force.csv', delimiter=',', nrows = nRowsRead)
df1.dataframeName = 'use-of-force.csv'
nRow, nCol = df1.shape
