...
df1 = pd.read_csv('/kaggle/input/make_rofneft_predict/data/sample_submission.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('/kaggle/input/make_rofneft_predict/data/train/train.csv', delimiter=',', nrows = nRowsRead)
