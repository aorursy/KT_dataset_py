...
low_cardinality_cols =[i for i in object_cols if X_train[i].nunique()<10]
...
low_cardinality_cols = ['Street', 'LotShape', 'LandContour', 'LotConfig', 'BldgType', 'ExterQual', 'CentralAir', 'PavedDrive', 'SaleCondition']
