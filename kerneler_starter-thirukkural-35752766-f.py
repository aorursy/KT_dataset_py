...
df1 = pd.read_csv('../input/Thirukural With Explanation.csv', delimiter=',', nrows = nRowsRead)
...
nRowsRead = 1000 # specify 'None' if want to read whole file
# Thirukural.csv has 1330 rows in reality, but we are only loading/previewing the first 1000 rows
df2 = pd.read_csv('../input/Thirukural.csv', delimiter=',', nrows = nRowsRead)
df2.dataframeName = 'Thirukural.csv'
nRow, nCol = df2.shape
print(f'There are {nRow} rows and {nCol} columns')
df2.head(5)
