...
X_train, y_train = dados_exemplo(1000)

X_test, y_test = dados_exemplo(100)
clf = Sequential()
...
plt.title("Acurácia por Época com função de ativação sigmoid", fontsize=20)
