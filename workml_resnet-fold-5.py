...
mod=resnet.ResNet50(include_top=True, weights='imagenet')
...
class DataGenerator(keras.utils.Sequence):
  ...
  for i in range(epoch):
      ...
      hist=model.fit_generator(train_data,epochs=1,validation_data=[tst_x,to_categorical(tst_y)],steps_per_epoch=len(trn_x)//2)
  ...
  gc.collect()
np.save('best_accuracy_last_fold5.npy',best_accuracy_last)

np.save('final_accuracy_last_fold5.npy',final_accuracy_last)

np.save('history_last_fold5.npy',history_last)

np.save('answers_last_fold5.npy',answers_last)

np.save('predictions_last_fold5.npy',predictions_last)

np.save('predictions_last_best_fold5.npy',predictions_last_best)

np.save('times_last_fold5.npy',times_last)