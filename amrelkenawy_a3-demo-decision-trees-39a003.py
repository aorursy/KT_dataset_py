...
tree_predcs = tree.predict(X_test)
accuracy_score(y_test,tree_predcs) #84,4
...
rf_predcs = rf.predict(X_test)
accuracy_score(y_test,rf_predcs)
...
locally_best_forest_pred = rf.predict(X_test)
