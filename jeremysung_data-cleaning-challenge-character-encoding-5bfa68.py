...
print(result) # TypeError: Expected object of type bytes or bytearray, got: <class 'str'>
...
# Verify:
police_killings_utf8_df = pd.read_csv("police_killings_utf8.csv")
police_killings_utf8_df.head()