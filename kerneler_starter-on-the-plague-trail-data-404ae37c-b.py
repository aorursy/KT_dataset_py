...
print(os.listdir('../input/8f86dc50-7-dataset'))
...
df1 = pd.read_csv('../input/8f86dc50-7-dataset/sample.csv', delimiter=',', nrows = nRowsRead)
...
df2 = pd.read_csv('../input/8f86dc50-7-dataset/test.csv', delimiter=',', nrows = nRowsRead)
...
df3 = pd.read_csv('../input/8f86dc50-7-dataset/train.csv', delimiter=',', nrows = nRowsRead)
